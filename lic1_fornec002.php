...
WHERE z01_numcgm = $pc21_numcgm";
  ...
  $cpfcnpj = db_utils::fieldsMemory($result, 0)->z01_cgccpf;
...
//  $cgmValido = false;
  if($cpfcnpj == '00000000000'){
    echo "<script>alert('O CGM selecionado não possui CPF, corrija o cadastro e em seguida tente novamente.');</script>";
  }else if($cpfcnpj == '0000000000000'){
    echo "<script>alert('O CGM selecionado não possui CNPJ, corrija o cadastro e em seguida tente novamente.');</script>";
  }else if($cpfcnpj == ''){
    echo "<script>alert('O CGM selecionado não possui CPF/CNPJ, corrija o cadastro e em seguida tente novamente.');</script>";
  }
