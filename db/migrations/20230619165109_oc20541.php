...
class Oc20541 extends AbstractMigration
{
    ...
    public function up()
    {
        $sSql = "
        BEGIN;
        INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr07_modalidade','int4' ,'Modalidade','', 'Modalidade',11,false, false, false, 1, 'int4', 'Modalidade');
