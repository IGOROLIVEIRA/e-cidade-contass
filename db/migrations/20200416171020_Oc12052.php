...
class Oc12052 extends AbstractMigration
{
    public function change()
    {
        ...
        ('333939100000000', 'Sentencas Judiciais', 0, 2, 0, 'N', 1),
        ('344501400000000', 'Diarias - Civil', 0, 2, 0, 'N', 1),
        ('344900400000000', 'Contratacao por Tempo Determinado', 0, 2, 0, 'N', 1),
        ...
        INSERT INTO conplanoorcamento
        SELECT conplanoorcamento.c60_codcon,
               t1.c60_anousu,
        ...
        JOIN conplanoorcamento t1 ON t1.c60_estrut = '331901103000000'
        WHERE conplanoorcamento.c60_estrut NOT IN (SELECT c60_estrut FROM conplanoorcamento WHERE c60_anousu > 2020)
          AND conplanoorcamento.c60_estrut IN (SELECT estrut FROM new_ctas_orc)
