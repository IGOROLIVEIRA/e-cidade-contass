      ...
      $sql = <<<SQL
                    BEGIN;
                        ...
                        SELECT fc_startsession();
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_numartourrt'		,'int8' ,'Nъmero da anotaзгo de responsabilidade tйcnica ou registro de responsabilidade tйcnica.' ,'', 'Numero da ART ou RRT'	 ,16	,false, false, false, 1, 'int8', 'Numero da ART ou RRT');
