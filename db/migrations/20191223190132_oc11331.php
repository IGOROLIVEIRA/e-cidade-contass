      ...
      $sql = <<<SQL
                    BEGIN;
                        ...
                        SELECT fc_startsession();
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_seqobra'	 		,'int4' ,'Nє Obra' 					,'', 'Nє Obra'	 			 	,11	,false, false, false, 1, 'int4', 'Nє Obra');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_situacao'  			,'int4' ,'Situaзгo'					,'', 'Situaзгo'				 	,16	,false, false, false, 1, 'int4', 'Situaзгo');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_motivoparalisacao'  ,'int4' ,'Motivo Paralizaзгo'		,'', 'Motivo Paralizaзгo'		,11	,false, false, false, 1, 'int4', 'Motivo Paralizaзгo');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_instit'		 		,'int4' ,'Instituiзгo'				,'', 'Instituiзгo'			 	,11	,false, false, false, 1, 'int4', 'Instituiзгo');
