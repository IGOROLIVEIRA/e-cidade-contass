      ...
      $sql = <<<SQL
                    BEGIN;
                        ...
                        SELECT fc_startsession();
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr01_licitacao'	 		,'int8' ,'Processo Licitatуrio' ,'', 'Processo Licitatуrio'	 ,11	,false, false, false, 1, 'int8', 'Processo Licitatуrio');
                          ...
                          -- INSERE db_syscampo
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_sequencial'	 		,'int8' ,'Cуd. Sequencial'		,'', 'Cуd. Sequencial'			 ,11	,false, false, false, 1, 'int8', 'Cуd. Sequencial');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_seqobra'	 		  ,'int8' ,'Nє Obra' 					  ,'', 'Nє Obra'	 			 	,11	,false, false, false, 1, 'int8', 'Nє Obra');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_responsavel'		,'int8' ,'Responsбvel'			  ,'', 'Responsбvel'			 ,16	,false, false, false, 1, 'int8', 'Responsбvel');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_tiporesponsavel','int8' ,'Tipo Responsбvel'		,'', 'Tipo Responsбvel'		 ,16	,false, false, false, 1, 'int8', 'Tipo Responsбvel');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_numartourrt'		,'int8' ,'Nъmero da anotaзгo de responsabilidade tйcnica ou registro de responsabilidade tйcnica.' ,'', 'Numero da ART ou RRT'	 ,13	,false, false, false, 1, 'int8', 'Numero da ART ou RRT');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_vinculoprofissional','int8' ,'Vinculo do Prof. com a Adm. Pъblica'	,'', 'Vinculo do Prof. com a Adm. Pъblica'		 ,16	,false, false, false, 1, 'int8', 'Vinculo do Prof. com a Adm. Pъblica');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr05_instit'		 		    ,'int8' ,'Instituiзгo'				,'', 'Instituiзгo'			 	,11	,false, false, false, 1, 'int8', 'Instituiзгo');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_veiculopublicacao'  ,'text' ,'Veнculo Publicaзгo'		,'', 'Veнculo Publicaзгo'	 	,50	,false, false, false, 0, 'text', 'Veнculo Publicaзгo');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_motivoparalisacao'  ,'int8' ,'Motivo Paralisaзгo'		,'', 'Motivo Paralisaзгo'		,11	,false, false, false, 1, 'int8', 'Motivo Paralisaзгo');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr02_dtparalisacao'		,'date' ,'Data Paralisaзгo'			,'', 'Data Paralisaзгo'		 	,10	,false, false, false, 0, 'date', 'Data Paralisaзгo');
                          ...
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr03_vlrmedicao'	 		,'float8' ,'Valor Mediзгo' 			,'', 'Valor Mediзгo' 			,11	,false, false, false, 4, 'float8', 'Valor Mediзгo');
                          ...
                          -- INSERE db_sysarquivo
                          INSERT INTO db_sysarquivo VALUES((select max(codarq)+1 from db_sysarquivo),'licobrasanexo','Cadastro de imagens da Mediзгo','obr04','2020-01-03','Cadastro de imagens da Mediзгo',0,'f','f','f','f');

                          -- INSERE db_sysarqmod
                          INSERT INTO db_sysarqmod (codmod, codarq) VALUES ((select codmod from db_sysmodulo where nomemod like '%Obras%'), (select max(codarq) from db_sysarquivo));

                          -- INSERE db_syscampo
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr04_sequencial'       ,'int8' ,'Cуd. Sequencial' ,'', 'Cуd. Sequencial' ,11 ,false, false, false, 1, 'int8', 'Cуd. Sequencial');
                          INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'obr04_licobrasmedicao'  ,'int8' ,'Obras Mediзгo'   ,'', 'Obras Mediзгo'   ,11 ,false, false, false, 1, 'int8', 'Obras Mediзгo');
