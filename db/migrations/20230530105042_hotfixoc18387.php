...
class Hotfixoc18387 extends AbstractMigration
{
    ...
    insert into db_documento values ((select max(db03_docum)+1 from db_documento),'SOLICITACAO DE DISPO. FINANCEIRA1',1,1);
    ...
    insert into db_documento values ((select max(db03_docum)+1 from db_documento),'DECLARACAO DE REC. ORC. E FINANCEIRO1',1,1);
