...
class Bugfixvarrel extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        INSERT INTO db_syscampo VALUES ((select max(codcam)+1 from db_syscampo), 'dCriacao','date' ,'Data de criaчуo mъs textual','', 'Data de criaчуo mъs textual',16	,false, false, false, 0, 'date', 'Data de criaчуo mъs textual');
