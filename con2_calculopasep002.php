...
foreach ($aReceitas as $Receitas) {
    ...
    if (substr($Receitas->o57_fonte, 0, 3) == '495') $fTEUEDM += abs($Receitas->saldo_arrecadado);
    if (substr($Receitas->o57_fonte, 0, 2) == '47') $fRCI += abs($Receitas->saldo_arrecadado);
            ...
            <table class="waffle" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <?php if ($RPPS) { ?>
                        ...
                        <tr style=''>
                            <td class="s3 bdleft">
                                Retificações da Receita Investimentos RRPS
                            </td>
