...
INSERT INTO db_menu VALUES ((select max(id_item) - 1 from db_itensmenu), (select max(id_item) + 1 from db_itensmenu), 1, 604);
...
INSERT INTO db_menu VALUES ((select max(id_item) - 2 from db_itensmenu), (select max(id_item) + 1 from db_itensmenu), 2, 604);
