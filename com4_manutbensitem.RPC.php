  ...
  switch ($oParam->exec) {
    ...
    case "getItens":
      ...
      for ($i = 0; $i < pg_numrows($rsResultItens); $i++) {
        ...
        $oItem->t99_itemsistema =  $item->t99_itemsistema == "1" ? "Sim" : urlencode("Não"); //$item->t99_itemsistema;
        $oItem->t99_codpcmater =    $item->t99_codpcmater == null ? "-" : $item->t99_codpcmater; //$item->t99_codpcmater;
