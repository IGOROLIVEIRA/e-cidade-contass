...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
    <center>
            ...
            <form action="" method="post" id="form1">
                            ...
                            <td width="100%">
                                <table width="100%" id="Aditamento">
                                    <tr style="background: #ffffff; height: 20px;">
                                        <th style="height: 25px; font-size:14px; background: #ffffff;">C�d. Aditamento</th>
                                        ...
                                        <th style="height: 25px; font-size:14px; background: #ffffff;">Data Publica��o</th>
                                        <th style="height: 25px; font-size:14px; background: #ffffff;">Veiculo de Divulga��o</th>
                                        <th style="height: 25px; font-size:14px; background: #ffffff;">Descri��o da Altera��o</th>
                                        <th style="height: 25px; font-size:14px; background: #ffffff;">Vig�ncia</th>
                                    </tr>
                                    <tr style="background: #ffffff; height:20px; ">
                                        ...
                                        <td style=""><?php echo date("d/m/Y", strtotime($oResult[0]->ac18_datainicio)) . " � " . date("d/m/Y", strtotime($oResult[0]->ac18_datafim)); ?></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                ...
                <fieldset style="width: 75%; margin-bottom: 10px">
                    ...
                    <table style='width: 100%; background: #ffffff;' border='0' align="center">
                        <tr style="background: #ffffff; height: 20px;">
                            <th style="height: 25px; font-size:14px; background: #ffffff;">C�digo Item</th>
                            <th style="height: 25px; font-size:14px; background: #ffffff;">Descri��o</th>
                            <th style="height: 25px; font-size:14px; background: #ffffff;">Quantidade</th>
                            <th style="height: 25px; font-size:14px; background: #ffffff;">Valor Unit�rio</th>
        ...
        <?php endif; ?>
            ...
            <div style="margin-right:910px; width: 10%;  <?php if (strcmp($oResult[0]->tipoaditivo, "12-Altera��o de Projeto/Especifica��o") != 0) {
                                                                echo "display: none;";
                                                            } ?>">
                <fieldset>
                    ...
                    <table style='width: 100%; ' align="right">
                        <tr>
                            <td style="height: 25px; font-size:12px; background: #7CFC00;"><strong>Itens inclu�dos</strong></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
