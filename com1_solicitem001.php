...
// Nova rotina inclui solicita��o de compras em processo ou licita��o
...
/**
 * Verificamos se a solicita��o � de um registro de preco(pc10_solicitacaotipo = 5);
...
if (isset($incluir) || isset($alterar)) {
  ...
  if (isset($incluir)) {
    ...
    if ($pc30_contrandsol=='t') {
      // db_msgbox("Controle do Andamento da Solicita��o!!Em manuten��o!!N�o � nescess�rio dar Andamento Inicial!!");
    }
  } else {
    $operacao = "Altera��o";
  }
  ...
  if ($pc30_obrigamat == 't') {
    if ((isset($pc16_codmater) && $pc16_codmater == "") || !isset($pc16_codmater)) {
      $naodig = false;
      $sqlerro = true;
      $erro_msg = "Usu�rio: \\n\\n$operacao abortada.\\nC�digo do material n�o informado. Campo obrigat�rio.\\n\\nAdministrador:";
    }
  }
  if ($pc30_obrigajust == 't') {
    if ((isset($pc11_just) && $pc11_just == "") || !isset($pc11_just)) {
      $naodig = true;
      $sqlerro = true;
      $erro_msg = "Usu�rio: \\n\\n$operacao abortada.\\nJustificativa para compra n�o informada.\\n\\nAdministrador:";
    } else {
      if (strlen(trim($pc11_just)) < $pc30_mincar) {
        $naodig = true;
        $sqlerro = true;
        $erro_msg = "Usu�rio: \\n\\n$operacao abortada.\\nJustificativa para compra deve ter no m�nimo $pc30_mincar caracteres.\\n\\nAdministrador:";
      }
    }
  }
}
  ...
  if ($sqlerro == false) {
    ...
    if ($sqlerro == false) {
      if (isset($param) && trim($param) != "") {
        if (isset($codproc) && trim($codproc) != "") {
          // Esse teste e para o caso de materiais de licitacao excluidos, o processo � excluido qdo nao
            ...
            if ($sqlerro == false) {
              ...
              if ($clliclicita->numrows > 0) {  // Existem itens no lote
                ...
                if ($clliclicita->numrows > 0){
                  ...
                  $sqlerro  = true;
                  $erro_msg = "Tipo de Julgamento n�o encontrado para Licita��o $codliclicita. Verifique.";
                }
              }
    ...
    if ($sqlerro == false && isset($pc16_codmater) && $pc16_codmater != "") {
      ...
      if ($clsolicitempcmater->numrows > 0) {
        $msg_alert = "AVISO \\n\\nItem ja cadastrado nesta solicita��o.";
        db_msgbox($msg_alert);
   ...
   // echo "<br>" . $pc11_servicoquantidade; die();
    ...
    /**
     * Quando o Servi�o Controlado por Quantidade: N�O o sistema sete automaticamente a unidade de medida servi�o para ele
     * @see: OC 3666
     */
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------
    //---------------------------------------------------------------------------------------------------------------------------------------------
    //-----------------------CONTROLE DE ANDAMENTO DOS ITENS DA  SOLICITA��O - ROGERIO BAUM --------------------------------
    /*
*CRIA UM PROCESSO PARA CADA ITEM DA SOLICITA��O E GRAVA O CODIGO DA SOLICITA��O E DO PROCESSO NA TABELA SOLICITEMPROT
*/
    /*
...
*/
  ...
  if (!isset($pc16_codmater) || (isset($pc16_codmater) && $pc16_codmater == "")) {
    ...
    if (($digitouresumo == "false" && trim($pc11_resum) == "") || (isset($pc11_resum) && $pc11_resum == "")) {
      ...
      $naodig = true;
      $sqlerro = true;
      $erro_msg = "Usu�rio:\\n\\nAltera��o abortada. \\nMaterial e resumo do item n�o informados.\\n\\nAdministrador:";
...
e55_sequen is not null and e54_anulad is null"
      ...
      if ($clpcproc->numrows > 0) {
        $sqlerro  = true;
        $erro_msg = "Item n�o pode ser alterado, pois j� autorizado a empenho!";
      }
        ...
        for ($i = 0; $i < $numrows_pcdotac; $i ++) {
          ...
          if ($pc11_quant != $pc11_quant_ant) {
            ...
            if ($clpcdotac->numrows > 0) {
              ...
              if ($pc11_quant < $quant_solic) {
                $passa1 = true;
                $msg_alert2 = " - Quantidade de itens por dota��o.\\n";
          ...
          if ($pc30_gerareserva == "t") {
            ...
            if ((isset($tot) && $tot < 0) && $sqlerro == false) {
              ...
              if ($saldoreserva == 0) {
                db_msgbox("\\nATEN��O: \\nUma, ou mais dota��es, est� sem saldo dispon�vel para reserva.\\nReserva ser� exclu�da.\\n");
              }
            }
          }

          if ($passa == true || $passa1 == true) {
            $msg_alert = "ALERTA: \\n Ocorrer�o, automaticamente, as seguintes altera��es nas dota��es com este item: \\n";
            $msg_alert1 = " - Valores das dota��es.\\n";
          }
          ...
          if ($sqlerro == false) {
            ...
            if ($clpcdotac->erro_status == 0) {
              $msg_alert = "Altera��o nas dota��es n�o efetuada.";
              $sqlerro = true;
              break;
            }
            if ($pc30_gerareserva == "t") {
              ...
              if ($sqlerro == false && isset($sqlerrosaldo) && $sqlerrosaldo == false && isset($o80_codres) && $o80_codres != "") {
                ...
                if ($clorcreservasol->erro_status == 0) {
                  ...
                  $msg_alert = "Altera��o na reserva de saldo n�o efetuada.";
                  $sqlerro = true;
                  break;
                }
...
e55_sequen is not null and e54_anulad is null"
      ...
      if ($clpcproc->numrows > 0) {
        ...
        // Exclusao de or�amento de processo de compras
...
where pc20_codorc = $codorc";
      ...
      if ($flag_pcproc == true) {
        $sqlerro  = true;
        $erro_msg = "Item n�o pode ser excluido, pois j� autorizado a empenho!";
      }
    }
    ...
    if ($sqlerro == false) {
      if (isset($codliclicita) && trim($codliclicita) != "") {
        ...
        if (isset($codlic) && trim($codlic) != "") {
          // Excluir or�amento de licitacao
          $result_pcorcamitem = $clpcorcamitem->sql_record($clpcorcamitem->sql_query_pcmaterlic(null,
...
//  $sqlerro = true;
  db_fim_transacao($sqlerro);
  // A quantidade de itens das dota��es ser�o atualizadas automaticamente!
}
...
if (isset($pc11_numero)) {
  ...
  /**
   * Verificamos se o usu�rio vinculou algum plano no cadastro da
   * solicitacao, caso a a solicita��o esteje vicnulado,
