...
/*
 * Vari�vel que controla se campos s�o edit�veis ou n�o.
 */
...
<html>
  ...
  <body bgcolor=#CCCCCC onload='if(document.form1.r01_regist) js_tabulacaoforms("form1","r01_regist",true,1,"r01_regist",true);'>
      ...
      if(isset($HTTP_POST_VARS["pesquisar"]) || isset($matricula) ) {
        ...
        if(!empty($HTTP_POST_VARS["r01_regist"])) {
         ...
         $matricula = $HTTP_POST_VARS["r01_regist"];
          ...
          ///////// VERIFICA SE A MATR�CULA POSSUI SAL�RIO
          ...
          if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI SUPLEMENTAR
            if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
              $iInstit = db_getsession("DB_instit");
              $sSql    = "SELECT *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI F�RIAS
           $resultgerffer = db_query("select *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI RESCISAO
           $resultgerfres = db_query("select *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI ADIANTAMENTO
           $resultgerfadi = db_query("select *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI 13 SAL�RIO
          ...
          ///////// VERIFICA SE A MATR�CULA POSSUI COMPLEMENTAR
          if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
            $iInstit = db_getsession("DB_instit");
            $sSql = "SELECT *
                       FROM rhhistoricocalculo
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI ponto fixo
           $resultgerffx = db_query("select *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI ajuste previdencia
           $resultpreviden = db_query("select *
            ...
            //////// VERIFICA SE A MATR�CULA POSSUI ajuste irf
           $resultajusteir = db_query("select *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI PROVIS�O DE F�RIAS
           $resultgerfprovfer = db_query("select *
            ...
            ///////// VERIFICA SE A MATR�CULA POSSUI PROVIS�O 13
                ...
                <table width="100%" >
                    <tr>
                      <td width="33%">
                       ...
                       <!-- Informa��es Matricula -->
                       <form action="">
                         <fieldset style="height:89%">
                           <legend>Informa��es do Servidor</legend>
                      ...
                      <td width="67%" height="100%" valign="top">
                        ...
                        <!-- Calculo Pontos -->
                        <fieldset>
                        <legend>Informa��es C�lculo</legend>
                        <table>
                          <tr class="links">
                            <td valign="top" width="33,3%" height="90%">
                              <fieldset>
                                <legend>C�lculos:</legend>
                                ...
                                <?php
                                  ...
                                  if ( @$temsalario == true || @$lTemSuplementar) {
                                    ...
                                    $aCalculos['salario'] = array("sLabel" => "SAL�RIO");

                                    if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()){
                                      $aCalculos['salario'] = array("sLabel" => "SAL�RIO/SUPLEMENTAR");
                                    }
                                  }
                                  ...
                                  if (@$temrescisao == true ) {
                                    ...
                                    $aCalculos['rescisao'] = array("sLabel" => "RESCIS�O");
                                  }
                                  ...
                                  if(@$temferias == true ){
                                    ...
                                    $aCalculos['ferias'] = array("sLabel" => "F�RIAS");
                                  }
                                  ...
                                  if (@$tem13salario == true ) {
                                    ...
                                    $aCalculos['13salario'] = array("sLabel" => "13o. SAL�RIO");
                                  }
                                 ...
                                 if (@$tempontofixo == true ) {
                                  ...
                                  if (@$temgerfprovfer == true ) {
                                    ...
                                    $aCalculos['gerfprovfer'] = array("sLabel" => "PROV. F�RIAS");
                                  }
                                  ...
                                  if (@$temgerfprovs13 == true ){
                                    ...
                                    $aCalculos['gerfprovs13'] = array("sLabel" => "PROV. 13o. SAL�RIO");
                                  }
                                  ...
                                  if (@$temajustepreviden == true ) {
                                    ...
                                    $aCalculos['previden'] = array("sLabel" => "AJUSTE PREVID�NCIA");
                                  }
    ...
    function js_mostraPonto(sPonto, iMatricula, sChama, sMuda) {
       ...
       * Fixo         : fx
       */
      js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_ponto','pes1_pontofx001.php?lConsulta=1&sPonto='+sPonto+'&iMatricula='+iMatricula+'&sChama='+sChama+'&sMuda='+sMuda+'&funcao_js=parent.js_preenche|0|1|2|3','Manuten�� do Ponto',true);
    }
        ...
        <fieldset style='height: 120px'>
          <legend><strong>Pontos</strong></legend>
            ...
            if ( @$temsalario ) {
              ...
              $aPontos['salario']            = array("sLabel" => "SAL�RIO", "lPermiteManutencao" => $lPermiteManutecao);
            }
            ...
            if ( @$temrescisao ) {
              ...
              $aPontos['rescisao']           = array("sLabel" => "RESCIS�O", "lPermiteManutencao" => $lPermiteManutecao);
            }

            if ( @$temferias ) {

              // Remove a op��o de editar o ponto de f�rias caso o sal�rio e a complementar estejam fechados
              if (DBPessoal::verificarUtilizacaoEstruturaSuplementar()) {
                if ( !FolhaPagamentoSalario::hasFolhaAberta($oCompetenciaFolha)
                  || !FolhaPagamentoComplementar::hasFolhaAberta($oCompetenciaFolha) ) {

                  $aPontos['ferias'] = array("sLabel" => "F�RIAS", "lPermiteManutencao" => false);
                } else {

                $lPermiteManutecao = db_permissaomenu( $iAnoUsu, 952, 4509) == "true";
                $aPontos['ferias'] = array("sLabel" => "F�RIAS", "lPermiteManutencao" => $lPermiteManutecao);
                }
              } else {
            ...
            if ( @$tem13salario ) {
              ...
              $aPontos['13salario']          = array("sLabel" => "13� SAL�RIO", "lPermiteManutencao" => $lPermiteManutecao);
            }
            ...
            if ( @$temgerfprovfer ) {
              ...
              $aPontos['provfer'] = array("sLabel" => "PROV. DE F�RIAS", "lPermiteManutencao" => $lPermiteManutecao);
            }

            if ( @$temgerfprovs13 ) {

              $lPermiteManutecao  = null;
              $aPontos['provs13'] = array("sLabel" => "PROV. DE 13�", "lPermiteManutencao" => $lPermiteManutecao);
            }

            if ( @$temajustepreviden ) {

              $lPermiteManutecao        = null;
              $aPrevidencia['previden'] = array("sLabel" => "AJUSTE PREVIDE�NCIA", "lPermiteManutencao" => $lPermiteManutecao);
            }
    ...
    $campos_pessoal_ = "RH02_ANOUSU as r01_anousu,
                        ...
                        <table width="100%" border="0">
                          <tr>
                            <td nowrap class="tabcols">
                              <strong># - Incid�ncia da Base </strong>
                            </td>
                          </tr>
                          <tr>
                            <td nowrap class="tabcols">
                              <strong>B - F�rmula com a Base</strong>
                            </td>
                          </tr>
                          <tr>
                            <td nowrap class="tabcols">
                              <strong>* - N�mero da F�rmula Escolhida </strong>
                            </td>
                          </tr>
                        </table>
                      </fieldset>
              ...
              <td height="28px" valign="middle" colspan="2" align="center">
                ...
                if(isset($voltarcorreto)){
                  if(isset($rubric)){
                    ...
                    echo "
                    <input name='retornar' type='button' id='voltar' value='Voltar' title='Voltar para consulta financeira por c�digo' onclick='location.href=\"pes3_codfinanc002.php?rubric=".$rubric."&ano=".$ano."&mes=".$mes."&opcao=".$xopcao."\"'>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ";
                    ...
                    echo "
                    <input name='retornar' type='button' id='voltar' value='Voltar' title='Voltar para consulta lota��o' onclick='location.href=\"pes3_consrhlotacao002.php?lotacao=".$lotacao."&ano=".$ano."&mes=".$mes."\"'>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ";
                  }
                }
      ...
      if (!$lReadOnly) {
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <input class="field-size2" type="button"    name="vars"  value="Vari�veis"        onclick="js_Pesquisa('Variaveis');" >
              ...
              <span id="boxToglePeriodo">
                <a id="togglePeriodo"  <? echo $lReadOnly ? "" : "href=''"; ?>><strong>Per�odo:</strong></a>
...
/**
 * Ano e M�s de implanta��o do sistema
 */
...
(function js_togglePeriodo() {
  ...
  /**
   * Select ano
   * verifica se � ano limite(atual) ou inicial(data da implanta��o do sistema)
