...
$sAnd = "";
if ($cgms) {
  $sWhere .= $sAnd . "si06_sequencial in (select si06_sequencial from adesaoregprecos inner join itensregpreco on si07_sequencialadesao = si06_sequencial inner join cgm on si07_fornecedor=z01_numcgm where z01_numcgm in (" . $cgms . "))";
  $sAnd = " and ";
}
