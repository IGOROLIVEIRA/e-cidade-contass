...
use repositories\caixa\relatorios\ReceitaPeriodoTesourariaEstruturalRepositoryLegacy;
...
require_once "repositories/caixa/relatorios/ReceitaPeriodoTesourariaEstruturalRepositoryLegacy.php";
require_once "repositories/caixa/relatorios/ReceitaTipoRepositoryLegacy.php";

class ReceitaPeriodoTesourariaEstrutural extends ReceitaPeriodoTesouraria
{
    /**
    ...
    public function __construct(
        ...
        $this->oReceitaPeriodoTesourariaRepository = new ReceitaPeriodoTesourariaEstruturalRepositoryLegacy(
            $sTipo,
            $sTipoReceita,
            $iFormaArrecadacao,
            $sOrdem,
