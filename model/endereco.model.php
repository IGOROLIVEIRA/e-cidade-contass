 ...
 */
    ...
    */
    function __construct($iCodigoEndereco=null) {
      ...
      if ($iCodigoEndereco != null) {
        ...
        if(strlen(db_utils::fieldsMemory($rsQueryLocal, 0)->db125_codigosistema) < 7 ){
          $sWhere       = " db76_sequencial = ".$iCodigoEndereco;
        ...
        $codigoIbge = $oDadosEndereco->db125_db_sistemaexterno != 4 ? $oDadosEndereco->codigoibge : $oDadosEndereco->db125_codigosistema;
  ...
  /**
   * Metodo para setar a propriedade codigo ibge do municipio
   * @param string ibge
   * @return void
   */
  public function setCodigoIbge($iCodigoIbge) {

    $this->db125_codigosistema = $iCodigoIbge;
  }
  /**
   * Metodo para retornar a propriedade codigo ibge do municipio
   * @return string
   */
