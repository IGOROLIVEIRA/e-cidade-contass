     ...
     */
	    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++){
    	    ...
    	    $oDados10 = db_utils::fieldsMemory($rsResult10, $iCont10);
			  ...
			  $claberlic102014->si46_criterioaceitabilidade        = $oDados10->criterioAceitabilidade;
			  ...
			  $claberlic102014->si46_formapagamento                = $oDados10->formaPagamento;
			  ...
			  $claberlic102014->si46_objeto                        = $oDados10->objeto;
    	 ...
    	 */
		       ...
		       for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
		    	 ...
		    	 $claberlic112014->si47_codorgaoresp             = $oDados11->codorgaoresp;
		    	 $claberlic112014->si47_codunidadesubresp        = $oDados11->codunidadesubresp;
		    	 $claberlic112014->si47_exerciciolicitacao       = $oDados11->exerciciolicitacao;
		    	 $claberlic112014->si47_nroprocessolicitatorio   = $oDados11->nroprocessolicitatorio;
		    	 $claberlic112014->si47_nrolote       			 = $oDados11->nrolote;
		    	 $claberlic112014->si47_dsclote 				 = $oDados11->dsclote;
		       ...
		       for ($iCont12 = 0; $iCont12 < pg_num_rows($rsResult12); $iCont12++) {
		    	 ...
		    	 $claberlic122014->si48_nroitem					 = $oDados12->nroitem;
		...
		AND liclicita.l20_codigo= $oDados10->seqlicitacao";	
		       ...
		       for ($iCont14 = 0; $iCont14 < pg_num_rows($rsResult14); $iCont14++) {
		    	 ...
		    	 $claberlic142014->si50_tiporegistro             	= 14;
		    	 $claberlic142014->si50_codorgaoresp             	= $oDados14->codorgaoresp;
		    	 $claberlic142014->si50_codunidadesubresp       	= $oDados14->codunidadesubresp;
		    	 $claberlic142014->si50_exerciciolicitacao   		= $oDados14->exerciciolicitacao;
		    	 $claberlic142014->si50_nroprocessolicitatorio		= $oDados14->nroprocessolicitatorio; 
		    	 $claberlic142014->si50_nrolote					 	= $oDados14->nrolote;
		    	 $claberlic142014->si50_reg10 				 	 	= $claberlic102014->si46_sequencial;// chave estrangeira
		    	 $claberlic142014->si50_coditem						= $oDados14->coditem;
		    	 $claberlic142014->si50_dtcotacao					= $oDados14->dtcotacao;
		    	 $claberlic142014->si50_vlcotprecosunitario			= $oDados14->vlcotprecosunitario;
		    	 $claberlic142014->si50_quantidade					= $oDados14->quantidade;
		    	 $claberlic142014->si50_vlminalienbens				= $oDados14->vlminalienbens;
		    	 $claberlic142014->si50_instit		   				   = db_getsession("DB_instit");
		    	 $claberlic142014->si50_mes                   	 	= $this->sDataFinal['5'].$this->sDataFinal['6'];
