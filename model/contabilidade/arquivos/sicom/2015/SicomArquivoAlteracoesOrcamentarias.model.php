...
class SicomArquivoAlteracoesOrcamentarias extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_fields($rsResult10); $iCont10++) {
    	...
    	$claoc102014->si38_nrodecreto   = $oDados10->nrodecreto;
    ...
    group by o46_codlei, o39_numero,o46_tiposup";
      ...
      for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
      	...
      	$claoc112014->si39_nrodecreto           = $oDados11->nrodecreto;
       ...
       */
       ...
       '2014-01-01' as dataLeiAlteracao
      from orcprojeto 
     ...
     where o39_codproj in ({$oDados10->codigovinc})";
    	...
    	for ($iCont12 = 0; $iCont12 < pg_num_rows($rsResult12); $iCont12++) {
    		...
    		$claoc122014->si40_nroleialteracao    = $oDados12->nroleialteracao;
  ...
  where o46_codlei in ({$oDados10->codigovinc})";
    	...
    	for ($iCont14 = 0; $iCont14 < pg_num_rows($rsResult14); $iCont14++) {
    		...
    		$claoc142014->si42_tiporegistro       = 14;
    		$claoc142014->si42_codreduzidodecreto = $oDados14->codreduzidodecreto;
    		$claoc142014->si42_tipoalteracao      = $oDados14->tipoalteracao;
    		$claoc142014->si42_codorgao           = $oDados14->codorgao;
    		$claoc142014->si42_codunidadesub      = $oDados14->codunidadesub;
    		$claoc142014->si42_codfuncao          = $oDados14->codfuncao;
    		$claoc142014->si42_codsubfuncao       = $oDados14->codsubfuncao;
    		$claoc142014->si42_codprograma        = $oDados14->codprograma;
    		$claoc142014->si42_idacao             = $oDados14->idacao;
    		$claoc142014->si42_idsubacao          = $oDados14->idsubacao;
    		$claoc142014->si42_naturezadespesa    = $oDados14->naturezadespesa;
    		$claoc142014->si42_codfontrecursos    = $oDados14->codfontrecursos;
    		$claoc142014->si42_vlacrescimoreducao = $oDados14->vlacrescimoreducao;
    		$claoc142014->si42_mes                = $this->sDataFinal['5'].$this->sDataFinal['6'];
    		$claoc142014->si42_reg10              = $claoc102014->si38_sequencial;
    		$claoc142014->si42_instit             = db_getsession("DB_instit");
