...
class SicomArquivoHabilitacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
	...
	AND DATE_PART('MONTH',homologacaoadjudica.l202_datahomologacao)= ".$this->sDataFinal['5'].$this->sDataFinal['6'];
		...
		for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
			...
			$clhablic102014->si57_objetosocial										=$oDados10->objetosocial;
			$clhablic102014->si57_orgaorespregistro									=$oDados10->orgaorespregistro;
			$clhablic102014->si57_dataregistro										=$oDados10->dataregistro;
			$clhablic102014->si57_nroregistro										=$oDados10->nroregistro;
			$clhablic102014->si57_dataregistrocvm									=$oDados10->dataregistrocvm;
			$clhablic102014->si57_nroregistrocvm									=$oDados10->nroregistrocvm;
