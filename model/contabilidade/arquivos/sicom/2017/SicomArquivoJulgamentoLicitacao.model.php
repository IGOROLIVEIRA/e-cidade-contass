  ...
  public function gerarDados() {
	...
	AND DATE_PART('MONTH',homologacaoadjudica.l202_datahomologacao)= ".$this->sDataFinal['5'].$this->sDataFinal['6'];
		...
		for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
		  ...
		  $oDados10       = db_utils::fieldsMemory($rsResult10, $iCont10);
			...
			$cljulglic102014->si60_tiporegistro   		  = 10;
			$cljulglic102014->si60_codorgao	 			  = $oDados10->codorgaoresp;
			$cljulglic102014->si60_codunidadesub	      = $oDados10->codunidadesubresp;
			$cljulglic102014->si60_exerciciolicitacao	  = $oDados10->exerciciolicitacao;
			$cljulglic102014->si60_nroprocessolicitatorio = $oDados10->nroprocessolicitatorio;
			$cljulglic102014->si60_tipodocumento		  = $oDados10->tipodocumento;
			$cljulglic102014->si60_nrodocumento			  = $oDados10->nrodocumento;
			$cljulglic102014->si60_nrolote				  = $oDados10->nrolote;
			$cljulglic102014->si60_coditem				  = $oDados10->coditem;
			$cljulglic102014->si60_vlunitario	          = $oDados10->vlunitario;
			$cljulglic102014->si60_quantidade	          = $oDados10->quantidade;
			$cljulglic102014->si60_instit		   		  = db_getsession("DB_instit");
		 	$cljulglic102014->si60_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
	...
	AND liclicita.l20_codigo = {$oDados10->codlicitacao}";
		...
		for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
		  ...
		  $cljulglic202014->si61_tiporegistro        	= 20;
		  $cljulglic202014->si61_codorgao            	= $oDados20->codorgaoresp;
		  $cljulglic202014->si61_codunidadesub		 	= $oDados20->codunidadesubresp;
		  $cljulglic202014->si61_exerciciolicitacao	 	= $oDados20->exerciciolicitacao;
		  $cljulglic202014->si61_nroprocessolicitatorio	= $oDados20->nroprocessolicitatorio;
		  $cljulglic202014->si61_tipodocumento   		= $oDados20->tipodocumento;
		  $cljulglic202014->si61_nrodocumento   		= $oDados20->nrodocumento;
		  $cljulglic202014->si61_nrolote  			    = $oDados20->nrolote;
		  $cljulglic202014->si61_coditem				= $oDados20->coditem;
		  $cljulglic202014->si61_percdesconto			= $oDados20->percdesconto;
		  $cljulglic202014->si61_instit		   		    = db_getsession("DB_instit");
		  $cljulglic202014->si61_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
