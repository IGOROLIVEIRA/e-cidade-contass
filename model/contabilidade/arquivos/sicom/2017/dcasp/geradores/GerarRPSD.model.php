...
class GerarRPSD extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from rpsd102017 where si189_mes = " . $this->iMes . " and si189_instit = " . db_getsession("DB_instit");
    $rsRPSD10 = db_query($sSql);

    $sSql2 = "select * from rpsd112017 where si190_mes = " . $this->iMes . " and si190_instit = " . db_getsession("DB_instit");
