...
class SicomArquivoIdentificacaoRemessa extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  {
    $aElementos = array("codMunicipio", "cnpjMunicipio", "codOrgao", "tipoOrgao", "exercicioReferencia", "mesReferencia", "dataGeracao", "codControleRemessa");
  ...
  public function gerarDados()
  {
     ...
     */
    db_inicio_transacao();
    $result = $clide2014->sql_record($clide2014->sql_query(null, "*", null, "si11_mes = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " and si11_instit = " . db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
      $clide2014->excluir(null, "si11_mes = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " and si11_instit = " . db_getsession("DB_instit"));
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsResult); $iCont++) {
      ...
      $clide2014->si11_instit = db_getsession("DB_instit");
