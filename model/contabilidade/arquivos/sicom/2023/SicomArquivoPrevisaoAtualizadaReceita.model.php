...
class SicomArquivoPrevisaoAtualizadaReceita extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
   ...
   /**
  	 ...
  	 */
  	$clparec102023 = new cl_parec102023();
  	$clparec112023 = new cl_parec112023();
    ...
    $result = $clparec112023->sql_record($clparec112023->sql_query(NULL,"*",NULL,"si23_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si23_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clparec112023->excluir(NULL,"si23_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si23_instit = ".db_getsession("DB_instit"));
      if ($clparec112023->erro_status == 0) {
    	  throw new Exception($clparec112023->erro_msg);
      }
    }
    
    $result = $clparec102023->sql_record($clparec102023->sql_query(NULL,"*",NULL,"si22_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si22_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clparec102023->excluir(NULL,"si22_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si22_instit = ".db_getsession("DB_instit"));
      if ($clparec102023->erro_status == 0) {
    	  throw new Exception($clparec102023->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
    	...
    	$clparec102023 = new cl_parec102023();
		  $clparec102023->si22_tiporegistro         = $oDados10->si22_tiporegistro;
		  $clparec102023->si22_codreduzido          = $oDados10->si22_codreduzido;
		  $clparec102023->si22_codorgao             = $oDados10->si22_codorgao;
		  $clparec102023->si22_ededucaodereceita    = $oDados10->si22_ededucaodereceita;
		  $clparec102023->si22_identificadordeducao = $oDados10->si22_identificadordeducao;
		  $clparec102023->si22_naturezareceita      = $oDados10->si22_naturezareceita;
		  $clparec102023->si22_tipoatualizacao      = $oDados10->si22_tipoatualizacao;
		  $clparec102023->si22_especificacao        = $oDados10->si22_especificacao;
		  $clparec102023->si22_vlacrescidoreduzido  = abs($oDados10->si22_vlacrescidoreduzido);
		  $clparec102023->si22_mes                  = $oDados10->si22_mes;
		  $clparec102023->si22_instit               = db_getsession("DB_instit");
		  
		  $clparec102023->incluir(null);
    	if ($clparec102023->erro_status == 0) {
    	  throw new Exception($clparec102023->erro_msg);
      }
      foreach ($oDados10->Reg11 as $oDados11) {
        ...
        $clparec112023 = new cl_parec112023();
    		$clparec112023->si23_tiporegistro    = $oDados11->si23_tiporegistro;
    		$clparec112023->si23_codreduzido     = $oDados11->si23_codreduzido;
    		$clparec112023->si23_codfontrecursos = $oDados11->si23_codfontrecursos;
    		$clparec112023->si23_vlfonte         = abs($oDados11->si23_vlfonte);
    		$clparec112023->si23_mes             = $oDados11->si23_mes;
    		$clparec112023->si23_reg10           = $clparec102023->si22_sequencial;
    		$clparec112023->si23_instit          = db_getsession("DB_instit");
    		
        $clparec112023->incluir(null);
    	  if ($clparec112023->erro_status == 0) {
    	    throw new Exception($clparec112023->erro_msg);
        }
