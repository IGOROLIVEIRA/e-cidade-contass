...
class SicomArquivoAnulacoesOrdensPagamento extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$claop102023 = new cl_aop102023();
  	$claop112023 = new cl_aop112023();
     ...
     */
    db_inicio_transacao();
    $result = $claop102023->sql_record($claop102023->sql_query(NULL,"*",NULL,"si137_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] 
    . " and si137_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	
    	$claop112023->excluir(NULL,"si138_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] . " and si138_instit = ".db_getsession("DB_instit"));
        if ($claop112023->erro_status == 0) {
	    	  throw new Exception($claop112023->erro_msg);
	      }
    	$claop102023->excluir(NULL,"si137_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] . " and si137_instit = ".db_getsession("DB_instit"));
	    if ($claop102023->erro_status == 0) {
	    	  throw new Exception($claop102023->erro_msg);
	      }
	}
