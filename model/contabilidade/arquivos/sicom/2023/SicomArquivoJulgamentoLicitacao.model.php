...
require_once ("classes/db_julglic202321_classe.php");
...
class SicomArquivoJulgamentoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	 ...
  	 */
  	$cljulglic102023 = new cl_julglic102023();
  	$cljulglic202321 = new cl_julglic202321();
  	$cljulglic302023 = new cl_julglic302023();
    
    /**
     * excluir informacoes do mes selecioado
     */
    db_inicio_transacao();
    $result = db_query($cljulglic102023->sql_query(NULL,"*",NULL,"si60_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si60_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$cljulglic102023->excluir(NULL,"si60_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si60_instit=".db_getsession("DB_instit"));
      if ($cljulglic102023->erro_status == 0) {
    	  throw new Exception($cljulglic102023->erro_msg);
      }
    }
    
    $result = db_query($cljulglic202321->sql_query(NULL,"*",NULL,"si61_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si61_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$cljulglic202321->excluir(NULL,"si61_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si61_instit=".db_getsession("DB_instit"));
      if ($cljulglic202321->erro_status == 0) {
    	  throw new Exception($cljulglic202321->erro_msg);
      }
    }
    
    $result = db_query($cljulglic302023->sql_query(NULL,"*",NULL,"si62_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si62_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$cljulglic302023->excluir(NULL,"si62_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si62_instit=".db_getsession("DB_instit"));
      if ($cljulglic302023->erro_status == 0) {
    	  throw new Exception($cljulglic302023->erro_msg);
      }
    }
	...
	AND DATE_PART('MONTH',homologacaoadjudica.l202_datahomologacao)= ".$this->sDataFinal['5'].$this->sDataFinal['6'];
		...
		for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
		  ...
		  $oDados10       = db_utils::fieldsMemory($rsResult10, $iCont10);
			...
			$cljulglic102023->si60_tiporegistro   		  = 10;
			$cljulglic102023->si60_codorgao	 			  = $oDados10->codorgaoresp;
			$cljulglic102023->si60_codunidadesub	      = $oDados10->codunidadesubresp;
			$cljulglic102023->si60_exerciciolicitacao	  = $oDados10->exerciciolicitacao;
			$cljulglic102023->si60_nroprocessolicitatorio = $oDados10->nroprocessolicitatorio;
			$cljulglic102023->si60_tipodocumento		  = $oDados10->tipodocumento;
			$cljulglic102023->si60_nrodocumento			  = $oDados10->nrodocumento;
			$cljulglic102023->si60_nrolote				  = $oDados10->nrolote;
			$cljulglic102023->si60_coditem				  = $oDados10->coditem;
			$cljulglic102023->si60_vlunitario	          = $oDados10->vlunitario;
			$cljulglic102023->si60_quantidade	          = $oDados10->quantidade;
			$cljulglic102023->si60_instit		   		  = db_getsession("DB_instit");
		 	$cljulglic102023->si60_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
		  	
		  $cljulglic102023->incluir(null);
		  if ($cljulglic102023->erro_status == 0) {
		    throw new Exception($cljulglic102023->erro_msg);
		  }
	...
	AND liclicita.l20_codigo = {$oDados10->codlicitacao}";
		...
		for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
		  ...
		  $cljulglic202321->si61_tiporegistro        	= 20;
		  $cljulglic202321->si61_codorgao            	= $oDados20->codorgaoresp;
		  $cljulglic202321->si61_codunidadesub		 	= $oDados20->codunidadesubresp;
		  $cljulglic202321->si61_exerciciolicitacao	 	= $oDados20->exerciciolicitacao;
		  $cljulglic202321->si61_nroprocessolicitatorio	= $oDados20->nroprocessolicitatorio;
		  $cljulglic202321->si61_tipodocumento   		= $oDados20->tipodocumento;
		  $cljulglic202321->si61_nrodocumento   		= $oDados20->nrodocumento;
		  $cljulglic202321->si61_nrolote  			    = $oDados20->nrolote;
		  $cljulglic202321->si61_coditem				= $oDados20->coditem;
		  $cljulglic202321->si61_percdesconto			= $oDados20->percdesconto;
		  $cljulglic202321->si61_instit		   		    = db_getsession("DB_instit");
		  $cljulglic202321->si61_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
		  	
		  $cljulglic202321->incluir(null);
		  if ($cljulglic202321->erro_status == 0) {
		    throw new Exception($cljulglic202321->erro_msg);
		  }
	...
	AND liclicita.l20_codigo = {$oDados10->codlicitacao}";
		...
		for ($iCont30 = 0; $iCont30 < pg_num_rows($rsResult30); $iCont30++) {
		  ...
		  $cljulglic302023->si62_tiporegistro     		= 30;
		  $cljulglic302023->si62_codorgao 				=$oDados30->codorgaoresp;
		  $cljulglic302023->si62_codunidadesub 			=$oDados30->codunidadesubresp;
		  $cljulglic302023->si62_exerciciolicitacao 	=$oDados30->exerciciolicitacao;
		  $cljulglic302023->si62_nroprocessolicitatorio =$oDados30->nroprocessolicitatorio;
		  $cljulglic302023->si62_dtjulgamento 			=$oDados30->dtjulgamento;
		  $cljulglic302023->si62_presencalicitantes 	=$oDados30->presencalicitantes;
		  $cljulglic302023->si62_renunciarecurso		=$oDados30->renunciarecurso;
		  $cljulglic302023->si62_instit		   		    = db_getsession("DB_instit");
		  $cljulglic302023->si62_mes              		= $this->sDataFinal['5'].$this->sDataFinal['6'];
		  	
		  $cljulglic302023->incluir(null);
		  if ($cljulglic302023->erro_status == 0) {
		    throw new Exception($cljulglic302023->erro_msg);
		  }
