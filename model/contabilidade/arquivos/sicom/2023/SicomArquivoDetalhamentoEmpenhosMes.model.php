...
class SicomArquivoDetalhamentoEmpenhosMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
	...
	public function gerarDados() {
		...
		$cEmp102023 = new cl_emp102023();
		$cEmp112023 = new cl_emp112023();
		...
		$sTrataCodUnidade = db_utils::fieldsMemory($rsResultTrataUnidade, 0)->si08_tratacodunidade;
		 ...
		 db_inicio_transacao();
		    ...
		    $result = $cEmp102023->sql_record($cEmp102023->sql_query(NULL,"*",NULL,"si106_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])
		     ." si106_instit = ".db_getsession("DB_instit"));
		    
		    if (pg_num_rows($result) > 0) {
		    	$cEmp112023->excluir(NULL,"si107_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
		    	." si107_instit = ".db_getsession("DB_instit"));
		    	$cEmp102023->excluir(NULL,"si106_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
		    	." si106_instit = ".db_getsession("DB_instit"));
		      if ($cEmp102023->erro_status == 0) {
		...
		for ($iCont = 0; $iCont < pg_num_rows($rsEmpenho); $iCont++) {
          ...
          db_inicio_transacao();
			...
			$oDadosEmpenho = new cl_emp102023();
