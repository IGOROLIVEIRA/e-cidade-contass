...
class SicomArquivoDetalhamentoLiquidacaoDespesa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cllqd102023 = new cl_lqd102023();
  	$cllqd112023 = new cl_lqd112023();
  	$cllqd122023 = new cl_lqd122023();
     ...
     */
    db_inicio_transacao();
    $result = $cllqd102023->sql_record($cllqd102023->sql_query(NULL,"*",NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
        ." and si118_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	
    	$cllqd112023->excluir(NULL,"si119_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si119_instit = ".db_getsession("DB_instit"));
    	$cllqd122023->excluir(NULL,"si120_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si120_instit = ".db_getsession("DB_instit"));
    	$cllqd102023->excluir(NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si118_instit = ".db_getsession("DB_instit"));
      if ($cllqd102023->erro_status == 0) {
    	  throw new Exception($cllqd102023->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
		    	  ...
		    	  $cllqd102023 = new cl_lqd102023();
				  $cllqd102023->si118_tiporegistro          = $oDados10->si118_tiporegistro;
				  $cllqd102023->si118_codreduzido           = $oDados10->si118_codreduzido;
				  $cllqd102023->si118_codorgao              = $oDados10->si118_codorgao;
				  $cllqd102023->si118_codunidadesub         = $oDados10->si118_codunidadesub;
				  $cllqd102023->si118_tpliquidacao          = $oDados10->si118_tpliquidacao;
				  $cllqd102023->si118_nroempenho            = $oDados10->si118_nroempenho;
				  $cllqd102023->si118_dtempenho             = $oDados10->si118_dtempenho;
				  $cllqd102023->si118_dtliquidacao          = $oDados10->si118_dtliquidacao;
				  $cllqd102023->si118_nroliquidacao         = $oDados10->si118_nroliquidacao;
				  $cllqd102023->si118_vlliquidado           = $oDados10->si118_vlliquidado;
				  $cllqd102023->si118_cpfliquidante         = $oDados10->si118_cpfliquidante;
				  $cllqd102023->si118_mes                   = $oDados10->si118_mes;
				  $cllqd102023->si118_instit 				= db_getsession("DB_instit");
				  
				  $cllqd102023->incluir(null);
		    	if ($cllqd102023->erro_status == 0) {
		    		echo "<pre>";print_r($cllqd102023);
		    	  throw new Exception($cllqd102023->erro_msg);
		      }
      foreach ($oDados10->Reg11 as $oDados11) {
    		...
    		$cllqd112023->si119_tiporegistro     = $oDados11->si119_tiporegistro;
    		$cllqd112023->si119_codreduzido      = $oDados11->si119_codreduzido;
    		$cllqd112023->si119_codfontrecursos  = $oDados11->si119_codfontrecursos;
    		$cllqd112023->si119_valorfonte       = $oDados11->si119_valorfonte;
    		$cllqd112023->si119_mes              = $oDados11->si119_mes;
    		$cllqd112023->si119_reg10            = $cllqd102023->si118_sequencial;
    		$cllqd112023->si119_instit 			 = db_getsession("DB_instit");
    		
          $cllqd112023->incluir(null);
    	  if ($cllqd112023->erro_status == 0) {
    	    throw new Exception($cllqd112023->erro_msg);
        }
