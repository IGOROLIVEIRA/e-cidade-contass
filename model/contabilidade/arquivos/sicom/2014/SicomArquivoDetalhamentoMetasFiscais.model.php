...
class SicomArquivoDetalhamentoMetasFiscais extends SicomArquivoBase implements iPadArquivoBaseCSV {
   ...
   */	
		...
		// Define todos anos utilizados no relat�rio apartir do ano de refer�ncia
		/*
		 ...
		 * so funciona deixando os anos da forma que t� aqui
		 */ 
		...
		// Cria objeto para cada linha do relat�rio
		...
		// Cria array com todos objetos "Linhas" do relat�rio
		...
		// Cria din�micamente o objeto valor para cada linha evitando refer�ncia de objetos
		...
		// Seta descri��o de cada linha
		$oReceitaTotal->Descricao      = "Receita Total"; 
		$oReceitasPrimarias->Descricao = "Receitas Prim�rias(I)";   
		$oDespesaTotal->Descricao      = "Despesa Total"; 
		$oDespesasPrimarias->Descricao = "Despesas Prim�rias(II)"; 
		$oResultadoPrimario->Descricao = "Resultado Prim�rio(III) = (I-II)"; 
		$oResultadoNominal->Descricao  = "Resultado Nominal"; 
		$oDivPublicConsol->Descricao   = "D�vida P�blica Consolidada";
		$oDivConsolLiquid->Descricao   = "D�vida Consolidada L�quida";
		...
		// Busca taxa de infla��o de cada ano
