  ...
  substr(o56_elemento,2,6)||'00' end as dotorig,
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
      ...
      $sSql = "select tiporegistro,
       ...
       from (select '11' as tiporegistro, 
        ...
        from     empempenho
                ...
                join db_config on codigo = e60_instit
                left join infocomplementaresinstit on codigo = si09_instit
        where   e60_numemp =  '{$clrsp102014->si112_codreduzidorsp}'
        group by   e60_anousu,
                e60_codemp,
                e60_emiss,
                z01_numcgm,
      ...
      for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
        ...
        $clrsp112014->si113_codreduzidorsp         = $oDados11->codreduzidorsp;
        $clrsp112014->si113_codfontrecursos        = $oDados11->codfontrecursos;
        $clrsp112014->si113_vloriginalfonte        = $oDados11->vloriginal;
        $clrsp112014->si113_vlsaldoantprocefonte   = $oDados11->vlsaldoantproce;
        $clrsp112014->si113_vlsaldoantnaoprocfonte = $oDados11->vlsaldoantnaoproc;
    ...
    for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
      ...
      $sSql = "select '21' as  tiporegistro,
       ...
       join empanulado on e94_numemp = e60_numemp
       left join infocomplementaresinstit on codigo = si09_instit
       where c71_data between '{$this->sDataInicial}' and '{$this->sDataFinal}' and e60_numemp = '{$clrsp202014->si115_codreduzidomov}';";
      ...
      for ($iCont21 = 0; $iCont21 < pg_num_rows($rsResult21); $iCont21++) {
        ...
        $clrsp212014->si116_codfontrecursos         = $oDados21->codfontrecursos;
        $clrsp212014->si116_vlmovimentacaofonte     = $oDados21->vlmovimentacaofonte;
