    ...
    for ($iContador = 0; $iContador < pg_num_rows($rsInst); $iContador++) {
	    ...
	    for ($iCont = 0; $iCont < pg_num_rows($rsDotacao); $iCont++) {
	      ...
	      */
	      ...
	      $sHash  = $oRegistro->o58_instit.$oRegistro->o58_unidade.$oRegistro->o58_funcao.$oRegistro->o58_subfuncao;
	      $sHash .= $oRegistro->o58_programa.$iTipoProjetoAtividade.$oRegistro->o58_elemento;

	      if (!isset($aDadosAgrupados[$sHash])) {

	        /**
	         * Caso n�o exista o indice, um objeto novo ser� criado
	         */
	        ...
	        /**
					 *caso j� exista esse indice no array, ele ser� passado para o objeto
	         */
