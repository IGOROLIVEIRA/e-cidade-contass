...
class SicomArquivoDetalhamentoReceitasMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    /**
  	 ...
  	 */
  	$clrec102019 = new cl_rec102019();
  	$clrec112019 = new cl_rec112019();
    ...
    $result = $clrec112019->sql_record($clrec112019->sql_query(NULL,"*",NULL,"si26_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])." and si26_instit = ".db_getsession("DB_instit"));
    if (pg_num_rows($result) > 0) {
    	$clrec112019->excluir(NULL,"si26_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si26_instit = ".db_getsession("DB_instit"));
      if ($clrec112019->erro_status == 0) {
    	  throw new Exception($clrec112019->erro_msg);
      }
    }

    $result = $clrec102019->sql_record($clrec102019->sql_query(NULL,"*",NULL,"si25_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si25_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clrec102019->excluir(NULL,"si25_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si25_instit = ".db_getsession("DB_instit"));
      if ($clrec102019->erro_status == 0) {
    	  throw new Exception($clrec102019->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
    	...
    	$clrec102019 = new cl_rec102019();
		  $clrec102019->si25_tiporegistro         = $oDados10->si25_tiporegistro;
		  $clrec102019->si25_codreceita           = $oDados10->si25_codreceita;
		  $clrec102019->si25_codorgao             = $oDados10->si25_codorgao;
		  $clrec102019->si25_ededucaodereceita    = $oDados10->si25_ededucaodereceita;
		  $clrec102019->si25_identificadordeducao = $oDados10->si25_identificadordeducao;
		  $clrec102019->si25_naturezareceita      = $oDados10->si25_naturezareceita;
		  $clrec102019->si25_especificacao        = $oDados10->si25_especificacao;
		  $clrec102019->si25_vlarrecadado         = abs($oDados10->si25_vlarrecadado);
		  $clrec102019->si25_mes                  = $oDados10->si25_mes;
		  $clrec102019->si25_instit               = db_getsession("DB_instit");

		  $clrec102019->incluir(null);
    	if ($clrec102019->erro_status == 0) {
    	  throw new Exception($clrec102019->erro_msg);
      }
      foreach ($oDados10->Reg11 as $oDados11) {
      	if (in_array($oDados10->si25_naturezareceita ,$aRectceSaudEduc )) {
      	  ...
      	  $clrec112019 = new cl_rec112019();
    		  $clrec112019->si26_tiporegistro      = $oDados11->si26_tiporegistro;
    		  $clrec112019->si26_reg10             = $clrec102019->si25_sequencial;
    		  $clrec112019->si26_codreceita        = $oDados11->si26_codreceita;
    		  $clrec112019->si26_codfontrecursos   = '100';
    		  $clrec112019->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.60);
    		  $clrec112019->si26_mes               = $oDados11->si26_mes;
    		  $clrec112019->si26_instit            = db_getsession("DB_instit");

          $clrec112019->incluir(null);
    	    if ($clrec112019->erro_status == 0) {
    	      throw new Exception($clrec112019->erro_msg);
          }

          $clrec112019->si26_sequencial = null;
          $clrec112019->si26_codfontrecursos   = '101';
          $clrec112019->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.25);
      	  $clrec112019->incluir(null);
    	    if ($clrec112019->erro_status == 0) {
    	      throw new Exception($clrec112019->erro_msg);
          }
      	  ...
      	  $clrec112019->si26_sequencial = null;
          $clrec112019->si26_codfontrecursos   = '102';
          $clrec112019->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.15);
      	  $clrec112019->incluir(null);
    	    if ($clrec112019->erro_status == 0) {
    	      throw new Exception($clrec112019->erro_msg);
          }
          ...
          $clrec112019 = new cl_rec112019();
    		  ...
    		  $clrec112019->si26_reg10             = $clrec102019->si25_sequencial;
    		  $clrec112019->si26_codreceita        = $oDados11->si26_codreceita;
    		  $clrec112019->si26_codfontrecursos   = $oDados11->si26_codfontrecursos;
    		  $clrec112019->si26_vlarrecadadofonte = abs($oDados11->si26_vlarrecadadofonte);
    		  $clrec112019->si26_mes               = $oDados11->si26_mes;
    		  $clrec112019->si26_instit            = db_getsession("DB_instit");
