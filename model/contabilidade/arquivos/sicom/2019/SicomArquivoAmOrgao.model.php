    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
      ...
      $clorgao102014->incluir(null);
    	...
    	for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
    		...
    		$clorgao112014->si15_tiporegistro      = 11;
    		$clorgao112014->si15_tiporesponsavel   = $oDados11->si166_tiporesponsavel;
    		$clorgao112014->si15_cartident         = $oDados11->z01_ident;
    		$clorgao112014->si15_orgemissorci      = $oDados11->z01_identorgao;
    		...
    		$clorgao112014->si15_dtinicio          = $oDados11->si166_dataini;
    		$clorgao112014->si15_dtfinal           = $oDados11->si166_datafim;
