...
require_once ("classes/db_parelic102022_classe.php");
...
class SicomArquivoParecerLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  /**
  	 ...
  	 */
  	$clparelic102022 = new cl_parelic102022();
  	
  	/**
     * excluir informacoes do mes selecioado
     */
    db_inicio_transacao(); 
    $result = db_query($clparelic102022->sql_query(NULL,"*",NULL,"si66_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si66_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clparelic102022->excluir(NULL,"si66_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si66_instit=".db_getsession("DB_instit"));
      if ($clparelic102022->erro_status == 0) {
    	  throw new Exception($clparelic102022->erro_msg);
      }
    }
    //
    	...
    	for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
		  ...
		  $clparelic102022->si66_tiporegistro                 = 10;
		  $clparelic102022->si66_codorgao                     = $oDados10->codorgaoresp;
		  $clparelic102022->si66_codunidadesub                = $oDados10->codunidadesubresp;
		  $clparelic102022->si66_exerciciolicitacao           = $oDados10->exerciciolicitacao;
		  $clparelic102022->si66_nroprocessolicitatorio       = $oDados10->nroprocessolicitatorio;        
		  $clparelic102022->si66_dataparecer                  = $oDados10->dataparecer;
		  $clparelic102022->si66_tipoparecer                  = $oDados10->tipoparecer;
		  $clparelic102022->si66_nrocpf                       = $oDados10->nrocpf;
		  $clparelic102022->si66_instit		   		     	  = db_getsession("DB_instit");
		  $clparelic102022->si66_mes                          = $this->sDataFinal['5'].$this->sDataFinal['6'];
		  
		  $clparelic102022->incluir(null);
		  if ($clparelic102022->erro_status == 0) {
		  	throw new Exception($clparelic102022->erro_msg);
		  }
