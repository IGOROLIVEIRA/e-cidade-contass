...
require_once("classes/db_idedcasp2022_classe.php");
require_once("model/contabilidade/arquivos/sicom/2022/dcasp/geradores/GerarIDE.model.php");
...
class SicomArquivoIDE extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clidedcasp = new cl_idedcasp2022();
