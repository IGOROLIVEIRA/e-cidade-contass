...
require_once("classes/db_rpsd102022_classe.php");
require_once("classes/db_rpsd112022_classe.php");
require_once("model/contabilidade/arquivos/sicom/2022/dcasp/geradores/GerarRPSD.model.php");
...
class SicomArquivoRPSD extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clrpsd10 = new cl_rpsd102022();
    $clrpsd11 = new cl_rpsd112022();
    ...
    function sql_query_saldoInicialContaCorrente ($iFonte=null, $sIntituicoes, $iAno=null){
        ...
        if($iAno==2022){
            $iAno = 2022;
            $sSqlReduzSuperavit = "select c61_reduz from conplano inner join conplanoreduz on c60_codcon=c61_codcon and c61_anousu=c60_anousu 
                             where substr(c60_estrut,1,5)='82910' and c60_anousu=2022 and c61_anousu=2022";
