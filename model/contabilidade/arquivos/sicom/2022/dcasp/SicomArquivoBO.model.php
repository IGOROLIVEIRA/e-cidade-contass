...
require_once("classes/db_bodcasp102022_classe.php");
require_once("classes/db_bodcasp202022_classe.php");
require_once("classes/db_bodcasp302022_classe.php");
require_once("classes/db_bodcasp402022_classe.php");
require_once("classes/db_bodcasp502022_classe.php");

require_once("model/contabilidade/arquivos/sicom/2022/dcasp/geradores/GerarBO.model.php");
...
class SicomArquivoBO extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clbodcasp10 = new cl_bodcasp102022();
    $clbodcasp20 = new cl_bodcasp202022();
    $clbodcasp30 = new cl_bodcasp302022();
    $clbodcasp40 = new cl_bodcasp402022();
    $clbodcasp50 = new cl_bodcasp502022();
