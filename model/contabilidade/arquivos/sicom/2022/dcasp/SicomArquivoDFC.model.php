...
require_once("classes/db_dfcdcasp102022_classe.php");
require_once("classes/db_dfcdcasp202022_classe.php");
require_once("classes/db_dfcdcasp302022_classe.php");
require_once("classes/db_dfcdcasp402022_classe.php");
require_once("classes/db_dfcdcasp502022_classe.php");
require_once("classes/db_dfcdcasp602022_classe.php");
require_once("classes/db_dfcdcasp702022_classe.php");
require_once("classes/db_dfcdcasp802022_classe.php");
require_once("classes/db_dfcdcasp902022_classe.php");
require_once("classes/db_dfcdcasp1002022_classe.php");
require_once("classes/db_dfcdcasp1102022_classe.php");

require_once("model/contabilidade/arquivos/sicom/2022/dcasp/geradores/GerarDFC.model.php");
...
class SicomArquivoDFC extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
         ...
         */
        $cldfcdcasp10   = new cl_dfcdcasp102022();
        $cldfcdcasp20   = new cl_dfcdcasp202022();
        $cldfcdcasp30   = new cl_dfcdcasp302022();
        $cldfcdcasp40   = new cl_dfcdcasp402022();
        $cldfcdcasp50   = new cl_dfcdcasp502022();
        $cldfcdcasp60   = new cl_dfcdcasp602022();
        $cldfcdcasp70   = new cl_dfcdcasp702022();
        $cldfcdcasp80   = new cl_dfcdcasp802022();
        $cldfcdcasp90   = new cl_dfcdcasp902022();
        $cldfcdcasp100  = new cl_dfcdcasp1002022();
        $cldfcdcasp110  = new cl_dfcdcasp1102022();
