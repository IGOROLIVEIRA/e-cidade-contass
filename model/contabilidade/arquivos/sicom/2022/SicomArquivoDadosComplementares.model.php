...
class SicomArquivoDadosComplementares extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
     ...
     */
    $result = $cldclrf102022->sql_record($cldclrf102022->sql_query(NULL,"*",NULL,"si157_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si157_instit = ".db_getsession("DB_instit") ));
    if (pg_num_rows($result) > 0) {
      $cldclrf102022->excluir(NULL,"si157_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si157_instit = ".db_getsession("DB_instit"));
