...
require_once ("classes/db_lqd102022_classe.php");
require_once ("classes/db_lqd112022_classe.php");
require_once ("classes/db_lqd122022_classe.php");
...
class SicomArquivoDetalhamentoLiquidacaoDespesa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cllqd102022 = new cl_lqd102022();
  	$cllqd112022 = new cl_lqd112022();
  	$cllqd122022 = new cl_lqd122022();
     ...
     */
    db_inicio_transacao();
    $result = $cllqd102022->sql_record($cllqd102022->sql_query(NULL,"*",NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
        ." and si118_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	
    	$cllqd112022->excluir(NULL,"si119_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si119_instit = ".db_getsession("DB_instit"));
    	$cllqd122022->excluir(NULL,"si120_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si120_instit = ".db_getsession("DB_instit"));
    	$cllqd102022->excluir(NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si118_instit = ".db_getsession("DB_instit"));
      if ($cllqd102022->erro_status == 0) {
    	  throw new Exception($cllqd102022->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
		    	  ...
		    	  $cllqd102022 = new cl_lqd102022();
				  $cllqd102022->si118_tiporegistro          = $oDados10->si118_tiporegistro;
				  $cllqd102022->si118_codreduzido           = $oDados10->si118_codreduzido;
				  $cllqd102022->si118_codorgao              = $oDados10->si118_codorgao;
				  $cllqd102022->si118_codunidadesub         = $oDados10->si118_codunidadesub;
				  $cllqd102022->si118_tpliquidacao          = $oDados10->si118_tpliquidacao;
				  $cllqd102022->si118_nroempenho            = $oDados10->si118_nroempenho;
				  $cllqd102022->si118_dtempenho             = $oDados10->si118_dtempenho;
				  $cllqd102022->si118_dtliquidacao          = $oDados10->si118_dtliquidacao;
				  $cllqd102022->si118_nroliquidacao         = $oDados10->si118_nroliquidacao;
				  $cllqd102022->si118_vlliquidado           = $oDados10->si118_vlliquidado;
				  $cllqd102022->si118_cpfliquidante         = $oDados10->si118_cpfliquidante;
				  $cllqd102022->si118_mes                   = $oDados10->si118_mes;
				  $cllqd102022->si118_instit 				= db_getsession("DB_instit");
				  
				  $cllqd102022->incluir(null);
		    	if ($cllqd102022->erro_status == 0) {
		    		echo "<pre>";print_r($cllqd102022);
		    	  throw new Exception($cllqd102022->erro_msg);
		      }
      foreach ($oDados10->Reg11 as $oDados11) {
    		...
    		$cllqd112022->si119_tiporegistro     = $oDados11->si119_tiporegistro;
    		$cllqd112022->si119_codreduzido      = $oDados11->si119_codreduzido;
    		$cllqd112022->si119_codfontrecursos  = $oDados11->si119_codfontrecursos;
    		$cllqd112022->si119_valorfonte       = $oDados11->si119_valorfonte;
    		$cllqd112022->si119_mes              = $oDados11->si119_mes;
    		$cllqd112022->si119_reg10            = $cllqd102022->si118_sequencial;
    		$cllqd112022->si119_instit 			 = db_getsession("DB_instit");
    		
          $cllqd112022->incluir(null);
    	  if ($cllqd112022->erro_status == 0) {
    	    throw new Exception($cllqd112022->erro_msg);
        }
