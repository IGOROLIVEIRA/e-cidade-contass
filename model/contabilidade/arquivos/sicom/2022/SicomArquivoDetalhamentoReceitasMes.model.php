...
require_once ("classes/db_rec102022_classe.php");
require_once ("classes/db_rec112022_classe.php");
...
class SicomArquivoDetalhamentoReceitasMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    /**
  	 ...
  	 */
  	$clrec102022 = new cl_rec102022();
  	$clrec112022 = new cl_rec112022();
    ...
    $result = $clrec112022->sql_record($clrec112022->sql_query(NULL,"*",NULL,"si26_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])." and si26_instit = ".db_getsession("DB_instit"));
    if (pg_num_rows($result) > 0) {
    	$clrec112022->excluir(NULL,"si26_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si26_instit = ".db_getsession("DB_instit"));
      if ($clrec112022->erro_status == 0) {
    	  throw new Exception($clrec112022->erro_msg);
      }
    }

    $result = $clrec102022->sql_record($clrec102022->sql_query(NULL,"*",NULL,"si25_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si25_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clrec102022->excluir(NULL,"si25_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si25_instit = ".db_getsession("DB_instit"));
      if ($clrec102022->erro_status == 0) {
    	  throw new Exception($clrec102022->erro_msg);
      }
    }
    ...
    $aRectceSaudEduc = array('11120101','11120220','11120431','11120434','11120800','11130501','11130502','17210102', '17210105','17213600',
    ...
    foreach ($aDadosAgrupados as $oDados10) {
    	...
    	$clrec102022 = new cl_rec102022();
		  $clrec102022->si25_tiporegistro         = $oDados10->si25_tiporegistro;
		  $clrec102022->si25_codreceita           = $oDados10->si25_codreceita;
		  $clrec102022->si25_codorgao             = $oDados10->si25_codorgao;
		  $clrec102022->si25_ededucaodereceita    = $oDados10->si25_ededucaodereceita;
		  $clrec102022->si25_identificadordeducao = $oDados10->si25_identificadordeducao;
		  $clrec102022->si25_naturezareceita      = $oDados10->si25_naturezareceita;
		  $clrec102022->si25_especificacao        = $oDados10->si25_especificacao;
		  $clrec102022->si25_vlarrecadado         = abs($oDados10->si25_vlarrecadado);
		  $clrec102022->si25_mes                  = $oDados10->si25_mes;
		  $clrec102022->si25_instit               = db_getsession("DB_instit");

		  $clrec102022->incluir(null);
    	if ($clrec102022->erro_status == 0) {
    	  throw new Exception($clrec102022->erro_msg);
      }
      foreach ($oDados10->Reg11 as $oDados11) {
      	if (in_array($oDados10->si25_naturezareceita ,$aRectceSaudEduc )) {
      	  ...
      	  $clrec112022 = new cl_rec112022();
    		  $clrec112022->si26_tiporegistro      = $oDados11->si26_tiporegistro;
    		  $clrec112022->si26_reg10             = $clrec102022->si25_sequencial;
    		  $clrec112022->si26_codreceita        = $oDados11->si26_codreceita;
    		  $clrec112022->si26_codfontrecursos   = '100';
    		  $clrec112022->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.60);
    		  $clrec112022->si26_mes               = $oDados11->si26_mes;
    		  $clrec112022->si26_instit            = db_getsession("DB_instit");

          $clrec112022->incluir(null);
    	    if ($clrec112022->erro_status == 0) {
    	      throw new Exception($clrec112022->erro_msg);
          }

          $clrec112022->si26_sequencial = null;
          $clrec112022->si26_codfontrecursos   = '101';
          $clrec112022->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.25);
      	  $clrec112022->incluir(null);
    	    if ($clrec112022->erro_status == 0) {
    	      throw new Exception($clrec112022->erro_msg);
          }
      	  ...
      	  $clrec112022->si26_sequencial = null;
          $clrec112022->si26_codfontrecursos   = '102';
          $clrec112022->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.15);
      	  $clrec112022->incluir(null);
    	    if ($clrec112022->erro_status == 0) {
    	      throw new Exception($clrec112022->erro_msg);
          }
          ...
          $clrec112022 = new cl_rec112022();
    		  ...
    		  $clrec112022->si26_reg10             = $clrec102022->si25_sequencial;
    		  $clrec112022->si26_codreceita        = $oDados11->si26_codreceita;
    		  $clrec112022->si26_codfontrecursos   = $oDados11->si26_codfontrecursos;
    		  $clrec112022->si26_vlarrecadadofonte = abs($oDados11->si26_vlarrecadadofonte);
    		  $clrec112022->si26_mes               = $oDados11->si26_mes;
    		  $clrec112022->si26_instit            = db_getsession("DB_instit");
