...
require_once ("classes/db_resplic102022_classe.php");
require_once ("classes/db_resplic202221_classe.php");
...
class SicomArquivoResponsaveisLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
 ...
 public function gerarDados(){
  	 ...
  	 */
  	$clresplic102022 = new cl_resplic102022();
  	$clresplic202221 = new cl_resplic202221();
    ...
    $result = db_query($clresplic102022->sql_query(NULL,"*",NULL,"si55_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si55_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clresplic102022->excluir(NULL,"si55_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si55_instit=".db_getsession("DB_instit"));
      if ($clresplic102022->erro_status == 0) {
    	  throw new Exception($clresplic102022->erro_msg);
      }
    }

    $result = db_query($clresplic202221->sql_query(NULL,"*",NULL,"si56_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si56_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clresplic202221->excluir(NULL,"si56_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si56_instit=".db_getsession("DB_instit"));
      if ($clresplic202221->erro_status == 0) {
    	  throw new Exception($clresplic202221->erro_msg);
      }
    }
  /**
   *########################### registro 10 #####################
   */
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    	...
    	$oDados10 = db_utils::fieldsMemory($rsResult10, $iCont10);
		 ...
		 $clresplic102022->si55_tiporegistro   				= 10;
		 $clresplic102022->si55_codorgao					= $oDados10->codorgaoresp           ;
		 $clresplic102022->si55_codunidadesub				= $oDados10->codunidadesubresp      ;
		 $clresplic102022->si55_exerciciolicitacao			= $oDados10->exerciciolicitacao    ;
		 $clresplic102022->si55_nroprocessolicitatorio		= $oDados10->nroprocessolicitatorio;
		 $clresplic102022->si55_tiporesp					= $oDados10->tiporesp        ;
		 $clresplic102022->si55_nrocpfresp					= $oDados10->nrocpfresp   ;
		 $clresplic102022->si55_instit		    			= db_getsession("DB_instit");
		 $clresplic102022->si55_mes             			= $this->sDataFinal['5'].$this->sDataFinal['6'];

		 $clresplic102022->incluir(null);
		  if ($clresplic102022->erro_status == 0) {
		  	throw new Exception($clresplic102022->erro_msg);
		  }
   ...
   */
		  ...
		  for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
    	    ...
    	    $oDados20 = db_utils::fieldsMemory($rsResult20, $iCont20);
		  	...
		  	$clresplic202221->si56_tiporegistro           = 20;
		  	$clresplic202221->si56_codorgao               = $oDados20->codorgaoresp;
		  	$clresplic202221->si56_codunidadesub          = $oDados20->codunidadesubresp;
		  	$clresplic202221->si56_exerciciolicitacao     = $oDados20->exerciciolicitacao;
		  	$clresplic202221->si56_nroprocessolicitatorio = $oDados20->nroprocessolicitatorio;
		  	$clresplic202221->si56_codtipocomissao        = $oDados20->codtipocomissao;
		  	$clresplic202221->si56_descricaoatonomeacao   = $oDados20->descricaoatonomeacao;
		  	$clresplic202221->si56_nroatonomeacao         = $oDados20->nroatonomeacao;
		  	$clresplic202221->si56_dataatonomeacao        = $oDados20->dataatonomeacao;
		  	$clresplic202221->si56_iniciovigencia         = $oDados20->iniciovigencia;
		  	$clresplic202221->si56_finalvigencia          = $oDados20->finalvigencia;
		  	$clresplic202221->si56_cpfmembrocomissao      = $oDados20->cpfmembrocomissao;
		  	$clresplic202221->si56_codatribuicao          = $oDados20->codatribuicao;
		  	$clresplic202221->si56_cargo 			      = $oDados20->cargo;
		  	$clresplic202221->si56_naturezacargo	 	  = $oDados20->naturezacargo;
		  	$clresplic202221->si56_instit		     	  = db_getsession("DB_instit");
		  	$clresplic202221->si56_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];

			$clresplic202221->incluir(null);
			if ($clresplic202221->erro_status == 0) {
			  throw new Exception($clresplic202221->erro_msg);
			}
