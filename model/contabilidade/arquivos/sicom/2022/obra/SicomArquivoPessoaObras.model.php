...
require_once("classes/db_pessoasobra102022_classe.php");
require_once("model/contabilidade/arquivos/sicom/2022/obra/geradores/gerarPESSOAOBRA.php");
...
class SicomArquivoPessoaObras extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clpessoasobra102022 = new cl_pessoasobra102022();
     ...
     */
    $result = db_query($clpessoasobra102022->sql_query(null, "*", null, "si194_mes = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " and si194_instit=" . db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
      $clpessoasobra102022->excluir(null, "si194_mes = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " and si194_instit=" . db_getsession("DB_instit"));
      if ($clpessoasobra102022->erro_status == 0) {
        throw new Exception($clpessoasobra102022->erro_msg);
      }
    }
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
      ...
      $clpessoasobra102022->si194_tiporegistro           = 10;
      $clpessoasobra102022->si194_nrodocumento           = $oDados10->si194_nrodocumento;
      $clpessoasobra102022->si194_nome                   = $this->removeCaracteres($oDados10->si194_nome);
      $clpessoasobra102022->si194_tipocadastro           = $oDados10->si194_tipocadastro;
      $clpessoasobra102022->si194_justificativaalteracao = $oDados10->si194_justificativaalteracao;
      $clpessoasobra102022->si194_mes                    = $this->sDataFinal['5'] . $this->sDataFinal['6'];
      $clpessoasobra102022->si194_instit                 = db_getsession("DB_instit");

      $clpessoasobra102022->incluir(null);
      if ($clpessoasobra102022->erro_status == 0) {
        throw new Exception($clpessoasobra102022->erro_msg);
      }
    }
