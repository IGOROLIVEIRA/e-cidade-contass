...
require_once ("classes/db_aop102022_classe.php");
require_once ("classes/db_aop112022_classe.php");
...
class SicomArquivoAnulacoesOrdensPagamento extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$claop102022 = new cl_aop102022();
  	$claop112022 = new cl_aop112022();
     ...
     */
    db_inicio_transacao();
    $result = $claop102022->sql_record($claop102022->sql_query(NULL,"*",NULL,"si137_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] 
    . " and si137_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	
    	$claop112022->excluir(NULL,"si138_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] . " and si138_instit = ".db_getsession("DB_instit"));
        if ($claop112022->erro_status == 0) {
	    	  throw new Exception($claop112022->erro_msg);
	      }
    	$claop102022->excluir(NULL,"si137_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] . " and si137_instit = ".db_getsession("DB_instit"));
	    if ($claop102022->erro_status == 0) {
	    	  throw new Exception($claop102022->erro_msg);
	      }
	}
    ...
    foreach ($aAnulacoes as $anulacao) {
    	  ...
    	  $oDadosAnulacao = new cl_aop102022();
		  ...
		  foreach($anulacao->reg11 as $reg11){
		  		  ...
		  		  $oDadosAnulacaoFonte = new cl_aop112022();
