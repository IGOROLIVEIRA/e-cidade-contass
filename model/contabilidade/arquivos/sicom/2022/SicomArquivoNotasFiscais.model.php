...
require_once ("classes/db_ntf102022_classe.php");
require_once ("classes/db_ntf112022_classe.php");
require_once ("classes/db_ntf122022_classe.php");
...
class SicomArquivoNotasFiscais extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$clntf102022 = new cl_ntf102022();
    $clntf112022 = new cl_ntf112022();
    $clntf122022 = new cl_ntf122022();
     ...
     */
    $result = $clntf122022->sql_record($clntf122022->sql_query(NULL,"*",NULL,"si145_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si145_instit = ".db_getsession("DB_instit") ));
    if (pg_num_rows($result) > 0) {

      $clntf122022->excluir(NULL,"si145_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si145_instit = ".db_getsession("DB_instit"));
      if ($clntf122022->erro_status == 0) {
        throw new Exception($clntf122022->erro_msg);
      }
    }
     ...
     */
    $result = $clntf112022->sql_record($clntf112022->sql_query(NULL,"*",NULL,"si144_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si144_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {

      $clntf112022->excluir(NULL,"si144_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si144_instit = ".db_getsession("DB_instit"));
      if ($clntf112022->erro_status == 0) {
        throw new Exception($clntf112022->erro_msg);
      }
    }
     ...
     */
    $result = $clntf102022->sql_record($clntf102022->sql_query(NULL,"*",NULL,"si143_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si143_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
      $clntf102022->excluir(NULL,"si143_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si143_instit = ".db_getsession("DB_instit"));
      if ($clntf102022->erro_status == 0) {
        throw new Exception($clntf102022->erro_msg);
      }
    }
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
      ...
      $clntf102022->si143_tiporegistro              = 10;
      $clntf102022->si143_codnotafiscal             = $oDados10->codnotafiscal;
      $clntf102022->si143_codorgao                  = $oDados10->codorgao;

      $oDados10->nfnumero = str_replace("/", "", $oDados10->nfnumero);
      if(ereg('[^0-9]',$oDados10->nfnumero)){
        $clntf102022->si143_nfnumero                  = null;
      }else{
        $clntf102022->si143_nfnumero                  = $oDados10->nfnumero;
      }

      $clntf102022->si143_nfserie                   = $oDados10->nfserie;
      $clntf102022->si143_tipodocumento             = $oDados10->tipodocumento;
      $clntf102022->si143_nrodocumento              = $oDados10->nrodocumento;
      $clntf102022->si143_nroinscestadual           = $oDados10->nroinscestadual;
      $clntf102022->si143_nroinscmunicipal          = $oDados10->nroinscmunicipal;
      $clntf102022->si143_nomemunicipio             = $oDados10->nomemunicipio;
      $clntf102022->si143_cepmunicipio              = $oDados10->cepmunicipio;
      $clntf102022->si143_ufcredor                  = $oDados10->ufcredor;
      $clntf102022->si143_notafiscaleletronica      = $oDados10->notafiscaleletronica;
      $clntf102022->si143_chaveacesso               = $oDados10->chaveacesso;
      $clntf102022->si143_chaveacessomunicipal      = $oDados10->chaveacessomunicipal;
      $clntf102022->si143_nfaidf                    = $oDados10->nfaidf;
      $clntf102022->si143_dtemissaonf               = $oDados10->dtemissaonf;
      $clntf102022->si143_dtvencimentonf            = $oDados10->dtvencimentonf;
      $clntf102022->si143_nfvalortotal              = $oDados10->nfvalortotal;
      $clntf102022->si143_nfvalordesconto           = $oDados10->nfvalordesconto;
      $clntf102022->si143_nfvalorliquido            = $oDados10->nfvalorliquido;
      $clntf102022->si143_mes                       = $this->sDataFinal['5'].$this->sDataFinal['6'];
      $clntf102022->si143_instit                    = db_getsession("DB_instit");

      $clntf102022->incluir(null);
      ...
      where empnota.e69_codnota = ".$clntf102022->si143_codnotafiscal;
      ...
      for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
        ...
        $clntf112022->si144_tiporegistro           = 11;
        $clntf112022->si144_reg10                  = $clntf102022->si143_sequencial;
        $clntf112022->si144_codnotafiscal          = $clntf112022->codnotafiscal;
        $clntf112022->si144_coditem                = $clntf112022->coditem;
        $clntf112022->si144_quantidadeitem         = $clntf112022->quantidadeitem;
        $clntf112022->si144_valorunitarioitem      = $clntf112022->valorunitarioitem;
        $clntf112022->si144_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
        $clntf112022->si144_instit                 = db_getsession("DB_instit");

        $clntf112022->incluir(null);
      ...
      and empnota.e69_codnota = ". $clntf102022->si143_codnotafiscal;
      ...
      for ($iCont12 = 0; $iCont12 < pg_num_rows($rsResult12); $iCont12++) {
        ...
        $clntf122022->si145_tiporegistro           = 12;
        $clntf122022->si145_reg10                  = $clntf102022->si143_sequencial;
        $clntf122022->si145_codnotafiscal          = $oDados12->codnotafiscal;
        $clntf122022->si145_codunidadesub          = str_pad($oDados12->orgao, 2, "0", STR_PAD_LEFT).str_pad($oDados12->unidade, 3, "0", STR_PAD_LEFT);
        $clntf122022->si145_dtempenho              = $oDados12->dtempenho;
        $clntf122022->si145_nroempenho             = $oDados12->nroempenho;
        $clntf122022->si145_dtliquidacao           = $oDados12->dtliquidacao;
        $clntf122022->si145_nroliquidacao          = $oDados12->nroliquidacao;
        $clntf122022->si145_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
        $clntf122022->si145_instit                 = db_getsession("DB_instit");

        $clntf122022->incluir(null);
