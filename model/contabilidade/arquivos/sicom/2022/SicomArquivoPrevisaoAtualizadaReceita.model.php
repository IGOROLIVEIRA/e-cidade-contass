...
require_once ("classes/db_parec102022_classe.php");
require_once ("classes/db_parec112022_classe.php");
...
class SicomArquivoPrevisaoAtualizadaReceita extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
   ...
   /**
  	 ...
  	 */
  	$clparec102022 = new cl_parec102022();
  	$clparec112022 = new cl_parec112022();
    ...
    $result = $clparec112022->sql_record($clparec112022->sql_query(NULL,"*",NULL,"si23_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si23_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clparec112022->excluir(NULL,"si23_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si23_instit = ".db_getsession("DB_instit"));
      if ($clparec112022->erro_status == 0) {
    	  throw new Exception($clparec112022->erro_msg);
      }
    }
    
    $result = $clparec102022->sql_record($clparec102022->sql_query(NULL,"*",NULL,"si22_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si22_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clparec102022->excluir(NULL,"si22_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si22_instit = ".db_getsession("DB_instit"));
      if ($clparec102022->erro_status == 0) {
    	  throw new Exception($clparec102022->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
    	...
    	$clparec102022 = new cl_parec102022();
		  $clparec102022->si22_tiporegistro         = $oDados10->si22_tiporegistro;
		  $clparec102022->si22_codreduzido          = $oDados10->si22_codreduzido;
		  $clparec102022->si22_codorgao             = $oDados10->si22_codorgao;
		  $clparec102022->si22_ededucaodereceita    = $oDados10->si22_ededucaodereceita;
		  $clparec102022->si22_identificadordeducao = $oDados10->si22_identificadordeducao;
		  $clparec102022->si22_naturezareceita      = $oDados10->si22_naturezareceita;
		  $clparec102022->si22_tipoatualizacao      = $oDados10->si22_tipoatualizacao;
		  $clparec102022->si22_especificacao        = $oDados10->si22_especificacao;
		  $clparec102022->si22_vlacrescidoreduzido  = abs($oDados10->si22_vlacrescidoreduzido);
		  $clparec102022->si22_mes                  = $oDados10->si22_mes;
		  $clparec102022->si22_instit               = db_getsession("DB_instit");
		  
		  $clparec102022->incluir(null);
    	if ($clparec102022->erro_status == 0) {
    	  throw new Exception($clparec102022->erro_msg);
      }
      foreach ($oDados10->Reg11 as $oDados11) {
        ...
        $clparec112022 = new cl_parec112022();
    		$clparec112022->si23_tiporegistro    = $oDados11->si23_tiporegistro;
    		$clparec112022->si23_codreduzido     = $oDados11->si23_codreduzido;
    		$clparec112022->si23_codfontrecursos = $oDados11->si23_codfontrecursos;
    		$clparec112022->si23_vlfonte         = abs($oDados11->si23_vlfonte);
    		$clparec112022->si23_mes             = $oDados11->si23_mes;
    		$clparec112022->si23_reg10           = $clparec102022->si22_sequencial;
    		$clparec112022->si23_instit          = db_getsession("DB_instit");
    		
        $clparec112022->incluir(null);
    	  if ($clparec112022->erro_status == 0) {
    	    throw new Exception($clparec112022->erro_msg);
        }
