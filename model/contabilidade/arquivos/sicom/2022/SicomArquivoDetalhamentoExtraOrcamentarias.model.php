...
require_once ("classes/db_ext202221_classe.php");
require_once ("classes/db_ext212022_classe.php");
require_once ("classes/db_ext222022_classe.php");
require_once ("classes/db_ext232022_classe.php");
...
class SicomArquivoDetalhamentoExtraOrcamentarias extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cExt20 = new cl_ext202221();
  	$cExt21 = new cl_ext212022();
  	$cExt22 = new cl_ext222022();
  	$cExt23 = new cl_ext232022();
  	/*
