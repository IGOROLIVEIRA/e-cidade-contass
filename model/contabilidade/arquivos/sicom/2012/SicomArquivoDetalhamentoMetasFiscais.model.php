...
//$iAno1  = 2011;
	    ...
	    $oDadosMTFIS->pcPIBReceitaTotal                   = number_format($oReceitaTotal->aValores[${$iAnoUsu}]->PIB, 2, "", "");
	    $oDadosMTFIS->pcPIBReceitaPrimaria                = number_format($oReceitasPrimarias->aValores[${$iAnoUsu}]->PIB, 2, "", "");
	    $oDadosMTFIS->pcPIBDespesaTotal                   = number_format($oDespesaTotal->aValores[${$iAnoUsu}]->PIB, 2, "", "");;
	    $oDadosMTFIS->pcPIBDespesaPrimaria                = number_format($oDespesasPrimarias->aValores[${$iAnoUsu}]->PIB, 2, "", "");;
	    $oDadosMTFIS->pcPIBResultadoNominal               = number_format($oResultadoNominal->aValores[${$iAnoUsu}]->PIB, 2, "", "");;
	    $oDadosMTFIS->pcPIBDividaPublicaConsolidada       = number_format($oDivPublicConsol->aValores[${$iAnoUsu}]->PIB, 2, "", "");;
	    $oDadosMTFIS->pcPIBDividaConsolidadaLiquida       = number_format($oDivConsolLiquid->aValores[${$iAnoUsu}]->PIB, 2, "", "");;
