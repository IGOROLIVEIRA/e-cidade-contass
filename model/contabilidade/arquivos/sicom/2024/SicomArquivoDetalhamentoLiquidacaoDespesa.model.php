...
class SicomArquivoDetalhamentoLiquidacaoDespesa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cllqd102024 = new cl_lqd102024();
  	$cllqd112024 = new cl_lqd112024();
  	$cllqd122024 = new cl_lqd122024();
     ...
     */
    db_inicio_transacao();
    $result = $cllqd102024->sql_record($cllqd102024->sql_query(NULL,"*",NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
        ." and si118_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {

    	$cllqd112024->excluir(NULL,"si119_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si119_instit = ".db_getsession("DB_instit"));
    	$cllqd122024->excluir(NULL,"si120_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si120_instit = ".db_getsession("DB_instit"));
    	$cllqd102024->excluir(NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si118_instit = ".db_getsession("DB_instit"));
      if ($cllqd102024->erro_status == 0) {
    	  throw new Exception($cllqd102024->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
		    	  ...
		    	  $cllqd102024 = new cl_lqd102024();
				  $cllqd102024->si118_tiporegistro          = $oDados10->si118_tiporegistro;
				  $cllqd102024->si118_codreduzido           = $oDados10->si118_codreduzido;
				  $cllqd102024->si118_codorgao              = $oDados10->si118_codorgao;
				  $cllqd102024->si118_codunidadesub         = $oDados10->si118_codunidadesub;
				  $cllqd102024->si118_tpliquidacao          = $oDados10->si118_tpliquidacao;
				  $cllqd102024->si118_nroempenho            = $oDados10->si118_nroempenho;
				  $cllqd102024->si118_dtempenho             = $oDados10->si118_dtempenho;
				  $cllqd102024->si118_dtliquidacao          = $oDados10->si118_dtliquidacao;
				  $cllqd102024->si118_nroliquidacao         = $oDados10->si118_nroliquidacao;
				  $cllqd102024->si118_vlliquidado           = $oDados10->si118_vlliquidado;
				  $cllqd102024->si118_cpfliquidante         = $oDados10->si118_cpfliquidante;
				  $cllqd102024->si118_mes                   = $oDados10->si118_mes;
				  $cllqd102024->si118_instit 				= db_getsession("DB_instit");

				  $cllqd102024->incluir(null);
		    	if ($cllqd102024->erro_status == 0) {
		    		echo "<pre>";print_r($cllqd102024);
		    	  throw new Exception($cllqd102024->erro_msg);
		      }
      foreach ($oDados10->Reg11 as $oDados11) {
    		...
    		$cllqd112024->si119_tiporegistro     = $oDados11->si119_tiporegistro;
    		$cllqd112024->si119_codreduzido      = $oDados11->si119_codreduzido;
    		$cllqd112024->si119_codfontrecursos  = $oDados11->si119_codfontrecursos;
    		$cllqd112024->si119_valorfonte       = $oDados11->si119_valorfonte;
    		$cllqd112024->si119_mes              = $oDados11->si119_mes;
    		$cllqd112024->si119_reg10            = $cllqd102024->si118_sequencial;
    		$cllqd112024->si119_instit 			 = db_getsession("DB_instit");

          $cllqd112024->incluir(null);
    	  if ($cllqd112024->erro_status == 0) {
    	    throw new Exception($cllqd112024->erro_msg);
        }
