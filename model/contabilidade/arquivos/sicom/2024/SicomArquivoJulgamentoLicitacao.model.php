...
class SicomArquivoJulgamentoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	 ...
  	 */
  	$cljulglic102024 = new cl_julglic102024();
  	$cljulglic202024 = new cl_julglic202024();
  	$cljulglic302024 = new cl_julglic302024();

    /**
     * excluir informacoes do mes selecioado
     */
    db_inicio_transacao();
    $result = db_query($cljulglic102024->sql_query(NULL,"*",NULL,"si60_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si60_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$cljulglic102024->excluir(NULL,"si60_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si60_instit=".db_getsession("DB_instit"));
      if ($cljulglic102024->erro_status == 0) {
    	  throw new Exception($cljulglic102024->erro_msg);
      }
    }

    $result = db_query($cljulglic202024->sql_query(NULL,"*",NULL,"si61_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si61_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$cljulglic202024->excluir(NULL,"si61_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si61_instit=".db_getsession("DB_instit"));
      if ($cljulglic202024->erro_status == 0) {
    	  throw new Exception($cljulglic202024->erro_msg);
      }
    }

    $result = db_query($cljulglic302024->sql_query(NULL,"*",NULL,"si62_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si62_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$cljulglic302024->excluir(NULL,"si62_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si62_instit=".db_getsession("DB_instit"));
      if ($cljulglic302024->erro_status == 0) {
    	  throw new Exception($cljulglic302024->erro_msg);
      }
    }
	...
	AND DATE_PART('MONTH',homologacaoadjudica.l202_datahomologacao)= ".$this->sDataFinal['5'].$this->sDataFinal['6'];
		...
		for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
		  ...
		  $oDados10       = db_utils::fieldsMemory($rsResult10, $iCont10);
			...
			$cljulglic102024->si60_tiporegistro   		  = 10;
			$cljulglic102024->si60_codorgao	 			  = $oDados10->codorgaoresp;
			$cljulglic102024->si60_codunidadesub	      = $oDados10->codunidadesubresp;
			$cljulglic102024->si60_exerciciolicitacao	  = $oDados10->exerciciolicitacao;
			$cljulglic102024->si60_nroprocessolicitatorio = $oDados10->nroprocessolicitatorio;
			$cljulglic102024->si60_tipodocumento		  = $oDados10->tipodocumento;
			$cljulglic102024->si60_nrodocumento			  = $oDados10->nrodocumento;
			$cljulglic102024->si60_nrolote				  = $oDados10->nrolote;
			$cljulglic102024->si60_coditem				  = $oDados10->coditem;
			$cljulglic102024->si60_vlunitario	          = $oDados10->vlunitario;
			$cljulglic102024->si60_quantidade	          = $oDados10->quantidade;
			$cljulglic102024->si60_instit		   		  = db_getsession("DB_instit");
		 	$cljulglic102024->si60_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];

		  $cljulglic102024->incluir(null);
		  if ($cljulglic102024->erro_status == 0) {
		    throw new Exception($cljulglic102024->erro_msg);
		  }
	...
	AND liclicita.l20_codigo = {$oDados10->codlicitacao}";
		...
		for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
		  ...
		  $cljulglic202024->si61_tiporegistro        	= 20;
		  $cljulglic202024->si61_codorgao            	= $oDados20->codorgaoresp;
		  $cljulglic202024->si61_codunidadesub		 	= $oDados20->codunidadesubresp;
		  $cljulglic202024->si61_exerciciolicitacao	 	= $oDados20->exerciciolicitacao;
		  $cljulglic202024->si61_nroprocessolicitatorio	= $oDados20->nroprocessolicitatorio;
		  $cljulglic202024->si61_tipodocumento   		= $oDados20->tipodocumento;
		  $cljulglic202024->si61_nrodocumento   		= $oDados20->nrodocumento;
		  $cljulglic202024->si61_nrolote  			    = $oDados20->nrolote;
		  $cljulglic202024->si61_coditem				= $oDados20->coditem;
		  $cljulglic202024->si61_percdesconto			= $oDados20->percdesconto;
		  $cljulglic202024->si61_instit		   		    = db_getsession("DB_instit");
		  $cljulglic202024->si61_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];

		  $cljulglic202024->incluir(null);
		  if ($cljulglic202024->erro_status == 0) {
		    throw new Exception($cljulglic202024->erro_msg);
		  }
	...
	AND liclicita.l20_codigo = {$oDados10->codlicitacao}";
		...
		for ($iCont30 = 0; $iCont30 < pg_num_rows($rsResult30); $iCont30++) {
		  ...
		  $cljulglic302024->si62_tiporegistro     		= 30;
		  $cljulglic302024->si62_codorgao 				=$oDados30->codorgaoresp;
		  $cljulglic302024->si62_codunidadesub 			=$oDados30->codunidadesubresp;
		  $cljulglic302024->si62_exerciciolicitacao 	=$oDados30->exerciciolicitacao;
		  $cljulglic302024->si62_nroprocessolicitatorio =$oDados30->nroprocessolicitatorio;
		  $cljulglic302024->si62_dtjulgamento 			=$oDados30->dtjulgamento;
		  $cljulglic302024->si62_presencalicitantes 	=$oDados30->presencalicitantes;
		  $cljulglic302024->si62_renunciarecurso		=$oDados30->renunciarecurso;
		  $cljulglic302024->si62_instit		   		    = db_getsession("DB_instit");
		  $cljulglic302024->si62_mes              		= $this->sDataFinal['5'].$this->sDataFinal['6'];

		  $cljulglic302024->incluir(null);
		  if ($cljulglic302024->erro_status == 0) {
		    throw new Exception($cljulglic302024->erro_msg);
		  }
