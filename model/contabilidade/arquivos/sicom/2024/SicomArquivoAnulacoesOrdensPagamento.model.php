...
class SicomArquivoAnulacoesOrdensPagamento extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$claop102024 = new cl_aop102024();
  	$claop112024 = new cl_aop112024();
     ...
     */
    db_inicio_transacao();
    $result = $claop102024->sql_record($claop102024->sql_query(NULL,"*",NULL,"si137_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    . " and si137_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {

    	$claop112024->excluir(NULL,"si138_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] . " and si138_instit = ".db_getsession("DB_instit"));
        if ($claop112024->erro_status == 0) {
	    	  throw new Exception($claop112024->erro_msg);
	      }
    	$claop102024->excluir(NULL,"si137_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'] . " and si137_instit = ".db_getsession("DB_instit"));
	    if ($claop102024->erro_status == 0) {
	    	  throw new Exception($claop102024->erro_msg);
	      }
	}
