...
require_once ("classes/db_homolic202321_classe.php");
...
class SicomArquivoHomologacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clhomolic102023 = new cl_homolic102023();
  	$clhomolic202321 = new cl_homolic202321();
  	 ...
  	 */
    $result = $clhomolic102023->sql_record($clhomolic102023->sql_query(NULL,"*",NULL,"si63_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si63_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clhomolic102023->excluir(NULL,"si63_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si63_instit=".db_getsession("DB_instit"));
      if ($clhomolic102023->erro_status == 0) {
    	  throw new Exception($clhomolic102023->erro_msg);
      }
    }
     ...
     */
    $result = $clhomolic202321->sql_record($clhomolic202321->sql_query(NULL,"*",NULL,"si64_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si64_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	
    	$clhomolic202321->excluir(NULL,"si64_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si64_instit=".db_getsession("DB_instit"));
      if ($clhomolic202321->erro_status == 0) {
    	  throw new Exception($clhomolic202321->erro_msg);
      }
    }
	...
	AND DATE_PART('MONTH',homologacaoadjudica.l202_datahomologacao) =" .$this->sDataFinal['5'].$this->sDataFinal['6']."";
    	...
    	for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    		...
    		$clhomolic102023->si63_tiporegistro	           = 10;
    		$clhomolic102023->si63_codorgao				   =$oDados10->codorgaoresp;
    		$clhomolic102023->si63_codunidadesub 		   =$oDados10->codunidadesubresp;
    		$clhomolic102023->si63_exerciciolicitacao      =$oDados10->exerciciolicitacao;
    		$clhomolic102023->si63_nroprocessolicitatorio  =$oDados10->nroprocessolicitatorio;
    		$clhomolic102023->si63_tipodocumento 		   =$oDados10->tipodocumento;
    		$clhomolic102023->si63_nrodocumento 		   =$oDados10->nrodocumento;
    		$clhomolic102023->si63_nrolote				   =$oDados10->nrolote;
    		$clhomolic102023->si63_coditem				   =$oDados10->coditem;
    		$clhomolic102023->si63_vlunitariohomologado    =$oDados10->vlunitario;
    		$clhomolic102023->si63_quantidade 			   =$oDados10->quantidade;
    		$clhomolic102023->si63_instit		   		   = db_getsession("DB_instit");
    		$clhomolic102023->si63_mes                     = $this->sDataFinal['5'].$this->sDataFinal['6'];
    	
    		$clhomolic102023->incluir(null);
    		if ($clhomolic102023->erro_status == 0) {
    			throw new Exception($clhomolic102023->erro_msg);
    		}
    ...
    for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
    	...
    	$clhomolic202321->si64_tiporegistro            = 20;
    	$clhomolic202321->si64_codorgao				   = $oDados20->codorgaoresp;
    	$clhomolic202321->si64_codunidadesub 		   = $oDados20->codunidadesubresp;
    	$clhomolic202321->si64_exerciciolicitacao      = $oDados20->exerciciolicitacao;
    	$clhomolic202321->si64_nroprocessolicitatorio  = $oDados20->nroprocessolicitatorio;
    	$clhomolic202321->si64_tipodocumento           = $oDados20->tipodocumento;
    	$clhomolic202321->si64_nrodocumento            = $oDados20->nrodocumento;
    	$clhomolic202321->si64_nrolote                 = $oDados20->nrolote;
    	$clhomolic202321->si64_coditem                 = $oDados20->coditem;
    	$clhomolic202321->si64_percdesconto            = $oDados20->percdesconto;
    	$clhomolic202321->si64_instit		   		   = db_getsession("DB_instit");
    	$clhomolic202321->si64_mes                     = $this->sDataFinal['5'].$this->sDataFinal['6'];
    	
    	$clhomolic202321->incluir(null);
    	if ($clhomolic202321->erro_status == 0) {
    		throw new Exception($clhomolic202321->erro_msg);
    	}
