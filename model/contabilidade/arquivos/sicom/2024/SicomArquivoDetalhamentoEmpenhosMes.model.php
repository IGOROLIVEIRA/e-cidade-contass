...
class SicomArquivoDetalhamentoEmpenhosMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
	...
	public function gerarDados() {
		...
		$cEmp102024 = new cl_emp102024();
		$cEmp112024 = new cl_emp112024();
		...
		$sTrataCodUnidade = db_utils::fieldsMemory($rsResultTrataUnidade, 0)->si08_tratacodunidade;
		 ...
		 db_inicio_transacao();
		    ...
		    $result = $cEmp102024->sql_record($cEmp102024->sql_query(NULL,"*",NULL,"si106_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])
		     ." si106_instit = ".db_getsession("DB_instit"));

		    if (pg_num_rows($result) > 0) {
		    	$cEmp112024->excluir(NULL,"si107_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
		    	." si107_instit = ".db_getsession("DB_instit"));
		    	$cEmp102024->excluir(NULL,"si106_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
		    	." si106_instit = ".db_getsession("DB_instit"));
		      if ($cEmp102024->erro_status == 0) {
		...
		for ($iCont = 0; $iCont < pg_num_rows($rsEmpenho); $iCont++) {
          ...
          db_inicio_transacao();
			...
			$oDadosEmpenho = new cl_emp102024();
