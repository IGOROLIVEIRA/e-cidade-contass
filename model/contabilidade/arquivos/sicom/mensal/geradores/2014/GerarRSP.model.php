...
class GerarRSP extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from rsp102014 where si112_mes = ". $this->iMes ." and si112_instit = ". db_getsession("DB_instit");
    $rsRSP10    = db_query($sSql);

    $sSql2 = "select * from rsp112014 where si113_mes = ". $this->iMes ." and si113_instit = ". db_getsession("DB_instit");
    $rsRSP11    = db_query($sSql2);

    $sSql3 = "select * from rsp122014 where si114_mes = ". $this->iMes ." and si114_instit = ". db_getsession("DB_instit");
    $rsRSP12    = db_query($sSql3);

    $sSql4 = "select * from rsp202014 where si115_mes = ". $this->iMes ." and si115_instit = ". db_getsession("DB_instit");
    $rsRSP20    = db_query($sSql4);

    $sSql5 = "select * from rsp212014 where si116_mes = ". $this->iMes ." and si116_instit = ". db_getsession("DB_instit");
    $rsRSP21    = db_query($sSql5);

    $sSql6 = "select * from rsp222014 where si117_mes = ". $this->iMes ." and si117_instit = ". db_getsession("DB_instit");
