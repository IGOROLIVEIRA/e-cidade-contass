...
class GerarLQD extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from lqd102014 where si118_mes = ". $this->iMes ." and si118_instit = ".db_getsession("DB_instit");
    $rsLQD10    = db_query($sSql);

    $sSql2 = "select * from lqd112014 where si119_mes = ". $this->iMes ." and si119_instit = ".db_getsession("DB_instit");
    $rsLQD11    = db_query($sSql2);

    $sSql3 = "select * from lqd122014 where si108_mes = ". $this->iMes ." and si108_instit = ".db_getsession("DB_instit");
      ...
      for ($iCont = 0;$iCont < pg_num_rows($rsLQD10); $iCont++) {
        ...
        for ($iCont3 = 0;$iCont3 < pg_num_rows($rsLQD12); $iCont3++) {        
          ...
          if ($aLQD10['si118_sequencial'] == $aLQD12['si120_reg10']) {
            ...
            $aCSVLQD12['si120_codreduzido']              =    substr($aLQD12['si120_codreduzidolqd'], 0, 15);
