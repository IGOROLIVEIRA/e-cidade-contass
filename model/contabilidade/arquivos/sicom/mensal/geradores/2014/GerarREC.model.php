...
class GerarREC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from rec102014 where si25_mes = ". $this->iMes." and si25_instit = ".db_getsession("DB_instit");
    $rsREC10    = db_query($sSql);

    $sSql2 = "select * from rec112014 where si26_mes = ". $this->iMes." and si26_instit = ".db_getsession("DB_instit");
