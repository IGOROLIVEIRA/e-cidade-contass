...
/**
  ...
  */
  ...
  public function gerarDados() {
  	...
  	$sSql          = "select * from pessoa102014 where si12_mes = ". $this->iMes." and si12_instit = ".db_getsession("DB_instit");
      ...
      $this->adicionaLinha();
  	  ...
  	  for ($iCont = 0;$iCont < pg_num_rows($rsPESSOA10); $iCont++) {
   	    ...
   	    $aPESSOA10['si12_tiporegistro']             =  str_pad($aPESSOA10['si12_tiporegistro'], 2, "0", STR_PAD_LEFT);
   	    $aPESSOA10['si12_tipodocumento']            =  str_pad($aPESSOA10['si12_tipodocumento'], 1, "0", STR_PAD_LEFT);
        ...
        $aPESSOA10['si12_tipocadastro']             =  str_pad($aPESSOA10['si12_tipocadastro'], 1, "0", STR_PAD_LEFT);
