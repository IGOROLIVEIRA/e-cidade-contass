...
class GerarREGADESAO extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql6 = "select * from regadesao152024 where si72_mes = " . $this->iMes. " and si72_instit=" . db_getsession("DB_instit");
    $rsREGADESAO15 = db_query($sSql6);

    $sSql7 = "select * from regadesao202024 where si73_mes = " . $this->iMes. " and si73_instit=" . db_getsession("DB_instit");
