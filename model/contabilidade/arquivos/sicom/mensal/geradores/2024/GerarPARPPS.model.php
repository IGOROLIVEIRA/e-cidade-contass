...
class GerarPARPPS extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql = "select * from parpps102023 where si156_mes = " . $this->iMes . " and si156_instit = " . db_getsession("DB_instit");
        $rsPARPPS10 = db_query($sSql);

        $sSql20 = "select * from parpps202023 where si155_mes = " . $this->iMes . " and si155_instit = " . db_getsession("DB_instit");
