    ...
    public function gerarDados()
    {
        ...
        if (pg_num_rows($rsCONTRATOS10) == 0 && pg_num_rows($rsCONTRATOS20) == 0 && pg_num_rows($rsCONTRATOS30) == 0 && pg_num_rows($rsCONTRATOS40) == 0) {
            ...
            for ($iCont = 0; $iCont < pg_num_rows($rsCONTRATOS10); $iCont++) {
                ...
                $aCSVCONTRATOS10['si83_indcriterioreajuste']          =   $aCONTRATOS10['si83_indcriterioreajuste'];
                $aCSVCONTRATOS10['si83_databasereajuste']             =   implode("", array_reverse(explode("-", $aCONTRATOS10['si83_databasereajuste'])));
                $aCSVCONTRATOS10['si83_periodicidadereajuste']        =   $aCONTRATOS10['si83_periodicidadereajuste'] == '' ? ' ' : str_pad($aCONTRATOS10['si83_periodicidadereajuste'], 2, "0", STR_PAD_LEFT);
                $aCSVCONTRATOS10['si83_tipocriterioreajuste']         =   $aCONTRATOS10['si83_tipocriterioreajuste'] == 0 ? ' ' : $aCONTRATOS10['si83_tipocriterioreajuste'];
                $aCSVCONTRATOS10['si83_dscreajuste']                  =   substr($aCONTRATOS10['si83_dscreajuste'], 0, 300);
                $aCSVCONTRATOS10['si83_indiceunicoreajuste']          =   $aCONTRATOS10['si83_indiceunicoreajuste'] == 0 ? ' ' : $aCONTRATOS10['si83_indiceunicoreajuste'];
                $aCSVCONTRATOS10['si83_dscindice']                    =   substr($aCONTRATOS10['si83_dscindice'], 0, 300);
                 ...
                 * OC11837
                 */
                $anocontrato = str_pad($aCONTRATOS10['si83_exerciciocontrato'], 4, "0", STR_PAD_LEFT);
                if ($aCONTRATOS10['si83_naturezaobjeto'] == "7" || $aCONTRATOS10['si83_naturezaobjeto'] == "1") {
                    for ($iCont2 = 0; $iCont2 < pg_num_rows($rsCONTRATOS11); $iCont2++) {
                        ...
                        if ($aCONTRATOS10['si83_sequencial'] == $aCONTRATOS11['si84_reg10']) {
                            ...
                            $aCSVCONTRATOS11['si84_nrolote']               =   $aCONTRATOS11['si84_nrolote'] == 0 ? ' ' : $aCONTRATOS11['si84_nrolote'];
                            ...
                            $aCSVCONTRATOS11['si84_obrordem']              =   $aCONTRATOS11['si84_obrordem'];
                ...
                for ($iCont3 = 0; $iCont3 < pg_num_rows($rsCONTRATOS12); $iCont3++) {
                    ...
                    if ($aCONTRATOS10['si83_sequencial'] == $aCONTRATOS12['si85_reg10']) {
                        ...
                        if ($anocontrato = "2022") {
                            ...
                            $aCSVCONTRATOS12['si85_codfontrecursos']       =   str_pad($aCONTRATOS12['si85_codfontrecursos'], 7, "0", STR_PAD_LEFT);
                        }
            ...
            for ($iCont5 = 0; $iCont5 < pg_num_rows($rsCONTRATOS20); $iCont5++) {
                ...
                $aCSVCONTRATOS20['si87_percentualreajuste']            =  $aCONTRATOS20['si87_percentualreajuste'] == 0 ? ' ' : number_format($aCONTRATOS20['si87_percentualreajuste'], 2, ",", "");
                $aCSVCONTRATOS20['si87_criterioreajuste']              =  $aCONTRATOS20['si87_criterioreajuste'];
                $aCSVCONTRATOS20['si87_descricaoindice']               =  substr($aCONTRATOS20['si87_descricaoindice'], 0, 300);
                $aCSVCONTRATOS20['si87_indiceunicoreajuste']           =  $aCONTRATOS20['si87_indiceunicoreajuste'] == 0 ? ' ' : $aCONTRATOS20['si87_indiceunicoreajuste'];
                $aCSVCONTRATOS20['si87_descricaoreajuste']             =  substr($aCONTRATOS20['si87_descricaoreajuste'], 0, 300);
                ...
                for ($iCont6 = 0; $iCont6 < pg_num_rows($rsCONTRATOS21); $iCont6++) {
                    ...
                    if ($aCONTRATOS21['si88_tipomaterial'] != "0" || $aCONTRATOS21['si88_tipomaterial'] != NULL) {
                        ...
                        if ($aCONTRATOS20['si87_sequencial'] == $aCONTRATOS21['si88_reg20']) {
                            ...
                            $aCSVCONTRATOS21['si88_nrolote']          =  $aCONTRATOS21['si88_nrolote']          == "0" ? '' : $aCONTRATOS21['si88_nrolote'];
                            ...
                            $aCSVCONTRATOS21['si88_obrordem']              =   $aCONTRATOS21['si88_obrordem'];
            ...
            for ($iCont7 = 0; $iCont7 < pg_num_rows($rsCONTRATOS30); $iCont7++) {
                ...
                if (strlen($aCONTRATOS30['si89_codunidadesub']) > 5) {
                    $aCSVCONTRATOS30['si89_codunidadesub']        = $aCONTRATOS30['si89_codunidadesub'] == '' ? ' ' : $this->padLeftZero($aCONTRATOS30['si89_codunidadesub'], 8);
                } else {
                    $aCSVCONTRATOS30['si89_codunidadesub']        = $aCONTRATOS30['si89_codunidadesub'] == '' ? ' ' : $this->padLeftZero($aCONTRATOS30['si89_codunidadesub'], 5);
                }
                if (strlen($aCONTRATOS30['si89_codunidadesubatual']) > 5) {
                    $aCSVCONTRATOS30['si89_codunidadesubatual']        = $aCONTRATOS30['si89_codunidadesubatual'] == '' ? ' ' : $this->padLeftZero($aCONTRATOS30['si89_codunidadesubatual'], 8);
                } else {
                    $aCSVCONTRATOS30['si89_codunidadesubatual']        = $aCONTRATOS30['si89_codunidadesubatual'] == '' ? ' ' : $this->padLeftZero($aCONTRATOS30['si89_codunidadesubatual'], 5);
                }
                ...
                $aCSVCONTRATOS30['si89_percentualreajuste']            =  $aCONTRATOS30['si89_percentualreajuste'] == 0 ? ' ' : number_format($aCONTRATOS30['si89_percentualreajuste'], 2, ",", "");
                $aCSVCONTRATOS30['si89_criterioreajuste']              =  $aCONTRATOS30['si89_criterioreajuste'];
                $aCSVCONTRATOS30['si89_descricaoindice']               =  substr($aCONTRATOS30['si89_descricaoindice'],0,300);
                $aCSVCONTRATOS30['si89_indiceunicoreajuste']           =  $aCONTRATOS30['si89_indiceunicoreajuste'] == 0 ? ' ' : $aCONTRATOS30['si89_indiceunicoreajuste'];
                $aCSVCONTRATOS30['si89_dscreajuste']                   =  substr($aCONTRATOS30['si89_dscreajuste'], 0, 300);
            ...
            for ($iCont8 = 0; $iCont8 < pg_num_rows($rsCONTRATOS40); $iCont8++) {
                ...
                $aCSVCONTRATOS40['si91_codunidadesubatual']            =  $aCONTRATOS40['si91_codunidadesubatual'] == ' ' ? ' ' : str_pad($aCONTRATOS40['si91_codunidadesubatual'], (strlen($aCONTRATOS40['si91_codunidadesubatual']) <= 5 ? 5 : 8), "0", STR_PAD_LEFT);
