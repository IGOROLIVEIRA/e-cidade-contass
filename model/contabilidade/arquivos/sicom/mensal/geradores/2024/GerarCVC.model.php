...
class GerarCVC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from cvc102024 where si146_mes = " . $this->iMes . " and si146_instit=" . db_getsession("DB_instit");
    $rsCVC10 = db_query($sSql);

    $sSql2 = "select * from cvc202024 where si147_mes = " . $this->iMes . " and si147_instit=" . db_getsession("DB_instit");
