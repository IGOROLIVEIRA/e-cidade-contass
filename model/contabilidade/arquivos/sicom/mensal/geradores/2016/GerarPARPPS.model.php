...
class GerarPARPPS extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from parpps102016 where si156_mes = ". $this->iMes ." and si156_instit = ". db_getsession("DB_instit");
    $rsPARPPS10    = db_query($sSql);

    $sSql2 = "select * from parpps202016 where si155_mes = ". $this->iMes ." and si155_instit = ". db_getsession("DB_instit");
