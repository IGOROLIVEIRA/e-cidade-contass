...
class GerarAOP extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from aop102016 where si137_mes = ". $this->iMes . " and si137_instit = ".db_getsession("DB_instit");
    $rsAOP10    = db_query($sSql);

    $sSql2 = "select * from aop112016 where si138_mes = ". $this->iMes . " and si138_instit = ".db_getsession("DB_instit");
