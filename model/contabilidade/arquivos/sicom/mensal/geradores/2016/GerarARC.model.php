...
class GerarARC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from arc102016 where si28_mes = ". $this->iMes." and si28_instit = ".db_getsession("DB_instit");
    $rsARC10    = db_query($sSql);

    $sSql2 = "select * from arc112016 where si29_mes = ". $this->iMes." and si29_instit = ".db_getsession("DB_instit");
    $rsARC11    = db_query($sSql2);

    $sSql3 = "select * from arc122016 where si30_mes = ". $this->iMes." and si30_instit = ".db_getsession("DB_instit");
    $rsARC12    = db_query($sSql3);

    $sSql4 = "select * from arc202016 where si31_mes = ". $this->iMes." and si31_instit = ".db_getsession("DB_instit");
    $rsARC20    = db_query($sSql4);

    $sSql5 = "select * from arc212016 where si32_mes = ". $this->iMes." and si32_instit = ".db_getsession("DB_instit");
