...
class GerarRSP extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from rsp102016 where si112_mes = ". $this->iMes ." and si112_instit = ". db_getsession("DB_instit");
    $rsRSP10    = db_query($sSql);

    $sSql2 = "select * from rsp112016 where si113_mes = ". $this->iMes ." and si113_instit = ". db_getsession("DB_instit");
    $rsRSP11    = db_query($sSql2);

    $sSql3 = "select * from rsp122016 where si114_mes = ". $this->iMes ." and si114_instit = ". db_getsession("DB_instit");
    $rsRSP12    = db_query($sSql3);

    $sSql4 = "select * from rsp202016 where si115_mes = ". $this->iMes ." and si115_instit = ". db_getsession("DB_instit");
    $rsRSP20    = db_query($sSql4);

    $sSql5 = "select * from rsp212016 where si116_mes = ". $this->iMes ." and si116_instit = ". db_getsession("DB_instit");
    $rsRSP21    = db_query($sSql5);

    $sSql6 = "select * from rsp222016 where si117_mes = ". $this->iMes ." and si117_instit = ". db_getsession("DB_instit");
      ...
      */
      for ($iCont4 = 0;$iCont4 < pg_num_rows($rsRSP20); $iCont4++) {
        ...
        */
        ...
        $aCSVRSP20['si115_dotorig']                         =    $aRSP20['si115_dotorig'] == '' ? ' ' : str_pad($aRSP20['si115_dotorig'], (strlen($aRSP20['si115_dotorig'])<=17 ? 17 : 21), "0", STR_PAD_LEFT);
        ...
        $aCSVRSP20['si115_codunidadesubencampatribuic']     =    $aRSP20['si115_codunidadesubencampatribuic'] == '' ? ' ' : str_pad($aRSP20['si115_codunidadesubencampatribuic'], (strlen($aRSP20['si115_codunidadesubencampatribuic']<=5 ? 5 : 8)), "0", STR_PAD_LEFT);
