...
class GerarDDC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from ddc102016 where si150_mes = ". $this->iMes;
    $rsDDC10    = db_query($sSql);

    $sSql2 = "select * from ddc202016 where si153_mes = ". $this->iMes;
    $rsDDC20    = db_query($sSql2);

    $sSql3 = "select * from ddc302016 where si154_mes = ". $this->iMes;
