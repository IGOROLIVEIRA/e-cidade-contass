...
class GerarALQ extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from alq102016 where si121_mes = ". $this->iMes ." and si121_instit = ".db_getsession("DB_instit");
    $rsALQ10    = db_query($sSql);

    $sSql2 = "select * from alq112016 where si122_mes = ". $this->iMes ." and si122_instit = ".db_getsession("DB_instit");
    $rsALQ11    = db_query($sSql2);
    

    $sSql3 = "select * from alq122016 where si123_mes = ". $this->iMes ." and si123_instit = ".db_getsession("DB_instit");
