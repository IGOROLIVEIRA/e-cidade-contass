...
class GerarFLPGO extends GerarAM {
	...
	public function gerarDados() {
		...
		$sSql = "select * from flpgo102016 where si195_mes = ". $this->iMes ." and si195_inst = ". db_getsession("DB_instit");
		$rsFLPGO10    = db_query($sSql);

		$sSql2 = "select * from flpgo112016 where si196_mes = ". $this->iMes ." and si196_inst = ". db_getsession("DB_instit");
		$rsFLPGO11    = db_query($sSql2);

		$sSql3 = "select * from flpgo122016 where si197_mes = ". $this->iMes ." and si197_inst = ". db_getsession("DB_instit");
