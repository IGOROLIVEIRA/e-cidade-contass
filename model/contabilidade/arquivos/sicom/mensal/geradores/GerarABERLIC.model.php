...
class GerarABERLIC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from aberlic102014 where si46_mes = ". $this->iMes." and si46_instit=".db_getsession("DB_instit"); 
    $rsABERLIC10    = db_query($sSql); 

    $sSql2 = "select * from aberlic112014 where si47_mes = ". $this->iMes." and si47_instit=".db_getsession("DB_instit");;
    $rsABERLIC11    = db_query($sSql2);

    $sSql3 = "select * from aberlic122014 where si48_mes = ". $this->iMes." and si48_instit=".db_getsession("DB_instit");;
    $rsABERLIC12    = db_query($sSql3);

    $sSql4 = "select * from aberlic132014 where si49_mes = ". $this->iMes." and si49_instit=".db_getsession("DB_instit");;
    $rsABERLIC13    = db_query($sSql4);

    $sSql5 = "select * from aberlic142014 where si50_mes = ". $this->iMes." and si50_instit=".db_getsession("DB_instit");;
    $rsABERLIC14    = db_query($sSql5);

    $sSql6 = "select * from aberlic152014 where si51_mes = ". $this->iMes." and si51_instit=".db_getsession("DB_instit");;
    $rsABERLIC15    = db_query($sSql6);

    $sSql7 = "select * from aberlic162014 where si52_mes = ". $this->iMes." and si52_instit=".db_getsession("DB_instit");;
  ...
  if (pg_num_rows($rsABERLIC10) == 0) {
      ...
      */
      for ($iCont = 0;$iCont < pg_num_rows($rsABERLIC10); $iCont++) {
        ...
        $aCSVABERLIC10['si46_tipolicitacao']              =   str_pad($aABERLIC10['si46_tipolicitacao'], 1, "0", STR_PAD_LEFT);
        $aCSVABERLIC10['si46_naturezaobjeto']             =   str_pad($aABERLIC10['si46_naturezaobjeto'], 1, "0", STR_PAD_LEFT);
        ...
        for ($iCont3 = 0;$iCont3 < pg_num_rows($rsABERLIC12); $iCont3++) {
          ...
          if ($aABERLIC10['si46_sequencial'] == $aABERLIC12['si48_reg10']) {
            ...
            $aCSVABERLIC12['si48_nroitem']                = substr($aABERLIC12['si48_nroitem'], 0, 4);
