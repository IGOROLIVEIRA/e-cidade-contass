...
class GerarCAIXA extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from caixa102018 where si103_mes = " . $this->iMes . " and si103_instit = " . db_getsession("DB_instit");
    $rsCAIXA10 = db_query($sSql);

    $sSql2 = "select * from caixa112018 where si166_mes = " . $this->iMes . " and si166_instit = " . db_getsession("DB_instit");
    $rsCAIXA11 = db_query($sSql2);

    $sSql3 = "select * from caixa122018 where si104_mes = " . $this->iMes . " and si104_instit = " . db_getsession("DB_instit");
    $rsCAIXA12 = db_query($sSql3);

    $sSql4 = "select * from caixa132018 where si105_mes = " . $this->iMes . " and si105_instit = " . db_getsession("DB_instit");
