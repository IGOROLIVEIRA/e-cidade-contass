...
class GerarRSP extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from rsp102018 where si112_mes = " . $this->iMes . " and si112_instit = " . db_getsession("DB_instit");
    $rsRSP10 = db_query($sSql);
    
    $sSql2 = "select * from rsp112018 where si113_mes = " . $this->iMes . " and si113_instit = " . db_getsession("DB_instit");
    ...
    $sSql4 = "select * from rsp202018 where si115_mes = " . $this->iMes . " and si115_instit = " . db_getsession("DB_instit");
    $rsRSP20 = db_query($sSql4);
    
    $sSql5 = "select * from rsp212018 where si116_mes = " . $this->iMes . " and si116_instit = " . db_getsession("DB_instit");
    $rsRSP21 = db_query($sSql5);
    
    $sSql6 = "select * from rsp222018 where si117_mes = " . $this->iMes . " and si117_instit = " . db_getsession("DB_instit");
