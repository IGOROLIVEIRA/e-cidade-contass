...
class GerarNTF extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    /*$sSql2 = "select * from ntf112018 where si144_mes = ". $this->iMes ." and si144_instit = ". db_getsession("DB_instit");
    $rsNTF11    = db_query($sSql2);*/

    $sSql3 = "select * from ntf202018 where si145_mes = " . $this->iMes . " and si145_instit = " . db_getsession("DB_instit");
