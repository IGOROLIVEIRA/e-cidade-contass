...
class GerarIDERP extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from iderp102018 where si179_mes = " . $this->iMes . " and si179_instit = " . db_getsession("DB_instit");
    $rsiderp10 = db_query($sSql);

    $sSql2 = "select * from iderp112018 where si180_mes = " . $this->iMes . " and si180_instit = " . db_getsession("DB_instit");
