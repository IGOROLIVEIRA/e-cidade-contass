...
class GerarTCE extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from tce102018 where si187_mes = " . $this->iMes . " and si187_instit = " . db_getsession("DB_instit");
    $rstce10 = db_query($sSql);

    $sSql2 = "select * from tce112018 where si188_mes = " . $this->iMes . " and si188_instit = " . db_getsession("DB_instit");
