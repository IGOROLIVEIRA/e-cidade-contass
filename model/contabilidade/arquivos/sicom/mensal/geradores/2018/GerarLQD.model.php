...
class GerarLQD extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from lqd102018 where si118_mes = " . $this->iMes . " and si118_instit = " . db_getsession("DB_instit");
    $rsLQD10 = db_query($sSql);
    
    $sSql2 = "select * from lqd112018 where si119_mes = " . $this->iMes . " and si119_instit = " . db_getsession("DB_instit");
    $rsLQD11 = db_query($sSql2);
    
    $sSql3 = "select * from lqd122018 where si120_mes = " . $this->iMes . " and si120_instit = " . db_getsession("DB_instit");
