...
class GerarLAO extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from lao102022 where si34_mes = " . $this->iMes . " and si34_instit = " . db_getsession("DB_instit");
    $rsLAO10 = db_query($sSql);

    $sSql2 = "select * from lao112022 where si35_mes = " . $this->iMes . " and si35_instit = " . db_getsession("DB_instit");
    $rsLAO11 = db_query($sSql2);

    $sSql3 = "select * from lao202022 where si36_mes = " . $this->iMes . " and si36_instit = " . db_getsession("DB_instit");
    $rsLAO20 = db_query($sSql3);

    $sSql4 = "select * from lao212022 where si37_mes = " . $this->iMes . " and si37_instit = " . db_getsession("DB_instit");
