...
class GerarHOMOLIC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from homolic102022 where si63_mes = " . $this->iMes . " and si63_instit=" . db_getsession("DB_instit");
    $rsHOMOLIC10 = db_query($sSql);

    $sSql2 = "select * from homolic202022 where si64_mes = " . $this->iMes . " and si64_instit=" . db_getsession("DB_instit");
    $rsHOMOLIC20 = db_query($sSql2);

  	$sSql3 = "select * from homolic302022 where si65_mes = " . $this->iMes . " and si65_instit=" . db_getsession("DB_instit");
	$rsHOMOLIC30 = db_query($sSql3);

    $sSql4 = "select * from homolic402022 where si65_mes = " . $this->iMes . " and si65_instit=" . db_getsession("DB_instit");
