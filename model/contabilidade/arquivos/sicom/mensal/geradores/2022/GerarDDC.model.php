...
class GerarDDC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from ddc102022 where si150_mes = " . $this->iMes . " and si150_instit = " . db_getsession("DB_instit");
    $rsDDC10 = db_query($sSql);

    $sSql2 = "select * from ddc202022 where si153_mes = " . $this->iMes . " and si153_instit = " . db_getsession("DB_instit");
    $rsDDC20 = db_query($sSql2);

    $sSql3 = "select * from ddc302022 where si154_mes = " . $this->iMes . " and si154_instit = " . db_getsession("DB_instit");
    $rsDDC30 = db_query($sSql3);

    $sSql4 = "select * from ddc402022 where si178_mes = " . $this->iMes . " and si178_instit = " . db_getsession("DB_instit");
