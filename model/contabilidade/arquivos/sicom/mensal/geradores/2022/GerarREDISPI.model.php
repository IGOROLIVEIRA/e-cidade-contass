...
class GerarREDISPI extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql = "select * from redispi102022 where si183_mes = " . $this->iMes . " and si183_instit=" . db_getsession("DB_instit");
        $rsREDISPI10 = db_query($sSql);

        $sSql2 = "select * from redispi112022 where si184_mes = " . $this->iMes . " and si184_instit=" . db_getsession("DB_instit");;
        $rsREDISPI11 = db_query($sSql2);

        $sSql3 = "select * from redispi122022 where si185_mes = " . $this->iMes . " and si185_instit=" . db_getsession("DB_instit");;
        ...
        if (pg_num_rows($rsREDISPI10) == 0) {
            ...
            for ($iCont = 0; $iCont < pg_num_rows($rsREDISPI10); $iCont++) {
                ...
                $aCSVREDISPI10['si183_regimeexecucaoobras']                   = $aREDISPI10['si183_regimeexecucaoobras'] == 0 ? ' ' : substr($aREDISPI10['si183_regimeexecucaoobras'], 0, 1);
                ...
                for ($iCont2 = 0; $iCont2 < pg_num_rows($rsREDISPI11); $iCont2++) {
                    ...
                    if ($aREDISPI10['si183_sequencial'] == $aREDISPI11['si184_reg10']) {
                        ...
                        $aCSVREDISPI11['si184_tipoatividadeobra']               = $aREDISPI11['si184_tipoatividadeobra'] == 0 ? '' : $this->padLeftZero($aREDISPI11['si184_tipoatividadeobra'], 2);
                        $aCSVREDISPI11['si184_tipoatividadeservico']            = !$aREDISPI11['si184_tipoatividadeservico'] ? '' : $this->padLeftZero($aREDISPI11['si184_tipoatividadeservico'], 2);
