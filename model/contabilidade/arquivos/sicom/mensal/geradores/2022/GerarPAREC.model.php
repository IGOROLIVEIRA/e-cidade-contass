...
class GerarPAREC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from parec102022  where  si22_mes  =  " . $this->iMes . " and si22_instit = " . db_getsession("DB_instit");
    $rsPAREC10 = db_query($sSql);
    
    $sSql2 = "select * from parec112022 where  si23_mes  =  " . $this->iMes . " and si23_instit = " . db_getsession("DB_instit");
