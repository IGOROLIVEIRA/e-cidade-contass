...
class GerarORGAO extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from orgao102022 where si14_mes = " . $this->iMes . " and si14_instit = " . db_getsession("DB_instit");
    $rsORGAO10 = db_query($sSql);

    $sSql2 = "select * from orgao112022 where si15_mes = " . $this->iMes . " and si15_instit = " . db_getsession("DB_instit");
