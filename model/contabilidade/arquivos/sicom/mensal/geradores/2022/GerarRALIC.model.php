...
class GerarRALIC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from ralic102022 where si180_mes = " . $this->iMes . " and si180_instit=" . db_getsession("DB_instit");
    $rsRALIC10 = db_query($sSql);

    $sSql2 = "select * from ralic112022 where si181_mes = " . $this->iMes . " and si181_instit=" . db_getsession("DB_instit");;
    ...
    if (pg_num_rows($rsRALIC10) == 0) {
      ...
      for ($iCont = 0; $iCont < pg_num_rows($rsRALIC10); $iCont++) {
        ...
        $aCSVRALIC10['si180_codunidadesubresp']          = $aRALIC10['si180_codunidadesubresp'];
        ...
        for ($iCont2 = 0; $iCont2 < pg_num_rows($rsRALIC11); $iCont2++) {
          ...
          if ($aRALIC10['si180_sequencial'] == $aRALIC11['si181_reg10']) {
            ...
            $aCSVRALIC11['si181_codunidadesubresp']               = $aRALIC11['si181_codunidadesubresp'];
          ...
          for ($iCont3 = 0; $iCont3 < pg_num_rows($rsRALIC12); $iCont3++) {
            ...
            if ($aRALIC10['si180_sequencial'] == $aRALIC12['si182_reg10'] && $aRALIC11['si181_codobralocal'] == $aRALIC12['si182_codobralocal']) {
              ...
              $aCSVRALIC12['si182_codunidadesubresp']           = $aRALIC12['si182_codunidadesubresp'];
              ...
              $aCSVRALIC12['si182_codbempublico']               = $this->padLeftZero($aRALIC12['si182_codbempublico'], 4);
              $aCSVRALIC12['si182_nrolote']                     = ($aRALIC10['si180_qtdlotes'] != 1) ? $aRALIC12['si182_nrolote'] : '';
