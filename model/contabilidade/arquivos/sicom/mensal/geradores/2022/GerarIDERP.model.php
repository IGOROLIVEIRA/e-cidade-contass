...
class GerarIDERP extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql = "select * from iderp102022 where si179_mes = " . $this->iMes . " and si179_instit = " . db_getsession("DB_instit");
        $rsiderp10 = db_query($sSql);

        $sSql2 = "select * from iderp112022 where si180_mes = " . $this->iMes . " and si180_instit = " . db_getsession("DB_instit");
        $rsiderp11 = db_query($sSql2);

        $sSql3 = "select * from iderp202022 where si181_mes = " . $this->iMes . " and si181_instit = " . db_getsession("DB_instit");
