...
class GerarDCLRF extends GerarAM {
    ...
    public function gerarDados() {
        ...
        $sSql = "select * from dclrf102022  ";
        $sSql .= " left join dclrf202022 on si157_sequencial = si191_reg10 ";
        $sSql .= " left join dclrf302022 on si157_sequencial = si192_reg10 ";
        $sSql .= " left join dclrf402022 on si157_sequencial = si193_reg10 ";
...
//        echo $sSql; db_criatabela($rsDCLRF);exit;
        ...
        $sSql11 = "select * from dclrf112022 where si205_mes = '".$this->iMes."' and si205_instit = ".db_getsession("DB_instit")."";
