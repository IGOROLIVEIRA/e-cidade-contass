...
class GerarRSP extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql2 = "select * from rsp112022 where si113_mes = " . $this->iMes . " and si113_instit = " . db_getsession("DB_instit");
    $rsRSP11 = db_query($sSql2);

    $sSql3 = "select * from rsp122022 where si114_mes = " . $this->iMes . " and si114_instit = " . db_getsession("DB_instit");
    ...
    $sSql5 = "select * from rsp212022 where si116_mes = " . $this->iMes . " and si116_instit = " . db_getsession("DB_instit");
    $rsRSP21 = db_query($sSql5);

    $sSql6 = "select * from rsp222022 where si117_mes = " . $this->iMes . " and si117_instit = " . db_getsession("DB_instit");
