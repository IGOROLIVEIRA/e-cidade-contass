...
class GerarLQD extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql2 = "select * from lqd112022 where si119_mes = " . $this->iMes . " and si119_instit = " . db_getsession("DB_instit");
    $rsLQD11 = db_query($sSql2);

    $sSql3 = "select * from lqd122022 where si120_mes = " . $this->iMes . " and si120_instit = " . db_getsession("DB_instit");
