...
class GerarRESPLIC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from resplic102022 where si55_mes = " . $this->iMes . " and si55_instit=" . db_getsession("DB_instit");
    $rsRESPLIC10 = db_query($sSql);

    $sSql2 = "select * from resplic202022 where si56_mes = " . $this->iMes . " and si56_instit=" . db_getsession("DB_instit");
    ...
    if (pg_num_rows($rsRESPLIC10) == 0 && pg_num_rows($rsRESPLIC20) == 0) {
      ...
      for ($iCont2 = 0; $iCont2 < pg_num_rows($rsRESPLIC20); $iCont2++) {
        ...
        $aCSVRESPLIC20['si56_codtipocomissao']        = $aRESPLIC20['si56_codtipocomissao'];
