  ...
  public function gerarDados()
  {
    ...
    if (pg_num_rows($rsREGADESAO10) == 0 && pg_num_rows($rsREGADESAO20) == 0) {
      ...
      for ($iCont = 0; $iCont < pg_num_rows($rsREGADESAO10); $iCont++) {
        ...
        $aCSVREGADESAO10['si67_tipocadastro']               = $this->padLeftZero($aREGADESAO10['si67_tipocadastro'], 1);
        ...
        $aCSVREGADESAO10['si67_nroedital']     				= substr($aREGADESAO10['si67_nroedital'], 0, 10);
        $aCSVREGADESAO10['si67_exercicioedital']  			= $this->padLeftZero($aREGADESAO10['si67_exercicioedital'], 4);
