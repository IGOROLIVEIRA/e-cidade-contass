...
class GerarABERLIC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql2 = "select * from aberlic112017 where si47_mes = " . $this->iMes . " and si47_instit=" . db_getsession("DB_instit");;
    $rsABERLIC11 = db_query($sSql2);

    $sSql3 = "select * from aberlic122017 where si48_mes = " . $this->iMes . " and si48_instit=" . db_getsession("DB_instit");;
    $rsABERLIC12 = db_query($sSql3);

    $sSql4 = "select * from aberlic132017 where si49_mes = " . $this->iMes . " and si49_instit=" . db_getsession("DB_instit");;
    $rsABERLIC13 = db_query($sSql4);

    $sSql5 = "select * from aberlic142017 where si50_mes = " . $this->iMes . " and si50_instit=" . db_getsession("DB_instit");;
    $rsABERLIC14 = db_query($sSql5);

    $sSql6 = "select * from aberlic152017 where si51_mes = " . $this->iMes . " and si51_instit=" . db_getsession("DB_instit");;
    $rsABERLIC15 = db_query($sSql6);

    $sSql7 = "select * from aberlic162017 where si52_mes = " . $this->iMes . " and si52_instit=" . db_getsession("DB_instit");;
