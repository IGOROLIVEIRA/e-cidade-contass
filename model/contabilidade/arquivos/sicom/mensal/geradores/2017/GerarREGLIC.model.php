...
class GerarREGLIC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from reglic102017 where si44_mes = " . $this->iMes . " and si44_instit=" . db_getsession("DB_instit");
    $rsREGLIC10 = db_query($sSql);

    $sSql2 = "select * from reglic202017 where si45_mes = " . $this->iMes . " and si45_instit=" . db_getsession("DB_instit");
