...
class GerarDCLRF extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from dclrf102017 where si157_mes = ". $this->iMes;
    $rsDCLRF10    = db_query($sSql);

    $sSql = "select * from dclrf202017 where si169_mes = ". $this->iMes;
    $rsDCLRF20    = db_query($sSql);

    $sSql = "select * from dclrf302017 where si178_mes = ". $this->iMes;
