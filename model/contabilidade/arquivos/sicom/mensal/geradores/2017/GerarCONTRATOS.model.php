...
class GerarCONTRATOS extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql4 = "select * from contratos132017 where si86_mes = ". $this->iMes ." and si86_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS13    = db_query($sSql4);

    $sSql5 = "select * from contratos202017 where si87_mes = ". $this->iMes ." and si87_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS20    = db_query($sSql5);

    $sSql6 = "select * from contratos212017 where si88_mes = ". $this->iMes ." and si88_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS21    = db_query($sSql6);

    $sSql7 = "select * from contratos302017 where si89_mes = ". $this->iMes ." and si89_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS30    = db_query($sSql7);

    $sSql8 = "select * from contratos402017 where si91_mes = ". $this->iMes ." and si91_instit = ". db_getsession("DB_instit");
