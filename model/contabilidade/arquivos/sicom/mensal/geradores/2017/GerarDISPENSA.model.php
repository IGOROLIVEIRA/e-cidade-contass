...
class GerarDISPENSA extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from dispensa102017 where si74_mes = " . $this->iMes . " and si74_instit=" . db_getsession("DB_instit");
    $rsDISPENSA10 = db_query($sSql);
    
    $sSql2 = "select * from dispensa112017 where si75_mes = " . $this->iMes . " and si75_instit=" . db_getsession("DB_instit");
    $rsDISPENSA11 = db_query($sSql2);
    
    $sSql3 = "select * from dispensa122017 where si76_mes = " . $this->iMes . " and si76_instit=" . db_getsession("DB_instit");
    $rsDISPENSA12 = db_query($sSql3);
    
    $sSql4 = "select * from dispensa132017 where si77_mes = " . $this->iMes . " and si77_instit=" . db_getsession("DB_instit");
    $rsDISPENSA13 = db_query($sSql4);
    
    $sSql5 = "select * from dispensa142017 where si78_mes = " . $this->iMes . " and si78_instit=" . db_getsession("DB_instit");
    $rsDISPENSA14 = db_query($sSql5);
    
    $sSql6 = "select * from dispensa152017 where si79_mes = " . $this->iMes . " and si79_instit=" . db_getsession("DB_instit");
    $rsDISPENSA15 = db_query($sSql6);
    
    $sSql7 = "select * from dispensa162017 where si80_mes = " . $this->iMes . " and si80_instit=" . db_getsession("DB_instit");
    $rsDISPENSA16 = db_query($sSql7);
    
    $sSql8 = "select * from dispensa172017 where si81_mes = " . $this->iMes . " and si81_instit=" . db_getsession("DB_instit");
    $rsDISPENSA17 = db_query($sSql8);
    
    $sSql9 = "select * from dispensa182017 where si82_mes = " . $this->iMes . " and si82_instit=" . db_getsession("DB_instit");
