...
class GerarAOC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from aoc102017 where si38_mes = " . $this->iMes . " and si38_instit = " . db_getsession("DB_instit");
    $rsAOC10 = db_query($sSql);

    $sSql2 = "select * from aoc112017 where si39_mes = " . $this->iMes . " and si39_instit = " . db_getsession("DB_instit");
    $rsAOC11 = db_query($sSql2);

    $sSql3 = "select * from aoc122017 where si40_mes = " . $this->iMes . " and si40_instit = " . db_getsession("DB_instit");
    $rsAOC12 = db_query($sSql3);

    $sSql4 = "select * from aoc132017 where si41_mes = " . $this->iMes . " and si41_instit = " . db_getsession("DB_instit");
    $rsAOC13 = db_query($sSql4);

    $sSql5 = "select * from aoc142017 where si42_mes = " . $this->iMes . " and si42_instit = " . db_getsession("DB_instit");
      ...
      for ($iCont = 0; $iCont < pg_num_rows($rsAOC10); $iCont++) {
        ...
        for ($iCont4 = 0; $iCont4 < pg_num_rows($rsAOC14); $iCont4++) {
          ...
          if ($aAOC10['si38_sequencial'] == $aAOC14['si42_reg10']) {
            ...
            $aCSVAOC14['si42_vlacrescimoreducao'] = $this->sicomNumberReal($aAOC14['si42_vlacrescimoreducao'], 2);
