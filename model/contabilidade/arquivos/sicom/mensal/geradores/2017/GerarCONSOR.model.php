...
class GerarCONSOR extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from consor102017 where si16_mes = " . $this->iMes . " and si16_instit = " . db_getsession("DB_instit");
    $rsCONSOR10 = db_query($sSql);

    $sSql2 = "select * from consor202017 where si17_mes = " . $this->iMes . " and si17_instit = " . db_getsession("DB_instit");
    $rsCONSOR20 = db_query($sSql2);

    $sSql3 = "select * from consor302017 where si18_mes = " . $this->iMes . " and si18_instit = " . db_getsession("DB_instit");
    $rsCONSOR30 = db_query($sSql3);

    $sSql4 = "select * from consor402017 where si19_mes = " . $this->iMes . " and si19_instit = " . db_getsession("DB_instit");
    $rsCONSOR40 = db_query($sSql4);

    $sSql5 = "select * from consor502017 where si20_mes = " . $this->iMes . " and si20_instit = " . db_getsession("DB_instit");
