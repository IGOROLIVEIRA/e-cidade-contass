...
class GerarCVC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from cvc102017 where si146_mes = " . $this->iMes . " and si146_instit=" . db_getsession("DB_instit");
    $rsCVC10 = db_query($sSql);

    $sSql2 = "select * from cvc202017 where si147_mes = " . $this->iMes . " and si147_instit=" . db_getsession("DB_instit");
    $rsCVC20 = db_query($sSql2);
    
    $sSql3 = "select * from cvc302017 where si148_mes = " . $this->iMes . " and si148_instit=" . db_getsession("DB_instit");
    $rsCVC30 = db_query($sSql3);

    $sSql4 = "select * from cvc402017 where si149_mes = " . $this->iMes . " and si149_instit=" . db_getsession("DB_instit");
