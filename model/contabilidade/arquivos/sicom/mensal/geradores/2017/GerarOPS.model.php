...
class GerarOPS extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql4 = "select * from ops132017 where si135_mes = " . $this->iMes . " and si135_instit = " . db_getsession("DB_instit");
    $rsOPS13 = db_query($sSql4);

    $sSql5 = "select * from ops142017 where si136_mes = " . $this->iMes . " and si136_instit = " . db_getsession("DB_instit");
