...
class GerarCONTRATOS extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from contratos102014 where si83_mes = ". $this->iMes ." and si83_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS10    = db_query($sSql);

    $sSql2 = "select * from contratos112014 where si84_mes = ". $this->iMes ." and si84_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS11    = db_query($sSql2);
    

    $sSql3 = "select * from contratos122014 where si85_mes = ". $this->iMes ." and si85_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS12    = db_query($sSql3);

    $sSql4 = "select * from contratos132014 where si86_mes = ". $this->iMes ." and si86_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS13    = db_query($sSql4);

    $sSql5 = "select * from contratos202014 where si87_mes = ". $this->iMes ." and si87_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS20    = db_query($sSql5);

    $sSql6 = "select * from contratos212014 where si88_mes = ". $this->iMes ." and si88_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS21    = db_query($sSql6);

    $sSql7 = "select * from contratos302014 where si89_mes = ". $this->iMes ." and si89_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS30    = db_query($sSql7);

    $sSql8 = "select * from contratos402014 where si91_mes = ". $this->iMes ." and si91_instit = ". db_getsession("DB_instit");
  ...
  if (pg_num_rows($rsCONTRATOS10) == 0 && pg_num_rows($rsCONTRATOS20) == 0 && pg_num_rows($rsCONTRATOS30) == 0 && pg_num_rows($rsCONTRATOS40) == 0) {
      ...
      */
      for ($iCont = 0;$iCont < pg_num_rows($rsCONTRATOS10); $iCont++) {
        ...
        $aCSVCONTRATOS10['si83_exercicioprocesso']            =   str_pad($aCONTRATOS10['si83_exercicioprocesso'], 4, "0", STR_PAD_LEFT);
      ...
      */
      for ($iCont5 = 0;$iCont5 < pg_num_rows($rsCONTRATOS20); $iCont5++) {
        ...
        $aCSVCONTRATOS20['si87_codunidadesub']                 =  str_pad($aCONTRATOS20['si87_codunidadesub'], 8, "0", STR_PAD_LEFT);
      ...
      */
      for ($iCont7 = 0;$iCont7 < pg_num_rows($rsCONTRATOS30); $iCont7++) {
        ...
        $aCSVCONTRATOS30['si89_codunidadesub']                 =  str_pad($aCONTRATOS30['si89_codunidadesub'], 8, "0", STR_PAD_LEFT);
        ...
        $aCSVCONTRATOS21['si89_valorapostila']                 =  number_format($aCONTRATOS21['si89_valorapostila'], 2, ",", "");
