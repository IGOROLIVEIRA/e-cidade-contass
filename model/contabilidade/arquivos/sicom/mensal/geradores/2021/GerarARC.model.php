...
class GerarARC extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql = "select * from arc102021 where si28_mes = " . $this->iMes . " and si28_instit = " . db_getsession("DB_instit");
        $rsARC10 = db_query($sSql);

        $sSql2 = "select * from arc112021 where si29_mes = " . $this->iMes . " and si29_instit = " . db_getsession("DB_instit");
