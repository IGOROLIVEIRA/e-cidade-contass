...
class GerarCUTE extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql10 = "select * from cute102023 where si199_mes = " . $this->iMes . " and si199_instit = " . db_getsession("DB_instit");
        $rscute10 = db_query($sSql10);

        $sSql22 = "select * from cute202023 where si200_mes = " . $this->iMes . " and si200_instit = " . db_getsession("DB_instit");
        $rscute20 = db_query($sSql22);

        $sSql21 = "select * from cute212023 where si201_mes = " . $this->iMes . " and si201_instit = " . db_getsession("DB_instit");
