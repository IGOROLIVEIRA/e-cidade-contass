...
class GerarREGADESAO extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from regadesao102014 where si67_mes = ". $this->iMes;
    $rsREGADESAO10    = db_query($sSql);

    $sSql2 = "select * from regadesao112014 where si68_mes = ". $this->iMes;
    $rsREGADESAO11    = db_query($sSql2);

    $sSql3 = "select * from regadesao122014 where si69_mes = ". $this->iMes;
    $rsREGADESAO12    = db_query($sSql3);

    $sSql4 = "select * from regadesao132014 where si70_mes = ". $this->iMes;
    $rsREGADESAO13    = db_query($sSql4);

    $sSql5 = "select * from regadesao142014 where si71_mes = ". $this->iMes;
    $rsREGADESAO14    = db_query($sSql5);

    $sSql6 = "select * from regadesao152014 where si72_mes = ". $this->iMes;
    $rsREGADESAO15    = db_query($sSql6);

    $sSql7 = "select * from regadesao202014 where si73_mes = ". $this->iMes;
