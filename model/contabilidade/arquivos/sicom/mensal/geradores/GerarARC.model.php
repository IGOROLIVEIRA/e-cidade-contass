...
class GerarARC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from arc102014 where si28_mes = ". $this->iMes." and si28_instit = ".db_getsession("DB_instit");
    $rsARC10    = db_query($sSql);

    $sSql2 = "select * from arc112014 where si29_mes = ". $this->iMes." and si29_instit = ".db_getsession("DB_instit");
    $rsARC11    = db_query($sSql2);

    $sSql3 = "select * from arc122014 where si30_mes = ". $this->iMes." and si30_instit = ".db_getsession("DB_instit");
    $rsARC12    = db_query($sSql3);

    $sSql4 = "select * from arc202014 where si31_mes = ". $this->iMes." and si31_instit = ".db_getsession("DB_instit");
    $rsARC20    = db_query($sSql4);

    $sSql5 = "select * from arc212014 where si32_mes = ". $this->iMes." and si32_instit = ".db_getsession("DB_instit");
