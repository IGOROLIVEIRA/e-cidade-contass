...
/**
  ...
  */
  ...
  public function gerarDados() {
  	...
  	$sSql         = "select * from orgao102015 where si14_mes = ". $this->iMes ." and si14_instit = ".db_getsession("DB_instit") ;
  	$rsORGAO10    = db_query($sSql);

  	$sSql2        = "select * from orgao112015 where si15_mes = ". $this->iMes ." and si15_instit = ".db_getsession("DB_instit");
      ...
      $this->adicionaLinha();
        ...
        $aCSVORGAO10['si14_tipodocumentofornsoftware']  =   str_pad($aORGAO10['si14_tipodocumentofornsoftware'], 1, "0", STR_PAD_LEFT);
        $aCSVORGAO10['si14_nrodocumentofornsoftware']   =   str_pad($aORGAO10['si14_nrodocumentofornsoftware'], 14, "0", STR_PAD_LEFT);
