...
class GerarDDC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from ddc102015 where si150_mes = ". $this->iMes;
    $rsDDC10    = db_query($sSql);

    $sSql2 = "select * from ddc202015 where si153_mes = ". $this->iMes;
    $rsDDC20    = db_query($sSql2);

    $sSql3 = "select * from ddc302015 where si154_mes = ". $this->iMes;
