...
class GerarRESPLIC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from resplic102015 where si55_mes = ". $this->iMes." and si55_instit=".db_getsession("DB_instit");
    $rsRESPLIC10    = db_query($sSql);

    $sSql2 = "select * from resplic202015 where si56_mes = ". $this->iMes." and si56_instit=".db_getsession("DB_instit");
