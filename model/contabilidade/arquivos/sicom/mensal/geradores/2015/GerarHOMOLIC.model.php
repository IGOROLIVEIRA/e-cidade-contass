...
class GerarHOMOLIC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from homolic102015 where si63_mes = ". $this->iMes." and si63_instit=".db_getsession("DB_instit");
    $rsHOMOLIC10    = db_query($sSql);

    $sSql2 = "select * from homolic202015 where si64_mes = ". $this->iMes." and si64_instit=".db_getsession("DB_instit");
    $rsHOMOLIC20    = db_query($sSql2);

    $sSql3 = "select * from homolic302015 where si65_mes = ". $this->iMes." and si65_instit=".db_getsession("DB_instit");
