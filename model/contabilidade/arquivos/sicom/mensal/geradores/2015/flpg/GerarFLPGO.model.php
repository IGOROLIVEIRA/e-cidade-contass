...
class GerarFLPGO extends GerarAM {
	...
	public function gerarDados() {
		...
		$sSql = "select * from flpgo102015 where si195_mes = ". $this->iMes;
		$rsFLPGO10    = db_query($sSql);

		$sSql2 = "select * from flpgo112015 where si196_mes = ". $this->iMes;
		...
		if (pg_num_rows($rsFLPGO10) == 0) {
			...
			for ($iCont = 0;$iCont < pg_num_rows($rsFLPGO10); $iCont++) {
				...
				$aCSVFLPGO10['si195_indcessao']                           =   str_pad($aFLPGO10['si195_indcessao'], 3, "0", STR_PAD_LEFT);
