...
class GerarAOC extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from aoc102015 where si38_mes = ". $this->iMes." and si38_instit = ".db_getsession("DB_instit");
    $rsAOC10    = db_query($sSql);

    $sSql2 = "select * from aoc112015 where si39_mes = ". $this->iMes." and si39_instit = ".db_getsession("DB_instit");
    $rsAOC11    = db_query($sSql2);

    $sSql3 = "select * from aoc122015 where si40_mes = ". $this->iMes." and si40_instit = ".db_getsession("DB_instit");
    $rsAOC12    = db_query($sSql3);

    $sSql4 = "select * from aoc132015 where si41_mes = ". $this->iMes." and si41_instit = ".db_getsession("DB_instit");
    $rsAOC13    = db_query($sSql4);

    $sSql5 = "select * from aoc142015 where si42_mes = ". $this->iMes." and si42_instit = ".db_getsession("DB_instit");
