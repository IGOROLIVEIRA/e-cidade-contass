...
class GerarCONV extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from conv102015 where si92_mes = ". $this->iMes ." and si92_instit = ". db_getsession("DB_instit");
    $rsCONV10    = db_query($sSql);

    $sSql2 = "select * from conv112015 where si93_mes = ". $this->iMes ." and si93_instit = ". db_getsession("DB_instit");
    $rsCONV11    = db_query($sSql2);

    $sSql3 = "select * from conv202015 where si94_mes = ". $this->iMes ." and si94_instit = ". db_getsession("DB_instit");
