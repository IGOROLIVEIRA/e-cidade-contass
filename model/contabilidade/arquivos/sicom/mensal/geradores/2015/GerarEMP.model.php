...
class GerarEMP extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from emp102015 where si106_mes = ". $this->iMes ." and si106_instit = ".db_getsession("DB_instit");
    $rsEMP10    = db_query($sSql);

    $sSql2 = "select * from emp112015 where si107_mes = ". $this->iMes ." and si107_instit = ".db_getsession("DB_instit");
    $rsEMP11    = db_query($sSql2);

    $sSql3 = "select * from emp122015 where si108_mes = ". $this->iMes ." and si108_instit = ".db_getsession("DB_instit");
    $rsEMP12    = db_query($sSql3);

    $sSql4 = "select * from emp202015 where si109_mes = ". $this->iMes ." and si109_instit = ".db_getsession("DB_instit");
