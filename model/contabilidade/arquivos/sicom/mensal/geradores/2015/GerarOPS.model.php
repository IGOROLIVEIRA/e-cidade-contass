...
class GerarOPS extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from ops102015 where si132_mes = ". $this->iMes . " and si132_instit = ".db_getsession("DB_instit");
    $rsOPS10    = db_query($sSql);

    $sSql2 = "select * from ops112015 where si133_mes = ". $this->iMes . " and si133_instit = ".db_getsession("DB_instit");
    $rsOPS11    = db_query($sSql2);

    $sSql3 = "select * from ops122015 where si134_mes = ". $this->iMes . " and si134_instit = ".db_getsession("DB_instit");
    $rsOPS12    = db_query($sSql3);

    $sSql4 = "select * from ops132015 where si135_mes = ". $this->iMes . " and si135_instit = ".db_getsession("DB_instit");
    $rsOPS13    = db_query($sSql4);

    $sSql5 = "select * from ops142015 where si136_mes = ". $this->iMes . " and si136_instit = ".db_getsession("DB_instit");
