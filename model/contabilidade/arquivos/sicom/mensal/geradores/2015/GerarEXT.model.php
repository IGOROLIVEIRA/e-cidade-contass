...
class GerarEXT extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from ext102015 where si124_mes = ". $this->iMes . " and  si124_instit = ".db_getsession("DB_instit");
    $rsEXT10    = db_query($sSql);

    $sSql = "select * from ext202015 where si165_mes = ". $this->iMes . " and  si165_instit = ".db_getsession("DB_instit");
    $rsEXT20    = db_query($sSql);
    

    $sSql2 = "select * from ext212015 where si125_mes = ". $this->iMes . " and  si125_instit = ".db_getsession("DB_instit");
    $rsEXT21    = db_query($sSql2);

    $sSql3 = "select * from ext222015 where si126_mes = ". $this->iMes . " and  si126_instit = ".db_getsession("DB_instit");
    $rsEXT22    = db_query($sSql3);

    $sSql4 = "select * from ext232015 where si127_mes = ". $this->iMes . " and  si127_instit = ".db_getsession("DB_instit");
    $rsEXT23    = db_query($sSql4);

    $sSql5 = "select * from ext242015 where si128_mes = ". $this->iMes . " and  si128_instit = ".db_getsession("DB_instit");
	          ...
	          if ($aEXT21['si125_sequencial'] == $aEXT22['si126_reg21']) {
		        ...
		        for ($iCont4 = 0;$iCont4 < pg_num_rows($rsEXT23); $iCont4++) {        
		          ...
		          if ($aEXT22['si126_sequencial'] == $aEXT23['si127_reg22']) {
		            ...
		            $aCSVEXT23['si127_desctipodocumentoop']      =    substr($aEXT23['si127_desctipodocumentoop'], 0, 50);
