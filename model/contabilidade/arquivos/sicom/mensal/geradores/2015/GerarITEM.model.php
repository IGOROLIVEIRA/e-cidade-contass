...
/**
  ...
  */
  ...
  public function gerarDados() {
  	...
  	$sSql          = "select * from item102015 where si43_mes = ". $this->iMes." and si43_instit = ".db_getsession("DB_instit");
      ...
      $this->adicionaLinha();
  	  ...
  	  for ($iCont = 0;$iCont < pg_num_rows($rsITEM10); $iCont++) {
   	    ...
   	    $aCSVITEM10['si43_tiporegistro']               =  str_pad($aITEM10['si43_tiporegistro'], 2, "0", STR_PAD_LEFT);
   	    $aCSVITEM10['si43_coditem']                    =  substr($aITEM10['si43_coditem'], 0,15);
   	    $aCSVITEM10['si43_dscitem']                    =  substr($aITEM10['si43_dscitem'], 0,250);
        $aCSVITEM10['si43_unidademedida']              =  substr($aITEM10['si43_unidademedida'], 0,50);
        $aCSVITEM10['si43_tipocadastro']               =  str_pad($aITEM10['si43_tipocadastro'], 1, "0", STR_PAD_LEFT);
