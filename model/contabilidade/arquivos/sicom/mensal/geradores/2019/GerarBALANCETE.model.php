...
class GerarBALANCETE extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql = "select * from balancete102019 where si177_mes = " . $this->iMes . " and si177_instit =" . db_getsession("DB_instit");
        $rsBALANCETE10 = db_query($sSql);
        $sSql1 = "select * from balancete112019 where si178_mes = " . $this->iMes . " and si178_instit =" . db_getsession("DB_instit");
        $rsBALANCETE11 = db_query($sSql1);
        $sSql2 = "select * from balancete122019 where si179_mes = " . $this->iMes . " and si179_instit =" . db_getsession("DB_instit");
        $rsBALANCETE12 = db_query($sSql2);
        $sSql3 = "select * from balancete132019 where si180_mes = " . $this->iMes . " and si180_instit =" . db_getsession("DB_instit");
        ...
        $sSql5 = "select * from balancete152019 where si182_mes = " . $this->iMes . " and si182_instit =" . db_getsession("DB_instit");
        $rsBALANCETE15 = db_query($sSql5);
        $sSql6 = "select * from balancete162019 where si183_mes = " . $this->iMes . " and si183_instit =" . db_getsession("DB_instit");
        $rsBALANCETE16 = db_query($sSql6);
        $sSql7 = "select * from balancete172019 where si184_mes = " . $this->iMes . " and si184_instit =" . db_getsession("DB_instit");
        $rsBALANCETE17 = db_query($sSql7);
        $sSql8 = "select * from balancete182019 where si185_mes = " . $this->iMes . " and si185_instit =" . db_getsession("DB_instit");
        $rsBALANCETE18 = db_query($sSql8);
        $sSql9 = "select * from balancete192019 where si186_mes = " . $this->iMes . " and si186_instit =" . db_getsession("DB_instit");
        $rsBALANCETE19 = db_query($sSql9);
        $sSql20 = "select * from balancete202019 where si187_mes = " . $this->iMes . " and si187_instit =" . db_getsession("DB_instit");
        $rsBALANCETE20 = db_query($sSql20);
        $sSql21 = "select * from balancete212019 where si188_mes = " . $this->iMes . " and si188_instit =" . db_getsession("DB_instit");
        $rsBALANCETE21 = db_query($sSql21);
        $sSql22 = "select * from balancete222019 where si189_mes = " . $this->iMes . " and si189_instit =" . db_getsession("DB_instit");
        $rsBALANCETE22 = db_query($sSql22);
        $sSql23 = "select * from balancete232019 where si190_mes = " . $this->iMes . " and si190_instit =" . db_getsession("DB_instit");
        $rsBALANCETE23 = db_query($sSql23);
        $sSql24 = "select * from balancete242019 where si191_mes = " . $this->iMes . " and si191_instit =" . db_getsession("DB_instit");
        $rsBALANCETE24 = db_query($sSql24);
        $sSql25 = "select * from balancete252019 where si195_mes = " . $this->iMes . " and si195_instit =" . db_getsession("DB_instit");
        $rsBALANCETE25 = db_query($sSql25);
        $sSql26 = "select * from balancete262019 where si196_mes = " . $this->iMes . " and si196_instit =" . db_getsession("DB_instit");
        $rsBALANCETE26 = db_query($sSql26);
        $sSql2 = "select * from balancete272019 where si197_mes = " . $this->iMes . " and si197_instit =" . db_getsession("DB_instit");
        $rsBALANCETE27 = db_query($sSql27);
        $sSql2 = "select * from balancete282019 where si198_mes = " . $this->iMes . " and si197_instit =" . db_getsession("DB_instit");
