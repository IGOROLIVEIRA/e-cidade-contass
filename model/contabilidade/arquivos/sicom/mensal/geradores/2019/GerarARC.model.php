...
class GerarARC extends GerarAM
{
    ...
    public function gerarDados()
    {
        ...
        $sSql2 = "select * from arc112019 where si29_mes = " . $this->iMes . " and si29_instit = " . db_getsession("DB_instit");
        $rsARC11 = db_query($sSql2);

        $sSql3 = "select * from arc122019 where si30_mes = " . $this->iMes . " and si30_instit = " . db_getsession("DB_instit");
        $rsARC12 = db_query($sSql3);

        $sSql4 = "select * from arc202019 where si31_mes = " . $this->iMes . " and si31_instit = " . db_getsession("DB_instit");
