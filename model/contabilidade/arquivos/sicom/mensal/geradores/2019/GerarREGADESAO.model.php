...
class GerarREGADESAO extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from regadesao102019 where si67_mes = " . $this->iMes. " and si67_instit=" . db_getsession("DB_instit");
    $rsREGADESAO10 = db_query($sSql);
    
    $sSql2 = "select * from regadesao112019 where si68_mes = " . $this->iMes. " and si68_instit=" . db_getsession("DB_instit");
    $rsREGADESAO11 = db_query($sSql2);
    
    $sSql3 = "select * from regadesao122019 where si69_mes = " . $this->iMes. " and si69_instit=" . db_getsession("DB_instit");
    $rsREGADESAO12 = db_query($sSql3);
    
    $sSql4 = "select * from regadesao132019 where si70_mes = " . $this->iMes. " and si70_instit=" . db_getsession("DB_instit");
    $rsREGADESAO13 = db_query($sSql4);
    
    $sSql5 = "select * from regadesao142019 where si71_mes = " . $this->iMes. " and si71_instit=" . db_getsession("DB_instit");
    $rsREGADESAO14 = db_query($sSql5);
    
    $sSql6 = "select * from regadesao152019 where si72_mes = " . $this->iMes. " and si72_instit=" . db_getsession("DB_instit");
    $rsREGADESAO15 = db_query($sSql6);
    
    $sSql7 = "select * from regadesao202019 where si73_mes = " . $this->iMes. " and si73_instit=" . db_getsession("DB_instit");
