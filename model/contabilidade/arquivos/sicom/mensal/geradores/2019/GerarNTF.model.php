...
class GerarNTF extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from ntf102019 where si143_mes = " . $this->iMes . " and si143_instit = " . db_getsession("DB_instit");
    $rsNTF10 = db_query($sSql);

    /*$sSql2 = "select * from ntf112019 where si144_mes = ". $this->iMes ." and si144_instit = ". db_getsession("DB_instit");
    $rsNTF11    = db_query($sSql2);*/

    $sSql3 = "select * from ntf202019 where si145_mes = " . $this->iMes . " and si145_instit = " . db_getsession("DB_instit");
