...
class GerarTEREM extends GerarAM {
	...
	public function gerarDados() {
		...
		$sSql         = "select * from terem102019 where si194_mes = ". $this->iMes." and si194_inst = ".db_getsession("DB_instit");
		$rsTEREM10    = db_query($sSql);

        $sSql2        = "select * from terem202019 where si196_mes = ". $this->iMes." and si196_inst = ".db_getsession("DB_instit");
