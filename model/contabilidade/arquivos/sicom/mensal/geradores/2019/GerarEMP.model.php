...
class GerarEMP extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql2 = "select * from emp112019 where si107_mes = " . $this->iMes . " and si107_instit = " . db_getsession("DB_instit");
    $rsEMP11 = db_query($sSql2);

    $sSql3 = "select * from emp122019 where si108_mes = " . $this->iMes . " and si108_instit = " . db_getsession("DB_instit");
