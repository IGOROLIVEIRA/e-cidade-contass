...
class GerarHABLIC extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from hablic102019 where si57_mes = " . $this->iMes . " and si57_instit=" . db_getsession("DB_instit");
    $rsHABLIC10 = db_query($sSql);
    
    $sSql2 = "select * from hablic112019 where si58_mes = " . $this->iMes . " and si58_instit=" . db_getsession("DB_instit");
    $rsHABLIC11 = db_query($sSql2);
    
    $sSql3 = "select * from hablic202019 where si59_mes = " . $this->iMes . " and si59_instit=" . db_getsession("DB_instit");
