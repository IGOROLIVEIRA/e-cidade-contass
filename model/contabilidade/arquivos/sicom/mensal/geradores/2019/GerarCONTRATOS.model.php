...
class GerarCONTRATOS extends GerarAM {
  ...
  */
  ...
  public function gerarDados() {
    ...
    $sSql = "select * from contratos102019 where si83_mes = ". $this->iMes ." and si83_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS10    = db_query($sSql);

    $sSql2 = "select * from contratos112019 where si84_mes = ". $this->iMes ." and si84_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS11    = db_query($sSql2);


    $sSql3 = "select * from contratos122019 where si85_mes = ". $this->iMes ." and si85_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS12    = db_query($sSql3);

    $sSql4 = "select * from contratos132019 where si86_mes = ". $this->iMes ." and si86_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS13    = db_query($sSql4);

    $sSql5 = "select * from contratos202019 where si87_mes = ". $this->iMes ." and si87_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS20    = db_query($sSql5);

    $sSql6 = "select * from contratos212019 where si88_mes = ". $this->iMes ." and si88_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS21    = db_query($sSql6);

    $sSql7 = "select * from contratos302019 where si89_mes = ". $this->iMes ." and si89_instit = ". db_getsession("DB_instit");
    $rsCONTRATOS30    = db_query($sSql7);

    $sSql8 = "select * from contratos402019 where si91_mes = ". $this->iMes ." and si91_instit = ". db_getsession("DB_instit");
