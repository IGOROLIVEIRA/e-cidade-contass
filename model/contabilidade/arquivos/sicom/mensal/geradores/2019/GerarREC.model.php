...
class GerarREC extends GerarAM {
    ...
    public function gerarDados() {
        ...
        $sSql = "select * from rec102019 where si25_mes = ". $this->iMes." and si25_instit = ".db_getsession("DB_instit");
        $rsREC10    = db_query($sSql);
//    echo $sSql;db_criatabela($rsREC10);echo "<br>";

        $sSql2 = "select * from rec112019 where si26_mes = ". $this->iMes." and si26_instit = ".db_getsession("DB_instit");
