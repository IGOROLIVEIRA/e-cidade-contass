...
class GerarANL extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from anl102019 where si110_mes = " . $this->iMes . " and si110_instit = " . db_getsession("DB_instit");
    $rsANL10 = db_query($sSql);

    $sSql2 = "select * from anl112019 where si111_mes = " . $this->iMes . " and si111_instit = " . db_getsession("DB_instit");
