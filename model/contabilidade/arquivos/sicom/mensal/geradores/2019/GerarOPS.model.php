...
class GerarOPS extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from ops102019 where si132_mes = " . $this->iMes . " and si132_instit = " . db_getsession("DB_instit");
    ...
    $sSql3 = "select * from ops122019 where si134_mes = " . $this->iMes . " and si134_instit = " . db_getsession("DB_instit");
    $rsOPS12 = db_query($sSql3);

    $sSql4 = "select * from ops132019 where si135_mes = " . $this->iMes . " and si135_instit = " . db_getsession("DB_instit");
    $rsOPS13 = db_query($sSql4);

    $sSql5 = "select * from ops142019 where si136_mes = " . $this->iMes . " and si136_instit = " . db_getsession("DB_instit");
