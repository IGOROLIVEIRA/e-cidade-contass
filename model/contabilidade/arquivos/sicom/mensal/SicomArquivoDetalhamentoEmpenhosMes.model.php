    ...
    $aCaracteres = array("°",chr(13),chr(10));
      ...
      if ($iDespDecContrato == 3) {
      	...
      	$sOrgaoResp = " ";
			...
			$oDadosEmpenho->especificacaoEmpenho         = $oEmpenho->e60_resumo == ' ' ? "SEM HISTORICO" : substr(str_replace($aCaracteres, "", $oEmpenho->e60_resumo), 0, 200);
			$oDadosEmpenho->despDecContrato              = 2;
			$oDadosEmpenho->codOrgaoResp				 = " ";
			...
			$oDadosEmpenho->despDecLicitacao             = 1;//$iDespDecLicitacao;
