...
require_once("classes/db_consor102017_classe.php");
require_once("classes/db_consor202017_classe.php");
require_once("classes/db_consor302017_classe.php");
require_once("classes/db_consor402017_classe.php");
require_once("classes/db_consor502017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clconsor10 = new cl_consor102017();
    $clconsor20 = new cl_consor202017();
    $clconsor30 = new cl_consor302017();
    $clconsor40 = new cl_consor402017();
    $clconsor50 = new cl_consor502017();
