...
require_once("classes/db_caixa102017_classe.php");
require_once("classes/db_caixa112017_classe.php");
require_once("classes/db_caixa122017_classe.php");
require_once("classes/db_caixa132017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarCAIXA.model.php");
...
class SicomArquivoCaixa extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clcaixa13 = new cl_caixa132017();
    $clcaixa12 = new cl_caixa122017();
    $clcaixa11 = new cl_caixa112017();
    $clcaixa10 = new cl_caixa102017();
    ...
    */
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsContasCaixa); $iCont++) {
      ...
      $oDadosCaixa = new cl_caixa102017();
      ...
      $oDadosSaldoCaixa = new cl_caixa112017();
      ...
      for ($iCont2 = 0; $iCont2 < pg_num_rows($rsMovi); $iCont2++) {
        ...
        $sSql = "select 13 as tiporegistro,
					...
					left join orcreceita on c74_codrec = o70_codrec and o70_anousu = 2017     
					left join orcfontes on o70_codfon = o57_codfon and o70_anousu = o57_anousu
