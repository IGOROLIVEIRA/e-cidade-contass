...
require_once("classes/db_homolic102017_classe.php");
require_once("classes/db_homolic202017_classe.php");
require_once("classes/db_homolic402017_classe.php");
require_once("model/contabilidade/arquivos/sicom/SicomArquivoBase.model.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarHOMOLIC.model.php");
...
class SicomArquivoHomologacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clhomolic10 = new cl_homolic102017();
    $clhomolic20 = new cl_homolic202017();
    $clhomolic40 = new cl_homolic402017();
