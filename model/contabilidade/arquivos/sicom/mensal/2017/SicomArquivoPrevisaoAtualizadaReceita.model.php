...
require_once("classes/db_parec102017_classe.php");
require_once("classes/db_parec112017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarPAREC.model.php");
