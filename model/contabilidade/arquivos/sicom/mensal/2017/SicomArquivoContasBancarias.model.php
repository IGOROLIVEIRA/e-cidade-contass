...
require_once("classes/db_ctb102017_classe.php");
require_once("classes/db_ctb202017_classe.php");
require_once("classes/db_ctb212017_classe.php");
require_once("classes/db_ctb222017_classe.php");
require_once("classes/db_ctb302017_classe.php");
require_once("classes/db_ctb312017_classe.php");
require_once("classes/db_ctb402017_classe.php");
require_once("classes/db_ctb412017_classe.php");
require_once("classes/db_ctb502017_classe.php");
require_once("classes/db_ctb602017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarCTB.model.php");
...
class SicomArquivoContasBancarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cCtb10 = new cl_ctb102017();
    $cCtb20 = new cl_ctb202017();
    $cCtb21 = new cl_ctb212017();
    $cCtb22 = new cl_ctb222017();
    $cCtb30 = new cl_ctb302017();
    $cCtb31 = new cl_ctb312017();
    $cCtb40 = new cl_ctb402017();
    $cCtb41 = new cl_ctb412017();
    $cCtb50 = new cl_ctb502017();
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsContas); $iCont++) {
      ...
      if ($oRegistro10->si09_tipoinstit != 5) {
        ...
        if (!isset($aBancosAgrupados[$aHash])) {
          ...
          $sSqlVerifica = "SELECT * FROM ctb102017 WHERE si95_codorgao = '$oRegistro10->si09_codorgaotce' AND si95_banco = '$oRegistro10->c63_banco'
          ...
          AND si95_agencia = '$oRegistro10->c63_agencia' AND si95_digitoverificadoragencia = '$oRegistro10->c63_dvagencia' AND si95_contabancaria = '$oRegistro10->c63_conta'
          AND si95_digitoverificadorcontabancaria = '$oRegistro10->c63_dvconta' AND si95_tipoconta = '$oRegistro10->tipoconta'" . " and si95_instit = " . db_getsession('DB_instit');
          $rsResultVerifica = db_query($sSqlVerifica);//echo $sSqlVerifica;db_criatabela($rsResultVerifica); exit;
