...
require_once("classes/db_rsp102017_classe.php");
require_once("classes/db_rsp112017_classe.php");
require_once("classes/db_rsp122017_classe.php");
require_once("classes/db_rsp202017_classe.php");
require_once("classes/db_rsp212017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarRSP.model.php");
...
class SicomArquivoRestosPagar extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clrsp11 = new cl_rsp112017();
    $clrsp12 = new cl_rsp122017();
    $clrsp20 = new cl_rsp202017();
    $clrsp21 = new cl_rsp212017();
