...
require_once("classes/db_aoc102017_classe.php");
require_once("classes/db_aoc112017_classe.php");
require_once("classes/db_aoc122017_classe.php");
require_once("classes/db_aoc132017_classe.php");
require_once("classes/db_aoc142017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarAOC.model.php");
...
class SicomArquivoAlteracoesOrcamentarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $claoc10 = new cl_aoc102017();
    $claoc11 = new cl_aoc112017();
    $claoc12 = new cl_aoc122017();
    $claoc13 = new cl_aoc132017();
    $claoc14 = new cl_aoc142017();
