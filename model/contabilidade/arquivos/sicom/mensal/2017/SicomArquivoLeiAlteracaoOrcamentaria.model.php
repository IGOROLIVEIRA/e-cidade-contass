...
require_once("classes/db_lao102017_classe.php");
require_once("classes/db_lao112017_classe.php");
require_once("classes/db_lao202017_classe.php");
require_once("classes/db_lao212017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarLAO.model.php");
...
class SicomArquivoLeiAlteracaoOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cllao10 = new cl_lao102017();
    $cllao11 = new cl_lao112017();
    $cllao20 = new cl_lao202017();
    $cllao21 = new cl_lao212017();
    ...
    if ($iTipoInstit != 1) {
      ...
      for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
         ...
         */
        $sSql = "select distinct orcleialtorcamentaria.* from orcleialtorcamentaria
        inner join orcprojetolei on o138_sequencial=o200_orcprojetolei
        inner join orcprojetoorcprojetolei on o138_sequencial=o139_orcprojetolei
        inner join orcprojeto on o139_orcprojeto=o39_codproj
        left join orcsuplem on o46_codlei=o39_codproj
        left join conlancamsup on c79_codsup=o46_codsup
