...
require_once("classes/db_reglic102017_classe.php");
require_once("classes/db_reglic202017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarREGLIC.model.php");
...
class SicomArquivoLegislacaoMunicipalLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clreglic10 = new cl_reglic102017();
    $clreglic20 = new cl_reglic202017();
  ...
  UNION select si44_nrodecretomunicipal from reglic102017 where si44_mes <= " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . ") ";
