...
require_once("classes/db_ops102017_classe.php");
require_once("classes/db_ops112017_classe.php");
require_once("classes/db_ops122017_classe.php");
require_once("classes/db_ops132017_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarOPS.model.php");
...
class SicomArquivoPagamentosDespesas extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clops10 = new cl_ops102017();
    $clops11 = new cl_ops112017();
    $clops12 = new cl_ops122017();
    $clops13 = new cl_ops132017();
