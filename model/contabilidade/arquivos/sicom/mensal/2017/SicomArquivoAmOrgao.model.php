...
require_once("classes/db_orgao102017_classe.php");
require_once("classes/db_orgao112017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarORGAO.model.php");
...
class SicomArquivoAmOrgao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clorgao10 = new cl_orgao102017();
    $clorgao11 = new cl_orgao112017();
