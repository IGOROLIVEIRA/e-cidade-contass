...
require_once("classes/db_aop102017_classe.php");
require_once("classes/db_aop112017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarAOP.model.php");
  ...
  public function gerarDados()
  {
    ...
    foreach ($aAnulacoes as $anulacao) {
      ...
      foreach ($anulacao->reg11 as $reg11) {
        ...
        $oDadosAnulacaoFonte = new cl_aop112017();
