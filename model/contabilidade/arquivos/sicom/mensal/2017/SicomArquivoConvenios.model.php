...
require_once("classes/db_conv102017_classe.php");
require_once("classes/db_conv112017_classe.php");
require_once("classes/db_conv202017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarCONV.model.php");
...
class SicomArquivoConvenios extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clconv10 = new cl_conv102017();
    $clconv11 = new cl_conv112017();
    $clconv20 = new cl_conv202017();
