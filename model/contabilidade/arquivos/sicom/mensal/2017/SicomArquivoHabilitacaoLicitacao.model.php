...
require_once("classes/db_hablic102017_classe.php");
require_once("classes/db_hablic112017_classe.php");
require_once("classes/db_hablic202017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarHABLIC.model.php");
...
class SicomArquivoHabilitacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clhablic10 = new cl_hablic102017();
    $clhablic11 = new cl_hablic112017();
    $clhablic20 = new cl_hablic202017();
    ...
    if (pg_num_rows($result) > 0) {
      ...
      if ($clconsor212017->erro_status == 0) {
        throw new Exception($clhablic20->erro_msg);
      }
    }
    /**
     * Sob solicitação de Igor, o campo nroRegistro foi alterado para pegar o cnpj 04/03/2017
     */
