...
require_once("classes/db_arc102017_classe.php");
require_once("classes/db_arc112017_classe.php");
require_once("classes/db_arc122017_classe.php");
require_once("classes/db_arc202017_classe.php");
require_once("classes/db_arc212017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarARC.model.php");
