...
require_once("classes/db_dispensa102017_classe.php");
require_once("classes/db_dispensa112017_classe.php");
require_once("classes/db_dispensa122017_classe.php");
require_once("classes/db_dispensa132017_classe.php");
require_once("classes/db_dispensa142017_classe.php");
require_once("classes/db_dispensa152017_classe.php");
require_once("classes/db_dispensa162017_classe.php");
require_once("classes/db_dispensa172017_classe.php");
require_once("classes/db_dispensa182017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarDISPENSA.model.php");
...
class SicomArquivoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $dispensa11 = new cl_dispensa112017();
    $dispensa12 = new cl_dispensa122017();
    $dispensa13 = new cl_dispensa132017();
    $dispensa14 = new cl_dispensa142017();
    $dispensa15 = new cl_dispensa152017();
    $dispensa16 = new cl_dispensa162017();
    $dispensa17 = new cl_dispensa172017();
    $dispensa18 = new cl_dispensa182017();
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
		...
		liclicita.l20_edital as nroProcessoLicitatorio,
		pctipocompratribunal.l44_codigotribunal as tipoProcesso,
		dispensa112017.si75_nrolote as nroLote,
		(pcmater.pc01_codmater::varchar || (case when matunid.m61_codmatunid is null then 1 else matunid.m61_codmatunid end)::varchar) as codItem
		FROM liclicitem
		INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
		INNER JOIN liclicita on (liclicitem.l21_codliclicita=liclicita.l20_codigo)
		INNER JOIN dispensa112017 on (liclicitemlote.l04_descricao = dispensa112017.si75_dsclote and dispensa112017.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
		...
		LEFT  JOIN dispensa112017 on (liclicitemlote.l04_descricao = dispensa112017.si75_dsclote and dispensa112017.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
