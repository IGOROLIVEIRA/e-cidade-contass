...
require_once("classes/db_anl102017_classe.php");
require_once("classes/db_anl112017_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $regitro10 = new cl_anl102017();
    $regitro11 = new cl_anl112017();
   ...
   $sSql = "SELECT c70_codlan,
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsEmpenhoAnulados); $iCont++) {
      ...
      $oDadosEmpenhoAnuladoFonte = new cl_anl112017();
