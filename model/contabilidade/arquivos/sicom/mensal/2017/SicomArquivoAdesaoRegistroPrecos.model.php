...
require_once("classes/db_regadesao102017_classe.php");
require_once("classes/db_regadesao112017_classe.php");
require_once("classes/db_regadesao122017_classe.php");
require_once("classes/db_regadesao132017_classe.php");
require_once("classes/db_regadesao142017_classe.php");
require_once("classes/db_regadesao152017_classe.php");
require_once("classes/db_regadesao202017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarREGADESAO.model.php");
...
class SicomArquivoAdesaoRegistroPrecos extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $regadesao10 = new cl_regadesao102017();
    $regadesao11 = new cl_regadesao112017();
    $regadesao12 = new cl_regadesao122017();
    $regadesao13 = new cl_regadesao132017();
    $regadesao14 = new cl_regadesao142017();
    $regadesao15 = new cl_regadesao152017();
    $regadesao20 = new cl_regadesao202017();
