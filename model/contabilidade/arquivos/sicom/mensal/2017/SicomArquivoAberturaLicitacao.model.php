...
require_once("classes/db_aberlic102017_classe.php");
require_once("classes/db_aberlic112017_classe.php");
require_once("classes/db_aberlic122017_classe.php");
require_once("classes/db_aberlic132017_classe.php");
require_once("classes/db_aberlic142017_classe.php");
require_once("classes/db_aberlic152017_classe.php");
require_once("classes/db_aberlic162017_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarABERLIC.model.php");
...
class SicomArquivoAberturaLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $claberlic11 = new cl_aberlic112017();
    $claberlic12 = new cl_aberlic122017();
    $claberlic13 = new cl_aberlic132017();
    $claberlic14 = new cl_aberlic142017();
    $claberlic15 = new cl_aberlic152017();
    $claberlic16 = new cl_aberlic162017();
  ...
  (SELECT CASE
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
      liclicita.l20_anousu as exercicioLicitacao,
      liclicita.l20_edital as nroProcessoLicitatorio,
      aberlic112017.si47_nrolote as nroLote,
      (pcmater.pc01_codmater::varchar || (CASE WHEN m61_codmatunid IS NULL THEN 1 ELSE m61_codmatunid END)::varchar) as codItem
      FROM liclicitem
      INNER JOIN liclicita on (liclicitem.l21_codliclicita=liclicita.l20_codigo)
      INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
      ...
      INNER JOIN db_config on (liclicita.l20_instit=db_config.codigo)
      INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
      INNER JOIN aberlic112017 on (liclicitemlote.l04_descricao = aberlic112017.si47_dsclote and aberlic112017.si47_nroprocessolicitatorio = liclicita.l20_edital::varchar)
      LEFT JOIN solicitemunid AS solicitemunid ON solicitem.pc11_codigo = solicitemunid.pc17_codigo
      LEFT JOIN matunid AS matunid ON solicitemunid.pc17_unid = matunid.m61_codmatunid
      LEFT JOIN infocomplementaresinstit on db_config.codigo = infocomplementaresinstit.si09_instit
      WHERE db_config.codigo= " . db_getsession("DB_instit") . " AND liclicita.l20_tipojulg = 3
  ...
  (SELECT CASE
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
    liclicita.l20_anousu as exercicioLicitacao,
    liclicita.l20_edital as nroProcessoLicitatorio,
    CASE WHEN liclicita.l20_tipojulg = 3 THEN aberlic112017.si47_nrolote ELSE 0 END AS nroLote,
    (pcmater.pc01_codmater::varchar || (CASE WHEN m61_codmatunid IS NULL THEN 1 ELSE m61_codmatunid END)::varchar) as codItem,
    ...
    LEFT JOIN aberlic112017 on (liclicitemlote.l04_descricao = aberlic112017.si47_dsclote and aberlic112017.si47_nroprocessolicitatorio = liclicita.l20_edital::varchar)
    INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
    INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
    INNER JOIN solicitempcmater on (solicitem.pc11_codigo = solicitempcmater.pc16_solicitem)
    INNER JOIN pcmater on (solicitempcmater.pc16_codmater = pcmater.pc01_codmater)
