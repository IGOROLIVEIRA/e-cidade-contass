...
require_once("classes/db_julglic102017_classe.php");
require_once("classes/db_julglic202017_classe.php");
require_once("classes/db_julglic402017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarJULGLIC.model.php");
...
class SicomArquivoJulgamentoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $cljulglic10 = new cl_julglic102017();
    $cljulglic20 = new cl_julglic202017();
    $cljulglic40 = new cl_julglic402017();
