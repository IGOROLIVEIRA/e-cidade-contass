...
require_once("classes/db_ddc102017_classe.php");
require_once("classes/db_ddc202017_classe.php");
require_once("classes/db_ddc302017_classe.php");
require_once("classes/db_ddc402017_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarDDC.model.php");
...
class SicomArquivoDividaConsolidada extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clddc10 = new cl_ddc102017();
    $clddc20 = new cl_ddc202017();
    $clddc30 = new cl_ddc302017();
    $clddc40 = new cl_ddc402017();
    ...
    */
    ...
    $sSql = "select * from dividaconsolidada where si167_mesreferencia = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "
             ...
             (select 1 from ddc102017  where si150_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si150_instit = " . db_getsession("DB_instit") . "
    ...
    $sSql = "select * from dividaconsolidada where si167_mesreferencia = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "
             and si167_anoreferencia = " . db_getsession("DB_anousu") . " and si167_instit = " . db_getsession("DB_instit") . " and not exists
             (select 1 from ddc202017  where si153_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si153_instit = " . db_getsession("DB_instit") . "
