...
require_once ("classes/db_rec102014_classe.php");
require_once ("classes/db_rec112014_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarREC.model.php");
...
class SicomArquivoDetalhamentoReceitasMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    /**
  	 ...
  	 */
  	$clrec102014 = new cl_rec102014();
  	$clrec112014 = new cl_rec112014();
    ...
    $result = $clrec112014->sql_record($clrec112014->sql_query(NULL,"*",NULL,"si26_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])." and si26_instit = ".db_getsession("DB_instit"));
    if (pg_num_rows($result) > 0) {
    	$clrec112014->excluir(NULL,"si26_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si26_instit = ".db_getsession("DB_instit"));
      if ($clrec112014->erro_status == 0) {
    	  throw new Exception($clrec112014->erro_msg);
      }
    }
    
    $result = $clrec102014->sql_record($clrec102014->sql_query(NULL,"*",NULL,"si25_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si25_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clrec102014->excluir(NULL,"si25_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si25_instit = ".db_getsession("DB_instit"));
      if ($clrec102014->erro_status == 0) {
    	  throw new Exception($clrec102014->erro_msg);
      }
    }
    ...
    foreach ($aDadosAgrupados as $oDados10) {
    	...
    	$clrec102014 = new cl_rec102014();
		  $clrec102014->si25_tiporegistro         = $oDados10->si25_tiporegistro;
		  $clrec102014->si25_codreceita           = $oDados10->si25_codreceita;
		  $clrec102014->si25_codorgao             = $oDados10->si25_codorgao;
		  $clrec102014->si25_ededucaodereceita    = $oDados10->si25_ededucaodereceita;
		  $clrec102014->si25_identificadordeducao = $oDados10->si25_identificadordeducao;
		  $clrec102014->si25_naturezareceita      = $oDados10->si25_naturezareceita;
		  $clrec102014->si25_especificacao        = $oDados10->si25_especificacao;
		  $clrec102014->si25_vlarrecadado         = abs($oDados10->si25_vlarrecadado);
		  $clrec102014->si25_mes                  = $oDados10->si25_mes;
		  $clrec102014->si25_instit               = db_getsession("DB_instit");
		  
		  $clrec102014->incluir(null);
    	if ($clrec102014->erro_status == 0) {
    	  throw new Exception($clrec102014->erro_msg);
      }
      foreach ($oDados10->Reg11 as $oDados11) {
      	if (in_array($oDados10->si25_naturezareceita ,$aRectceSaudEduc ) && 
      	  ...
      	  $clrec112014 = new cl_rec112014();
    		  $clrec112014->si26_tiporegistro      = $oDados11->si26_tiporegistro;
    		  $clrec112014->si26_reg10             = $clrec102014->si25_sequencial;
    		  $clrec112014->si26_codreceita        = $oDados10->si25_codreceita;
    		  $clrec112014->si26_codfontrecursos   = '100';
    		  $clrec112014->si26_vlarrecadadofonte = number_format(abs($oDados10->si25_vlarrecadado*0.60), 2, ".", "");
    		  $clrec112014->si26_mes               = $oDados11->si26_mes;
    		  $clrec112014->si26_instit            = db_getsession("DB_instit");
    		
          $clrec112014->incluir(null);
    	    if ($clrec112014->erro_status == 0) {
    	      throw new Exception($clrec112014->erro_msg);
          }
          
          $clrec112014->si26_sequencial = null;
          $clrec112014->si26_codfontrecursos   = '101';
          $clrec112014->si26_vlarrecadadofonte = number_format(abs($oDados10->si25_vlarrecadado*0.25), 2, ".", "");
      	  $clrec112014->incluir(null);
    	    if ($clrec112014->erro_status == 0) {
    	      throw new Exception($clrec112014->erro_msg);
          }
      	  ...
      	  $clrec112014->si26_sequencial = null;
          $clrec112014->si26_codfontrecursos   = '102';
          $clrec112014->si26_vlarrecadadofonte = number_format(abs($oDados10->si25_vlarrecadado), 2, ".", "")-(number_format(abs($oDados10->si25_vlarrecadado*0.60), 2, ".", "")+number_format(abs($oDados10->si25_vlarrecadado*0.25), 2, ".", ""));
      	  $clrec112014->incluir(null);
    	    if ($clrec112014->erro_status == 0) {
    	      throw new Exception($clrec112014->erro_msg);
          }
      		break;
      	} else if (!in_array($oDados10->si25_naturezareceita ,$aRectceSaudEduc ) || $oDados10->si25_identificadordeducao != 0
          ...
          $clrec112014 = new cl_rec112014();
    		  ...
    		  $clrec112014->si26_reg10             = $clrec102014->si25_sequencial;
    		  $clrec112014->si26_codreceita        = $oDados10->si25_codreceita;
    		  $clrec112014->si26_codfontrecursos   = $oDados11->si26_codfontrecursos;
    		  $clrec112014->si26_vlarrecadadofonte = abs($oDados11->si26_vlarrecadadofonte);
    		  $clrec112014->si26_mes               = $oDados11->si26_mes;
    		  $clrec112014->si26_instit            = db_getsession("DB_instit");
