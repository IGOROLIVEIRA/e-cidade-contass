...
require_once ("classes/db_item102014_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarITEM.model.php");
...
class SicomArquivoItem extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
  	 ...
  	 */
  	$clitem102014 = new cl_item102014();
  	
  	/**
     * excluir informacoes do mes selecioado
     */
    db_inicio_transacao(); 
    $result = db_query($clitem102014->sql_query(NULL,"*",NULL,"si43_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si43_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clitem102014->excluir(NULL,"si43_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si43_instit=".db_getsession("DB_instit"));
      if ($clitem102014->erro_status == 0) {
    	  throw new Exception($clitem102014->erro_msg);
      }
    }
...
WHERE (DATE_PART ('YEAR' , empnota . e69_dtinclusao) =".db_getsession("DB_anousu")."
...
WHERE DATE_PART ('MONTH' , si172_dataassinatura) = ".$this->sDataFinal['5'].$this->sDataFinal['6']."
  ...
  SELECT distinct '10' AS tipoRegistro ,
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    	...
    	//$sSqlitem="select si43_coditem,si43_unidademedida from item102014  where si43_coditem=".$oDados10->coditem." and si43_unidademedida='{$oDados10->unidademedida}'";
    	$sSqlitem="select si43_coditem,si43_unidademedida from item102014  where si43_coditem=".$oDados10->coditem." and si43_mes <= ".$this->sDataFinal['5'].$this->sDataFinal['6'];
       ...
       if(pg_num_rows($rsResultitem) == 0 ){
		      ...
		      $clitem102014->si43_tiporegistro           = 10;
				  $clitem102014->si43_coditem                = $oDados10->coditem;
				  $clitem102014->si43_dscItem                = trim(preg_replace("/[^a-zA-Z0-9 ]/", "",str_replace($what, $by,  $oDados10->dscitem)))." $oDados10->coditem";
				  $clitem102014->si43_unidademedida          = trim(preg_replace("/[^a-zA-Z0-9 ]/", "",str_replace($what, $by,  $oDados10->unidademedida)));
				  $clitem102014->si43_tipocadastro           = $oDados10->tipocadastro;        
				  $clitem102014->si43_justificativaalteracao = $oDados10->justificativaalteracao;
				  $clitem102014->si43_instit		   				   = db_getsession("DB_instit");
				  $clitem102014->si43_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
				  //echo pg_last_error();
				  $clitem102014->incluir(null);
				  if ($clitem102014->erro_status == 0) {
				  	throw new Exception($clitem102014->erro_msg);
				  }
       }
