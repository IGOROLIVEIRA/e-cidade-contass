...
require_once ("classes/db_alq102014_classe.php");
require_once ("classes/db_alq112014_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarALQ.model.php");
  ...
  public function gerarDados() {
    ...
    $sSql      =   "SELECT e50_data,e71_codnota, c80_data, orctiporec.o15_codtri,e60_codemp, e60_emiss,  e60_anousu,
							...
							GROUP BY e60_numemp, e60_resumo, e60_destin, e60_codemp, e60_emiss, e60_numcgm, 
								 ...
								 c70_data, c70_codlan, c53_tipo, c53_descr, e91_numemp,e71_codnota,c80_data,e50_data,si09_codorgaotce,o41_subunidade
    ...
    $clalq102014 = new cl_alq102014();
    $clalq112014 = new cl_alq112014();
    /*
     * SE JA FOI GERADO ESTA ROTINA UMA VEZ O SISTEMA APAGA OS DADOS DO BANCO E GERA NOVAMENTE
     */
    db_inicio_transacao();
    $result = $clalq102014->sql_record($clalq102014->sql_query(NULL,"*",NULL,"si121_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])
         ." and si121_instit = ".db_getsession("DB_instit"));
    if (pg_num_rows($result) > 0) {
    	
    	$clalq112014->excluir(NULL,"si122_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    	." and si122_instit = ".db_getsession("DB_instit"));
    	$clalq102014->excluir(NULL,"si121_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    	." and si121_instit = ".db_getsession("DB_instit"));
   
      if ($clalq102014->erro_status == 0) {
    	  throw new Exception($clalq102014->erro_msg);
      }
    }
    /**
    ...
    for ($iCont = 0;$iCont < pg_num_rows($rsDetalhamentos); $iCont++) {
      ...
      $sHash = substr($oDetalhamento->e71_codnota, 0, 9);
      ...
      if (!isset($aDadosAgrupados[$sHash])) {
        ...
        $oDadosDetalhamento->si121_codreduzido            = substr($oDetalhamento->e71_codnota, 0, 15);
        ...
        $oDadosDetalhamento->si121_nroliquidacao 			= substr($oDetalhamento->e71_codnota, 0, 9);
        $oDadosDetalhamento->si121_dtanulacaoliq			= $oDetalhamento->c70_data;
        $oDadosDetalhamento->si121_nroliquidacaoanl		= substr($oDetalhamento->e71_codnota, 0, 9);
        ...
        $oDadosDetalhamentoFonte->si122_codreduzido        = substr($oDetalhamento->e71_codnota, 0, 15);
