...
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarLAO.model.php");
...
class SicomArquivoLeiAlteracaoOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    	...
    	$cllao102014->si34_nroleialteracao  = substr($oDados10->o138_numerolei,0,6);
    	...
    	for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
    		...
    		$cllao112014->si35_nroleialteracao       = substr($oDados10->o138_numerolei,0,6);
    ...
    for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
    	...
    	$cllao202014->si36_nroleialterorcam  = substr($oDados20->o138_numerolei,0,6);
    	...
    	for ($iCont21 = 0; $iCont21 < pg_num_rows($rsResult21); $iCont21++) {
    		...
    		$cllao212014->si37_nroleialterorcam        = substr($oDados20->o138_numerolei,0,6);
    		$cllao212014->si37_tipoautorizacao         = $oDados21->o200_tipoleialteracao;
    		$cllao212014->si37_artigoleialterorcamento = $oDados21->o200_artleialteracao;
    		$cllao212014->si37_descricaoartigo         = $oDados21->o200_descrartigo;
    		$cllao212014->si37_novopercentual          = $oDados21->o200_percautorizado;
