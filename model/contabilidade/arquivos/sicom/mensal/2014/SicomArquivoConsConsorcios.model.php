...
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
    ...
    $result = db_query($clconsor212014->sql_query(NULL,"*",NULL,"si18_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si18_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clconsor212014->excluir(NULL,"si18_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si18_instit = ".db_getsession("DB_instit"));
    ...
    $result = db_query($clconsor302014->sql_query(NULL,"*",NULL,"si20_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si20_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clconsor302014->excluir(NULL,"si20_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si20_instit = ".db_getsession("DB_instit"));
      if ($clconsor302014->erro_status == 0) {
    	  throw new Exception($clconsor302014->erro_msg);
      }
    }
    
    $result = db_query($clconsor202014->sql_query(NULL,"*",NULL,"si17_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si17_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clconsor202014->excluir(NULL,"si17_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si17_instit = ".db_getsession("DB_instit"));
      if ($clconsor202014->erro_status == 0) {
    	  throw new Exception($clconsor202014->erro_msg);
      }
    }
    
    $result = db_query($clconsor102014->sql_query(NULL,"*",NULL,"si16_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6'])." and si16_instit = ".db_getsession("DB_instit"));
    if (pg_num_rows($result) > 0) {
    	$clconsor102014->excluir(NULL,"si16_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si16_instit = ".db_getsession("DB_instit"));
    ...
    if ($this->sDataFinal['5'].$this->sDataFinal['6'] == 01) {
      ...
      join db_config on c200_instit = codigo join infocomplementaresinstit on codigo = si09_instit where si09_instit = ".db_getsession("DB_instit");
    } else {
    	$sSql = "select si09_codorgaotce,z01_cgccpf,c200_areaatuacao,c200_descrarea from consconsorcios join cgm on z01_numcgm = c200_numcgm 
      join db_config on c200_instit = codigo join infocomplementaresinstit on codigo = si09_instit 
      where c200_dataadesao >= '{$this->sDataInicial}' and c200_dataadesao <= '{$this->sDataFinal}'"." and si09_instit = ".db_getsession("DB_instit");
    }
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    	...
    	$oDados10 = db_utils::fieldsMemory($rsResult10, $iCont10);
		  ...
		  $clconsor102014->si16_descareaatuacao = $oDados10->c200_areaatuacao == '99' ? $oDados10->c200_descrarea : '0';
		  $clconsor102014->si16_mes             = $this->sDataFinal['5'].$this->sDataFinal['6'];
		  $clconsor102014->si16_instit          = db_getsession("DB_instit");
		...
		join infocomplementaresinstit on codigo = si09_instit where c201_anousu = ".db_getsession("DB_anousu")." and c201_mescompetencia = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si09_instit = ".db_getsession("DB_instit");; 
		...
		for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
		  ...
		  $clconsor202014->si17_instit         = db_getsession("DB_instit");
		...
		where c202_anousu = ".db_getsession("DB_anousu")." and c202_mescompetencia  = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si09_instit = ".db_getsession("DB_instit");
		$rsResult21 = db_query($sSql);//db_criatabela($rsResult21);
		/**
		 * registro 21
		 */
		for ($iCont21 = 0; $iCont21 < pg_num_rows($rsResult21); $iCont21++) {
		  ...
		  $clconsor212014->si18_naturezadespesa      = substr($oDados21->c202_elemento,0,6);
		  $clconsor212014->si18_subelemento          = substr($oDados21->c202_elemento,6,2);
		  ...
		  $clconsor212014->si18_reg20                = $clconsor202014->si17_sequencial;
		  $clconsor212014->si18_instit               = db_getsession("DB_instit");
		...
		if ($this->sDataFinal['5'].$this->sDataFinal['6'] == 12) {
		  ...
		  join cgm on c200_numcgm = z01_numcgm join db_config on c200_instit = codigo 
		  join infocomplementaresinstit on codigo = si09_instit where c203_anousu = ".db_getsession("DB_anousu")." and si09_instit = ".db_getsession("DB_instit");
		  ...
		  for ($iCont22 = 0; $iCont22 < pg_num_rows($rsResult22); $iCont22++) {
		    ...
		    $clconsor222014 = new cl_consor22014();
		  	...
		  	$clconsor222014->si19_reg20         = $clconsor202014->si17_sequencial;
		  	$clconsor222014->si19_instit        = db_getsession("DB_instit");
		...
		and c204_dataencerramento >= '{$this->sDataInicial}' and c204_dataencerramento <= '{$this->sDataFinal}'"." and si09_instit = ".db_getsession("DB_instit");
		...
		for ($iCont30 = 0; $iCont30 < pg_num_rows($rsResult30); $iCont30++) {
		  ...
		  $clconsor302014->si20_instit           = db_getsession("DB_instit");
