...
require_once ("classes/db_parelic102014_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarPARELIC.model.php");
...
class SicomArquivoParecerLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  /**
  	 ...
  	 */
  	$clparelic102014 = new cl_parelic102014();
  	
  	/**
     * excluir informacoes do mes selecioado
     */
    db_inicio_transacao(); 
    $result = db_query($clparelic102014->sql_query(NULL,"*",NULL,"si66_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si66_instit=".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	$clparelic102014->excluir(NULL,"si66_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si66_instit=".db_getsession("DB_instit"));
      if ($clparelic102014->erro_status == 0) {
    	  throw new Exception($clparelic102014->erro_msg);
      }
    }
    //
...
join orcunidade on db01_orgao=o41_orgao and db01_unidade=o41_unidade and db01_anousu = o41_anousu
	...
	INNER JOIN pctipocompratribunal ON (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
    	...
    	for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
		  ...
		  $clparelic102014->si66_tiporegistro                 = 10;
		  $clparelic102014->si66_codorgao                     = $oDados10->codorgaoresp;
		  $clparelic102014->si66_codunidadesub                = $oDados10->codunidadesubresp;
		  $clparelic102014->si66_exerciciolicitacao           = $oDados10->exerciciolicitacao;
		  $clparelic102014->si66_nroprocessolicitatorio       = $oDados10->nroprocessolicitatorio;        
		  $clparelic102014->si66_dataparecer                  = $oDados10->dataparecer;
		  $clparelic102014->si66_tipoparecer                  = $oDados10->tipoparecer;
		  $clparelic102014->si66_nrocpf                       = $oDados10->nrocpf;
		  $clparelic102014->si66_instit		   		     	        = db_getsession("DB_instit");
		  $clparelic102014->si66_mes                          = $this->sDataFinal['5'].$this->sDataFinal['6'];
		  
		  $clparelic102014->incluir(null);
		  if ($clparelic102014->erro_status == 0) {
		  	throw new Exception($clparelic102014->erro_msg);
		  }
