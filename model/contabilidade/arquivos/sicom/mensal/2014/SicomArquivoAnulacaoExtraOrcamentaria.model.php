...
require_once ("classes/db_aex102014_classe.php");
require_once ("classes/db_aex112014_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarAEX.model.php");
...
class SicomArquivoAnulacaoExtraOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $cAex10 = new cl_aex102014();
  	
    $cAex11 = new cl_aex112014();
  	 ...
  	 */
  	 db_inicio_transacao();
	    ...
	    //echo "<pre>";	    print_r($aAex10Agrupa);exit;
	     
	    /* foreach ($aAex10Agrupa as $oDados10) {
	    			
			    	    $claex   = new cl_aex102014();
			    		...
			    		$claex->si129_instit 				 = db_getsession("DB_instit");
	      ...
	      foreach ($oDados10->aex11 as $oDados11) {
	            ...
	            $aex11 = new cl_aex112014();
		    		...
		    		$aex11->si130_instit		    = db_getsession("DB_instit");
