...
require_once ("classes/db_anl102014_classe.php");
require_once ("classes/db_anl112014_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2014/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$regitro10 = new cl_anl102014();
  	$regitro11 = new cl_anl112014();
   ...
   // echo $sSql;exit;
    ...
    if ($oEmpenhoAnulado->subunidade != '' && $oEmpenhoAnulado->subunidade != 0) {
    	...
    	$oDadosEmpenhoAnulado = new cl_anl102014();
	    ...
	    $oDadosEmpenhoAnuladoFonte = new cl_anl112014();
