    ...
    public function gerarDados()
    {
        ...
        */
        ...
        for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
            ...
            $cldipr10->si230_tipocadastro = $oDados10->c236_tipocadastro;
            ...
            $cldipr10->si230_dtatonormativo = $oDados10->c236_dtatonormacrirpps;
            $cldipr10->si230_nroatonormasegremassa = $oDados10->c236_nroatonormasegremassa;
            $cldipr10->si230_dtatonormasegremassa = $oDados10->c236_dtatonormasegremassa;
            $cldipr10->si230_planodefatuarial = $oDados10->c236_planodefatuarial;
            $cldipr10->si230_atonormplanodefat = $oDados10->c236_atonormplanodefat;
            $cldipr10->si230_dtatoplanodefat = $oDados10->c236_dtatoplanodefat;
        ...
        $sSql = "SELECT diprbasecontribuicao.*, CASE WHEN c237_tipoente = 1 THEN i1.si09_codorgaotce WHEN c237_tipoente = 2 THEN i2.si09_codorgaotce WHEN c237_tipoente = 3 THEN i3.si09_codorgaotce when c237_tipoente = 4 then i4.si09_codorgaotce END as c236_orgao FROM diprbasecontribuicao LEFT JOIN dipr ON c236_coddipr = c237_coddipr LEFT JOIN db_config db1 ON db1.numcgm = c236_numcgmexecutivo LEFT JOIN infocomplementaresinstit i1 ON i1.si09_instit = db1.codigo LEFT JOIN db_config db2 ON db2.numcgm = c236_numcgmlegislativo LEFT JOIN infocomplementaresinstit i2 ON i2.si09_instit = db2.codigo LEFT JOIN db_config db3 ON db3.numcgm = c236_numcgmgestora LEFT JOIN infocomplementaresinstit i3 ON i3.si09_instit = db3.codigo left join db_config db4 on db4.numcgm = c236_numcgmautarquia left join infocomplementaresinstit i4 on i4.si09_instit = db4.codigo WHERE c236_orgao = " . db_getsession("DB_instit") . " AND c237_datasicom BETWEEN '{$this->sDataInicial}' AND '{$this->sDataFinal}'; ";
        ...
        for ($iCont30 = 0; $iCont30 < pg_num_rows($rsResult30); $iCont30++) {
            ...
            $cldipr30->si232_valorjuros = $oDados30->c238_valorjuros;
            $cldipr30->si232_valormulta = $oDados30->c238_valormulta ;
            $cldipr30->si232_valoratualizacaomonetaria = $oDados30->c238_valoratualizacaomonetaria;
            $cldipr30->si232_valortotaldeducoes = $oDados30->c238_valortotaldeducoes;
        ...
        $sSql = "SELECT diprdeducoes.*, CASE WHEN c239_tipoente = 1 THEN i1.si09_codorgaotce WHEN c239_tipoente = 2 THEN i2.si09_codorgaotce WHEN c239_tipoente = 3 THEN i3.si09_codorgaotce when c238_tipoente = 4 then i4.si09_codorgaotce END as c236_orgao FROM diprdeducoes LEFT JOIN dipr ON c236_coddipr = c239_coddipr LEFT JOIN db_config db1 ON db1.numcgm = c236_numcgmexecutivo LEFT JOIN infocomplementaresinstit i1 ON i1.si09_instit = db1.codigo LEFT JOIN db_config db2 ON db2.numcgm = c236_numcgmlegislativo LEFT JOIN infocomplementaresinstit i2 ON i2.si09_instit = db2.codigo LEFT JOIN db_config db3 ON db3.numcgm = c236_numcgmgestora LEFT JOIN infocomplementaresinstit i3 ON i3.si09_instit = db3.codigo left join db_config db4 on db4.numcgm = c236_numcgmautarquia left join infocomplementaresinstit i4 on i4.si09_instit = db4.codigo WHERE c236_orgao = " . db_getsession("DB_instit") . " AND c239_datasicom BETWEEN '{$this->sDataInicial}' AND '{$this->sDataFinal}';";
        ...
        for ($iCont40 = 0; $iCont40 < pg_num_rows($rsResult40); $iCont40++) {
            ...
            $cldipr40->si233_datarepasse = $oDados40->c239_datarepasse;
        ...
        $sSql = "SELECT dipraportes.*, CASE WHEN c240_tipoente = 1 THEN i1.si09_codorgaotce WHEN c240_tipoente = 2 THEN i2.si09_codorgaotce WHEN c240_tipoente = 3 THEN i3.si09_codorgaotce when c238_tipoente = 4 then i4.si09_codorgaotce END as c236_orgao FROM dipraportes LEFT JOIN dipr ON c236_coddipr = c240_coddipr LEFT JOIN db_config db1 ON db1.numcgm = c236_numcgmexecutivo LEFT JOIN infocomplementaresinstit i1 ON i1.si09_instit = db1.codigo LEFT JOIN db_config db2 ON db2.numcgm = c236_numcgmlegislativo LEFT JOIN infocomplementaresinstit i2 ON i2.si09_instit = db2.codigo LEFT JOIN db_config db3 ON db3.numcgm = c236_numcgmgestora LEFT JOIN infocomplementaresinstit i3 ON i3.si09_instit = db3.codigo left join db_config db4 on db4.numcgm = c236_numcgmautarquia left join infocomplementaresinstit i4 on i4.si09_instit = db4.codigo WHERE c236_orgao = " . db_getsession("DB_instit") . " AND c240_datasicom BETWEEN '{$this->sDataInicial}' AND '{$this->sDataFinal}';";
        ...
        for ($iCont50 = 0; $iCont50 < pg_num_rows($rsResult50); $iCont50++) {
            ...
            $cldipr50->si234_datarepasse= $oDados50->c240_datarepasse;
