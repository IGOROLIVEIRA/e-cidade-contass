...
class SicomArquivoContasBancarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $cCtb30 = new cl_ctb302024();
        $cCtb31 = new cl_ctb312024();
        ...
        $aCtb21 = array();
        foreach ($aBancosAgrupados as $oContaAgrupada) foreach ($oContaAgrupada->contas as $oConta) {
            ...
            for ($iCont20 = 0; $iCont20 < pg_num_rows($rsReg20Fonte); $iCont20++) {
                ...
                $hash21 = $oCtb20->si96_codctb . $oCtb20->si96_codfontrecursos;

                if (isset($aCtb21[$hash21])) {
                    continue;
                }
                ...
                $aCtb21[$hash21] = db_utils::fieldsMemory($rsMovi21, 0);
    ...
    public function gerarRegistro20($rsReg20Fonte, int $iCont20, $oConta, array $aCtb20Agrupado, $oContaAgrupada): array
    {
        ...
        $saldoInicial = $nat_vlr_si == 'C' ? $saldoInicial *-1 : $saldoInicial;
        $saldoFinal = $nat_vlr_sf == 'C' ? $saldoFinal *-1 : $saldoFinal;
        ...
        if (!$aCtb20Agrupado[$sHash20]) {
            ...
            $oCtb20->nat_vlr_si = $nat_vlr_si;
            $oCtb20->nat_vlr_sf = $nat_vlr_sf;
            $oCtb20->ctb21 = array();
            $aCtb20Agrupado[$sHash20] = $oCtb20;
        } else {
