...
require_once ("classes/db_consid102015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCONSID.model.php");
...
class SicomArquivoConsideracoes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$clconsid10 = new cl_consid102015();
