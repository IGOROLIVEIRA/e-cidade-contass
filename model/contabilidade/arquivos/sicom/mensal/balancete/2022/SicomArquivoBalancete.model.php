...
class SicomArquivoBalancete extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    {
        $sSqlVerifica = " select distinct si96_codfontrecursos, si96_anousu from ( SELECT distinct si96_codfontrecursos, 2022 as si96_anousu FROM ctb202022 WHERE si96_codctb = {$iReduz}
    ...
    */
    ...
    public function gerarDados()
    {
        ...
        $obalancete19 = new cl_balancete192022();
        $obalancete20 = new cl_balancete202022();
        $obalancete21 = new cl_balancete212022();
        $obalancete22 = new cl_balancete222022();
        ...
        $sqlReg10 = "select
                    ...
                    case when c60_naturezasaldo = 1 then 'D' when c60_naturezasaldo = 2 then 'C' else 'C' end as c60_naturezasaldo
                        ...
                        where c60_anousu = " . db_getsession("DB_anousu") . " {$sWhere10} and (c61_reduz = 25480 or c61_codtce = 25480)) as x
                        where  debito != 0 or credito != 0 or saldoinicialano != 0 order by contacontabil";

        $rsReg10 = db_query($sqlReg10);
        db_criatabela($rsReg10);
                ...
                if ($oContas10->nregobrig == 31) {                                                  
                         $sSqlVinculoContaOrcamento = " SELECT
                                                ...
                                                contacorrente
                                                    ...
                                                    LEFT JOIN orcreceita on o70_codfon = c61_codcon
                                                    and o70_anousu = c60_anousu
                                                    LEFT JOIN taborc on taborc.k02_anousu = o70_anousu
                                                    and taborc.k02_codrec = o70_codrec
                                                    ...
                                                    LEFT JOIN conplanoreduz on k13_reduz = conplanoreduz.c61_reduz
                                                    and conplanoreduz.c61_anousu = c60_anousu
                                                    LEFT JOIN conplanocontabancaria ON c56_codcon = conplanoreduz.c61_codcon
                                                    and conplanoreduz.c61_anousu = c56_anousu
                                             ...
                                             (SELECT
                                                (SELECT CASE WHEN c29_debito > 0 THEN c29_debito WHEN c29_credito > 0 THEN -1 * c29_credito ELSE 0 END AS saldoanterior
                                                 ...
                                                 WHERE c19_reduz IN (" . implode(',', $oContas10->contas) . ")
                                                   AND c17_sequencial = {$nContaCorrente} ";
                                                    if ($oContas10->nregobrig == 31) {
                                                        if ($objContas->c19_emparlamentar == 3) 
                                                            $sSqlReg12saldos .= " AND (c19_emparlamentar IN ({$objContas->c19_emparlamentar}) OR c19_emparlamentar IS NULL) ";
                                                        else 
...
//
            ...
            foreach ($oDado10->reg17 as $reg17) {
                ...
                } else if(db_getsession("DB_anousu")==2022 && in_array($obalreg17->si184_codctb,$aEncerradas['si95_codtceant'])){
                    $obalreg17->si184_codctb = $aEncerradas['si95_reduz'][$obalreg17->si184_codctb];
                }
            ...
            foreach ($oDado10->reg23 as $reg23) {
                ...
                $obalreg23 = new cl_balancete232022();
