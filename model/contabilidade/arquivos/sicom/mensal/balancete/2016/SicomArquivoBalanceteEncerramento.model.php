        ...
        foreach ($aDadosAgrupados10 as $reg10Hash => $oContas10) {
            ...
            if ($oContas10->nregobrig == 17) {
                ...
                for ($iContctb = 0; $iContctb < pg_num_rows($rsSqlCTB); $iContctb++) {
                     ...
                     *
                     */
                    $sSqlVerifica = " select distinct si95_codctb, ano from ( SELECT distinct si95_codctb, 2016 as ano FROM ctb102016 WHERE si95_codorgao::INTEGER = $objContasctb->si09_codorgaotce AND si95_banco = '$objContasctb->c63_banco'
