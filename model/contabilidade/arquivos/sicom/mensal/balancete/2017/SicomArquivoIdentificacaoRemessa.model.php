...
require_once ("classes/db_ide2017_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2017/GerarIDE.model.php");
  ...
  public function gerarDados(){
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsResult); $iCont++) {
    	...
    	$oDadosIde = db_utils::fieldsMemory($rsResult, $iCont);
		  ...
		  $clide->si11_mesreferencia        = $this->bEncerramento == true ? 13 : $this->sDataFinal['5'].$this->sDataFinal['6'];
