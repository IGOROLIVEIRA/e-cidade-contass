        ...
        foreach ($aDadosAgrupados10 as $reg10Hash => $oContas10) {
                ...
                for ($iContRp = 0; $iContRp < pg_num_rows($rsRestos); $iContRp++) {
                    ...
                    for ($iContSaldo14 = 0; $iContSaldo14 < pg_num_rows($rsReg14saldos); $iContSaldo14++) {
                        ...
                        if (!(($oReg14Saldo->saldoanterior == "" || $oReg14Saldo->saldoanterior == 0) && $oReg14Saldo->debitos == "" && $oReg14Saldo->creditos == "")) {
                            ...
                            if (in_array($oReg14->codfontrecursos, $this->aFontesEncerradas) && $nMes == '01' && db_getsession("DB_anousu") == 2020 && $saldoFinalRsp != 0) {
                                $iFonte = substr($oReg14->codfontrecursos, 0, 1).'59';
                            } elseif (in_array($oReg14->codfontrecursos, $this->aFontesEncerradas) && $nMes != '01' && db_getsession("DB_anousu") != 2020) {
                                $iFonte = substr($oReg14->codfontrecursos, 0, 1).'59';
                            } else {
            ...
            if ($oContas10->nregobrig == 17) {
                ...
                for ($iContctb = 0; $iContctb < pg_num_rows($rsSqlCTB); $iContctb++) {
                     ...
                     *
                     */
                    /*$sSqlVerifica = " select distinct si95_codctb, ano from ( SELECT distinct si95_codctb, 2020 as ano FROM ctb102020 WHERE si95_codorgao = '$objContasctb->si09_codorgaotce' AND si95_banco = '$objContasctb->c63_banco'
