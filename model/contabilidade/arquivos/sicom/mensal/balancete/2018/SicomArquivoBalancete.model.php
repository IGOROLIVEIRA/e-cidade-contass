...
require_once("classes/db_balancete102018_classe.php");
require_once("classes/db_balancete112018_classe.php");
require_once("classes/db_balancete122018_classe.php");
require_once("classes/db_balancete132018_classe.php");
require_once("classes/db_balancete142018_classe.php");
require_once("classes/db_balancete152018_classe.php");
require_once("classes/db_balancete162018_classe.php");
require_once("classes/db_balancete172018_classe.php");
require_once("classes/db_balancete182018_classe.php");
require_once("classes/db_balancete192018_classe.php");
require_once("classes/db_balancete202018_classe.php");
require_once("classes/db_balancete212018_classe.php");
require_once("classes/db_balancete222018_classe.php");
require_once("classes/db_balancete232018_classe.php");
require_once("classes/db_balancete242018_classe.php");
require_once("classes/db_balancete252018_classe.php");
require_once("classes/db_balancete262018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarBALANCETE.model.php");
...
class SicomArquivoBalancete extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    {
        $sSqlVerifica = " select distinct si96_codfontrecursos, si96_anousu from ( SELECT distinct si96_codfontrecursos, 2018 as si96_anousu FROM ctb202018 WHERE si96_codctb = {$iReduz}
    ...
    public function gerarDados()
    {
        ...
        db_inicio_transacao();
        $obalancete10 = new cl_balancete102018();
        $obalancete11 = new cl_balancete112018();
        $obalancete12 = new cl_balancete122018();
        $obalancete13 = new cl_balancete132018();
        $obalancete14 = new cl_balancete142018();
        $obalancete15 = new cl_balancete152018();
        $obalancete16 = new cl_balancete162018();
        $obalancete17 = new cl_balancete172018();
        $obalancete18 = new cl_balancete182018();
        $obalancete23 = new cl_balancete232018();
        $obalancete24 = new cl_balancete242018();
        $obalancete25 = new cl_balancete252018();
        $obalancete26 = new cl_balancete262018();

        $obalancete26->excluir(null, "si193_mes = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " and si193_instit = " . db_getsession("DB_instit"));
        $obalancete25->excluir(null, "si194_mes = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " and si194_instit = " . db_getsession("DB_instit"));
        ...
        foreach ($aDadosAgrupados10 as $reg10Hash => $oContas10) {
                ...
                for ($iContRp = 0; $iContRp < pg_num_rows($rsRestos); $iContRp++) {
                    ...
                    for ($iContSaldo14 = 0; $iContSaldo14 < pg_num_rows($rsReg14saldos); $iContSaldo14++) {
                        ...
                        if (!(($oReg14Saldo->saldoanterior == "" || $oReg14Saldo->saldoanterior == 0) && $oReg14Saldo->debitos == "" && $oReg14Saldo->creditos == "")) {
                             ...
                             * 2. Verifica se existe dotacao em 2018 passando a unidade e o orgao
            ...
            if ($oContas10->nregobrig == 17) {
                ...
                for ($iContctb = 0; $iContctb < pg_num_rows($rsSqlCTB); $iContctb++) {
                     ...
                     *
                     */
                    $sSqlVerifica = " select distinct si95_codctb, ano from ( SELECT distinct si95_codctb, 2018 as ano FROM ctb102018 WHERE si95_codorgao = '$objContasctb->si09_codorgaotce' AND si95_banco = '$objContasctb->c63_banco'
        ...
        */
        ...
        foreach ($aContasReg10 as $oDado10) {
            ...
            foreach ($oDado10->reg11 as $reg11) {
                ...
                $obalreg11 = new cl_balancete112018();
            ...
            foreach ($oDado10->reg12 as $reg12) {
                ...
                $obalreg12 = new cl_balancete122018();
            ...
            foreach ($oDado10->reg13 as $reg13) {
                ...
                $obalreg13 = new cl_balancete132018();
                /*
                 * Contas do PPA
                 */
            ...
            foreach ($oDado10->reg14 as $reg14) {
                $obalreg14 = new cl_balancete142018();
            ...
            foreach ($oDado10->reg15 as $reg15) {
                ...
                $obalreg15 = new cl_balancete152018();
            ...
            foreach ($oDado10->reg16 as $reg16) {
                ...
                $obalreg16 = new cl_balancete162018();
            ...
            foreach ($oDado10->reg17 as $reg17) {
                ...
                $obalreg17 = new cl_balancete172018();
            ...
            foreach ($oDado10->reg18 as $reg18) {
                ...
                $obalreg18 = new cl_balancete182018();
            ...
            foreach ($oDado10->reg19 as $reg19) {
                ...
                $obalreg19 = new cl_balancete192018();
            ...
            foreach ($oDado10->reg20 as $reg20) {
                ...
                $obalreg20 = new cl_balancete202018();
            ...
            foreach ($oDado10->reg21 as $reg21) {
                ...
                $obalreg21 = new cl_balancete212018();
            ...
            foreach ($oDado10->reg22 as $reg22) {
                ...
                $obalreg22 = new cl_balancete222018();
            ...
            foreach ($oDado10->reg23 as $reg23) {
                ...
                $obalreg23 = new cl_balancete232018();
            ...
            foreach ($oDado10->reg24 as $reg24) {
                ...
                $obalreg24 = new cl_balancete242018();
            ...
            foreach ($oDado10->reg25 as $reg25) {
                ...
                $obalreg25 = new cl_balancete252018();

                $obalreg25->si194_tiporegistro    = $reg25->si194_tiporegistro;
                $obalreg25->si194_contacontabil   = $reg25->si194_contacontabil;
                $obalreg25->si194_codfundo        = $reg25->si194_codfundo;
                $obalreg25->si194_atributosf      = $reg25->si194_atributosf;
                $obalreg25->si194_naturezareceita = $reg25->si194_naturezareceita;
                $obalreg25->si194_saldoinicialsf  = number_format(abs($reg25->si194_saldoinicialsf == '' ? 0 : $reg25->si194_saldoinicialsf),2,".","");
                $obalreg25->si194_naturezasaldoinicialsf = $reg25->si194_naturezasaldoinicialsf;
                $obalreg25->si194_totaldebitossf = number_format(abs($reg25->si194_totaldebitossf == '' ? 0 : $reg25->si194_totaldebitossf),2,".","");
                $obalreg25->si194_totalcreditossf = number_format(abs($reg25->si194_totalcreditossf == '' ? 0 : $reg25->si194_totalcreditossf),2,".","");
                $obalreg25->si194_saldofinalsf = number_format(abs($reg25->si194_saldofinalsf == '' ? 0 : $reg25->si194_saldofinalsf),2,".","");
                $obalreg25->si194_naturezasaldofinalsf = $reg25->si194_naturezasaldofinalsf;
                $obalreg25->si194_mes = $reg25->si194_mes;
                $obalreg25->si194_instit = $reg25->si194_instit;
                $obalreg25->si194_reg10 = $obalancete10->si177_sequencial;
            ...
            foreach ($oDado10->reg26 as $reg26) {
                ...
                $obalreg26 = new cl_balancete262018();

                $obalreg26->si193_tiporegistro = $reg26->si193_tiporegistro;
                $obalreg26->si193_contacontabil = $reg26->si193_contacontabil;
                $obalreg26->si193_codfundo = "00000000";
                $obalreg26->si193_tipodocumentopessoaatributosf = $reg26->si193_tipodocumentopessoaatributosf;
                $obalreg26->si193_nrodocumentopessoaatributosf = $reg26->si193_nrodocumentopessoaatributosf;
                $obalreg26->si193_atributosf = $reg26->si193_atributosf;
                $obalreg26->si193_saldoinicialpessoaatributosf = number_format(abs($reg26->si193_saldoinicialpessoaatributosf == '' ? 0 : $reg26->si193_saldoinicialpessoaatributosf), 2, ".", "");
                $obalreg26->si193_naturezasaldoinicialpessoaatributosf = $reg26->si193_saldoinicialpessoaatributosf == 0 ? $oDado10->naturezasaldo : ($reg26->si193_saldoinicialpessoaatributosf > 0 ? 'D' : 'C');
                $obalreg26->si193_totaldebitospessoaatributosf = number_format(abs($reg26->si193_totaldebitospessoaatributosf), 2, ".", "");
                $obalreg26->si193_totalcreditospessoaatributosf = number_format(abs($reg26->si193_totalcreditospessoaatributosf), 2, ".", "");
                $saldoFinal = ($reg26->si193_saldoinicialpessoaatributosf + $reg26->si193_totaldebitospessoaatributosf - $reg26->si193_totalcreditospessoaatributosf) == '' ? 0 : ($reg26->si193_saldoinicialpessoaatributosf + $reg26->si193_totaldebitospessoaatributosf - $reg26->si193_totalcreditospessoaatributosf);
                $obalreg26->si193_saldofinalpessoaatributosf = number_format(abs($saldoFinal), 2, ".", "");
                $obalreg26->si193_naturezasaldofinalpessoaatributosf = $saldoFinal == 0 ? $obalreg26->si193_naturezasaldoinicialpessoaatributosf : ($saldoFinal > 0 ? 'D' : 'C');
                $obalreg26->si193_instit = $reg26->si193_instit;
                $obalreg26->si193_mes = $reg26->si193_mes;
                $obalreg26->si193_reg10 = $obalancete10->si177_sequencial;

                $obalreg26->incluir(null);

                if ($obalreg26->erro_status == 0) {
                    throw new Exception($obalreg26->erro_msg." conta contabil {$obalreg26->si193_contacontabil}");
                }
            }
