...
require_once ("classes/db_rec102016_classe.php");
require_once ("classes/db_rec112016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarREC.model.php");
...
class SicomArquivoDetalhamentoReceitasMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    /**
  	 ...
  	 */
  	$clrec10 = new cl_rec102016();
  	$clrec11 = new cl_rec112016();
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    	...
    	if (!isset($aDadosAgrupados[$sHash10])) {
    	  ...
    	  $oDados10 = new stdClass();
		    ...
		    $oDados10->si25_ededucaodereceita    = $iIdentDeducao != '' ? 1 : 2;
