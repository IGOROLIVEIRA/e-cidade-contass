...
require_once ("classes/db_aberlic102016_classe.php");
require_once ("classes/db_aberlic112016_classe.php");
require_once ("classes/db_aberlic122016_classe.php");
require_once ("classes/db_aberlic132016_classe.php");
require_once ("classes/db_aberlic142016_classe.php");
require_once ("classes/db_aberlic152016_classe.php");
require_once ("classes/db_aberlic162016_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarABERLIC.model.php");
...
class SicomArquivoAberturaLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
	...
	public function gerarDados() {
  	 ...
  	 */
      $claberlic10 = new cl_aberlic102016();
      $claberlic11 = new cl_aberlic112016();
      $claberlic12 = new cl_aberlic122016();
      $claberlic13 = new cl_aberlic132016();
      $claberlic14 = new cl_aberlic142016();
      $claberlic15 = new cl_aberlic152016();
      $claberlic16 = new cl_aberlic162016();
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=".db_getsession("DB_anousu")." LIMIT 1) as codUnidadeSubResp,
			...
			INNER JOIN db_config on (liclicita.l20_instit=db_config.codigo)
			INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
			INNER JOIN aberlic112016 on (liclicitemlote.l04_descricao = aberlic112016.si47_dsclote and aberlic112016.si47_nroprocessolicitatorio = liclicita.l20_edital::varchar)
			LEFT JOIN solicitemunid AS solicitemunid ON solicitem.pc11_codigo = solicitemunid.pc17_codigo
      LEFT JOIN matunid AS matunid ON solicitemunid.pc17_unid = matunid.m61_codmatunid
			LEFT JOIN infocomplementaresinstit on db_config.codigo = infocomplementaresinstit.si09_instit
			WHERE db_config.codigo= " .db_getsession("DB_instit")." AND liclicita.l20_tipojulg = 3 
