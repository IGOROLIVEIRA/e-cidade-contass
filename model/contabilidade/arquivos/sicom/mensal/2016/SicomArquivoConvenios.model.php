...
require_once ("classes/db_conv102016_classe.php");
require_once ("classes/db_conv112016_classe.php");
require_once ("classes/db_conv202016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarCONV.model.php");
...
class SicomArquivoConvenios extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clconv10 = new cl_conv102016();
    $clconv11 = new cl_conv112016();
    $clconv20 = new cl_conv202016();
