...
require_once ("classes/db_parpps102016_classe.php");
require_once ("classes/db_parpps202016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/SicomArquivoBase.model.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarPARPPS.model.php");
  ...
  public function gerarDados() {
    ...
    if ($this->sDataFinal['5'].$this->sDataFinal['6'] == 12 && $sTipoinstit == 5) {
	    ...
	    $sSql       = "select * from projecaoatuarial20 where si169_exercicio >= ".(db_getsession("DB_anousu")-1)." 
	                   and si169_instit = ".db_getsession("DB_instit")." order by si169_exercicio limit 75";
