...
require_once ("classes/db_caixa102016_classe.php");
require_once ("classes/db_caixa112016_classe.php");
require_once ("classes/db_caixa122016_classe.php");
require_once ("classes/db_caixa132016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarCAIXA.model.php");
...
class SicomArquivoCaixa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clcaixa13 = new cl_caixa132016();
    $clcaixa12 = new cl_caixa122016();
    $clcaixa11 = new cl_caixa112016();
    $clcaixa10 = new cl_caixa102016();
    ...
    for ($iCont = 0;$iCont < pg_num_rows($rsContasCaixa); $iCont++) {
        ...
        db_inicio_transacao();
    	  ...
    	  $oDadosCaixa = new cl_caixa102016();
    	  ...
    	  $oDadosSaldoCaixa = new cl_caixa112016();    	
