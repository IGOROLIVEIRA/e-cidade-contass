...
require_once ("classes/db_parec102016_classe.php");
require_once ("classes/db_parec112016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarPAREC.model.php");
/**
 * 
...
class SicomArquivoPrevisaoAtualizadaReceita extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
   ...
   /**
  	 ...
  	 */
  	$clparec10 = new cl_parec102016();
  	$clparec11 = new cl_parec112016();
