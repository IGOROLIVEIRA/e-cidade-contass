...
require_once ("classes/db_resplic102016_classe.php");
require_once ("classes/db_resplic202016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarRESPLIC.model.php");
...
class SicomArquivoResponsaveisLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
 ...
 public function gerarDados(){
  	 ...
  	 */
  	$clresplic10 = new cl_resplic102016();
  	$clresplic20 = new cl_resplic202016();
