...
require_once("classes/db_emp102016_classe.php");
require_once("classes/db_emp112016_classe.php");
require_once("classes/db_emp122016_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarEMP.model.php");
...
class SicomArquivoDetalhamentoEmpenhosMes extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $cEmp10 = new cl_emp102016();
        $cEmp11 = new cl_emp112016();
        $cEmp12 = new cl_emp122016();
        ...
        for ($iCont = 0; $iCont < pg_num_rows($rsEmpenho); $iCont++) {
            ...
            $oDadosEmpenho = new cl_emp102016();
             ...
             * dados registro 11
             */
            $oDadosEmpenhoFonte = new cl_emp112016();
