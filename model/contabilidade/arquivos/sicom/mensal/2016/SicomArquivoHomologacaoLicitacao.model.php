...
require_once ("classes/db_homolic102016_classe.php");
require_once ("classes/db_homolic202016_classe.php");
require_once ("classes/db_homolic302016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/SicomArquivoBase.model.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarHOMOLIC.model.php");
...
class SicomArquivoHomologacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clhomolic10 = new cl_homolic102016();
  	$clhomolic20 = new cl_homolic202016();
  	$clhomolic30 = new cl_homolic302016();
