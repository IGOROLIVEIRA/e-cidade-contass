...
require_once ("classes/db_pessoa102016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarPESSOA.model.php");
...
class SicomArquivoPessoa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
    ...
    if (pg_num_rows($result) > 0) {
  	...
  	if ($this->sDataFinal['5'].$this->sDataFinal['6'] != 01) {
  		...
  		$sSql  = "select z01_cgccpf, 
		      ...
		      and (z01_cgccpf != '' and z01_cgccpf is not null)
		      and z01_cgccpf not EXISTS (select si12_nrodocumento from pessoa102015)
		      and z01_cgccpf not EXISTS (select si12_nrodocumento from pessoa102014)";
  	}
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsResult); $iCont++) {
    	...
    	$clpessoa->si12_justificativaalteracao = $sJustificativaalteracao;
