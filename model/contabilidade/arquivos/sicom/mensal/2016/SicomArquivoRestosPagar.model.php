...
require_once ("classes/db_rsp102016_classe.php");
require_once ("classes/db_rsp112016_classe.php");
require_once ("classes/db_rsp122016_classe.php");
require_once ("classes/db_rsp202016_classe.php");
require_once ("classes/db_rsp212016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarRSP.model.php");
...
class SicomArquivoRestosPagar extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clrsp10 = new cl_rsp102016();
    $clrsp11 = new cl_rsp112016();
    $clrsp12 = new cl_rsp122016();
    $clrsp20 = new cl_rsp202016();
    $clrsp21 = new cl_rsp212016();
