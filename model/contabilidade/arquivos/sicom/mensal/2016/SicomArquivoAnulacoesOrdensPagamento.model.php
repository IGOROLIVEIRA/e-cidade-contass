...
require_once("classes/db_aop102016_classe.php");
require_once("classes/db_aop112016_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarAOP.model.php");
...
class SicomArquivoAnulacoesOrdensPagamento extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $claop10 = new cl_aop102016();
        $claop11 = new cl_aop112016();
    ...
    and c70_data < '" . $oAnulacoes->dtanulacao . "' and c80_codord = {$oAnulacoes->e50_codord}";
        ...
        foreach ($aAnulacoes as $anulacao) {
            ...
            $oDadosAnulacao = new cl_aop102016();
            ...
            foreach ($anulacao->reg11 as $reg11) {
                ...
                $oDadosAnulacaoFonte = new cl_aop112016();
