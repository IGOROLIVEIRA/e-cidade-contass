...
require_once ("classes/db_consor102016_classe.php");
require_once ("classes/db_consor202016_classe.php");
require_once ("classes/db_consor302016_classe.php");
require_once ("classes/db_consor402016_classe.php");
require_once ("classes/db_consor502016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
  	 ...
  	 */
  	$clconsor10 = new cl_consor102016();
  	$clconsor20 = new cl_consor202016();
  	$clconsor30 = new cl_consor302016();
  	$clconsor40 = new cl_consor402016();
  	$clconsor50 = new cl_consor502016();
