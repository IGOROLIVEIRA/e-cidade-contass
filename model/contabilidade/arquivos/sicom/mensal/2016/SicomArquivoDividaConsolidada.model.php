...
require_once ("classes/db_ddc102016_classe.php");
require_once ("classes/db_ddc202016_classe.php");
require_once ("classes/db_ddc302016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarDDC.model.php");
...
class SicomArquivoDividaConsolidada extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clddc10 = new cl_ddc102016();
    $clddc20 = new cl_ddc202016();
    $clddc30 = new cl_ddc302016();

    db_inicio_transacao();
    /*
     * excluir informacoes do mes selecionado registro 10
     */
    $result = $clddc10->sql_record($clddc10->sql_query(NULL,"*",NULL,"si150_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']));
    if (pg_num_rows($result) > 0) {
      $clddc10->excluir(NULL,"si150_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']);
     ...
     */
    $result = $clddc20->sql_record($clddc20->sql_query(NULL,"*",NULL,"si153_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']));
    if (pg_num_rows($result) > 0) {
      $clddc20->excluir(NULL,"si153_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']);
     ...
     */
    $result = $clddc30->sql_record($clddc30->sql_query(NULL,"*",NULL,"si154_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']));
    if (pg_num_rows($result) > 0) {
      $clddc30->excluir(NULL,"si154_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']);
    ...
    */
    ...
    for ($iCont30 = 0; $iCont30 < pg_num_rows($rsResult30); $iCont30++) {
      ...
      $clddc30->si154_tipodocumentocredor        = $oDados30->si167_tipodocumentocredor;
      $clddc30->si154_nrodocumentocredor         = $oDados30->si167_nrodocumentocredor;
