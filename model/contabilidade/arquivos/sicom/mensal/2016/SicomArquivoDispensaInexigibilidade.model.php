...
require_once ("classes/db_dispensa102016_classe.php");
require_once ("classes/db_dispensa112016_classe.php");
require_once ("classes/db_dispensa122016_classe.php");
require_once ("classes/db_dispensa132016_classe.php");
require_once ("classes/db_dispensa142016_classe.php");
require_once ("classes/db_dispensa152016_classe.php");
require_once ("classes/db_dispensa162016_classe.php");
require_once ("classes/db_dispensa172016_classe.php");
require_once ("classes/db_dispensa182016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarDISPENSA.model.php");
...
class SicomArquivoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	 ...
  	 */
  	$dispensa10 = new cl_dispensa102016();
  	$dispensa11 = new cl_dispensa112016();
  	$dispensa12 = new cl_dispensa122016();
  	$dispensa13 = new cl_dispensa132016();
  	$dispensa14 = new cl_dispensa142016();
  	$dispensa15 = new cl_dispensa152016();
  	$dispensa16 = new cl_dispensa162016();
  	$dispensa17 = new cl_dispensa172016();
  	$dispensa18 = new cl_dispensa182016();
  ...
  $result = db_query($dispensa10->sql_query(NULL,"*",NULL,"si74_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si74_instit=".db_getsession("DB_instit")));
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=".db_getsession("DB_anousu")." LIMIT 1) as codUnidadeSubResp,
		...
		liclicita.l20_edital as nroProcessoLicitatorio,
		pctipocompratribunal.l44_codigotribunal as tipoProcesso,
		dispensa112016.si75_nrolote as nroLote,
		(pcmater.pc01_codmater::varchar || (case when matunid.m61_codmatunid is null then 1 else matunid.m61_codmatunid end)::varchar) as codItem
		FROM liclicitem
		INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
		INNER JOIN liclicita on (liclicitem.l21_codliclicita=liclicita.l20_codigo)
		INNER JOIN dispensa112016 on (liclicitemlote.l04_descricao = dispensa112016.si75_dsclote and dispensa112016.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=".db_getsession("DB_anousu")." LIMIT 1) as codUnidadeSubResp,
		...
		LEFT  JOIN dispensa112016 on (liclicitemlote.l04_descricao = dispensa112016.si75_dsclote and dispensa112016.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
