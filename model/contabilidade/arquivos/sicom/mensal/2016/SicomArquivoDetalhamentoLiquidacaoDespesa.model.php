...
require_once ("classes/db_lqd102016_classe.php");
require_once ("classes/db_lqd112016_classe.php");
require_once ("classes/db_lqd122016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarLQD.model.php");
 /**
...
class SicomArquivoDetalhamentoLiquidacaoDespesa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cllqd10 = new cl_lqd102016();
  	$cllqd11 = new cl_lqd112016();
  	$cllqd12 = new cl_lqd122016();
     ...
     */
    db_inicio_transacao();
    $result = $cllqd10->sql_record($cllqd10->sql_query(NULL,"*",NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
        ." and si118_instit = ".db_getsession("DB_instit")));
    if (pg_num_rows($result) > 0) {
    	
    	$cllqd11->excluir(NULL,"si119_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si119_instit = ".db_getsession("DB_instit"));
    	$cllqd12->excluir(NULL,"si120_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si120_instit = ".db_getsession("DB_instit"));
    	$cllqd10->excluir(NULL,"si118_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']
    		." and si118_instit = ".db_getsession("DB_instit"));
