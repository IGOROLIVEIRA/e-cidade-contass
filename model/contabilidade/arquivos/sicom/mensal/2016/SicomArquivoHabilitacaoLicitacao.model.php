...
require_once ("classes/db_hablic102016_classe.php");
require_once ("classes/db_hablic112016_classe.php");
require_once ("classes/db_hablic202016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarHABLIC.model.php");
...
class SicomArquivoHabilitacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
	...
	public function gerarDados() {
		 ...
		 */
		$clhablic10 = new cl_hablic102016();
		$clhablic11 = new cl_hablic112016();
		$clhablic20 = new cl_hablic202016();
		...
		if (pg_num_rows($result) > 0) {
			...
			if ($clconsor212016->erro_status == 0) {
				throw new Exception($clhablic20->erro_msg);
			}
		}
		/**
		 * Sob solicitação de Igor, o campo nroRegistro foi alterado para pegar o cnpj 04/03/2016
		 */
