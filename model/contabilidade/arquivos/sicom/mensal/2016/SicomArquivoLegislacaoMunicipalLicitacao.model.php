...
require_once ("classes/db_reglic102016_classe.php");
require_once ("classes/db_reglic202016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarREGLIC.model.php");
...
class SicomArquivoLegislacaoMunicipalLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
	...
	$clreglic10 = new cl_reglic102016();
  	$clreglic20 = new cl_reglic202016();
	...
	UNION select si44_nrodecretomunicipal from reglic102016 where si44_mes <= ".$this->sDataFinal['5'].$this->sDataFinal['6'].") ";
