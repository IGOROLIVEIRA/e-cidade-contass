...
require_once ("classes/db_arc102016_classe.php");
require_once ("classes/db_arc112016_classe.php");
require_once ("classes/db_arc122016_classe.php");
require_once ("classes/db_arc202016_classe.php");
require_once ("classes/db_arc212016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarARC.model.php");
