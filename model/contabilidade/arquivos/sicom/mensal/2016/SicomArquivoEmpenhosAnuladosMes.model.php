...
require_once ("classes/db_anl102016_classe.php");
require_once ("classes/db_anl112016_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$regitro10 = new cl_anl102016();
  	$regitro11 = new cl_anl112016();
    ...
    if ($oEmpenhoAnulado->subunidade != '' && $oEmpenhoAnulado->subunidade != 0) {
    	...
    	$oDadosEmpenhoAnulado = new cl_anl102016();
	    ...
	    $oDadosEmpenhoAnuladoFonte = new cl_anl112016();
