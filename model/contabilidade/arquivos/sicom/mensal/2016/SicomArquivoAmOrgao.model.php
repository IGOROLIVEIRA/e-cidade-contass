...
require_once ("classes/db_orgao102016_classe.php");
require_once ("classes/db_orgao112016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarORGAO.model.php");
...
class SicomArquivoAmOrgao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$clorgao10 = new cl_orgao102016();
  	$clorgao11 = new cl_orgao112016();
