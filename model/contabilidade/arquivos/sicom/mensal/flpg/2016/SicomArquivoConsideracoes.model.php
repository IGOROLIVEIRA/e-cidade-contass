...
require_once ("classes/db_consid102016_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2016/GerarCONSID.model.php");
...
class SicomArquivoConsideracoes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clconsid10 = new cl_consid102016();
