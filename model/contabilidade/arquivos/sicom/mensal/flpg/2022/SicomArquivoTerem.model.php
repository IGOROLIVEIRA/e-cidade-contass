...
require_once ("classes/db_terem102022_classe.php");
require_once ("classes/db_tetoremuneratorio_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/flpg/GerarTEREM.model.php");
...
class SicomArquivoTerem extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados() {
        ...
        $clterem10 = new cl_terem102022();
        $clterem20 = new cl_terem202022();
