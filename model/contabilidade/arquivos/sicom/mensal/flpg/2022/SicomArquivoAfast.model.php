...
require_once ("classes/db_afast102022_classe.php");
require_once ("classes/db_afast202022_classe.php");
require_once ("classes/db_afast302022_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/flpg/GerarAFAST.model.php");
...
class SicomArquivoAfast extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados()
    {
      ...
      $aRegistros20 = array();
         ...
         */
        $clafast = new cl_afast102022();
        $clafast20 = new cl_afast202022();
        $clafast30 = new cl_afast302022();
