...
require_once ("classes/db_viap102022_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/flpg/GerarVIAP.model.php");
            ...
            $sSql = "select distinct z01_cgccpf,
		      ...
		      AND rh01_regist NOT IN
                        (SELECT si198_codvinculopessoa
                         FROM viap102022 where si198_mes < {$iMes} )
