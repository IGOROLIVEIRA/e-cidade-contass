...
require_once ("classes/db_pessoaflpgo102022_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/flpg/GerarPESSOA.model.php");
...
class SicomArquivoPessoa extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados(){
         ...
         */
        $clpessoa = new cl_pessoaflpgo102022();
...
AND z01_cgccpf NOT IN
 ...
 AND   rh01_sicom = 1
  ...
  INNER JOIN rhpessoalmov ON rh01_regist = rh02_regist and rh02_mesusu=01 and rh02_anousu=2022
