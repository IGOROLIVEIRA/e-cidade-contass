...
require_once ("classes/db_flpgo102022_classe.php");
require_once ("classes/db_flpgo112022_classe.php");
require_once ("classes/db_flpgo122022_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/flpg/GerarFLPGO.model.php");
...
class SicomArquivoFlpgo extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  function convert_accented_characters($str){
	...
	public function gerarDados() {
		...
		$clflpgo10 = new cl_flpgo102022();
		$clflpgo11 = new cl_flpgo112022();
		$clflpgo12 = new cl_flpgo122022();
