...
require_once ("classes/db_afast102024_classe.php");
require_once ("classes/db_afast202024_classe.php");
require_once ("classes/db_afast302024_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2024/flpg/GerarAFAST.model.php");
...
class SicomArquivoAfast extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados()
    {
      ...
      $aRegistros20 = array();
         ...
         */
        $clafast = new cl_afast102024();
        $clafast20 = new cl_afast202024();
        $clafast30 = new cl_afast302024();
