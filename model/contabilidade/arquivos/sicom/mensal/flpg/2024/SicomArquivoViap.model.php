...
require_once ("classes/db_viap102024_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2024/flpg/GerarVIAP.model.php");
    ...
    public function gerarDados(){
        ...
        rh05_seqpes is null
                    ...
                    (date_part('MONTH',rh05_recis) = 01
                     and date_part('YEAR',rh05_recis) = 2024
                    )
                    or
            ...
            $sSql = "select distinct z01_cgccpf,
		      ...
		      AND rh01_regist NOT IN
                        (SELECT si198_codvinculopessoa
                         FROM viap102024 where si198_mes < {$iMes} )
