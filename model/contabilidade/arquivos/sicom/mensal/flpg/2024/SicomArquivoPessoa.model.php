...
require_once ("classes/db_pessoaflpgo102024_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2024/flpg/GerarPESSOA.model.php");
...
class SicomArquivoPessoa extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados(){
         ...
         */
        $clpessoa = new cl_pessoaflpgo102024();
...
WHERE (z01_cgccpf != '00000000000'
 ...
 AND   rh01_sicom = 1
  ...
  INNER JOIN rhpessoalmov ON rh01_regist = rh02_regist and rh02_mesusu=01 and rh02_anousu=2024
