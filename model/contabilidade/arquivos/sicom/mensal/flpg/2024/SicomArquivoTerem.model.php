...
require_once ("classes/db_terem102024_classe.php");
require_once ("classes/db_tetoremuneratorio_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2024/flpg/GerarTEREM.model.php");
...
class SicomArquivoTerem extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados() {
        ...
        $clterem10 = new cl_terem102024();
        $clterem20 = new cl_terem202024();
