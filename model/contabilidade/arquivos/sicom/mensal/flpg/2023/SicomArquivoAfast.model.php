...
require_once ("classes/db_afast102023_classe.php");
require_once ("classes/db_afast202023_classe.php");
require_once ("classes/db_afast302023_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2023/flpg/GerarAFAST.model.php");
...
class SicomArquivoAfast extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados()
    {
      ...
      $aRegistros20 = array();
         ...
         */
        $clafast = new cl_afast102023();
        $clafast20 = new cl_afast202023();
        $clafast30 = new cl_afast302023();
