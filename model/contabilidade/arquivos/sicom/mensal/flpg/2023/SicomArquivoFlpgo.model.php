...
require_once ("classes/db_flpgo102023_classe.php");
require_once ("classes/db_flpgo112023_classe.php");
require_once ("classes/db_flpgo122023_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2023/flpg/GerarFLPGO.model.php");
...
class SicomArquivoFlpgo extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  function convert_accented_characters($str){
	...
	public function gerarDados() {
		...
		$clflpgo11 = new cl_flpgo112023();
		$clflpgo12 = new cl_flpgo122023();
