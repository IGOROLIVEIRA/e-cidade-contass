...
require_once ("classes/db_terem102023_classe.php");
require_once ("classes/db_tetoremuneratorio_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2023/flpg/GerarTEREM.model.php");
...
class SicomArquivoTerem extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados() {
        ...
        $clterem10 = new cl_terem102023();
        $clterem20 = new cl_terem202023();
