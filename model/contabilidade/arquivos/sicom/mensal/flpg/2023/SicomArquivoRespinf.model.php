...
require_once ("classes/db_respinf102023_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2023/flpg/GerarRESPINF.model.php");
...
class SicomArquivoRespinf extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clrespinf10 = new cl_respinf102023();
    ...
    $sSql .= " where si166_instit = " . db_getsession("DB_instit") . " and si166_tiporesponsavel = 7 and DATE_PART('YEAR',si166_dataini) <= ". db_getsession('DB_anousu')." and DATE_PART('YEAR',si166_datafim) >= ". db_getsession('DB_anousu');
