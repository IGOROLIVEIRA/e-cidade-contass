...
require_once ("classes/db_viap102023_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2023/flpg/GerarVIAP.model.php");
            ...
            $sSql = "select distinct z01_cgccpf,
		      ...
		      AND rh01_regist NOT IN
                        (SELECT si198_codvinculopessoa
                         FROM viap102023 where si198_mes < {$iMes} )
