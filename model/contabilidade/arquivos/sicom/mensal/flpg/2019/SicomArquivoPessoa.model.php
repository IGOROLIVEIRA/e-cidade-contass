...
require_once ("classes/db_pessoaflpgo102019_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2019/flpg/GerarPESSOA.model.php");
...
class SicomArquivoPessoa extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados(){
         ...
         */
        $clpessoa = new cl_pessoaflpgo102019();
...
WHERE (z01_cgccpf != '00000000000'
 ...
 AND   rh01_sicom = 1
  ...
  INNER JOIN rhpessoalmov ON rh01_regist = rh02_regist and rh02_mesusu=01 and rh02_anousu=2019
  ...
  ";
        ...
        for ($iCont = 0; $iCont < pg_num_rows($rsResult); $iCont++) {
            ...
            if(($this->sDataFinal['5'].$this->sDataFinal['6']) != '01' && db_getsession("DB_anousu") != 2019){
