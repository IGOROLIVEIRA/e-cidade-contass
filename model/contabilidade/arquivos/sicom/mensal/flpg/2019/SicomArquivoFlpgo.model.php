...
require_once ("classes/db_flpgo102019_classe.php");
require_once ("classes/db_flpgo112019_classe.php");
require_once ("classes/db_flpgo122019_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2019/flpg/GerarFLPGO.model.php");
...
class SicomArquivoFlpgo extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  function convert_accented_characters($str){
	...
	public function gerarDados() {
		...
		$clflpgo11 = new cl_flpgo112019();
		$clflpgo12 = new cl_flpgo122019();
