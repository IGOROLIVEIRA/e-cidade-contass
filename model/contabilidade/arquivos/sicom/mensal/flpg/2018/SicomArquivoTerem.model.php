...
require_once ("classes/db_terem102018_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2018/flpg/GerarTEREM.model.php");
...
//    $sSql .= " and round(te01_valor,2) not in (select round(si194_vlrparateto,2) from terem102018 where si194_mes <= ".($this->sDataFinal['5'].$this->sDataFinal['6'])." )";
