...
require_once ("classes/db_dispensa102015_classe.php");
require_once ("classes/db_dispensa112015_classe.php");
require_once ("classes/db_dispensa122015_classe.php");
require_once ("classes/db_dispensa132015_classe.php");
require_once ("classes/db_dispensa142015_classe.php");
require_once ("classes/db_dispensa152015_classe.php");
require_once ("classes/db_dispensa162015_classe.php");
require_once ("classes/db_dispensa172015_classe.php");
require_once ("classes/db_dispensa182015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarDISPENSA.model.php");
...
class SicomArquivoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	 ...
  	 */
  	$dispensa10 = new cl_dispensa102015();
  	$dispensa11 = new cl_dispensa112015();
  	$dispensa12 = new cl_dispensa122015();
  	$dispensa13 = new cl_dispensa132015();
  	$dispensa14 = new cl_dispensa142015();
  	$dispensa15 = new cl_dispensa152015();
  	$dispensa16 = new cl_dispensa162015();
  	$dispensa17 = new cl_dispensa172015();
  	$dispensa18 = new cl_dispensa182015();
...
join orcunidade on db01_orgao=o41_orgao and db01_unidade=o41_unidade and db01_anousu = o41_anousu
	where db01_coddepto=l20_codepartamento and db01_anousu=".db_getsession("DB_anousu")." limit 1) as x) as codUnidadeSubResp,
		...
		liclicita.l20_edital as nroProcessoLicitatorio,
		pctipocompratribunal.l44_codigotribunal as tipoProcesso,
		dispensa112015.si75_nrolote as nroLote,
		(pcmater.pc01_codmater::varchar || (case when matunid.m61_codmatunid is null then 1 else matunid.m61_codmatunid end)::varchar) as codItem
		FROM liclicitem
		INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
		INNER JOIN liclicita on (liclicitem.l21_codliclicita=liclicita.l20_codigo)
		INNER JOIN dispensa112015 on (liclicitemlote.l04_descricao = dispensa112015.si75_dsclote and dispensa112015.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
...
join orcunidade on db01_orgao=o41_orgao and db01_unidade=o41_unidade and db01_anousu = o41_anousu
	where db01_coddepto=l20_codepartamento and db01_anousu=".db_getsession("DB_anousu")." limit 1) as x) as codUnidadeSubResp,
		...
		LEFT  JOIN dispensa112015 on (liclicitemlote.l04_descricao = dispensa112015.si75_dsclote and dispensa112015.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
