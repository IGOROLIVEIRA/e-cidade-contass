...
require_once ("classes/db_arc102015_classe.php");
require_once ("classes/db_arc112015_classe.php");
require_once ("classes/db_arc122015_classe.php");
require_once ("classes/db_arc202015_classe.php");
require_once ("classes/db_arc212015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarARC.model.php");
