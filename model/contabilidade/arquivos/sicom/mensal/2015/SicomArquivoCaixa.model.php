...
require_once ("classes/db_caixa102015_classe.php");
require_once ("classes/db_caixa112015_classe.php");
require_once ("classes/db_caixa122015_classe.php");
require_once ("classes/db_caixa132015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCAIXA.model.php");
...
class SicomArquivoCaixa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clcaixa13 = new cl_caixa132015();
    $clcaixa12 = new cl_caixa122015();
    $clcaixa11 = new cl_caixa112015();
    $clcaixa10 = new cl_caixa102015();
    ...
    for ($iCont = 0;$iCont < pg_num_rows($rsContasCaixa); $iCont++) {
        ...
        db_inicio_transacao();
    	  ...
    	  $oDadosCaixa = new cl_caixa102015();
    	  ...
    	  $oDadosSaldoCaixa = new cl_caixa112015();    	
