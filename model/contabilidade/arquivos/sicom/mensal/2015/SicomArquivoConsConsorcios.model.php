...
require_once ("classes/db_consor102015_classe.php");
require_once ("classes/db_consor202015_classe.php");
require_once ("classes/db_consor302015_classe.php");
require_once ("classes/db_consor402015_classe.php");
require_once ("classes/db_consor502015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados(){
  	 ...
  	 */
  	$clconsor10 = new cl_consor102015();
  	$clconsor20 = new cl_consor202015();
  	$clconsor30 = new cl_consor302015();
  	$clconsor40 = new cl_consor402015();
  	$clconsor50 = new cl_consor502015();
