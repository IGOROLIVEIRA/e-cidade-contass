...
require_once ("classes/db_ntf102015_classe.php");
require_once ("classes/db_ntf112015_classe.php");
require_once ("classes/db_ntf202015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarNTF.model.php");
...
class SicomArquivoNotasFiscais extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$clntf10 = new cl_ntf102015();
    $clntf11 = new cl_ntf112015();
    $clntf20 = new cl_ntf202015();
...
where e55_item = pcmater.pc01_codmater and e55_autori = empautoriza.e54_autori limit 1) )::varchar  AS coditem,
      ...
      for ($iCont11 = 0; $iCont11 < pg_num_rows($rsResult11); $iCont11++) {
        ...
        if (!isset($aDadosAgrupados11[$sHash11])) {
        	...
        	$oNtf112015 = new stdClass();
        	$oNtf112015->si144_tiporegistro           = 11;
          $oNtf112015->si144_reg10                  = $clntf10->si143_sequencial;
          $oNtf112015->si144_codnotafiscal          = $oDados11->codnotafiscal;
          $oNtf112015->si144_coditem                = $oDados11->coditem;
          $oNtf112015->si144_quantidadeitem         = $oDados11->quantidadeitem;
          $oNtf112015->si144_valorunitarioitem      = $oDados11->valorunitarioitem;
          $oNtf112015->si144_mes                    = $this->sDataFinal['5'].$this->sDataFinal['6'];
          $oNtf112015->si144_instit                 = db_getsession("DB_instit");
          $aDadosAgrupados11[$sHash11] = $oNtf112015;
