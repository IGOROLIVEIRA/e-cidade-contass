...
require_once ("classes/db_rsp102015_classe.php");
require_once ("classes/db_rsp112015_classe.php");
require_once ("classes/db_rsp122015_classe.php");
require_once ("classes/db_rsp202015_classe.php");
require_once ("classes/db_rsp212015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarRSP.model.php");
...
class SicomArquivoRestosPagar extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clrsp11 = new cl_rsp112015();
    $clrsp12 = new cl_rsp122015();
    $clrsp20 = new cl_rsp202015();
    $clrsp21 = new cl_rsp212015();
