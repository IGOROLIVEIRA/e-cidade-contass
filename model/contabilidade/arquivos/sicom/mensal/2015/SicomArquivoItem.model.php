...
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarITEM.model.php");
...
WHERE DATE_PART ('MONTH' , si172_dataassinatura) = ".$this->sDataFinal['5'].$this->sDataFinal['6']."
  ...
  SELECT distinct '10' AS tipoRegistro ,
    ...
    for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
    	...
    	$sSqlitem  ="select si43_coditem,si43_unidademedida from item102015  where si43_coditem=".$oDados10->coditem." and si43_mes <= ".$this->sDataFinal['5'].$this->sDataFinal['6'];
    	$sSqlitem .=" union 
