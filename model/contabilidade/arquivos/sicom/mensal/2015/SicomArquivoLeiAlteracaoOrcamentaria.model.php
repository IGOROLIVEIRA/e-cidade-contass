...
require_once("classes/db_lao102015_classe.php");
require_once("classes/db_lao112015_classe.php");
require_once("classes/db_lao202015_classe.php");
require_once("classes/db_lao212015_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarLAO.model.php");
...
class SicomArquivoLeiAlteracaoOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $cllao10 = new cl_lao102015();
        $cllao11 = new cl_lao112015();
        $cllao20 = new cl_lao202015();
        $cllao21 = new cl_lao212015();
