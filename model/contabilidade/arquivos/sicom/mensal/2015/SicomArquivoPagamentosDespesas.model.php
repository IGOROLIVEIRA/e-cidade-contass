...
require_once ("classes/db_ops102015_classe.php");
require_once ("classes/db_ops112015_classe.php");
require_once ("classes/db_ops122015_classe.php");
require_once ("classes/db_ops132015_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarOPS.model.php");
 /**
...
class SicomArquivoPagamentosDespesas extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clops11 = new cl_ops112015();
    $clops12 = new cl_ops122015();
    $clops13 = new cl_ops132015();
