...
require_once ("classes/db_parpps102015_classe.php");
require_once ("classes/db_parpps202015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/SicomArquivoBase.model.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarPARPPS.model.php");
...
class SicomArquivoProjecaoAtuarial extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$clparpps10 = new cl_parpps102015();
    $clparpps20 = new cl_parpps202015();
