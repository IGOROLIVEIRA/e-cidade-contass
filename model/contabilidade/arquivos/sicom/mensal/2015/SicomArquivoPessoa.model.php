...
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarPESSOA.model.php");
    ...
    if (pg_num_rows($result) > 0) {
  	...
  	if ($this->sDataFinal['5'].$this->sDataFinal['6'] != 01) {
  		...
  		$sSql  = "select distinct case when length(z01_cgccpf) < 11 then lpad(z01_cgccpf, 11, '0') else z01_cgccpf end as z01_cgccpf, 
					 ...
					 and z01_cgccpf not in (select si12_nrodocumento from pessoa102015 where si12_mes < ".($this->sDataFinal['5'].$this->sDataFinal['6']).")
