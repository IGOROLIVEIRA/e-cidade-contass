...
require_once("classes/db_cvc102015_classe.php");
require_once("classes/db_cvc202015_classe.php");
require_once("classes/db_cvc302015_classe.php");
require_once("classes/db_cvc402015_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCVC.model.php");
...
class SicomArquivoCadastroVeiculos extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
         ...
         */
        $clcvc10 = new cl_cvc102015();
        $clcvc20 = new cl_cvc202015();
        $clcvc30 = new cl_cvc302015();
        $clcvc40 = new cl_cvc402015();
        ...
        if (pg_num_rows($rsResult10) != 0) {
            for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
                ...
                $sSqlVerifica = "select si146_sequencial from cvc102015 where si146_codveiculo = '{$oDados10->codveiculo}'
