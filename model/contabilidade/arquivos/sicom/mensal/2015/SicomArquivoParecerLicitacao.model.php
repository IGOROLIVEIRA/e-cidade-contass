...
require_once ("classes/db_parelic102015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarPARELIC.model.php");
...
class SicomArquivoParecerLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  /**
  	 ...
  	 */
  	$clparelic10 = new cl_parelic102015();
