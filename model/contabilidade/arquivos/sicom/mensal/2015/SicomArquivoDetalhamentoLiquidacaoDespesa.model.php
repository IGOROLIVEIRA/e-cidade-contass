...
require_once ("classes/db_lqd102015_classe.php");
require_once ("classes/db_lqd112015_classe.php");
require_once ("classes/db_lqd122015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarLQD.model.php");
 /**
...
class SicomArquivoDetalhamentoLiquidacaoDespesa extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cllqd11 = new cl_lqd112015();
  	$cllqd12 = new cl_lqd122015();
