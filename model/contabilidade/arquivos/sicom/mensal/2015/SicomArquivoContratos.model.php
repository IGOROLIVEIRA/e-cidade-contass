...
require_once ("classes/db_contratos102015_classe.php");
require_once ("classes/db_contratos112015_classe.php");
require_once ("classes/db_contratos122015_classe.php");
require_once ("classes/db_contratos132015_classe.php");
require_once ("classes/db_contratos202015_classe.php");
require_once ("classes/db_contratos212015_classe.php");
require_once ("classes/db_contratos302015_classe.php");
require_once ("classes/db_contratos402015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCONTRATOS.model.php");
...
where si173_codcontrato = '".$oDados10->si172_sequencial."'";
      ...
      if (count($aDadosAgrupados) > 0) {
        $sSql = "UPDATE contratos102015 set si83_vlcontrato = (
        SELECT SUM(si84_valorunitarioitem*si84_quantidadeitem)
        FROM contratos112015 WHERE si84_reg10 = {$clcontratos10->si83_sequencial}) WHERE si83_sequencial = {$clcontratos10->si83_sequencial}";
