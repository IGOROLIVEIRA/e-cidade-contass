...
require_once ("classes/db_rec102015_classe.php");
require_once ("classes/db_rec112015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarREC.model.php");
...
class SicomArquivoDetalhamentoReceitasMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    /**
  	 ...
  	 */
  	$clrec10 = new cl_rec102015();
  	$clrec11 = new cl_rec112015();
