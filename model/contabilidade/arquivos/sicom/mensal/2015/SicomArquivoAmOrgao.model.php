...
require_once ("classes/db_orgao102015_classe.php");
require_once ("classes/db_orgao112015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarORGAO.model.php");
...
class SicomArquivoAmOrgao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$clorgao10 = new cl_orgao102015();
  	$clorgao11 = new cl_orgao112015();
