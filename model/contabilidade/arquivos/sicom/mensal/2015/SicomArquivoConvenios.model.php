...
require_once ("classes/db_conv102015_classe.php");
require_once ("classes/db_conv112015_classe.php");
require_once ("classes/db_conv202015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCONV.model.php");
...
class SicomArquivoConvenios extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $clconv10 = new cl_conv102015();
    $clconv11 = new cl_conv112015();
    $clconv20 = new cl_conv202015();
