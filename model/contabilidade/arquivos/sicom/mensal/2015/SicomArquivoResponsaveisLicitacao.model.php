...
require_once ("classes/db_resplic102015_classe.php");
require_once ("classes/db_resplic202015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarRESPLIC.model.php");
...
class SicomArquivoResponsaveisLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
 ...
 public function gerarDados(){
  	...
  	$clresplic20 = new cl_resplic202015();
