...
require_once ("classes/db_ctb102015_classe.php");
require_once ("classes/db_ctb202015_classe.php");
require_once ("classes/db_ctb212015_classe.php");
require_once ("classes/db_ctb222015_classe.php");
require_once ("classes/db_ctb302015_classe.php");
require_once ("classes/db_ctb312015_classe.php");
require_once ("classes/db_ctb402015_classe.php");
require_once ("classes/db_ctb412015_classe.php");
require_once ("classes/db_ctb502015_classe.php");
require_once ("classes/db_ctb602015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarCTB.model.php");
...
class SicomArquivoContasBancarias extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$cCtb10 = new cl_ctb102015();
	$cCtb20 = new cl_ctb202015();
	$cCtb21 = new cl_ctb212015();
	$cCtb22 = new cl_ctb222015();
	$cCtb30 = new cl_ctb302015();
	$cCtb31 = new cl_ctb312015();
	$cCtb40 = new cl_ctb402015();
	$cCtb41 = new cl_ctb412015();
	$cCtb50 = new cl_ctb502015();
   ...
   /**
    ...
    $sSqlContaJainformada ="select si95_codorgao||si95_banco||si95_agencia||si95_digitoverificadoragencia||si95_contabancaria
          					 ...
          					 from ctb102015 where si95_mes < ".$this->sDataFinal['5'].$this->sDataFinal['6'];
    ...
    for ($iCont = 0;$iCont < pg_num_rows($rsContas); $iCont++) {
      ...
      if($oRegistro10->si09_tipoinstit != 5){
          ...
          AND si95_digitoverificadorcontabancaria = '$oRegistro10->c63_dvconta' AND si95_tipoconta = '$oRegistro10->tipoconta' and si95_instit = ".db_getsession('DB_instit');
			$sSqlVerifica .= " UNION ALL SELECT * FROM ctb102014 WHERE si95_codctb = ".$cCtb10->si95_codctb." and si95_instit = ".db_getsession('DB_instit');
