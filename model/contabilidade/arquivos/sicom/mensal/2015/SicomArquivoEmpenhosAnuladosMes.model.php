...
require_once ("classes/db_anl102015_classe.php");
require_once ("classes/db_anl112015_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	...
  	$regitro10 = new cl_anl102015();
  	$regitro11 = new cl_anl112015();
    ...
    if ($oEmpenhoAnulado->subunidade != '' && $oEmpenhoAnulado->subunidade != 0) {
    	...
    	$oDadosEmpenhoAnulado = new cl_anl102015();
	    ...
	    $oDadosEmpenhoAnuladoFonte = new cl_anl112015();
