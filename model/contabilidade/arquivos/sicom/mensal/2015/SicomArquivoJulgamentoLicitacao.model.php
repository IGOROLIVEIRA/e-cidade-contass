...
require_once ("classes/db_julglic102015_classe.php");
require_once ("classes/db_julglic202015_classe.php");
require_once ("classes/db_julglic302015_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2015/GerarJULGLIC.model.php");
...
class SicomArquivoJulgamentoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
  	 ...
  	 */
  	$cljulglic10 = new cl_julglic102015();
  	$cljulglic20 = new cl_julglic202015();
  	$cljulglic30 = new cl_julglic302015();
