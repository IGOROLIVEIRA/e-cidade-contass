...
require_once("classes/db_consor202022_classe.php");
require_once("classes/db_consor302022_classe.php");
require_once("classes/db_consor402022_classe.php");
require_once("classes/db_consor502022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clconsor10 = new cl_consor102022();
    $clconsor20 = new cl_consor202022();
    $clconsor30 = new cl_consor302022();
    $clconsor40 = new cl_consor402022();
    $clconsor50 = new cl_consor502022();
