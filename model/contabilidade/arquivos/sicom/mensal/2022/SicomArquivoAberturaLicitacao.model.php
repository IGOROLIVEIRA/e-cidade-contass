...
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarABERLIC.model.php");
...
class SicomArquivoAberturaLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
         ...
         */
        $claberlic10 = new cl_aberlic102022();
        $claberlic11 = new cl_aberlic112022();
        $claberlic12 = new cl_aberlic122022();
        $claberlic13 = new cl_aberlic132022();
        $claberlic14 = new cl_aberlic142022();
        $claberlic15 = new cl_aberlic152022();
        $claberlic16 = new cl_aberlic162022();
