...
require_once("classes/db_alq102022_classe.php");
require_once("classes/db_alq112022_classe.php");
require_once("classes/db_alq122022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarALQ.model.php");
...
class SicomArquivoDetalhamentoAnulacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
   ...
   $sSql = "SELECT e50_data,
    ...
    $clalq10 = new cl_alq102022();
    $clalq11 = new cl_alq112022();
    $clalq12 = new cl_alq122022();
