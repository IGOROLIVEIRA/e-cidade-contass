...
require_once ("classes/db_aex102022_classe.php");
//require_once ("classes/db_aex112022_classe.php");

require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarAEX.model.php");
...
class SicomArquivoAnulacaoExtraOrcamentariaPorFonte extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $cAex10 = new cl_aex102022();
  	
    //$cAex11 = new cl_aex112022();
