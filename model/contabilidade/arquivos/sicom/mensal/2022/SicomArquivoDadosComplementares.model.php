...
require_once ("classes/db_dclrf102022_classe.php");
require_once ("classes/db_dclrf112022_classe.php");
require_once ("classes/db_dclrf202022_classe.php");
require_once ("classes/db_dclrf302022_classe.php");
require_once ("classes/db_dclrf402022_classe.php");
...
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarDCLRF.model.php");
...
class SicomArquivoDadosComplementares extends SicomArquivoBase implements iPadArquivoBaseCSV {
    ...
    public function gerarDados() {
        ...
        $cldclrf10                  = new cl_dclrf102022();
        $cldclrf11                  = new cl_dclrf112022();
        $cldclrf20                  = new cl_dclrf202022();
        $cldclrf30                  = new cl_dclrf302022();
        $cldclrf40                  = new cl_dclrf402022();
