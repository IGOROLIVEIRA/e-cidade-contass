...
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarDISPENSA.model.php");
...
class SicomArquivoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $dispensa11 = new cl_dispensa112022();
    $dispensa12 = new cl_dispensa122022();
    $dispensa13 = new cl_dispensa132022();
    $dispensa14 = new cl_dispensa142022();
    $dispensa15 = new cl_dispensa152022();
    $dispensa16 = new cl_dispensa162022();
    $dispensa17 = new cl_dispensa172022();
    $dispensa18 = new cl_dispensa182022();
  ...
  l20_leidalicitacao,
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
	...
	liclicita.l20_veicdivulgacao as veiculoPublicacao,
	 (CASE
        WHEN liclicita.l20_cadInicial is null or liclicita.l20_cadInicial = 0 and liclicita.l20_anousu >= 2022 THEN 1
  ...
  WHERE db_config.codigo= " . db_getsession("DB_instit") . "
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
		...
		liclicita.l20_edital as nroProcessoLicitatorio,
		pctipocompratribunal.l44_codigotribunal as tipoProcesso,
		dispensa112022.si75_nrolote as nroLote,
		(pcmater.pc01_codmater::varchar || (case when matunid.m61_codmatunid is null then 1 else matunid.m61_codmatunid end)::varchar) as codItem,
		manutencaolicitacao.manutlic_codunidsubanterior AS codunidsubant
    FROM liclicitem
		INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
		INNER JOIN liclicita on (liclicitem.l21_codliclicita=liclicita.l20_codigo)
		INNER JOIN dispensa112022 on (liclicitemlote.l04_descricao = dispensa112022.si75_dsclote and dispensa112022.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
    ...
    manutencaolicitacao.manutlic_codunidsubanterior AS codunidsubant
		...
		LEFT  JOIN dispensa112022 on (liclicitemlote.l04_descricao = dispensa112022.si75_dsclote and dispensa112022.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
