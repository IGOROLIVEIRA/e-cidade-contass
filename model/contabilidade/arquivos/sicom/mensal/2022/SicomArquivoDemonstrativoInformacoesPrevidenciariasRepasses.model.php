   ...
   */
    ...
    public function gerarDados()
    {
        ...
        */
        ...
        $sSql = "SELECT * FROM dipr WHERE c236_orgao = " . db_getsession("DB_instit") . " AND not exists (select 1 from dipr102022 where si230_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si230_instit = " . db_getsession("DB_instit") . " AND si230_coddipr = c236_coddipr );";
