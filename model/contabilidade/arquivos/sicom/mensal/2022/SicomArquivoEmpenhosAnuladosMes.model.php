...
require_once("classes/db_anl102022_classe.php");
require_once("classes/db_anl112022_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $regitro10 = new cl_anl102022();
        $regitro11 = new cl_anl112022();
  	 ...
  	 si08_anousu = " . db_getsession("DB_anousu") . " and si08_instit = " . db_getsession("DB_instit");
        ...
        for ($iCont = 0; $iCont < pg_num_rows($rsEmpenhoAnulados); $iCont++) {
            ...
            $oDadosEmpenhoAnulado = new cl_anl102022();
            ...
            $oDadosEmpenhoAnuladoFonte = new cl_anl112022();
