...
require_once("classes/db_reglic202022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarREGLIC.model.php");
...
class SicomArquivoLegislacaoMunicipalLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clreglic10 = new cl_reglic102022();
    $clreglic20 = new cl_reglic202022();
  ...
  (select si44_nrodecretomunicipal from reglic102022
   UNION 
   select si44_nrodecretomunicipal from reglic102022
   UNION
   select si44_nrodecretomunicipal from reglic102022
   ...
   select si44_nrodecretomunicipal from reglic102022
   UNION
   select si44_nrodecretomunicipal from reglic102022 where si44_mes <= " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . ") 
    AND DATE_PART ( 'YEAR' , l201_datapublicacao ) = '2022'
