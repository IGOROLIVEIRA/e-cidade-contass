...
require_once("classes/db_ops102022_classe.php");
require_once("classes/db_ops112022_classe.php");
require_once("classes/db_ops122022_classe.php");
require_once("classes/db_ops132022_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarOPS.model.php");
...
class SicomArquivoPagamentosDespesas extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clops10 = new cl_ops102022();
    $clops11 = new cl_ops112022();
    $clops12 = new cl_ops122022();
    $clops13 = new cl_ops132022();
      ...
      if (db_utils::fieldsMemory($rsQuantExtornos, 0)->valor == "" || db_utils::fieldsMemory($rsQuantExtornos, 0)->valor > 0) {
        ...
        if (!isset($aInformado[$sHash])) {
          ...
          $sSql11 = " SELECT tiporegistro, codreduzidoop, codunidadesub, nroop, tipopagamento, nroempenho, dtempenho, nroliquidacao, dtliquidacao,
                      ...
                      FROM
                          (SELECT 11 AS tiporegistro,
                                  ...
                                  CASE
                                      WHEN date_part('year',e50_data) < 2022 THEN e71_codnota::varchar /*nao alterar esse ano*/
          ...
          if (pg_num_rows($rsPagOrd12) > 0 && $reg12->codctb != '') {
            ...
            $sSqlContaPagFont = "select * from ( select distinct 'ctb102022' as ano, si95_codctb  as contapag, o15_codtri as fonte from conplanoconta
          ...
          $sSql11 = " SELECT tiporegistro, codreduzidoop, codunidadesub, nroop, tipopagamento, nroempenho, dtempenho, nroliquidacao, dtliquidacao,
                      ...
                      FROM
                          (SELECT 11 AS tiporegistro,
                                  ...
                                  e60_emiss AS dtempenho,
                                  CASE
                                      WHEN date_part('year',e50_data) < 2022 THEN e71_codnota::varchar
                                      ELSE (rpad(e71_codnota::varchar,9,'0') || lpad(e71_codord::varchar,9,'0'))
                                  END AS nroliquidacao,
                                  e50_data AS dtliquidacao,
                                  o15_codtri AS codfontrecursos,
