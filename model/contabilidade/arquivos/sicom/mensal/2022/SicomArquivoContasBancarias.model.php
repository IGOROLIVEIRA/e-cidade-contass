...
require_once("classes/db_ctb102022_classe.php");
require_once("classes/db_ctb202022_classe.php");
require_once("classes/db_ctb212022_classe.php");
require_once("classes/db_ctb222022_classe.php");
require_once("classes/db_ctb302022_classe.php");
require_once("classes/db_ctb312022_classe.php");
require_once("classes/db_ctb402022_classe.php");
require_once("classes/db_ctb412022_classe.php");
require_once("classes/db_ctb502022_classe.php");
require_once("classes/db_ctb602022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarCTB.model.php");
...
class SicomArquivoContasBancarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cCtb10 = new cl_ctb102022();
    $cCtb20 = new cl_ctb202022();
    $cCtb21 = new cl_ctb212022();
    $cCtb22 = new cl_ctb222022();
    $cCtb30 = new cl_ctb302022();
    $cCtb31 = new cl_ctb312022();
    $cCtb40 = new cl_ctb402022();
    $cCtb41 = new cl_ctb412022();
    $cCtb50 = new cl_ctb502022();
    ...
    if (pg_num_rows($rsCtasReg40) != 0) {
      ...
      for ($icont40 = 0; $icont40 < pg_num_rows($rsCtasReg40); $icont40++) {
        ...
        $sSql40 = "SELECT 'ctb402022' AS ano, ctb402022.* FROM ctb402022
