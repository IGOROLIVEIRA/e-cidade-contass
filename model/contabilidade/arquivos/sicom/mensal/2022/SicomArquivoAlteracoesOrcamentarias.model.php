...
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarAOC.model.php");
...
class SicomArquivoAlteracoesOrcamentarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $claoc10 = new cl_aoc102022();
        $claoc11 = new cl_aoc112022();
        $claoc12 = new cl_aoc122022();
        $claoc13 = new cl_aoc132022();
        $claoc14 = new cl_aoc142022();
        $claoc15 = new cl_aoc152022();
            ...
            if($oDadosSql14->tipodecretoalteracao == 98 && in_array($sTipoDecretoReg11, $aTipoDecretoNaoObrigReg15)){
                ...
                foreach ($aDadosAgrupados15 as $oDadosReg14) {
                    ...
                    if ($claoc14->erro_status == 0) {
                         ...
                         * Novo Registro Inserido a partir de 2022, conforme layout Versão 8.0_2022
                         *
                         */
