...
require_once("classes/db_hablic202022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarHABLIC.model.php");
...
class SicomArquivoHabilitacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $clhablic11 = new cl_hablic112022();
        $clhablic20 = new cl_hablic202022();
        ...
        if (pg_num_rows($result) > 0) {
            ...
            if ($clconsor202022->erro_status == 0) {
