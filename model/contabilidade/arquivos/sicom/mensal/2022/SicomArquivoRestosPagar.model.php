...
require_once("classes/db_rsp102022_classe.php");
require_once("classes/db_rsp112022_classe.php");
require_once("classes/db_rsp122022_classe.php");
require_once("classes/db_rsp202022_classe.php");
require_once("classes/db_rsp212022_classe.php");
require_once("classes/db_rsp222022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarRSP.model.php");
...
class SicomArquivoRestosPagar extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clrsp10 = new cl_rsp102022();
    $clrsp11 = new cl_rsp112022();
    $clrsp12 = new cl_rsp122022();
    $clrsp20 = new cl_rsp202022();
    $clrsp21 = new cl_rsp212022();
    $clrsp22 = new cl_rsp222022();
