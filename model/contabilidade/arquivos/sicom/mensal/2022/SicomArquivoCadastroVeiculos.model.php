...
require_once("classes/db_cvc202022_classe.php");
require_once("classes/db_cvc302022_classe.php");
require_once("classes/db_cvc402022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarCVC.model.php");
...
class SicomArquivoCadastroVeiculos extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
         ...
         */
        $clcvc10 = new cl_cvc102022();
        $clcvc20 = new cl_cvc202022();
        $clcvc30 = new cl_cvc302022();
        $clcvc40 = new cl_cvc402022();
      ...
      AND veicbaixa.ve04_veiccadtipobaixa != 7
        ...
        and si146_mes <= " . $this->sDataFinal['5'] . $this->sDataFinal['6'];
                ...
                $sSqlNaoRepete = "
          select * from cvc102022 where si146_codveiculo = '{$oDados10->codveiculo}' and si146_codunidadesub = '{$oDados10->ve01_codunidadesub}'
        ";
