...
require_once("classes/db_regadesao102022_classe.php");
require_once("classes/db_regadesao112022_classe.php");
require_once("classes/db_regadesao122022_classe.php");
require_once("classes/db_regadesao132022_classe.php");
require_once("classes/db_regadesao142022_classe.php");
require_once("classes/db_regadesao152022_classe.php");
require_once("classes/db_regadesao202022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarREGADESAO.model.php");
...
class SicomArquivoAdesaoRegistroPrecos extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $regadesao10 = new cl_regadesao102022();
