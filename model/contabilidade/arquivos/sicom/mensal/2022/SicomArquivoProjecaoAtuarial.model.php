...
require_once("classes/db_parpps202022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarPARPPS.model.php");
...
class SicomArquivoProjecaoAtuarial extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $clparpps10 = new cl_parpps102022();
        $clparpps20 = new cl_parpps202022();
