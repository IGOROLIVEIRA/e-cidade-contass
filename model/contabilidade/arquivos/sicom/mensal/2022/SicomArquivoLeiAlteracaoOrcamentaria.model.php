...
require_once("classes/db_lao202022_classe.php");
require_once("classes/db_lao212022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarLAO.model.php");
...
class SicomArquivoLeiAlteracaoOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cllao10 = new cl_lao102022();
    $cllao11 = new cl_lao112022();
    $cllao20 = new cl_lao202022();
    $cllao21 = new cl_lao212022();
