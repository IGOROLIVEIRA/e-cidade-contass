...
require_once("classes/db_resplic202022_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarRESPLIC.model.php");
...
class SicomArquivoResponsaveisLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
         ...
         */
        $clresplic10 = new cl_resplic102022();
        $clresplic20 = new cl_resplic202022();
