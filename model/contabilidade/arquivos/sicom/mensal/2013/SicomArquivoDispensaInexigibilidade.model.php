...
class SicomArquivoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    /**
	  ...
	  $sSql = "select l20_codigo,l20_anousu,l20_numero,l20_dataaber,l20_datacria,l20_dtpublic,l20_objeto, l44_codigotribunal 
		from liclicita 
		...
		and l44_sequencial in (101,102)";
    
    $rsDispensaInex = db_query($sSql);
    ...
    for ($iCont = 0;$iCont < pg_num_rows($rsDispensaInex); $iCont++) {
      ...
      foreach ($oDadosComplLicitacoes as $oDadosComplLicitacao ) {
          ...
          $oDadosDispensaInex->justificativa          			=  substr($oDadosComplLicitacao->getAttribute('justificativa'), 0, 250);
          $oDadosDispensaInex->razao          					 	  =  substr($oDadosComplLicitacao->getAttribute('razao'), 0, 250);;
     ...
     */
      ...
      if (pg_num_rows($rsDetaPesq) == 0) {
      	...
      	$sSql3 = "select pc01_codmater,pc01_descrmater,e62_vlrun from empempenho join empempitem on e60_numemp = e62_numemp
join pcmater on e62_item = pc01_codmater where e60_numerol = '".$sNumerol."'";
          ...
          $oDadosDetaPesq->vlCotPrecosUnitario =  number_format($oDetaPesq->e62_vlrun, 2, "", "");
            
          $this->aDados[] = $oDadosDetaPesq;
     ...
     */
      ...
      $sSql5 = "select z01_nome,pc01_descrmater,pc01_codmater,pc11_quant,pc23_valor, z01_cgccpf
	  from pcorcamjulg 
          ...
          if ($oDadosComplLicitacao->getAttribute('instituicao') == db_getsession("DB_instit")
              ...
              if ($oHabilitacao->getAttribute('instituicao') == db_getsession("DB_instit")
                ...
                $oDadosDetaForn = new stdClass();
		            ...
		            $oDadosDetaForn->nroItem           					        =  str_pad($oDetaForn->pc01_codmater, 4, "0", STR_PAD_LEFT);
        ...
        foreach ($oDadosComplLicitacoes as $oDadosComplLicitacao ) {
          ...
          if ($oDadosComplLicitacao->getAttribute('instituicao') == db_getsession("DB_instit")
              ...
              if ($oHabilitacao->getAttribute('instituicao') == db_getsession("DB_instit")
        	      ...
        	      $sSqlItem = "select pc01_codmater,pc01_descrmater,e62_vlrun,e62_quant from empempenho join empempitem on e60_numemp = e62_numemp
join pcmater on e62_item = pc01_codmater where e60_numerol = '".$sNumerol."'";
