...
class SicomArquivoDetalhamentoAnulacao extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    for ($iCont = 0;$iCont < pg_num_rows($rsDetalhamentos); $iCont++) {
      ...
      $oDadosDetalhamento->vlAnulado					= number_format($oDetalhamento->c70_valor, 2, "", "");
      
      $this->aDados[] = $oDadosDetalhamento;
      ...
      $oDadosDetalhamentoFonte->valorAnuladoFonte  = number_format($oDetalhamento->c70_valor, 2, "", "");
      
      $this->aDados[] = $oDadosDetalhamentoFonte;
