...
class SicomArquivoConvenios extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
     ...
     */
    $result = $clconv112014->sql_record($clconv112014->sql_query(NULL,"*",NULL,"si93_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']));
    if (pg_num_rows($result) > 0) {
      
      $clconv112014->excluir(NULL,"si93_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']);
    ...
    $result = $clconv102014->sql_record($clconv102014->sql_query(NULL,"*",NULL,"si92_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']));
    if (pg_num_rows($result) > 0) {
      $clconv102014->excluir(NULL,"si92_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']);
     ...
     */
    $result = $clconv202014->sql_record($clconv202014->sql_query(NULL,"*",NULL,"si94_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']));
    if (pg_num_rows($result) > 0) {
      $clconv202014->excluir(NULL,"si94_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']);
     ...
     */
    $sSql   = "select * from convconvenios where c206_dataassinatura >= '{$this->sDataInicial}' and c206_dataassinatura <= '{$this->sDataFinal}'";
