...
require_once("classes/db_rsp102018_classe.php");
require_once("classes/db_rsp112018_classe.php");
require_once("classes/db_rsp122018_classe.php");
require_once("classes/db_rsp202018_classe.php");
require_once("classes/db_rsp212018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarRSP.model.php");
...
class SicomArquivoRestosPagar extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clrsp10 = new cl_rsp102018();
    $clrsp11 = new cl_rsp112018();
    $clrsp12 = new cl_rsp122018();
    $clrsp20 = new cl_rsp202018();
    $clrsp21 = new cl_rsp212018();
