...
require_once("classes/db_reglic102018_classe.php");
require_once("classes/db_reglic202018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarREGLIC.model.php");
...
class SicomArquivoLegislacaoMunicipalLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clreglic10 = new cl_reglic102018();
    $clreglic20 = new cl_reglic202018();
  ...
  UNION select si44_nrodecretomunicipal from reglic102018 where si44_mes <= " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . ") ";
