...
require_once("classes/db_orgao102018_classe.php");
require_once("classes/db_orgao112018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarORGAO.model.php");
...
class SicomArquivoAmOrgao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clorgao10 = new cl_orgao102018();
    $clorgao11 = new cl_orgao112018();
