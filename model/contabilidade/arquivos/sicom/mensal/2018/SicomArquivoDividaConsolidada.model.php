...
require_once("classes/db_ddc102018_classe.php");
require_once("classes/db_ddc202018_classe.php");
require_once("classes/db_ddc302018_classe.php");
require_once("classes/db_ddc402018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarDDC.model.php");
...
class SicomArquivoDividaConsolidada extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clddc10 = new cl_ddc102018();
    $clddc20 = new cl_ddc202018();
    $clddc30 = new cl_ddc302018();
    $clddc40 = new cl_ddc402018();
    ...
    */
    ...
    $sSql = "select * from dividaconsolidada where si167_mesreferencia = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "
             ...
             (select 1 from ddc102018  where si150_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si150_instit = " . db_getsession("DB_instit") . "
             and si150_nroleiautorizacao = si167_nroleiautorizacao and si150_dtleiautorizacao = si167_dtleiautorizacao
              union select 1 from ddc102015  where si150_nroleiautorizacao = si167_nroleiautorizacao and si150_dtleiautorizacao = si167_dtleiautorizacao
    ...
    $sSql = "select * from dividaconsolidada where si167_mesreferencia = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "
             and si167_anoreferencia = " . db_getsession("DB_anousu") . " and si167_instit = " . db_getsession("DB_instit") . " and not exists
             (select 1 from ddc202018  where si153_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si153_instit = " . db_getsession("DB_instit") . "
