...
require_once("classes/db_regadesao102018_classe.php");
require_once("classes/db_regadesao112018_classe.php");
require_once("classes/db_regadesao122018_classe.php");
require_once("classes/db_regadesao132018_classe.php");
require_once("classes/db_regadesao142018_classe.php");
require_once("classes/db_regadesao152018_classe.php");
require_once("classes/db_regadesao202018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarREGADESAO.model.php");
...
class SicomArquivoAdesaoRegistroPrecos extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $regadesao10 = new cl_regadesao102018();
    $regadesao11 = new cl_regadesao112018();
    $regadesao12 = new cl_regadesao122018();
    $regadesao13 = new cl_regadesao132018();
    $regadesao14 = new cl_regadesao142018();
    $regadesao15 = new cl_regadesao152018();
    $regadesao20 = new cl_regadesao202018();
    ...
    $sSql = "select adesaoregprecos.*,si06_anoproc as exercicioadesao,orgaogerenciador.z01_nome as nomeorgaogerenciador,responsavel.z01_cgccpf as cpfresponsavel,
