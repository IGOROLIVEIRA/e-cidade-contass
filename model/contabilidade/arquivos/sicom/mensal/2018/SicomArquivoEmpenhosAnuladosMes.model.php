...
require_once("classes/db_anl102018_classe.php");
require_once("classes/db_anl112018_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $regitro10 = new cl_anl102018();
    $regitro11 = new cl_anl112018();
   ...
   $sSql = "SELECT c70_codlan,
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsEmpenhoAnulados); $iCont++) {
      ...
      $oDadosEmpenhoAnulado = new cl_anl102018();
      ...
      $oDadosEmpenhoAnuladoFonte = new cl_anl112018();
