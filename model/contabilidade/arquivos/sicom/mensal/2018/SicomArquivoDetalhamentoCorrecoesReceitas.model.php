...
require_once("classes/db_arc102018_classe.php");
require_once("classes/db_arc112018_classe.php");
require_once("classes/db_arc122018_classe.php");
require_once("classes/db_arc202018_classe.php");
require_once("classes/db_arc212018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarARC.model.php");
