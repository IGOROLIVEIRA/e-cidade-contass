...
require_once("classes/db_aoc102018_classe.php");
require_once("classes/db_aoc112018_classe.php");
require_once("classes/db_aoc122018_classe.php");
require_once("classes/db_aoc132018_classe.php");
require_once("classes/db_aoc142018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarAOC.model.php");
...
class SicomArquivoAlteracoesOrcamentarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $claoc10 = new cl_aoc102018();
    $claoc11 = new cl_aoc112018();
    $claoc12 = new cl_aoc122018();
    $claoc13 = new cl_aoc132018();
    $claoc14 = new cl_aoc142018();
    ...
    group by o46_codlei, o39_numero,o46_tiposup";
         ...
         * registro 14
         */
        $sSql = "select distinct o46_codsup,'14' as tipoRegistro,
  o46_codlei as codReduzidoDecreto,
  (case when o46_tiposup = 1001 or o46_tiposup = 1006 then 3
       when o46_tiposup = 1002 then 4
       when o46_tiposup = 1003 then 1
