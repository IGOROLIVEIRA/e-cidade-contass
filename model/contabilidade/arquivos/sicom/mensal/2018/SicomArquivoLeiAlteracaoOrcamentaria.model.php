...
require_once("classes/db_lao102018_classe.php");
require_once("classes/db_lao112018_classe.php");
require_once("classes/db_lao202018_classe.php");
require_once("classes/db_lao212018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarLAO.model.php");
...
class SicomArquivoLeiAlteracaoOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cllao10 = new cl_lao102018();
    $cllao11 = new cl_lao112018();
    $cllao20 = new cl_lao202018();
    $cllao21 = new cl_lao212018();
