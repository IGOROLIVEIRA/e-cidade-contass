...
require_once ("classes/db_tce102018_classe.php");
require_once ("classes/db_tce112018_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarTCE.model.php");
 /**
...
class SicomArquivoTomadasContasEspeciais extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $tce102018 = new cl_tce102018();
    $tce112018 = new cl_tce112018();
    ...
    $result = $tce112018->sql_record($tce112018->sql_query(NULL,"*",NULL,"si188_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si188_instit = ".db_getsession("DB_instit") ));
    if (pg_num_rows($result) > 0) {
      $tce112018->excluir(NULL,"si188_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si188_instit = ".db_getsession("DB_instit"));
      if ($tce112018->erro_status == 0) {
        throw new Exception($tce112018->erro_msg);
      }
    }
    $result = $tce102018->sql_record($tce102018->sql_query(NULL,"*",NULL,"si187_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si187_instit = ".db_getsession("DB_instit") ));
    if (pg_num_rows($result) > 0) {
      $tce102018->excluir(NULL,"si187_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si187_instit = ".db_getsession("DB_instit"));
      if ($tce102018->erro_status == 0) {
        throw new Exception($tce102018->erro_msg);
      }
    }
