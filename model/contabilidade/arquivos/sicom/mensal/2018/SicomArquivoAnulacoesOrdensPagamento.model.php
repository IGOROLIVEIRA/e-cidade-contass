...
require_once("classes/db_aop102018_classe.php");
require_once("classes/db_aop112018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarAOP.model.php");
...
class SicomArquivoAnulacoesOrdensPagamento extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $claop10 = new cl_aop102018();
    $claop11 = new cl_aop112018();
   ...
   $sSql = "SELECT c71_coddoc,
    ...
    foreach ($aAnulacoes as $anulacao) {
      ...
      $oDadosAnulacao = new cl_aop102018();
      ...
      foreach ($anulacao->reg11 as $reg11) {
        ...
        $oDadosAnulacaoFonte = new cl_aop112018();
