...
require_once("classes/db_consor102018_classe.php");
require_once("classes/db_consor202018_classe.php");
require_once("classes/db_consor302018_classe.php");
require_once("classes/db_consor402018_classe.php");
require_once("classes/db_consor502018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clconsor10 = new cl_consor102018();
    $clconsor20 = new cl_consor202018();
    $clconsor30 = new cl_consor302018();
    $clconsor40 = new cl_consor402018();
    $clconsor50 = new cl_consor502018();
