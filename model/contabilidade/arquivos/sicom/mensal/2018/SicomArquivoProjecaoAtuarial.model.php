...
require_once("classes/db_parpps102018_classe.php");
require_once("classes/db_parpps202018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarPARPPS.model.php");
...
class SicomArquivoProjecaoAtuarial extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clparpps10 = new cl_parpps102018();
    $clparpps20 = new cl_parpps202018();
