...
require_once("classes/db_alq102018_classe.php");
require_once("classes/db_alq112018_classe.php");
require_once("classes/db_alq122018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarALQ.model.php");
