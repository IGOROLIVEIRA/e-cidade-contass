...
require_once("classes/db_julglic102018_classe.php");
require_once("classes/db_julglic202018_classe.php");
require_once("classes/db_julglic302018_classe.php");
require_once("classes/db_julglic402018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarJULGLIC.model.php");
...
class SicomArquivoJulgamentoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $cljulglic10 = new cl_julglic102018();
    $cljulglic20 = new cl_julglic202018();
    $cljulglic30 = new cl_julglic302018();
    $cljulglic40 = new cl_julglic402018();
  ...
  INNER JOIN cflicita ON (cflicita.l03_codigo = liclicita.l20_codtipocom)
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
    ...
    LEFT JOIN matunid AS matunid ON solicitemunid.pc17_unid = matunid.m61_codmatunid
	LEFT JOIN infocomplementaresinstit on db_config.codigo = infocomplementaresinstit.si09_instit
	WHERE db_config.codigo = " . db_getsession("DB_instit") . " AND liclicita.l20_criterioadjudicacao = 1
