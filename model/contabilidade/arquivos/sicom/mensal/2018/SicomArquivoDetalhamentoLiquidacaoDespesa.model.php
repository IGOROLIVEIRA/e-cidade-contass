...
require_once("classes/db_lqd102018_classe.php");
require_once("classes/db_lqd112018_classe.php");
require_once("classes/db_lqd122018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarLQD.model.php");
...
class SicomArquivoDetalhamentoLiquidacaoDespesa extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cllqd10 = new cl_lqd102018();
    $cllqd11 = new cl_lqd112018();
    $cllqd12 = new cl_lqd122018();
    ...
    e50_codord, e50_DATA, e60_anousu,e60_numemp,
                 e60_codemp, e60_emiss, e60_datasentenca, lpad((CASE WHEN o40_codtri = '0'
