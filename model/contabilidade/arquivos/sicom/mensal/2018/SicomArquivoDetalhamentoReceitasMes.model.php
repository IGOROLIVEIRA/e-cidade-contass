...
require_once("classes/db_rec102018_classe.php");
require_once("classes/db_rec112018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarREC.model.php");
