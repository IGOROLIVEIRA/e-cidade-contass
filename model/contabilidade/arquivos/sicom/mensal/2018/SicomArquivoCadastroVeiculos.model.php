...
require_once("classes/db_cvc102018_classe.php");
require_once("classes/db_cvc202018_classe.php");
require_once("classes/db_cvc302018_classe.php");
require_once("classes/db_cvc402018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarCVC.model.php");
  ...
  public function gerarDados()
  {
    ...
    if (pg_num_rows($rsResult10) > 0) {
      for ($iCont10 = 0; $iCont10 < pg_num_rows($rsResult10); $iCont10++) {
        ...
        $sSqlNaoRepete = "
          select * from cvc102018 where si146_codveiculo = '{$oDados10->codveiculo}' and si146_codunidadesub = '{$oDados10->ve01_codunidadesub}'
        ";
