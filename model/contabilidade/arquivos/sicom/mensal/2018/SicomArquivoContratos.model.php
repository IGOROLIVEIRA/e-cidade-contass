...
require_once("classes/db_contratos102018_classe.php");
require_once("classes/db_contratos112018_classe.php");
require_once("classes/db_contratos122018_classe.php");
require_once("classes/db_contratos132018_classe.php");
require_once("classes/db_contratos202018_classe.php");
require_once("classes/db_contratos212018_classe.php");
require_once("classes/db_contratos302018_classe.php");
require_once("classes/db_contratos402018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarCONTRATOS.model.php");
...
inner join liclicita on ltrim(((string_to_array(e60_numerol, '/'))[1])::varchar,'0') = l20_edital::varchar
    ...
    public function gerarDados()
    {
        ...
        $clcontratos10 = new cl_contratos102018();
        $clcontratos11 = new cl_contratos112018();
        $clcontratos12 = new cl_contratos122018();
        $clcontratos13 = new cl_contratos132018();
        $clcontratos20 = new cl_contratos202018();
        $clcontratos21 = new cl_contratos212018();
        $clcontratos30 = new cl_contratos302018();
        $clcontratos40 = new cl_contratos402018();
