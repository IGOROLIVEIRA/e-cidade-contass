...
require_once("classes/db_dispensa102018_classe.php");
require_once("classes/db_dispensa112018_classe.php");
require_once("classes/db_dispensa122018_classe.php");
require_once("classes/db_dispensa132018_classe.php");
require_once("classes/db_dispensa142018_classe.php");
require_once("classes/db_dispensa152018_classe.php");
require_once("classes/db_dispensa162018_classe.php");
require_once("classes/db_dispensa172018_classe.php");
require_once("classes/db_dispensa182018_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2018/GerarDISPENSA.model.php");
...
class SicomArquivoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $dispensa10 = new cl_dispensa102018();
    $dispensa11 = new cl_dispensa112018();
    $dispensa12 = new cl_dispensa122018();
    $dispensa13 = new cl_dispensa132018();
    $dispensa14 = new cl_dispensa142018();
    $dispensa15 = new cl_dispensa152018();
    $dispensa16 = new cl_dispensa162018();
    $dispensa17 = new cl_dispensa172018();
    $dispensa18 = new cl_dispensa182018();
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
		...
		liclicita.l20_edital as nroProcessoLicitatorio,
		pctipocompratribunal.l44_codigotribunal as tipoProcesso,
		dispensa112018.si75_nrolote as nroLote,
		(pcmater.pc01_codmater::varchar || (case when matunid.m61_codmatunid is null then 1 else matunid.m61_codmatunid end)::varchar) as codItem
		FROM liclicitem
		INNER JOIN liclicitemlote on (liclicitem.l21_codigo=liclicitemlote.l04_liclicitem)
		INNER JOIN liclicita on (liclicitem.l21_codliclicita=liclicita.l20_codigo)
		INNER JOIN dispensa112018 on (liclicitemlote.l04_descricao = dispensa112018.si75_dsclote and dispensa112018.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
   ...
   WHERE db01_coddepto=l20_codepartamento and db01_anousu=" . db_getsession("DB_anousu") . " LIMIT 1) as codUnidadeSubResp,
		...
		LEFT  JOIN dispensa112018 on (liclicitemlote.l04_descricao = dispensa112018.si75_dsclote and dispensa112018.si75_nroprocesso = liclicita.l20_edital::varchar)
		INNER JOIN cflicita on (liclicita.l20_codtipocom = cflicita.l03_codigo)
		INNER JOIN pctipocompratribunal on (cflicita.l03_pctipocompratribunal = pctipocompratribunal.l44_sequencial)
		INNER JOIN pcprocitem  on (liclicitem.l21_codpcprocitem = pcprocitem.pc81_codprocitem)
		INNER JOIN solicitem on (pcprocitem.pc81_solicitem = solicitem.pc11_codigo)
