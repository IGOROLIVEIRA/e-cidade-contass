...
//        exit;
        ...
        foreach ($oDados20 as $reg20){
            ...
            $iderp202018->si181_codorgao = $sCodorgao;
            $iderp202018->si181_codfontrecursos = $reg20->c224_fonte;
            $iderp202018->si181_vlcaixabruta = $reg20->c224_vlrcaixabruta;
            $iderp202018->si181_vlrspexerciciosanteriores = $reg20->c224_rpexercicioanterior;
            $iderp202018->si181_vlrestituiveisrecolher = $reg20->c224_vlrrestoarecolher;
            $iderp202018->si181_vlrestituiveisativofinanceiro = $reg20->c224_vlrrestoregativofinanceiro;
