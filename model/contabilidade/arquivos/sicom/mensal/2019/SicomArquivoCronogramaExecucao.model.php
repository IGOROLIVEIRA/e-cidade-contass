...
require_once("classes/db_cronem102019_classe.php");
require_once("classes/db_cronogramamesdesembolso_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarCRONEM.model.php");
...
class SicomArquivoCronogramaExecucao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clcronem10 = new cl_cronem102019();
