...
require_once("classes/db_reglic102019_classe.php");
require_once("classes/db_reglic202019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarREGLIC.model.php");
...
class SicomArquivoLegislacaoMunicipalLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clreglic10 = new cl_reglic102019();
    $clreglic20 = new cl_reglic202019();
  ...
  UNION select si44_nrodecretomunicipal from reglic102019 where si44_mes <= " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . ") ";
