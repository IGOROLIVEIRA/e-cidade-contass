...
require_once("classes/db_aop102019_classe.php");
require_once("classes/db_aop112019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarAOP.model.php");
  ...
  public function gerarDados()
  {
   ...
   $sSql = "SELECT c71_coddoc,
    ...
    foreach ($aAnulacoes as $anulacao) {
      ...
      $oDadosAnulacao = new cl_aop102019();
      ...
      foreach ($anulacao->reg11 as $reg11) {
        ...
        $oDadosAnulacaoFonte = new cl_aop112019();
