...
require_once("classes/db_arc102019_classe.php");
require_once("classes/db_arc112019_classe.php");
require_once("classes/db_arc122019_classe.php");
require_once("classes/db_arc202019_classe.php");
require_once("classes/db_arc212019_classe.php");
require_once("classes/db_rec102019_classe.php");
require_once("classes/db_rec112019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarARC.model.php");
...
class SicomArquivoDetalhamentoCorrecoesReceitas extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados(){
    ...
    $clarc20 = new cl_arc202019();
    $clarc21 = new cl_arc212019();
    ...
    foreach ($aDadosAgrupados as $oDados10) {
      ...
      foreach ($oDados10->Reg11 as $aDados11) {
        foreach ($aDados11 as $oDados11) {
          ...
          $clarc21->si32_tipodocumento = intval($oDados11->si26_tipodocumento);// \d arc212019
          $clarc21->si32_nrodocumento = $oDados11->si26_cnpjorgaocontribuinte;
          $clarc21->si32_nroconvenio = $oDados11->si26_nroconvenio;
          $clarc21->si32_dataassinatura = $oDados11->si26_dataassinatura;
