...
require_once("classes/db_regadesao102019_classe.php");
require_once("classes/db_regadesao112019_classe.php");
require_once("classes/db_regadesao122019_classe.php");
require_once("classes/db_regadesao132019_classe.php");
require_once("classes/db_regadesao142019_classe.php");
require_once("classes/db_regadesao152019_classe.php");
require_once("classes/db_regadesao202019_classe.php");
...
class SicomArquivoAdesaoRegistroPrecos extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $regadesao10 = new cl_regadesao102019();
    $regadesao11 = new cl_regadesao112019();
    $regadesao12 = new cl_regadesao122019();
    $regadesao13 = new cl_regadesao132019();
    $regadesao14 = new cl_regadesao142019();
    $regadesao15 = new cl_regadesao152019();
    $regadesao20 = new cl_regadesao202019();
