...
require_once("classes/db_caixa102019_classe.php");
require_once("classes/db_caixa112019_classe.php");
require_once("classes/db_caixa122019_classe.php");
require_once("classes/db_caixa132019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarCAIXA.model.php");
...
class SicomArquivoCaixa extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clcaixa13 = new cl_caixa132019();
    $clcaixa12 = new cl_caixa122019();
    $clcaixa11 = new cl_caixa112019();
    $clcaixa10 = new cl_caixa102019();
    ...
    */
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsContasCaixa); $iCont++) {
      ...
      $oDadosCaixa = new cl_caixa102019();
      ...
      $oDadosSaldoCaixa = new cl_caixa112019();
