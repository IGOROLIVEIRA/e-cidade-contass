...
require_once("classes/db_consor102019_classe.php");
require_once("classes/db_consor202019_classe.php");
require_once("classes/db_consor302019_classe.php");
require_once("classes/db_consor402019_classe.php");
require_once("classes/db_consor502019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarCONSOR.model.php");
...
class SicomArquivoConsConsorcios extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clconsor10 = new cl_consor102019();
    $clconsor20 = new cl_consor202019();
    $clconsor30 = new cl_consor302019();
    $clconsor40 = new cl_consor402019();
    $clconsor50 = new cl_consor502019();
