...
require_once("classes/db_pessoa102019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarPESSOA.model.php");
...
//    }
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsResult); $iCont++) {
      ...
      $sSqlVerifica = "select si12_nomerazaosocial from pessoa102014 WHERE si12_nrodocumento = '{$oDados->z01_cgccpf}'
                                 ...
                                 UNION
                                 select si12_nomerazaosocial from pessoa102019 where si12_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . " AND si12_nrodocumento = '{$oDados->z01_cgccpf}'";
