...
require_once("classes/db_homolic102019_classe.php");
require_once("classes/db_homolic202019_classe.php");
require_once("classes/db_homolic302019_classe.php");
require_once("classes/db_homolic402019_classe.php");
require_once("model/contabilidade/arquivos/sicom/SicomArquivoBase.model.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarHOMOLIC.model.php");

/**
 * Homologa��o da Licita��o Sicom Acompanhamento Mensal
...
class SicomArquivoHomologacaoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  /**
   * Homologa��o da Licita��o do mes para gerar o arquivo
   * @see iPadArquivoBase::gerarDados()
   */
  public function gerarDados()
  {

    $clhomolic10 = new cl_homolic102019();
    $clhomolic20 = new cl_homolic202019();
    $clhomolic30 = new cl_homolic302019();
