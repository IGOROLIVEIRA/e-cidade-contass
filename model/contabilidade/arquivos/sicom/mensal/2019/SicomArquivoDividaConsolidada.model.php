...
require_once("classes/db_ddc102019_classe.php");
require_once("classes/db_ddc202019_classe.php");
require_once("classes/db_ddc302019_classe.php");
require_once("classes/db_ddc402019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarDDC.model.php");
...
class SicomArquivoDividaConsolidada extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clddc10 = new cl_ddc102019();
    $clddc20 = new cl_ddc202019();
    $clddc30 = new cl_ddc302019();
    $clddc40 = new cl_ddc402019();
    ...
    */
    ...
    $sSql = "select * from dividaconsolidada where si167_mesreferencia = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "
             ...
             (select 1 from ddc102019  where si150_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si150_instit = " . db_getsession("DB_instit") . "
    ...
    $sSql = "select * from dividaconsolidada where si167_mesreferencia = " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "
             and si167_anoreferencia = " . db_getsession("DB_anousu") . " and si167_instit = " . db_getsession("DB_instit") . " and not exists
             (select 1 from ddc202019  where si153_mes < " . $this->sDataFinal['5'] . $this->sDataFinal['6'] . "  and si153_instit = " . db_getsession("DB_instit") . "
