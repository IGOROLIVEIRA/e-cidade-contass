...
require_once("classes/db_contratos102019_classe.php");
require_once("classes/db_contratos112019_classe.php");
require_once("classes/db_contratos122019_classe.php");
require_once("classes/db_contratos132019_classe.php");
require_once("classes/db_contratos202019_classe.php");
require_once("classes/db_contratos212019_classe.php");
require_once("classes/db_contratos302019_classe.php");
require_once("classes/db_contratos402019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarCONTRATOS.model.php");
...
inner join liclicita on ltrim(((string_to_array(e60_numerol, '/'))[1])::varchar,'0') = l20_edital::varchar
  ...
  public function gerarDados()
  {
    ...
    $clcontratos11 = new cl_contratos112019();
    $clcontratos12 = new cl_contratos122019();
    $clcontratos13 = new cl_contratos132019();
    $clcontratos20 = new cl_contratos202019();
    $clcontratos21 = new cl_contratos212019();
    $clcontratos30 = new cl_contratos302019();
    $clcontratos40 = new cl_contratos402019();
...
//ini_set('display_errors','on');
      ...
      }elseif ($oDados10->ac16_origem == self::ORIGEM_MANUAL || $oDados10->ac16_origem == self::ORIGEM_PROCESSO_COMPRAS) {
...
//                        echo "<pre>";var_dump($oDadosBusca);die();
    ...
    $sSql = "
      ...
      INNER JOIN
          (SELECT ac20_acordoposicao,
                  sum(abs(ac20_valoraditado)) AS ac20_valoraditado
          FROM acordoitem
    ...
    for ($iCont20 = 0; $iCont20 < pg_num_rows($rsResult20); $iCont20++) {
      ...
      if (strtotime($oDados20->ac26_data) > strtotime('2019-04-05')) {
        ...
        if (in_array($oAcordoPosicao->getTipo(), array(4, 9, 10, 11, 14))) {
          ...
          foreach ($oAcordoPosicao->getItens() as $oAcordoItem) {
            ...
            if (abs($oAcordoItem->getQuantiAditada()) > 0 || abs($oAcordoItem->getValorAditado()) > 0) {

              $sSql = "SELECT si43_coditem FROM
                                (select si43_coditem,si43_dscitem  from item102014 union select si43_coditem,si43_dscitem from item102015 union select si43_coditem,si43_dscitem from item102016 union select si43_coditem,si43_dscitem from item102017 union select si43_coditem,si43_dscitem from item102019) as y
