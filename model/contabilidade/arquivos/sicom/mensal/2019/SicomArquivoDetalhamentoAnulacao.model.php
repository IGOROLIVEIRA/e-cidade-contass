...
require_once("classes/db_alq102019_classe.php");
require_once("classes/db_alq112019_classe.php");
require_once("classes/db_alq122019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarALQ.model.php");
...
//    db_criatabela($rsDetalhamentos);echo pg_last_error();
    ...
    $clalq10 = new cl_alq102019();
    $clalq11 = new cl_alq112019();
    $clalq12 = new cl_alq122019();
