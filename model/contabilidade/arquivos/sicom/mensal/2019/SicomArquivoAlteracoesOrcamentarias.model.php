...
require_once("classes/db_aoc102019_classe.php");
require_once("classes/db_aoc112019_classe.php");
require_once("classes/db_aoc122019_classe.php");
require_once("classes/db_aoc132019_classe.php");
require_once("classes/db_aoc142019_classe.php");
...
class SicomArquivoAlteracoesOrcamentarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $claoc10 = new cl_aoc102019();
        $claoc11 = new cl_aoc112019();
        $claoc12 = new cl_aoc122019();
        $claoc13 = new cl_aoc132019();
        $claoc14 = new cl_aoc142019();
        $claoc15 = new cl_aoc152019();
    ...
    group by o46_codlei, o39_numero,o46_tiposup";
                ...
                $sSql = "SELECT DISTINCT o46_codsup,
                        ...
                        si09_codorgaotce AS codOrgao,
                        substr(o47_codsup, length(o47_codsup)-2, 3)||substr(o56_elemento,3,5)||o58_projativ||o15_codtri AS codorigem,
                        o47_codsup,
                        CASE
