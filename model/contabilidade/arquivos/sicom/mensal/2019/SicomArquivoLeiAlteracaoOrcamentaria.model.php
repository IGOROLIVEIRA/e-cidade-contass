...
require_once("classes/db_lao102019_classe.php");
require_once("classes/db_lao112019_classe.php");
require_once("classes/db_lao202019_classe.php");
require_once("classes/db_lao212019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarLAO.model.php");
...
class SicomArquivoLeiAlteracaoOrcamentaria extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $cllao10 = new cl_lao102019();
    $cllao11 = new cl_lao112019();
    $cllao20 = new cl_lao202019();
    $cllao21 = new cl_lao212019();
