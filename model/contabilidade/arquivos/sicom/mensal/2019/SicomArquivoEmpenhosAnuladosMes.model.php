...
require_once("classes/db_anl102019_classe.php");
require_once("classes/db_anl112019_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarANL.model.php");
...
class SicomArquivoEmpenhosAnuladosMes extends SicomArquivoBase implements iPadArquivoBaseCSV
{
    ...
    public function gerarDados()
    {
        ...
        $regitro10 = new cl_anl102019();
        $regitro11 = new cl_anl112019();
...
//    echo $sSql; db_criatabela($rsEmpenhoAnulados);
        ...
        for ($iCont = 0; $iCont < pg_num_rows($rsEmpenhoAnulados); $iCont++) {
            ...
            $oDadosEmpenhoAnulado = new cl_anl102019();
            ...
            $oDadosEmpenhoAnuladoFonte = new cl_anl112019();
