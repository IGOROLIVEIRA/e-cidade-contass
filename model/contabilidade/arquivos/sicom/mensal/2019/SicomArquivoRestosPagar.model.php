...
require_once("classes/db_rsp102019_classe.php");
require_once("classes/db_rsp112019_classe.php");
require_once("classes/db_rsp122019_classe.php");
require_once("classes/db_rsp202019_classe.php");
require_once("classes/db_rsp212019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarRSP.model.php");
...
class SicomArquivoRestosPagar extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    $clrsp10 = new cl_rsp102019();
    $clrsp11 = new cl_rsp112019();
    $clrsp12 = new cl_rsp122019();
    $clrsp20 = new cl_rsp202019();
    $clrsp21 = new cl_rsp212019();
