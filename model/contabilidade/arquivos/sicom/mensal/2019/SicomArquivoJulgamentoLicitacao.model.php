...
require_once("classes/db_julglic102019_classe.php");
require_once("classes/db_julglic202019_classe.php");
require_once("classes/db_julglic302019_classe.php");
require_once("classes/db_julglic402019_classe.php");
require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarJULGLIC.model.php");
...
class SicomArquivoJulgamentoLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $cljulglic10 = new cl_julglic102019();
    $cljulglic20 = new cl_julglic202019();
    $cljulglic30 = new cl_julglic302019();
    $cljulglic40 = new cl_julglic402019();
  ...
  aberlic102019.si46_criterioadjudicacao as criterioadjudicacao
  ...
  LEFT JOIN aberlic102019 on (aberlic102019.si46_nroprocessolicitatorio = liclicita.l20_edital::varchar)
  ...
  LEFT JOIN matunid AS matunid ON solicitemunid.pc17_unid = matunid.m61_codmatunid
	LEFT JOIN infocomplementaresinstit on db_config.codigo = infocomplementaresinstit.si09_instit
	WHERE db_config.codigo = " . db_getsession("DB_instit") . "
	AND aberlic102019.si46_criterioadjudicacao = 1 AND liclicita.l20_codigo in (" . implode(",", $aLicitacoes) . ")";
  ...
  LEFT JOIN infocomplementaresinstit on db_config.codigo = infocomplementaresinstit.si09_instit
  WHERE db_config.codigo = " . db_getsession("DB_instit") . "
  AND aberlic102019.si46_criterioadjudicacao = 2 AND liclicita.l20_codigo in (" . implode(",", $aLicitacoes) . ")";
