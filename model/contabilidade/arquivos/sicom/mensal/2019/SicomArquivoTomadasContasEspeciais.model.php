...
require_once ("classes/db_tce102019_classe.php");
require_once ("classes/db_tce112019_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2019/GerarTCE.model.php");
 /**
...
class SicomArquivoTomadasContasEspeciais extends SicomArquivoBase implements iPadArquivoBaseCSV {
  ...
  public function gerarDados() {
    ...
    $tce102019 = new cl_tce102019();
    $tce112019 = new cl_tce112019();
    ...
    $result = $tce112019->sql_record($tce112019->sql_query(NULL,"*",NULL,"si188_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si188_instit = ".db_getsession("DB_instit") ));
    if (pg_num_rows($result) > 0) {
      $tce112019->excluir(NULL,"si188_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si188_instit = ".db_getsession("DB_instit"));
      if ($tce112019->erro_status == 0) {
        throw new Exception($tce112019->erro_msg);
      }
    }
    $result = $tce102019->sql_record($tce102019->sql_query(NULL,"*",NULL,"si187_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si187_instit = ".db_getsession("DB_instit") ));
    if (pg_num_rows($result) > 0) {
      $tce102019->excluir(NULL,"si187_mes = ".$this->sDataFinal['5'].$this->sDataFinal['6']." and si187_instit = ".db_getsession("DB_instit"));
      if ($tce102019->erro_status == 0) {
        throw new Exception($tce102019->erro_msg);
      }
    }
