...
require_once("classes/db_redispi102022_classe.php");
require_once("classes/db_redispi112022_classe.php");
require_once("classes/db_redispi122022_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarREDISPI.model.php");
...
class SicomArquivoResumoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clredispi10 = new cl_redispi102022();
    $clredispi11 = new cl_redispi112022();
    $clredispi12 = new cl_redispi122022();
