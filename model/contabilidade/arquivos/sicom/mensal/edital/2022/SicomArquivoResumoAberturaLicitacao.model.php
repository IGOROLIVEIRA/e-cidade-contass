...
require_once("classes/db_ralic102022_classe.php");
require_once("classes/db_ralic112022_classe.php");
require_once("classes/db_ralic122022_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarRALIC.model.php");
...
class SicomArquivoResumoAberturaLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clralic10 = new cl_ralic102022();
    $clralic11 = new cl_ralic112022();
    $clralic12 = new cl_ralic122022();
