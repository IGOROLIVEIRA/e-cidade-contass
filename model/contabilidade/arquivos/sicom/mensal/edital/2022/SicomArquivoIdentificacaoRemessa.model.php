...
require_once ("classes/db_ideedital2022_classe.php");
require_once ("model/contabilidade/arquivos/sicom/mensal/geradores/2022/GerarIDEEDITAL.model.php");
...
class SicomArquivoIdentificacaoRemessa extends SicomArquivoBase implements iPadArquivoBaseCSV {
   ...
   */
    ...
    public function gerarDados(){
       ...
       */
        $clideedital = new cl_ideedital2022();
