...
require_once("classes/db_redispi102023_classe.php");
require_once("classes/db_redispi112023_classe.php");
require_once("classes/db_redispi122023_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2023/GerarREDISPI.model.php");
...
class SicomArquivoResumoDispensaInexigibilidade extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clredispi10 = new cl_redispi102023();
    $clredispi11 = new cl_redispi112023();
    $clredispi12 = new cl_redispi122023();
