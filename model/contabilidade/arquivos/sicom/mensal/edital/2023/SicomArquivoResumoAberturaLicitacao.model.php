...
require_once("classes/db_ralic102023_classe.php");
require_once("classes/db_ralic112023_classe.php");
require_once("classes/db_ralic122023_classe.php");

require_once("model/contabilidade/arquivos/sicom/mensal/geradores/2023/GerarRALIC.model.php");
...
class SicomArquivoResumoAberturaLicitacao extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clralic10 = new cl_ralic102023();
    $clralic11 = new cl_ralic112023();
    $clralic12 = new cl_ralic122023();
