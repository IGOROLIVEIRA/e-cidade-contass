...
require_once("classes/db_ctb412023_classe.php");
require_once("classes/db_ctb502023_classe.php");
require_once("classes/db_ctb602023_classe.php");
...
class SicomArquivoContasBancarias extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
    ...
    if( db_getsession("DB_anousu") == 2023 && $this->sDataFinal['5'] . $this->sDataFinal['6'] == 1 ) {
    ...
    for ($iCont = 0; $iCont < pg_num_rows($rsContas); $iCont++) {
        ...
        if (!isset($aBancosAgrupados[$aHash])) {
          ...
          $sSqlVerifica = "SELECT 'ctb102023' AS ano, si95_codctb, si95_nroconvenio FROM ctb102023 ";
    ...
    if (pg_num_rows($rsCtasReg40) != 0) {
      ...
      for ($icont40 = 0; $icont40 < pg_num_rows($rsCtasReg40); $icont40++) {
        ...
        $sSql40 = "SELECT 'ctb402023' AS ano, ctb402023.* FROM ctb402023
