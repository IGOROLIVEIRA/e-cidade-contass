      ...
      foreach ($oDados10->Reg11 as $oDados11) {
      	if (in_array($oDados10->si25_naturezareceita ,$aRectceSaudEduc )) {
      	  ...
      	  $clrec112014 = new cl_rec112014();
    		  ...
    		  $clrec112014->si26_codreceita        = $oDados11->si26_codreceita;
    		  $clrec112014->si26_codfontrecursos   = '100';
    		  $clrec112014->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.60);
          ...
          $clrec112014->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.25);
      	  $clrec112014->incluir(null);
    	    if ($clrec112014->erro_status == 0) {
    	      throw new Exception($clrec112014->erro_msg);
          }
          ...
          $clrec112014->si26_vlarrecadadofonte = abs($oDados10->si25_vlarrecadado*0.15);
      	  $clrec112014->incluir(null);
    	    if ($clrec112014->erro_status == 0) {
    	      throw new Exception($clrec112014->erro_msg);
          }
