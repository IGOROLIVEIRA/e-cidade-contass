...
require_once("classes/db_dvpdcasp102018_classe.php");
require_once("classes/db_dvpdcasp202018_classe.php");
require_once("classes/db_dvpdcasp302018_classe.php");

require_once("model/contabilidade/arquivos/sicom/2018/dcasp/geradores/GerarDVP.model.php");
...
class SicomArquivoDVP extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $cldvpdcasp10 = new cl_dvpdcasp102018();
    $cldvpdcasp20 = new cl_dvpdcasp202018();
    $cldvpdcasp30 = new cl_dvpdcasp302018();
