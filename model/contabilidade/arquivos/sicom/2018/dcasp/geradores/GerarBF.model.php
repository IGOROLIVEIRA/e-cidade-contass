...
class GerarBF extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from bfdcasp102018 where si206_ano = {$this->iAno} AND si206_periodo = {$this->iPeriodo} AND si206_institu = " . db_getsession("DB_instit");
    $rsBF10 = db_query($sSql);

    $sSql = "select * from bfdcasp202018 where si207_ano = {$this->iAno} AND si207_periodo = {$this->iPeriodo} AND si207_institu = " . db_getsession("DB_instit");
