...
class GerarRPSD extends GerarAM
{
  ...
  public function gerarDados()
  {
    ...
    $sSql = "select * from rpsd102018 where si189_mes = " . $this->iMes . " and si189_instit = " . db_getsession("DB_instit");
    $rsRPSD10 = db_query($sSql);

    $sSql2 = "select * from rpsd112018 where si190_mes = " . $this->iMes . " and si190_instit = " . db_getsession("DB_instit");
      ...
      for ($iCont = 0; $iCont < pg_num_rows($rsRPSD10); $iCont++) {
        ...
        for ($iCont2 = 0; $iCont2 < pg_num_rows($rsRPSD11); $iCont2++) {
          ...
          if ($aRPSD10['si189_sequencial'] == $aRPSD11['si190_reg10']) {
            ...
            $aCSVRPSD11['si190_codreduzidorsp']  = $this->padLeftZero($aRPSD11['si190_codreduzidorsp'], 15);
