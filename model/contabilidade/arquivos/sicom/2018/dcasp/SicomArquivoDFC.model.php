...
require_once("classes/db_dfcdcasp102018_classe.php");
require_once("classes/db_dfcdcasp202018_classe.php");
require_once("classes/db_dfcdcasp302018_classe.php");
require_once("classes/db_dfcdcasp402018_classe.php");
require_once("classes/db_dfcdcasp502018_classe.php");
require_once("classes/db_dfcdcasp602018_classe.php");
require_once("classes/db_dfcdcasp702018_classe.php");
require_once("classes/db_dfcdcasp802018_classe.php");
require_once("classes/db_dfcdcasp902018_classe.php");
require_once("classes/db_dfcdcasp1002018_classe.php");
require_once("classes/db_dfcdcasp1102018_classe.php");

require_once("model/contabilidade/arquivos/sicom/2018/dcasp/geradores/GerarDFC.model.php");
...
class SicomArquivoDFC extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $cldfcdcasp10   = new cl_dfcdcasp102018();
    $cldfcdcasp20   = new cl_dfcdcasp202018();
    $cldfcdcasp30   = new cl_dfcdcasp302018();
    $cldfcdcasp40   = new cl_dfcdcasp402018();
    $cldfcdcasp50   = new cl_dfcdcasp502018();
    $cldfcdcasp60   = new cl_dfcdcasp602018();
    $cldfcdcasp70   = new cl_dfcdcasp702018();
    $cldfcdcasp80   = new cl_dfcdcasp802018();
    $cldfcdcasp90   = new cl_dfcdcasp902018();
    $cldfcdcasp100  = new cl_dfcdcasp1002018();
    $cldfcdcasp110  = new cl_dfcdcasp1102018();
