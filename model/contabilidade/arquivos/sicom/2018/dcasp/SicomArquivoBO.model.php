...
require_once("classes/db_bodcasp102018_classe.php");
require_once("classes/db_bodcasp202018_classe.php");
require_once("classes/db_bodcasp302018_classe.php");
require_once("classes/db_bodcasp402018_classe.php");
require_once("classes/db_bodcasp502018_classe.php");

require_once("model/contabilidade/arquivos/sicom/2018/dcasp/geradores/GerarBO.model.php");
...
class SicomArquivoBO extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clbodcasp10 = new cl_bodcasp102018();
    $clbodcasp20 = new cl_bodcasp202018();
    $clbodcasp30 = new cl_bodcasp302018();
    $clbodcasp40 = new cl_bodcasp402018();
    $clbodcasp50 = new cl_bodcasp502018();
