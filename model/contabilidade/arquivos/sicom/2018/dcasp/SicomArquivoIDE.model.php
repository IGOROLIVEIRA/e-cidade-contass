...
require_once("classes/db_idedcasp2018_classe.php");
require_once("model/contabilidade/arquivos/sicom/2018/dcasp/geradores/GerarIDE.model.php");
...
class SicomArquivoIDE extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clidedcasp = new cl_idedcasp2018();
