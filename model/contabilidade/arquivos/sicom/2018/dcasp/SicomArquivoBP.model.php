...
require_once("classes/db_bpdcasp102018_classe.php");
require_once("classes/db_bpdcasp202018_classe.php");
require_once("classes/db_bpdcasp302018_classe.php");
require_once("classes/db_bpdcasp402018_classe.php");
require_once("classes/db_bpdcasp502018_classe.php");
require_once("classes/db_bpdcasp602018_classe.php");
require_once("classes/db_bpdcasp702018_classe.php");
require_once("classes/db_bpdcasp712018_classe.php");

require_once("model/contabilidade/arquivos/sicom/2018/dcasp/geradores/GerarBP.model.php");
...
class SicomArquivoBP extends SicomArquivoBase implements iPadArquivoBaseCSV
{
  ...
  public function gerarDados()
  {
     ...
     */
    $clbpdcasp10 = new cl_bpdcasp102018();
    $clbpdcasp20 = new cl_bpdcasp202018();
    $clbpdcasp30 = new cl_bpdcasp302018();
    $clbpdcasp40 = new cl_bpdcasp402018();
    $clbpdcasp50 = new cl_bpdcasp502018();
    $clbpdcasp60 = new cl_bpdcasp602018();
    $clbpdcasp70 = new cl_bpdcasp702018();
