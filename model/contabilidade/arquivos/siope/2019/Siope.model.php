                ...
                if ($oDespesa->o58_elemento != "") {
                    ...
                    for ($contDesp = 0; $contDesp < pg_num_rows($resDepsMes); $contDesp++) {
                        ...
                        if (isset($aDadosAgrupados[$sHashDesp])) {
                            ...
                            if ($iCodPlan == 238 || $iCodPlan == 239 || $iCodPlan == 240 || $iCodPlan == 173) {
                                $oNaturdessiopeDesd = $this->getNaturDesSiope($oDespesa->o56_elemento, 't');
                            } else {
                                $oNaturdessiopeDesd = $this->getNaturDesSiope($oDespesa->o56_elemento, 'f');
                            }
                ...
                if ($oDespesaAnoSeg->o58_codigo > 0) {
                    ...
                    if ($oDespesaAnoSeg->o58_elemento != "") {
                        ...
                        if (!isset($aDadosAgrupados[$sHashDesp])) {
                            ...
                            if ($iCodPlan == 238 || $iCodPlan == 239 || $iCodPlan == 240 || $iCodPlan == 173) {
                                $oNaturdessiope = $this->getNaturDesSiope($oDespesa->o56_elemento, 't');
                            } else {
                                $oNaturdessiope = $this->getNaturDesSiope($oDespesa->o56_elemento, 'f');
                            }
