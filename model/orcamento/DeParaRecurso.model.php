...
class DeParaRecurso
{
    ...
    public function getDePara2024($de)
    {
        $iPrimeiroDigito = strlen(ltrim($de,0)) == 3 ? substr(ltrim($de,0),0,1) : substr($de, 0, 1);
        $de = strlen(ltrim($de,0)) == 3 ? substr(ltrim($de,0),1,2) : substr($de, 1, 7);
        return (array_key_exists($de, $this->dePara2024)) ? $iPrimeiroDigito . $this->dePara2024[$de] : $iPrimeiroDigito . $de;
    }
    ...
    public function setDePara2024()
    {
        $this->dePara2024 = array(
            "00" => "5000000",
            "01" => "5000001",
            "02" => "5000002",
            "03" => "8000000",
