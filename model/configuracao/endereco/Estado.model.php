...
class Estado {
  ...
  /**
   * Retorna um array com os municípios vinculados ao estado
   */
  ...
  public function getMunicipiosByEstado($estado){
    ...
    if($totalMunicipios > 1){
      for ($cont = 0; $cont < $totalMunicipios; $cont++) {
        ...
        $listaMunicipios[$cont]['sequencial'] = $rs->db72_sequencial;
        $listaMunicipios[$cont]['descricao']  = $rs->db72_descricao;
      }
