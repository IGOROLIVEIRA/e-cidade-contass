        ...
        <td>
          <fieldset>
            ...
            <table border="0">
              ...
              <tr>
                <td nowrap title="ï¿½ltima Medida"><b>ï¿½ltima Medida:</b></td>
                <td>
                  <?
              ...
              ?>
              <tr>
                <td nowrap title="Observaï¿½ï¿½o" colspan="2">
                  <fieldset>
              ...
              <tr>
                <td align="left" nowrap title="<?= $Tsi05_numemp ?>">
                  <? db_ancora(@$Lsi05_numemp, "js_pesquisae60_codemp(true);", 1);  ?>
                </td>
                <td nowrap="nowrap" title='<?= $Tsi05_numemp ?>'>
...
<script>
  ...
  function js_pesquisae60_codemp(mostra) {
    if (mostra == true) {
      js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_empempenho', 'func_empempenho.php?funcao_js=parent.js_mostraempempenho2|e60_numemp', 'Pesquisa', true);
    } else {
  ...
  function js_verificaDataAbastecimento() {
    ...
    if (js_comparadata(dtRetirada, dtAbastecimento, "==")) {
      ...
      if (nHoraRetirada > nHoraAbastecimento) {
        ...
        alert("Hora da retirada ï¿½ maior que a hora de abastecimento.");
        return false;
      }
    }
  ...
  function js_pesquisave73_veicretirada(mostra) {
    ...
    if (iCodVeiculo == "") {
      ...
      alert("Selecione um veï¿½culo para selecionar a retirada.");
      return false;
    }
  ...
  function js_verifica(op) {
    ...
    if (op == '1') {
      if (document.form1.ve70_medida.value == 0) {
        resp = confirm('Vocï¿½ deseja realmente zerar a medida de consumo?');
        if (resp == true) {
    ...
    if (ultimasaida > medidasaida) {
      alert("Valor da medida menor que o valor da ï¿½ltima medida");
  ...
  function js_verifica_hora(valor, campo) {
    ...
    if (erro > 0) {
      alert("Informe uma hora vï¿½lida.");
    }
    if (valor != "") {
