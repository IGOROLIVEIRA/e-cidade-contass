...
<body bgcolor='#CCCCCC' leftmargin="0" id='body' topmargin="0" marginwidth="0" marginheight="0" onLoad="js_init()">
    ...
    <fieldset>
        ...
        <div style='position:fixed;
            ...
            <div style='padding:0px;text-align:right;border-bottom: 2px outset white;background-color: #2C7AFE;color:white'>
                <span style='float:left'><b>Hist�rico</b></span>
    ...
    <input type="checkbox" id='emiterelatorio'><label for="emiterelatorio">Emite Relat�rio de Pagamento</label>
...
<script>
    ...
    function js_init() {
        ...
        gridNotas.setCellAlign(new Array("right",
            ...
            "left",
            "left"));
        // Condi��o inclu�da na OC

        if (iForma == 4) {
            gridNotas.setHeader(new Array("Mov.", "Cod. Cheque", "Empenho", "Recurso", "Ordem", "Conta Pagadora", "Nome", "Data Pgto", "Vlr Atual Nota", "Reten��o", "Pagar", "Hist�rico", "Cheque", "N� Documento"));
            //gridNotas.setCellWidth(new Array('7%', '7%', '7%', '7%', '7%', '7%', '15%', '15%', '17%', '5%', '7%', '7%', '7%', '7%'));
        } else {
            gridNotas.setHeader(new Array("Mov.", "Cod. Cheque", "Empenho", "Recurso", "Ordem", "Conta Pagadora", "Nome", "Data Pgto", "Vlr Atual Nota", "Reten��o", "Pagar", "Hist�rico", "Cheque"));
            //gridNotas.setCellWidth(new Array('7%', '7%', '7%', '7%', '7%', '7%', '15%', '15%', '17%', '5%', '7%', '7%', '7%', '7%'));
        }
        ...
        */
        ...
        for (var i = 0; i < aMovimentos.length; i++) {
            ...
            if (lRetencaoMesAnterior == "true") {
                ...
                sMsgRetencaoMesAnterior += oMovimento.iNotaLiq + " possui reten��es configuradas em meses anteriores.\n";
                sVirgula = ", ";
