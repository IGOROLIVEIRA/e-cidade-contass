...
//				   where p.k00_numpre is null  and a.k00_numpre = ".$HTTP_POST_VARS["k00_numpre"]." limit 1";
	...
	?>
        <table width="100%" border="1" cellspacing="0" cellpadding="0">
		  ...
		  <input name="id_resp_parc"  id="id_resp_parc" type="hidden" value="<?=@$id_resp_parc?>"><!--este dois inputs guardam o responsável pelo parcelamento
		      ...
		      echo "
				  ...
				  <tr>
				    <td valign=\"top\" class=\"links2\" id=\"tiposemdeb1\">
			          <a class=\"links2\" onClick=\"js_MudaLink('tiposemdeb1')\" id=\"tiposemdeb1\" href=\"cai3_gerfinanc015.php?\" target=\"debitos\">NOTIFICAÇÕES LANÇADAS</a>
                    </td>
				 </tr>
				 </table>\n";
		    }
...
$dados = pg_exec($sql);
          ...
          <tr> 
            <td height="24"> 
              ...
              <input type="button" name="btcda" id="btcda" value="Certidão" onClick="js_certidao()" disabled> 
	    ...
	    function js_certidao(){
	      ...
	      debitos.document.form1.submit();
            ...
            <td nowrap title="Data para cálculo dos acréscimos no sistema"> <strong>Data 
              Pagamento:</strong> 
              <?
			//
