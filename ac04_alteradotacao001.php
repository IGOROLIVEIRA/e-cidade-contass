...
if(isset($codigo_acordo)){
  ...
  JOIN pcmater ON ac20_pcmater = pc01_codmater
  WHERE o56_anousu = '".DB_getsession("DB_anousu")."' AND ac20_acordoposicao = (SELECT max(ac26_sequencial) FROM acordoposicao where ac26_acordo = '".$codigo_acordo."' AND ac26_acordoposicaotipo <> 6) AND ac16_sequencial = '".$codigo_acordo."' AND ac26_acordoposicaotipo <> 6 ORDER BY ac20_acordoposicao DESC, ac20_ordem asc, ac22_coddot ASC ";
