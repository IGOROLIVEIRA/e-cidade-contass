 ...
 ?>
  <script>
   ...
   parent.document.formaba.a6.disabled = false;
    ...
    top.corpo.iframe_a2.location.href = 'edu1_disciplinaetapa001.php?' + sParametros;
   ...
   top.corpo.iframe_a6.location.href = 'edu1_outrosprofissionaisturma001.php?iTurma=<?=$ed57_i_codigo?>' ;
  </script>
 <?
}
?>
