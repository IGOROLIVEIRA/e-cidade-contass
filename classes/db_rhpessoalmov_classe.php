...
class cl_rhpessoalmov
{
    ...
    var $campos = "
                 ...
                 rh02_tipodeficiencia = int4 = C�digo do tipo de defici�ncia
                 rh02_abonopermanencia = bool = Abono Perman�ncia
                 rh02_diasgozoferias = int4 = Dias padr�o a Gozar
                 ...
                 rh02_desctipoparentescoinst = Text = Descri��o do Tipo de Parentesco
                 rh02_laudodeficiencia = oid = Laudo M�dico
                 rh02_laudoportadormolestia = oid = Laudo M�dico
                 rh02_segatuacao = oid = Segmento de Atua��o
                 rh02_reabreadap = bool = Trabalhador Reabilitado/Readaptado
                 rh02_cotadeficiencia = bool = cota de pessoas com defici�ncia habilitadas ou de benefici�rios reabilitados
                 rh02_plansegreg = int4 = Plano de Segrega��o da Massa
                 rh02_datainicio = date = Data in�cio
                 rh02_tipojornada = int4 = Tipo de Jornada
                 rh02_horarionoturno = bool = Horario noturno
                 rh02_cnpjcedente = varchar(100) = cnpj cedente
                 rh02_mattraborgcedente = varchar(100) = Matricula do Trabalhador no �rg�o Cedente
    ...
    public function sql_geracaoPlanilhasIAPEP($sTabela, $sSigla, $sFiltroAdmissao, $iAnoCompetencia, $iMesCompetencia, $iInstit, $sTipoVinculo, $lIsPlanilha13 = false, $sOrder = 'z01_nome', $fContribuicaoPatronalServidor = '0.24')
    {
         ...
         *
         */
        // L�gica antiga $sRubricaCalculo           = " 'R981', 'R975' ";
    ...
    /**
     * Retorna todas as matriculas com duplo vinculo ativas na compet�ncia informada como par�metro
     * @param  integer $iAnoUsu Ano compet�ncia
     * @param  integer $iMesUsu M�s compet�ncia
     * @return string SQL
     */
    ...
    /**
     * Retorna os duplos v�nculos ativos, para a matricula informada como par�metro.
     *
     * @param  integer $iMatricula Matricula do servidor
     * @param  integer $iAnoUsu    Ano da compet�ncia
     * @param  integer $iMesUsu    M�s da compet�ncia
     * @return string SQL
     */
