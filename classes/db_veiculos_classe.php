...
class cl_veiculos
{
    ...
    function alterar($ve01_codigo = null, $si04_tipoveiculo = null)
    {
        $this->atualizacampos();
    ...
    function sql_query_ultimamedida($ve01_codigo = null, $dDataBase = null, $sHoraBase = null, $sWhereA = null, $sWhereM = null, $sWhereD = null, $sWhereR = null)
    {
  	 ...
  	 */
        ...
        $sqlultimamedida .= "             and to_timestamp((ve70_dtabast||' '||ve70_hora)::text, 'YYYY-MM-DD HH24:MI \"PM\"') <= ";
        $sqlultimamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,    'YYYY-MM-DD HH24:MI \"PM\"') ";
        ...
        $sqlultimamedida .= "             and to_timestamp((ve62_dtmanut||' '||ve62_hora)::text, 'YYYY-MM-DD HH24:MI \"PM\"') <= ";
        $sqlultimamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,    'YYYY-MM-DD HH24:MI \"PM\"') ";
        ...
        $sqlultimamedida .= "             and to_timestamp((ve61_datadevol||' '||ve61_horadevol)::text, 'YYYY-MM-DD HH24:MI \"PM\"') <= ";
        $sqlultimamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,           'YYYY-MM-DD HH24:MI \"PM\"') ";
        ...
        $sqlultimamedida .= "           where ve60_veiculo    = {$ve01_codigo} ";
        $sqlultimamedida .= "             and to_timestamp((ve60_datasaida||' '||ve60_horasaida)::text, 'YYYY-MM-DD HH24:MI \"PM\"') <= ";
        $sqlultimamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,           'YYYY-MM-DD HH24:MI \"PM\"') ";
    ...
    function sql_query_proximamedida($ve01_codigo = null, $dDataBase = null, $sHoraBase = null, $sWhereA = null, $sWhereM = null, $sWhereD = null, $sWhereR = null)
    {
        ...
        $sqlproximamedida .= "             and to_timestamp((ve70_dtabast||' '||ve70_hora)::text, 'YYYY-MM-DD HH24:MI \"PM\"') >= ";
        $sqlproximamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,    'YYYY-MM-DD HH24:MI \"PM\"') ";
        ...
        $sqlproximamedida .= "             and to_timestamp((ve62_dtmanut||' '||ve62_hora)::text, 'YYYY-MM-DD HH24:MI \"PM\"') >= ";
        $sqlproximamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,    'YYYY-MM-DD HH24:MI \"PM\"') ";
        ...
        $sqlproximamedida .= "             and to_timestamp((ve61_datadevol||' '||ve61_horadevol)::text, 'YYYY-MM-DD HH24:MI \"PM\"') >= ";
        $sqlproximamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,           'YYYY-MM-DD HH24:MI \"PM\"') ";
        ...
        $sqlproximamedida .= "           where ve60_veiculo    = {$ve01_codigo} ";
        $sqlproximamedida .= "             and to_timestamp((ve60_datasaida||' '||ve60_horasaida)::text, 'YYYY-MM-DD HH24:MI \"PM\"') >= ";
        $sqlproximamedida .= "                 to_timestamp('{$dDataBase} {$sHoraBase}'::text,           'YYYY-MM-DD HH24:MI \"PM\"') ";
    ...
    function sql_query_medida_between($ve01_codigo = null, $dDataInicial, $sHoraInicial, $dDataFinal, $sHoraFinal)
    {
        ...
        $sqlultimamedida .= "           where ve70_veiculos  = {$ve01_codigo} ";
        $sqlultimamedida .= "             and to_timestamp((ve70_dtabast||' '||ve70_hora)::text, 'YYYY-MM-DD HH24:MI \"PM\"') ";
        $sqlultimamedida .= "         between to_timestamp('{$dDataInicial} {$sHoraInicial}'::text,    'YYYY-MM-DD HH24:MI \"PM\"') ";
        $sqlultimamedida .= "             and to_timestamp('{$dDataFinal} {$sHoraFinal}'::text,    'YYYY-MM-DD HH24:MI \"PM\"') ";
        $sqlultimamedida .= "             and not exists (select 1 from veicabastanu where ve74_veicabast = ve70_codigo) ";
        $sqlultimamedida .= "        order by ve70_dtabast desc, ";
        $sqlultimamedida .= "                 ve70_hora    desc, ";
        $sqlultimamedida .= "                 ve70_codigo  desc  ";
