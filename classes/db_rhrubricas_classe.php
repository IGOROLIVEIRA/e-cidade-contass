...
class cl_rhrubricas
{
    ...
    var $campos = "
                 rh27_rubric = char(4) = C�digo da Rubrica
                 rh27_descr = varchar(50) = Descri��o do C�digo
                 rh27_pd = int4 = Tipo Rubrica
                 rh27_quant = float8 = Qtda ou Valor para Inicializar
                 rh27_cond2 = varchar(120) = Condi��o da F�rmula 2
                 rh27_cond3 = varchar(120) = Condi��o da F�rmula 3
                 rh27_form = varchar(120) = F�rmula
                 rh27_form2 = varchar(120) = F�rmula 2
                 rh27_form3 = varchar(120) = F�rmula  3
                 rh27_formq = varchar(120) = F�rmula Quantidade
                 rh27_calc1 = int4 = M�dia p/ F�rias
                 rh27_calc2 = int4 = M�dia p/ 13�  Sal�rio
                 rh27_calc3 = bool = C�digo Rescis�o
                 rh27_tipo = int4 = Tipo de Inicializa��o
                 rh27_limdat = bool = Usa Data Limite
                 rh27_presta = bool = Calcula Presta��es
                 rh27_calcp = bool = Proporcionaliza no Afastamento
                 rh27_propq = bool = Proporcionaliza nas M�dias
                 rh27_propi = bool = Propor��o para Inativos
                 rh27_obs = varchar(120) = Observa��o
                 rh27_instit = int4 = codigo da instituicao
                 rh27_ativo = bool = Ativo
                 rh27_complementarautomatica = bool = Auto. Complementar
                 rh27_valorpadrao = float8 = Valor Padr�o
                 rh27_quantidadepadrao = float8 = Quantidade Padr�o
                 rh27_rhfundamentacaolegal = int4 = C�digo Fundamenta��o Legal
                 rh27_codincidprev = char(2) = Cod. incid�ncia tribut�ria previd�ncia social
                 rh27_codincidirrf = char(2) = Cod. incid�ncia tribut�ria irrf
                 rh27_codincidfgts = char(2) = Cod. incid�ncia para o fgts
                 rh27_codincidregime = char(2) = Cod. incid�ncia Regime Pr�prio RPPS/regime militar
                 rh27_tetoremun = Boolean = Teto remunerat�rio (art. 37, XI, da CF/1988)
                 ";
    ...
    function incluir($rh27_rubric, $rh27_instit)
    {
        ...
        if ($this->rh27_descr == null) {
            $this->erro_sql = " Campo Descri��o do C�digo n�o informado.";
        ...
        if ($this->rh27_pd == null) {
            $this->erro_sql = " Campo Tipo Rubrica n�o informado.";
        ...
        if ($this->rh27_quant == null) {
            $this->erro_sql = " Campo Qtda ou Valor para Inicializar n�o informado.";
        ...
        if ($this->rh27_calc1 == null) {
            $this->erro_sql = " Campo M�dia p/ F�rias n�o informado.";
        ...
        if ($this->rh27_calc2 == null) {
            $this->erro_sql = " Campo M�dia p/ 13�  Sal�rio n�o informado.";
        ...
        if ($this->rh27_calc3 == null) {
            $this->erro_sql = " Campo C�digo Rescis�o n�o informado.";
        ...
        if ($this->rh27_tipo == null) {
            $this->erro_sql = " Campo Tipo de Inicializa��o n�o informado.";
        ...
        if ($this->rh27_limdat == null) {
            $this->erro_sql = " Campo Usa Data Limite n�o informado.";
        ...
        if ($this->rh27_presta == null) {
            $this->erro_sql = " Campo Calcula Presta��es n�o informado.";
        ...
        if ($this->rh27_calcp == null) {
            $this->erro_sql = " Campo Proporcionaliza no Afastamento n�o informado.";
        ...
        if ($this->rh27_propq == null) {
            $this->erro_sql = " Campo Proporcionaliza nas M�dias n�o informado.";
        ...
        if ($this->rh27_propi == null) {
            $this->erro_sql = " Campo Propor��o para Inativos n�o informado.";
        ...
        if ($this->rh27_ativo == null) {
            $this->erro_sql = " Campo Ativo n�o informado.";
        ...
        if ($this->rh27_complementarautomatica == null) {
            $this->erro_sql = " Campo Auto. Complementar n�o informado.";
        ...
        /**
         * Se a fundamenta��o for v�zia o campo � preenchido com null.
         */
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql   = "Tabela de rubricas ($this->rh27_rubric." - ".$this->rh27_instit) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_banco = "Tabela de rubricas j� Cadastrado";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            } else {
                $this->erro_sql   = "Tabela de rubricas ($this->rh27_rubric." - ".$this->rh27_instit) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    function alterar($rh27_rubric = null, $rh27_instit = null)
    {
        ...
        if (trim($this->rh27_rubric) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh27_rubric"])) {
            ...
            if (trim($this->rh27_rubric) == null) {
                $this->erro_sql = " Campo C�digo da Rubrica n�o informado.";
        ...
        if (trim($this->rh27_instit) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh27_instit"])) {
            ...
            if (trim($this->rh27_instit) == null) {
                $this->erro_sql = " Campo codigo da instituicao n�o informado.";
        ...
        if (trim($this->rh27_codincidprev) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidprev"])) {
            if (trim($this->rh27_codincidprev) == "" && isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidprev"])) {
                $this->erro_sql = " Cod. incid�ncia tribut�ria previd�ncia social.";
        ...
        if (trim($this->rh27_codincidirrf) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidirrf"])) {
            if (trim($this->rh27_codincidirrf) == "" && isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidirrf"])) {
                $this->erro_sql = " Cod. incid�ncia tribut�ria irrf.";
        ...
        if (trim($this->rh27_codincidfgts) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidfgts"])) {
            if (trim($this->rh27_codincidfgts) == "" && isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidfgts"])) {
                $this->erro_sql = " Cod. incid�ncia para o fgts.";
        ...
        if (trim($this->rh27_codincidregime) != "" || isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidregime"])) {
            if (trim($this->rh27_codincidregime) == "" && isset($GLOBALS["HTTP_POST_VARS"]["rh27_codincidregime"])) {
                $this->erro_sql = " Cod. incid�ncia Regime Pr�prio RPPS/regime militar.";
    ...
    function excluir($rh27_rubric = null, $rh27_instit = null, $dbwhere = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Tabela de rubricas nao Exclu�do. Exclus�o Abortada.\\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Tabela de rubricas nao Encontrado. Exclus�o n�o Efetuada.\\n";
                $this->erro_sql .= "Valores : " . $rh27_rubric . "-" . $rh27_instit;
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
