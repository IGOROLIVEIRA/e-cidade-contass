...
class cl_inssirf
{
    ...
    var $campos = "
                 r33_instit = int4 = Cod. Institui��o
                 r33_codigo = int8 = C�digo da tabela
                 ...
                 r33_rubmat = varchar(4) = Rubrica sal�rio maternidade
                 r33_rubmat13 = varchar(4) = Rubrica sal�rio maternidade 13
                 r33_ppatro = float8 = Percentual Previd�ncia Patronal
                 r33_rubsau = varchar(4) = Rubrica Licen�a Sa�de
                 r33_rubaci = varchar(4) = Rubrica Acidente de Trabalho
                 r33_basfer = varchar(4) = Base Previd�ncia F�rias
                 r33_basfet = varchar(4) = Base Previd�ncia F�rias (Total)
                 r33_tinati = float8 = Teto para Inativos
                 r33_codele = int4 = C�digo do Desdobramento
                 r33_novocalculo = Boolean = Al�quota Progressiva
    ...
    function incluir($r33_codigo, $r33_instit)
    {
        ...
        if ($r33_codigo == "" || $r33_codigo == null) {
            ...
            if (($result != false) && (pg_result($result, 0, 0) < $r33_codigo)) {
                $this->erro_sql = " Campo r33_codigo maior que �ltimo n�mero da sequencia.";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql   = "Cadastro das Tabelas                               ($this->r33_codigo." - ".$this->r33_instit) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_banco = "Cadastro das Tabelas                               j� Cadastrado";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            } else {
                $this->erro_sql   = "Cadastro das Tabelas                               ($this->r33_codigo." - ".$this->r33_instit) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    function alterar($r33_codigo = null, $r33_instit = null)
    {
        ...
        if (trim($this->r33_codigo) != "" || isset($GLOBALS["HTTP_POST_VARS"]["r33_codigo"])) {
            ...
            if (trim($this->r33_codigo) == null) {
                $this->erro_sql = " Campo C�digo da tabela nao Informado.";
    ...
    function excluir($r33_codigo = null, $r33_instit = null, $dbwhere = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Cadastro das Tabelas                               nao Exclu�do. Exclus�o Abortada.\\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Cadastro das Tabelas                               nao Encontrado. Exclus�o n�o Efetuada.\\n";
                $this->erro_sql .= "Valores : " . $r33_codigo . "-" . $r33_instit;
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    public function getPercentuaisPatronais($iAno, $iMes, $iInstituicao = null)
    {
        ...
        /**
         * Valores padr�o para base dos valores patronais
         */
