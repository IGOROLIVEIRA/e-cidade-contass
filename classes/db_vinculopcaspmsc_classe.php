...
class cl_vinculopcaspmsc { 
  ...
  function alterar ($c210_pcaspestrut=null,$c210_mscestrut=null) { 
      $this->atualizacampos();
     ...
     if ($c210_pcaspestrut!=null) {
       $sql .= " c210_pcaspestrut = '$this->c210_pcaspestrut'";
     }
     if ($c210_mscestrut!=null) {
       $sql .= " and  c210_mscestrut = '$this->c210_mscestrut'";
     }
     $lSessaoDesativarAccount = db_getsession("DB_desativar_account", false);
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       && ($lSessaoDesativarAccount === false))) {
     ...
     if ($result==false) { 
       ...
       if (pg_affected_rows($result)==0) {
         $this->erro_banco = "";
         $this->erro_sql = "Vínculo Pcasp MSC nao foi Alterado. Alteracao Executada.\\n";
         $this->erro_sql .= "Valores : ".$this->c210_pcaspestrut."-".$this->c210_mscestrut;
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "1";
