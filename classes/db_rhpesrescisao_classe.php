...
class cl_rhpesrescisao
{
    ...
    var $campos = "
                 rh05_seqpes = int4 = Sequ�ncia
                 rh05_recis = date = Data da Rescis�o
                 rh05_causa = int4 = Causa da Rescis�o
                 rh05_caub = varchar(2) = Sub causa de rescis�o
                 rh05_aviso = date = Data de Aviso Pr�vio
                 rh05_taviso = int4 = Tipo de Aviso
                 rh05_mremun = float8 = Maior Remunera��o
                 rh05_empenhado = bool = Rescis�o Empenhada
                 rh05_trct = varchar(200) = TRCT
                 rh05_codigoseguranca = varchar(200) = C�digo de seguran�a
                 rh05_feriasavos = int4 = Avos de f�rias
                 rh05_feriasvencidas = int4 = F�rias vencidas
                 rh05_13salarioavos = int4 = Avos de 13� sal�rio
    ...
    function incluir($rh05_seqpes)
    {
        ...
        if ($this->rh05_recis == null) {
            $this->erro_sql = " Campo Data da Rescis�o nao Informado.";
        ...
        if ($this->rh05_causa == null) {
            $this->erro_sql = " Campo Causa da Rescis�o nao Informado.";
        ...
        if ($this->rh05_mremun == null) {
            $this->erro_sql = " Campo Maior Remunera��o nao Informado.";
        ...
        if ($result == false) {
            ...
            if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
                $this->erro_sql   = "Funcion�rios em rescis�o ($this->rh05_seqpes) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_banco = "Funcion�rios em rescis�o j� Cadastrado";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            } else {
                $this->erro_sql   = "Funcion�rios em rescis�o ($this->rh05_seqpes) nao Inclu�do. Inclusao Abortada.";
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    function alterar($rh05_seqpes = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Funcion�rios em rescis�o nao Alterado. Alteracao Abortada.\\n";
            $this->erro_sql .= "Valores : " . $this->rh05_seqpes;
            $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
            $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
            $this->erro_status = "0";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Funcion�rios em rescis�o nao foi Alterado. Alteracao Executada.\\n";
                $this->erro_sql .= "Valores : " . $this->rh05_seqpes;
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    function excluir($rh05_seqpes = null, $dbwhere = null)
    {
        ...
        if ($result == false) {
            $this->erro_banco = str_replace("\n", "", @pg_last_error());
            $this->erro_sql   = "Funcion�rios em rescis�o nao Exclu�do. Exclus�o Abortada.\\n";
            ...
            if (pg_affected_rows($result) == 0) {
                $this->erro_banco = "";
                $this->erro_sql = "Funcion�rios em rescis�o nao Encontrado. Exclus�o n�o Efetuada.\\n";
                $this->erro_sql .= "Valores : " . $rh05_seqpes;
                $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
                $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
                $this->erro_status = "1";
    ...
    function sql_relatorios_termo_rescisao_pontorescisao($iAno, $iMes, $campos = "*", $dbwhere = "")
    {
        ...
        $sSql .= "where ";
        $sSql .= " case";
        $sSql .= "     when gerfres.r20_regist IS NOT NULL and r20_anousu = $iAno and  r20_mesusu = $iMes";/* Caso tenha c�lculo */
        ...
        $sSql .= "    and case                                                                                                                                        \n";
        $sSql .= "          when gerfres.r20_regist is null                                       /* Caso n�o tenha c�lculo                              */           \n";
        $sSql .= "          then (afasta.r45_regist is not null and rhcadregime.rh52_regime <> 2) /* Valida se tem afastamento e se o servidor n�o � CLT */           \n";
        $sSql .= "          else true                                                             /* no caso de haver c�lculo retorna semrpre            */           \n";
        $sSql .= "        end                                                                                                                                         \n";
        $sSql .= "                                  $dbwhere                                                                                                           \n";
