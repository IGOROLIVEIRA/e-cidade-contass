...
class cl_publicacaoeperiodicidadergf {
   ...
   function incluir (){
     ...
     $result = @pg_query("insert into publicacaoeperiodicidadergf(
   ...
   function alterar ( $c221_dadoscomplementareslrf=null ) {
     ...
     if(trim($this->c221_dtpublicacaorelatoriorgf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c221_dtpublicacaorelatoriorgf"])){
        if(trim($this->c221_dtpublicacaorelatoriorgf)=="" && isset($GLOBALS["HTTP_POST_VARS"]["c221_dtpublicacaorelatoriorgf"])){
           $this->c221_dtpublicacaorelatoriorgf = "0" ;
        }
       $sql  .= $virgula." c221_dtpublicacaorelatoriorgf = '$this->c221_dtpublicacaorelatoriorgf' ";
       $virgula = ",";
       if(trim($this->c221_dtpublicacaorelatoriorgf) == null ){
         $this->erro_sql = " Campo Data da Publicação do RGF nao Informado.";
         $this->erro_campo = "c221_dtpublicacaorelatoriorgf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->c221_localpublicacaorgf)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c221_localpublicacaorgf"])){
       ...
       $virgula = ",";
       if(trim($this->c221_localpublicacaorgf) == null ){
         $this->erro_sql = " Campo Local da Publicação da RGF nao Informado.";
         $this->erro_campo = "c221_localpublicacaorgf";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
     ...
     if(trim($this->c221_exerciciotpperiodo)!="" || isset($GLOBALS["HTTP_POST_VARS"]["c221_exerciciotpperiodo"])){
        if(trim($this->c221_exerciciotpperiodo)=="" && isset($GLOBALS["HTTP_POST_VARS"]["c221_exerciciotpperiodo"])){
           $this->c221_exerciciotpperiodo = "0" ;
        }
       $sql  .= $virgula." c221_exerciciotpperiodo = $this->c221_exerciciotpperiodo ";
       $virgula = ",";
       if(trim($this->c221_exerciciotpperiodo) == null ){
         $this->erro_sql = " Campo Exercício a que se refere o período nao Informado.";
         $this->erro_campo = "c221_exerciciotpperiodo";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
