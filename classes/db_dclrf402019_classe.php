...
class cl_dclrf402019 {
   ...
   // funcao do sql
   function sql_query ( $si193_reg10 = null,$campos="dclrf402019.si193_reg10,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     if($dbwhere==""){
       if( $si193_reg10 != "" && $si193_reg10 != null){
          $sql2 = " where dclrf402019.si193_reg10 = $si193_reg10";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
