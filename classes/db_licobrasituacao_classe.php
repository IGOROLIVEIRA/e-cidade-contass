...
class cl_licobrasituacao { 
  ...
  public $campos = "
                 ...
                 obr02_seqobra = int4 = NÂº Obra 
                 obr02_dtlancamento = date = Data LanÃ§amento 
                 obr02_situacao = int4 = SituaÃ§Ã£o 
                 obr02_dtsituacao = date = Data SituaÃ§Ã£o 
                 obr02_veiculopublicacao = text = VeÃ­culo PublicaÃ§Ã£o 
                 obr02_descrisituacao = text = Desc. SituaÃ§Ã£o da Obra 
                 obr02_motivoparalisacao = int4 = Motivo ParalizaÃ§Ã£o 
                 obr02_dtparalizacao = date = Data ParalizaÃ§Ã£o 
                 obr02_outrosmotivos = text = Outros Motivos 
                 obr02_dtretomada = date = Data Retomada 
                 obr02_instit = int4 = InstituiÃ§Ã£o 
                 ";
  ...
  function incluir () { 
     ...
     if ($this->obr02_situacao == null ) { 
       $this->erro_sql = " Campo SituaÃ§Ã£o não informado.";
     ...
     if ($this->obr02_dtsituacao == null ) { 
       $this->erro_sql = " Campo Data SituaÃ§Ã£o não informado.";
     ...
     if ($this->obr02_veiculopublicacao == null ) { 
       $this->erro_sql = " Campo VeÃ­culo PublicaÃ§Ã£o não informado.";
     ...
     if ($this->obr02_descrisituacao == null ) { 
       $this->erro_sql = " Campo Desc. SituaÃ§Ã£o da Obra não informado.";
     ...
     if ($this->obr02_motivoparalisacao == null ) { 
       $this->erro_sql = " Campo Motivo ParalizaÃ§Ã£o não informado.";
     ...
     if ($this->obr02_dtparalizacao == null ) { 
       $this->erro_sql = " Campo Data ParalizaÃ§Ã£o não informado.";
  ...
  function alterar ( $oid=null ) { 
     ...
     if (trim($this->obr02_motivoparalisacao)!="" || isset($GLOBALS["HTTP_POST_VARS"]["obr02_motivoparalisacao"])) { 
       ...
       $virgula = ",";
       if (trim($this->obr02_motivoparalisacao) == null ) { 
         $this->erro_sql = " Campo Motivo ParalizaÃ§Ã£o não informado.";
         $this->erro_campo = "obr02_motivoparalisacao";
         $this->erro_banco = "";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
