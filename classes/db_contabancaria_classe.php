...
class cl_contabancaria
{
  ...
  var $db83_numerocontratooc = null;
  var $db83_dataassinaturacop = null;

  // cria propriedade com as variaveis do arquivo
  var $campos = "
                 db83_sequencial = int4 = Codigo sequencial da conta bancaria
                 db83_descricao = varchar(100) = Descri��o da Conta
                 ...
                 db83_codigooperacao = varchar(4) = C�digo da Opera��o
                 db83_tipoconta = int4 = Tipo Conta
                 db83_contaplano = bool = Conta plano
                 db83_convenio = int8 = Conv�nio
                 db83_tipoaplicacao = int8 = Tipo Aplica��o
                 db83_numconvenio = int8 = N�mero Conv�nio
                 db83_dataconvenio = date = Data Conv�nio
                 db83_nroseqaplicacao = int8 = N�mero sequencial da aplica��o
                 db83_numerocontratooc = varchar(30) = N� do Contrato da Opera��o de Cr�dito
  ...
  function atualizacampos($exclusao = false)
  {
    if ($exclusao == false) {
      ...
      $this->db83_numerocontratooc = ($this->db83_numerocontratooc == "" ? @$GLOBALS["HTTP_POST_VARS"]["db83_numerocontratooc"] : $this->db83_numerocontratooc);
      // $this->db83_dataassinaturacop = ($this->db83_dataassinaturacop == "" ? @$GLOBALS["HTTP_POST_VARS"]["db83_dataassinaturacop"] : $this->db83_dataassinaturacop);
      ...
      if ($this->db83_dataassinaturacop == "") {
        $this->db83_dataassinaturacop_dia = ($this->db83_dataassinaturacop_dia == "" ? @$GLOBALS["HTTP_POST_VARS"]["db83_dataassinaturacop_dia"] : $this->db83_dataassinaturacop_dia);
        $this->db83_dataassinaturacop_mes = ($this->db83_dataassinaturacop_mes == "" ? @$GLOBALS["HTTP_POST_VARS"]["db83_dataassinaturacop_mes"] : $this->db83_dataassinaturacop_mes);
        $this->db83_dataassinaturacop_ano = ($this->db83_dataassinaturacop_ano == "" ? @$GLOBALS["HTTP_POST_VARS"]["db83_dataassinaturacop_ano"] : $this->db83_dataassinaturacop_ano);
        if ($this->db83_dataassinaturacop_dia != "") {
          $this->db83_dataassinaturacop = $this->db83_dataassinaturacop_ano . "-" . $this->db83_dataassinaturacop_mes . "-" . $this->db83_dataassinaturacop_dia;
        }
      }
  ...
  function incluir($db83_sequencial)
  {
    ...
    if ($this->db83_numerocontratooc != null) {
      if ($this->db83_dataassinaturacop == null) {
        $this->erro_sql = " Data de Assinatura do Contrato OP nao Informado.";
        $this->erro_campo = "db83_dataassinaturacop";
        $this->erro_banco = "";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "0";
    ...
    if ($this->db83_numconvenio == null && $this->db83_convenio == 1) {
      $this->erro_sql = " Campo N�mero Conv�nio nao Informado.";
    ...
    if ($this->db83_dataconvenio == null && $this->db83_convenio == 1) {
      $this->erro_sql = " Campo Data Conv�nio nao Informado.";
    ...
    if (pg_result($result, 0, 0) == 5 && $this->db83_tipoconta == 3 && ($this->db83_tipoaplicacao == null || $this->db83_tipoaplicacao == 0)) {
      $this->erro_sql = " Campo Tipo Aplica��o nao Informado.";
    ...
    if (pg_result($result, 0, 0) == 5 && $this->db83_tipoconta == 3 && ($this->db83_nroseqaplicacao == null || $this->db83_nroseqaplicacao == 0)) {
      $this->erro_sql = " Campo N�mero sequencial da aplica��o nao Informado.";
    ...
    if ($db83_sequencial == "" || $db83_sequencial == null) {
      ...
      if (($result != false) && (pg_result($result, 0, 0) < $db83_sequencial)) {
        $this->erro_sql = " Campo db83_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    $sql = "insert into contabancaria(
                                      ...
                                      ,db83_numerocontratooc
                                      ,db83_dataassinaturacop
                       )
                values (
                               ...
                               ,'$this->db83_numerocontratooc'
                               ," . ($this->db83_dataassinaturacop == "null" || $this->db83_dataassinaturacop == "" ? "null" : "'" . $this->db83_dataassinaturacop . "'") . "
                      )";
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Cadastro de contas bancaria ($this->db83_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "Cadastro de contas bancaria j� Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql   = "Cadastro de contas bancaria ($this->db83_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
    ...
    if (($resaco != false) || ($this->numrows != 0)) {
      ...
      $resac = db_query("insert into db_acount values($acount,2740,15643,'','" . AddSlashes(pg_result($resaco, 0, 'db83_numerocontratooc')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
      $resac = db_query("insert into db_acount values($acount,2740,15644,'','" . AddSlashes(pg_result($resaco, 0, 'db83_dataassinaturacop')) . "'," . db_getsession('DB_datausu') . "," . db_getsession('DB_id_usuario') . ")");
  ...
  function alterar($db83_sequencial = null)
  {
    ...
    if (trim($this->db83_numerocontratooc) != "" || isset($GLOBALS["HTTP_POST_VARS"]["db83_numerocontratooc"])) {
      $sql  .= $virgula . " db83_numerocontratooc = '$this->db83_numerocontratooc' ";
      $virgula = ",";
    }
    if (trim($this->db83_numerocontratooc) != "") {
      if (trim($this->db83_dataassinaturacop) != "" || isset($GLOBALS["HTTP_POST_VARS"]["db83_dataassinaturacop"]) &&  ($GLOBALS["HTTP_POST_VARS"]["db83_dataassinaturacop"] != "")) {
        $sql  .= $virgula . " db83_dataassinaturacop = '$this->db83_dataassinaturacop' ";
        $virgula = ",";
      }
      if (trim($this->db83_dataassinaturacop) == "") {
        $sql  .= $virgula . " db83_dataassinaturacop = '$this->db83_dataassinaturacop' ";

        if (trim($this->db83_dataassinaturacop) == "") {
          $this->erro_sql = " Campo Data de Assinatura do Contrato OP nao Informado.";
          $this->erro_campo = "db83_dataassinaturacop";
          $this->erro_banco = "";
          $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
          $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
    ...
    if (trim($this->db83_numerocontratooc) == "") {
      if (trim($this->db83_dataassinaturacop) != "") {
        $this->erro_sql = " Campos N� do Contrato da Opera��o de Cr�dito nao Informado.";
        $this->erro_campo = "db83_numerocontratooc";
        $this->erro_banco = "";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "0";
  ...
  function excluir($db83_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Cadastro de contas bancaria nao Exclu�do. Exclus�o Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Cadastro de contas bancaria nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $db83_sequencial;
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
