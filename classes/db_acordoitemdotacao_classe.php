...
class cl_acordoitemdotacao
{
  ...
  var $campos = "
                 ...
                 ac22_coddot = int4 = C�digo Dota��o
                 ac22_anousu = int4 = Ano Exerc�cio
  ...
  function incluir($ac22_sequencial)
  {
    ...
    if ($this->ac22_coddot == null) {
      $this->erro_sql = " Campo C�digo Dota��o nao Informado.";
    ...
    if ($ac22_sequencial == "" || $ac22_sequencial == null) {
      ...
      if (($result != false) && (pg_result($result, 0, 0) < $ac22_sequencial)) {
        $this->erro_sql = " Campo ac22_sequencial maior que �ltimo n�mero da sequencia.";
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Acordo Item Dota��o ($this->ac22_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "Acordo Item Dota��o j� Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql   = "Acordo Item Dota��o ($this->ac22_sequencial) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  function alterar($ac22_sequencial = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Acordo Item Dota��o nao Alterado. Alteracao Abortada.\\n";
      $this->erro_sql .= "Valores : " . $this->ac22_sequencial;
      $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
      $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      $this->erro_status = "0";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Acordo Item Dota��o nao foi Alterado. Alteracao Executada.\\n";
        $this->erro_sql .= "Valores : " . $this->ac22_sequencial;
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
  ...
  function excluir($ac22_sequencial = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Acordo Item Dota��o nao Exclu�do. Exclus�o Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Acordo Item Dota��o nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $ac22_sequencial;
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
