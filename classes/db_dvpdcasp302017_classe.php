...
class cl_dvpdcasp302017 { 
   ...
   function incluir ($si218_sequencial){ 
     ...
     if($this->si218_vlresultadopatrimonialperiodo == null ){ 
       ...
       $this->si218_sequencial = $si218_sequencial; 
     if(($this->si218_sequencial == null) || ($this->si218_sequencial == "") ){ 
       $this->erro_sql = " Campo si218_sequencial nao declarado.";
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if(($resaco!=false)||($this->numrows!=0)){
         ...
         $resac = db_query("insert into db_acountkey values($acount,1009474,'$this->si218_sequencial','I')");
         $resac = db_query("insert into db_acount values($acount,1010212,1009474,'','".AddSlashes(pg_result($resaco,0,'si218_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010212,1009475,'','".AddSlashes(pg_result($resaco,0,'si218_tiporegistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010212,1009476,'','".AddSlashes(pg_result($resaco,0,'si218_exercicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = db_query("insert into db_acount values($acount,1010212,1009477,'','".AddSlashes(pg_result($resaco,0,'si218_vlresultadopatrimonialperiodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     return true;
   } 
   ...
   function excluir ($si218_sequencial=null,$dbwhere=null) { 
     ...
     if (!isset($lSessaoDesativarAccount) || (isset($lSessaoDesativarAccount)
       ...
       if ($dbwhere==null || $dbwhere=="") {
         ...
         $resaco = $this->sql_record($this->sql_query_file($si218_sequencial));
       } else { 
       ...
       if (($resaco != false) || ($this->numrows!=0)) {
         ...
         for ($iresaco = 0; $iresaco < $this->numrows; $iresaco++) {
           ...
           $acount = pg_result($resac,0,0);
           $resac  = db_query("insert into db_acountacesso values($acount,".db_getsession("DB_acessado").")");
           $resac  = db_query("insert into db_acountkey values($acount,1009474,'$si218_sequencial','E')");
           $resac  = db_query("insert into db_acount values($acount,1010212,1009474,'','".AddSlashes(pg_result($resaco,$iresaco,'si218_sequencial'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010212,1009475,'','".AddSlashes(pg_result($resaco,$iresaco,'si218_tiporegistro'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010212,1009476,'','".AddSlashes(pg_result($resaco,$iresaco,'si218_exercicio'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
           $resac  = db_query("insert into db_acount values($acount,1010212,1009477,'','".AddSlashes(pg_result($resaco,$iresaco,'si218_vlresultadopatrimonialperiodo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         }
       }
     }
