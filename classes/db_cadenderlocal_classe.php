...
class cl_cadenderlocal {
   ...
   function sql_query_completo ( $db75_sequencial=null, $campos="*", $ordem=null, $dbwhere="", $incluiCodIbge=false){
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = split("#",$campos);
       $virgula = "";
     ...
     $sql .= "      left  join cadendermunicipiosistema on a.db72_sequencial = db125_cadendermunicipio       ";

     if ($incluiCodIbge){
       $sql .= "      left  join (select *, db125_codigosistema as codigoibge                                ";
       $sql .= "                   from cadendermunicipiosistema                                             ";
       $sql .= "                   join  cadendermunicipio c ON c.db72_sequencial = db125_cadendermunicipio  ";
       $sql .= "                     where db125_db_sistemaexterno = 4) as municipios                        ";
       $sql .= "                     ON municipios.db72_descricao = a.db72_descricao                         ";
     }
