...
class cl_basesr
{
  ...
  var $campos = "
                 r09_instit = int4 = Cod. Institui��o
  ...
  function incluir($r09_anousu, $r09_mesusu, $r09_base, $r09_rubric, $r09_instit)
  {
    ...
    if ($result == false) {
      ...
      if (strpos(strtolower($this->erro_banco), "duplicate key") != 0) {
        $this->erro_sql   = "Interliga o arquivo bases com as rubricas          ($this->r09_anousu." - ".$this->r09_mesusu." - ".$this->r09_base." - ".$this->r09_rubric." - ".$this->r09_instit) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_banco = "Interliga o arquivo bases com as rubricas          j� Cadastrado";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
      } else {
        $this->erro_sql   = "Interliga o arquivo bases com as rubricas          ($this->r09_anousu." - ".$this->r09_mesusu." - ".$this->r09_base." - ".$this->r09_rubric." - ".$this->r09_instit) nao Inclu�do. Inclusao Abortada.";
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
  ...
  function excluir($r09_anousu = null, $r09_mesusu = null, $r09_base = null, $r09_rubric = null, $r09_instit = null, $dbwhere = null)
  {
    ...
    if ($result == false) {
      $this->erro_banco = str_replace("\n", "", @pg_last_error());
      $this->erro_sql   = "Interliga o arquivo bases com as rubricas          nao Exclu�do. Exclus�o Abortada.\\n";
      ...
      if (pg_affected_rows($result) == 0) {
        $this->erro_banco = "";
        $this->erro_sql = "Interliga o arquivo bases com as rubricas          nao Encontrado. Exclus�o n�o Efetuada.\\n";
        $this->erro_sql .= "Valores : " . $r09_anousu . "-" . $r09_mesusu . "-" . $r09_base . "-" . $r09_rubric . "-" . $r09_instit;
        $this->erro_msg   = "Usu�rio: \\n\\n " . $this->erro_sql . " \\n\\n";
        $this->erro_msg   .=  str_replace('"', "", str_replace("'", "",  "Administrador: \\n\\n " . $this->erro_banco . " \\n"));
        $this->erro_status = "1";
