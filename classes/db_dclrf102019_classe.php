...
class cl_dclrf102019 {
   ...
   function incluir (){
     ...
     if($si190_sequencial == "" || $si190_sequencial == null ){
       ...
       if($result==false){
         ...
         $this->erro_sql   = "Verifique o cadastro da sequencia: dclrf102019_si190_sequencial_seq do campo: si190_sequencial";
         $this->erro_msg   = "Usuário: \\n\\n ".$this->erro_sql." \\n\\n";
         $this->erro_msg   .=  str_replace('"',"",str_replace("'","",  "Administrador: \\n\\n ".$this->erro_banco." \\n"));
         $this->erro_status = "0";
         return false;
       ...
       $result = @pg_query("select last_value from dclrf102019_si190_sequencial_seq");
   ...
   // funcao do sql
   function sql_query ( $si190_sequencial = null,$campos="dclrf102019.si190_sequencial,*",$ordem=null,$dbwhere=""){
     $sql = "select ";
     if($campos != "*" ){
     ...
     if($dbwhere==""){
       if( $si190_sequencial != "" && $si190_sequencial != null){
          $sql2 = " where dclrf102019.si190_sequencial = $si190_sequencial";
       }
     }else if($dbwhere != ""){
       $sql2 = " where $dbwhere";
     }
