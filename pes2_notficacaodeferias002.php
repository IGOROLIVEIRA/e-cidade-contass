    ...
    case 'matricula':
        ...
        for ($iCont = 0; $iCont < pg_num_rows($rsDadosServidor); $iCont++) {
            ...
            if(pg_num_rows($rsDadosFerias) == 0 ){
                ...
                $dtFimFeriasPeriodo = date('d/m/Y', strtotime('+365 days', strtotime($dtAdmissao)));
            }else{
                ...
                $dtFimFeriasPeriodo = date('d/m/Y', strtotime('+365 days', strtotime($dtFimFerias)));
            }
            ...
            $pdf->cell($w,$alt,"Nome do Servidor",  0,1,"C",0);
        }
