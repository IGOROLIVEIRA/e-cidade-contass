...
// para gestores
if ($lSepararGestor && ($listagestor == '0' || !empty($listagestor))) {
...
if ($processar == "a") {
	...
	if ($clempempenho->numrows > 0) {
		...
		db_redireciona('db_erros.php?fechar=true&db_erro=NAo existem dados para gerar a consulta (A21) !');
	}
	...
	if ($clempempenho->numrows > 0) {
		...
		db_redireciona('db_erros.php?fechar=true&db_erro=NAo existem dados para gerar a consulta!');
	}
}
