...
for($v=0;$v<$claluno->numrows;$v++){
 ...
 $head1 = "CERTIFICADO DE CONCLUSÃO";
 $head2 = "Nome: $ed47_v_nome";
 $head3 = "Nascido em: ".db_formatar($ed47_d_nasc,'d');
 $nacionalidade = array("1"=>"BRASILEIRO","2"=>"ESTRANGEIRO","3"=>"BRASILEIRO NASCIDO NO EXTERIOR OU NATURALIZADO");
 $head4 = "Nacionalidade: $nacionalidade[$ed47_i_nacion]";
 $head5 = "Nome do Pai: ".Abreviar($ed47_v_pai,30);
 $head6 = "Nome da Mãe: ".Abreviar($ed47_v_mae,30);
 $head7 = "Doc. Identidade: $ed47_v_ident";
 $head8 = "Curso: $ed29_i_codigo - $ed29_c_descr";
 $head9 = "Ato de Autorização: Resolução Elaboração Hist.Esc. nº: 115";
 $pdf->addpage('L');
