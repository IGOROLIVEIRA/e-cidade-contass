...
<?}?>
       <?
db_input('t52_ident',20,$It52_ident,true,'text',$opc);
...
db_input('t64_descr',38,$It64_descr,true,'text',3,'')
  ...
  <!--
  <tr>
    <td nowrap title="<?=@$Tt52_codmat?>">
       <?/*
       db_ancora(@$Lt52_codmat,"js_pesquisat52_codmat(true);",$db_opcao);
       */
       ?>
    </td>
    <td>
<?
/*
db_input('t52_codmat',8,$It52_codmat,true,'text',$db_opcao," onchange='js_pesquisat52_codmat(false);'")
*/
?>
       <?
       /*
...
db_input('t70_descr',40,$It70_descr,true,'text',3,'');
  if(isset($tipo_inclui)&&trim($tipo_inclui)!=""){
...
db_input("dadimovlot",40,"0",true,"hidden",3,"");
db_input("dadimovobs",40,"0",true,"hidden",3,"");
db_input("dadmat",40,"0",true,"hidden",3,"");
       ?>
    </td>
  </tr>
  <tr>
...
function js_pesquisa_bens(){
  ...
  for(i = 0;i < x.length;i++){
    if(x.elements[i].type == "text"){
      ...
      if((nome.search("nome")==-1 && nome.search("descr")==-1 || nome=="t52_descr") && nome != "t52_ident" && nome != "t52_bem"){
  ...
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_bens','db_iframe_clabens','func_clabens.php?funcao_js=parent.js_mostraclabens1|t64_class|t64_descr&analitica=true','Pesquisa',true);
     ...
     if(testa != '' && testa != 0){
       ...
       js_OpenJanelaIframe('CurrentWindow.corpo.iframe_bens','db_iframe_clabens','func_clabens.php?pesquisa_chave='+testa+'&funcao_js=parent.js_mostraclabens&analitica=true','Pesquisa',false);
     }else{
