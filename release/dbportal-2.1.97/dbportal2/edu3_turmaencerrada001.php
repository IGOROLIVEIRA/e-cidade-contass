     ...
     <td align="center" valign="top">
      <table border='1px' width="100%" bgcolor="#cccccc" style="" cellspacing="0px">
       ...
       $sql = "SELECT ed10_c_descr,
               ...
               $where
               GROUP BY ed10_i_codigo,ed11_i_sequencia,ed10_c_descr,ed11_c_descr,ed57_c_descr,ed57_i_codigo,ed15_c_nome
          ...
          <td width="50%">
           <table width="100%">
            <tr style="color:<?=$color?>;font-weight:bold;">
             <td width="40%">&nbsp;&nbsp;&nbsp;Turma: <a href="javascript:js_matriculas(<?=$ed57_i_codigo?>,'<?=$ed57_c_descr?>',<?=$calendario?>)" style="color:<?=$color?>;font-weight:bold;" title="Veja os alunos matriculados nesta turma"><?=$ed57_c_descr?></a></td>
...
function js_matriculas(turma,descrturma,calendario){
 js_OpenJanelaIframe('','db_iframe_matriculas','edu3_turmaencerrada002.php?turma='+turma,'Alunos Matriculados na Turma '+descrturma,true);
 location.href = "#topo";
}
