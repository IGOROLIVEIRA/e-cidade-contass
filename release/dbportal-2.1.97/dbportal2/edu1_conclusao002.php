...
$result = $clbase->sql_record($clbase->sql_query("","ed31_c_descr as nomebase,ed29_c_descr as nomecurso",""," ed31_i_codigo = $base"));
...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
 <tr>
  <td class="titulo">
   Conclusão do curso <?=$nomecurso?> com a base curricular <?=$nomebase?>
  </td>
 </tr>
 <tr>
