...
function js_pesquisa_usuario(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_usucliente','func_db_usuclientesalt.php?cliente='+document.form1.cliente.value+'&funcao_js=parent.js_mostramatordem1|at10_usuario|at10_nome|dl_aniversário','Pesquisa',true);
  }else{
