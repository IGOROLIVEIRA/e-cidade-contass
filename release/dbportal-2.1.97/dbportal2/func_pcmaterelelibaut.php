    ...
    <td align="center" valign="top"> 
      ...
      if (!isset($pesquisa_chave)) {
        ...
        if (isset($chave_pc07_codmater) && (trim($chave_pc07_codmater)!="") ) {
          $sql = $clpcmaterele->sql_query(null,null,$campos,"pc07_codmater"," pc07_codmater=$chave_pc07_codmater $where_ativo and $where_libaut");
          ...
          $sql = $clpcmaterele->sql_query_funcauteledescr("","",$campos,"pc07_codmater","$chave_pc01_descrmater#$chave_o56_elemento");
          ...
          $sql = $clpcmaterele->sql_query_funcaut("","",$campos,"pc07_codmater"," pc01_descrmater like '%$chave_pc01_descrmater%' and $where_libaut $where_ativo ".((isset($chave_o56_elemento) and trim($chave_o56_elemento))!=""?"   and  o56_elemento like '$chave_o56_elemento%'":""));
          $repassa["chave_pc01_descrmater"] = $chave_pc01_descrmater;
        } else if (isset($chave_o56_elemento) && (trim($chave_o56_elemento)!="") ) {
          $sql = $clpcmaterele->sql_query_funcautele("","",$campos,"pc07_codmater"," o56_elemento like '$chave_o56_elemento%' and o56_anousu = " . db_getsession("DB_anousu") . " ");
          $repassa["chave_o56_elemento"]    = $chave_o56_elemento;
        } else {
          $sql = $clpcmaterele->sql_query_funcaut("","",$campos,"pc07_codmater#pc07_codele"," 1=1 and $where_libaut $where_ativo ");
          $sql = "";
        }
        db_lovrot($sql, 12, "()", "", $funcao_js, "", "NoMe", $repassa);
      } else {
        if ($pesquisa_chave!=null && $pesquisa_chave!="") {
          $result = $clpcmaterele->sql_record($clpcmaterele->sql_query(null,null,"*",""," pc07_codmater=$pesquisa_chave and $where_libaut $where_ativo"));
