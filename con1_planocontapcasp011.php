            ...
            <fieldset style="width: 500px;">
                ...
                <table border="0" width="500px;">
                    ...
                    <tr id="trIndicadorSuperavit" style="display: none;">
                        <td nowrap="nowrap"><b>Indicador Super�vit:</b></td>
                        <td>
                            <?php
                            /*
                    ...
                    <tr id='infCompMSC' style='display: none;'>
                        ...
                        <td>
                            <?php
                            $aInfCompMSC = array(
                                "" => "Selecione", 1 => "01 - Poder e Org�o", 2 => "02 - Atributos do Super�vit Financeiro", 3 => "03 - D�vida Consolidada", 4 => "04 - Financeiro por Fonte", 5 => "05 - Fonte de recursos", 6 => "06 - C�lula da Receita", 7 => "07 - C�lula da Despesa", 8 => "08 - Financeiro por fonte mais DC", 9 => "09 - Restos a Pagar"
                            );
                            ...
                            <fieldset>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $aTipoLancamento = array(0 => "", 1 => "01-Dep�sitos e Consigna��es", 2 => "02-D�bitos de Tesouraria", 3 => "03-Ativo Realiz�vel", 4 => "04-Transfer�ncias Financeiras", 5 => "05-Valores Disponibilizados em Conta �nica do Tesouro Municipal", 9999 => "99-Outros");
                                    ...
                                    <tr id="trsubtipoNovo" style="display:none;">
                                        <td nowrap="nowrap" colspan="2">
                                            <fieldset>
                                                ...
                                                <b>Descri��o</b><?php db_input("c200_descsubtipo", 35, 0, 3, "text", $db_opcao, "", "", "", "text-transform: uppercase;", 100); ?>
                                    ...
                                    <tr id="trdesdobramentoNovo" style="display:none;">
                                        <td nowrap="nowrap" colspan="2">
                                            <fieldset>
                                                ...
                                                <b>Descri��o</b><?php db_input("c201_descdesdobrasubtipo", 35, 0, 3, "text", $db_opcao, "", "", "", "text-transform: uppercase;", 100); ?>
...
<script>
    ...
    /**
     * Fun��o adicionada para incluir o subtipo conforme layout do sicom
     */
    ...
    /**
     * Fun��o adicionada para incluir o desdobrasubtipo conforme layout do sicom
     */
    ...
    /**
     * Atualiza a conta removendo o indicador de super�vit
     */
    function removerIndicadorsuperavit() {
        ...
        new AjaxRequest(sUrlRPC, {
            ...
            }).setMessage("Aguarde, alterando o indicador de super�vit.")
            .execute();
    }

    /**
     * Valida o indicador de super�vit
     * Caso o indicador seja diferente de n�o se aplica, deve ter algum reduzido cadastrado
     */
    /**
     * Fun��o comentada pois n�o estava deixando incluir uma conta com puperavit sem reduzido
     */
    /*$('sIndicadorSuperavit').observe('change', function() {
      ...
      if ($("iSistemaConta").value == 2 && this.value != 'N') {
        ...
        if (oGridReduzidos == undefined || oGridReduzidos.getRows().length < 1) {
          ...
          this.value = 'N';
          alert('Somente contas anal�ticas possuem Indicador de Super�vit. � necess�rio cadastrar um reduzido para a conta.');
    ...
    $("btnIncluir").observe("click", function() {
        ...
        if (iDetalhamentoSistema == 7) {
            if (iTipoLancamento == "0") {
                alert("Informe o tipo de lan�amento.");
        ...
        /**
         * retirado valida��o por que alguns clientes precisam salvar o desdobramento em branco
         * /
	  ...
	  if(iDesdobramento==""){
        ...
        if (iTipoConta == 1) {
            if (iNaturezaReceita == '' && iEstrututalpermitido.contains(iEstrutValid)) {
                alert('Natureza da Receita n�o Informado !');
                return false;
            }

            if (infCompMSC == '') {
                alert('Informa��o Complementar da MSC n�o Informado!');
                return false;
            }
        }
