...
if(isset($alterar)){
  ...
  if($l20_usaregistropreco == 'f' && empty($l202_dataadjudicacao)) {
    echo "<script>alert('Campo Data Adjudica√ß√£o √© Obrigat√≥rio');</script>";
...
//  }
    ...
    /**
     * Verificar Encerramento Periodo Patrimonial e data do jultamento da licitaÁ„o
     */
    ...
    if(pg_numrows($rsResult) > 0){
      ...
      if($oLicSituacao->l08_sequencial == 1) {
        ...
        if($dtDataParecer < $dtDataJulg){
          ...
          $clliclicitasituacao->erro_msg = 'LicitaÁ„o julgada em '.$dtDataJulgShow.'. A data do parecer dever· ser igual ou superior a data de julgamento.';
