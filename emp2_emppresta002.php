...
if(isset($codemp) && isset($e60_numemp)){
  $sSql = $clemppresta->sql_query_empenhos(null, 'distinct(e45_numemp)',
   "e45_numemp","e60_codemp = '$codemp' and e60_numemp = $e60_numemp and
...
//    " e60_codemp = $codemp and e60_anousu = $ano and e60_instit = " . db_getsession("DB_instit"));
	...
	$sSql = $clemppresta->sql_query_empenhos(null, 'distinct(e45_numemp)',
		"e45_numemp","e45_numemp = $e60_numemp and e60_instit = " . db_getsession("DB_instit"));
...
//    "e45_numemp = $e60_numemp and e60_instit = " . db_getsession("DB_instit"));
	...
	if($filtro != ''){
		$sSql = $clemppresta->sql_query_empenhos(null, 'distinct(e45_numemp)',
			'e45_numemp',"$filtro e60_instit = " . db_getsession("DB_instit"));
    }
...
if(pg_num_rows($rsSql) == 0) {
  db_redireciona("db_erros.php?fechar=true&db_erro=Não foram encontrados registros.");
    ...
    for($contador = 0; $contador < pg_num_rows($rsSql); $contador++) {
      ...
      $sSqlItens = $clemppresta->sql_query_empenhos(null, 'distinct e45_sequencial,e45_numemp,e60_anousu,e45_data,e45_obs,e45_tipo,e45_acerta,
            e45_conferido,z01_nome,e44_descr,
            e60_codemp, e60_vlremp, e60_vlranu, e60_vlrliq, e60_coddot,
            fc_estruturaldotacao(e60_anousu,e60_coddot) as dl_estrutural, e46_valor', "e45_sequencial desc",
		...
		ob_start();
            ...
            <table cellspacing="0" width="100%">
                ...
                <?
                    ...
                    $result_itens = $clempprestaitem->sql_record($clempprestaitem->sql_query(null, '*', 'e46_nota',
                        "$sWhere "));
                ...
                <?php
                    foreach ($result_itens as $item): ?>
                        ...
                        if ($nota != $item->e46_nota):
                            ...
                            $rsNota = $clempdescontonota->sql_record($clempdescontonota->sql_query(null, "*", null,
