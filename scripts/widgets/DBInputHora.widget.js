/**
 * Componente que renderiza/transforma um input para suportar variações de data 
 * alem de suas validações
 *
...
DBInputHora = function( oElement ) {
  ...
  this.oInput               = DBInputHora.prepareElement( oElement || this.createElement() );
  ...
  */
  this.oInput.addEventListener('keypress', DBInputHora.eventFunctions.keyPress.bind(this));

  this.oInput.addEventListener('change',   DBInputHora.eventFunctions.changeValue.bind(this));
  this.oInput.addEventListener('paste',    DBInputHora.eventFunctions.changeValue.bind(this));
  this.oInput.addEventListener('drop',     DBInputHora.eventFunctions.changeValue.bind(this));
}
 ...
 *
 * @returns HTMLElementInput 
 */
DBInputHora.prototype.createElement = function() {

  var oInput = document.createElement('input');
  return oInput;
}

DBInputHora.prototype.getValue = function() {
  return this.oInput.value;
}

DBInputHora.prototype.setValue = function( sValue, lMantemPosicionamento ) {
 ...
 */
DBInputHora.prototype.getElement=function() {
  return this.oInput;
}
 ...
 * @returns void
 */
DBInputHora.prototype.setErrorCallBack = function( fCallBack ) {
 ...
 */
DBInputHora.prototype.show = function( oElement ) {

  oElement.appendChild(this.oInput);
}
  ...
  "keyPress" : function(event) {
    ...
    if ( (key == 38 || key == 40 || key == 33 || key == 34) && !!this.lIncrementarComSetas ) {//Up,Down,PgUp,PgDown
      ...
      if ( (key == 38 || key == 40) && !lIncrementaHorasComSeta) {//Up,Down
        this.setValue(DBInputHora.modifyMinutes(this.getValue(), nIncremento),true);
      }
      
      if ( ( key == 33 || key == 34 ) || lIncrementaHorasComSeta ) {//PgUp, PgDown
        this.setValue(DBInputHora.modifyHours(this.getValue(), nIncremento),true);
      }
 ...
 */
DBInputHora.prototype.maskValue = function() {
 ...
 */
DBInputHora.build = function( oElemento ) {
