...
/**
 * @fileoverview Esse arquivo define classes para a constru��o de uma datagrid
 * para visualiza�ao de dados tabulares
 *
...
function DBGrid(sName) {
  ...
  /**
   * callback paraa sele��o de colunas
   * @type string
   * @private
   */
  ...
  /**
   * Armazena a propriedade oFooter criada quando a grid tem um rodap� de totalizadores
  ...
  /**
   * Callback que ser� chamado apos a sele��o de um checkbox
   * @type {function}
   */
  ...
  /**
   * Callback para execucao apos a sele��o do checkbox
  ...
  var me = this;
   ...
   /**
   * Metodo para alinha o rodap� se este existir
   *
   * @param {Object} Obj�to da tabela do Cabe�alho
   * @return void
   *
   */
  this.alinhaFooter = function (oHeader) {
   ...
   /**
   * Retorna um {integer} com a primeira linha que estiv�r vis�vel.
   *
   * @param {Object} Obj�to da tabela do Body
   * @return Integer
   *
   */
  this.getFirstLineValid = function(oBody){
    ...
    // Percorre as linhas da tabela localizando e retornando a primeira linha vis�vel.
  ...
  /**
   * Garante que as colunas permane�am alinhadas
   *
   * @param {Object} Obj�to da tabela do header
   * @param {Object} Obj�to da tabela do Body
   * @param {Object} Obj�to da tabela do Footer
   * @return void
   *
   */
  ...
  this.addRow =  function(aRow, lRender, lDisabled, lChecked) {
    ...
    if ((aRow instanceof Array)) {
     ...
     //Iteramos sobre as posi��es do array Criado.
  ...
  /**
   * Renderiza a grid no n� especificado no parametro
  ...
  this.renderFooter = function() {
    ...
    this.show = function (oNode) {
        ...
        if (this.hasPesquisaConteudo){
            ...
            sGrid    += "onclick='$(\"filtro\").value = \"\";$(\""+this.sName+"pesquisaConteudo\").value = \"\"; btnPesquisarDados.click();' value='Recome�ar'></span>";
            sGrid    += "<span style='margin-right: 5px'> Indique o Conte�do:</span>";
   ...
   * @param {string} domNode n� que deve iniciar a busca default � document.
   ...
   *
   * @param {bool} lSelectAll true para mostrar a op��o
   * @see #getSelectAll
   * @return void;
   */
  ...
  /**
   * retorna se deve  mostrar op��o para selecionar todos os checkbox
   * @see #setSelectAll
   * @type bool
   * @return boolean
   */
   ...
   * @param  {bool} lInSelection se leva em considera��o apenas o que est� selecionado
   * @type   Number
  ...
  this.showSelectCol = function (oSender) {
    ...
    /*
     * decidimos se mostramos ou n�o o dropdown, conforme o seu estado.
     */
...
function tableCell(sContent, sId, sWidth, sClasse) {
  ...
  /**
   * Adiciona uma class na TD atrav�s do Id passado.
   */
  ...
  /**
   * Remove a class na TD atrav�s do ID passado
   */
  ...
  /**
   * Seta o conte�do da c�lula e altera em tela
  ...
  /**
   * Retorna o valor da celula.
   * analisa o no filho da celula, para decidir qual informa��o deve pegar.
   * @return string
   */
  this.getValue = function() {
    ...
    switch(oCelulaAtiva.childNodes[0].nodeName) {
      ...
      case "#text" : //n� padrao, a TD possui apenas texto, sem nenhuma tag html.
  ...
  /**
   * Define a Utiliza��o de Colspan pela C�lula
   * @param lUtilizaColspan      bool
   * @param iQuantidadeMesclagem integer - Quantidade de Colunas que v�o ser mescladas
   */
  ...
  /**
   * Adiciona um evento � ser chamado
   * @param sEvento - Evento desejado - EX: onclick, onmousein
   * @param sFuncao - Fun��o � ser executada
   */
...
function tableHeader(sContent, sWidth, iCol, classe, sGridCollNumber) {
  ...
  /**
   * Define se a coluna est� vis�vel ou n�o
   * @type bool
   */
  this.lDisplayed = true;
