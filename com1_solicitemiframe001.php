...
if (isset($incluir) || isset($alterar) || isset($excluir)) {
  ...
  if ($sqlerro == false){
     echo "<script> CurrentWindow.corpo.iframe_solicitem.location.href = 'com1_solicitem001.php?pc11_numero=$pc11_numero&pc11_codigo=$pc13_codigo&pc13_codele=".@$pc13_codele."$parametro'; </script>";
  }
}
