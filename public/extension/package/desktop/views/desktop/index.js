...
var notifications = [];
if (pusher !== null) {
  var userId = document.querySelector('[name="user_id"]');
  userId = userId ? userId.content : 0;
  var channel = pusher.subscribe("private-App.User.".concat(userId));
...
function _getUserNotifications() {
  _getUserNotifications = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, _iterator2, _step2, notification;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return axios.get("".concat(urlApi, "/user/notifications"));
        case 4:
          response = _context.sent;
          notifications.length = 0;
          _iterator2 = _createForOfIteratorHelper(response.data.data);
          try {
...
function renderNotification(notification) {
  ...
  div.innerHTML = notification.title;
...
function countNotifications() {
  var countNotification = document.getElementById('count-notifications');
...
function _markAsRead() {
  _markAsRead = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var id;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 2;
          _context2.next = 5;
          return axios.put("".concat(urlApi, "/user/notifications/").concat(id));
        case 5:
          _context2.next = 7;
...
function loading(loading) {
  var divLoading = document.getElementById('notification-loader');
  var notificationsList = document.getElementById('notifications');
