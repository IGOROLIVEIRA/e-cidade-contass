...
<body bgcolor=#CCCCCC leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table width="100%" height="100%" border="0" align="center" cellspacing="0" bgcolor="#CCCCCC">
		<tr>
				...
				<table width="100%" border="0" cellspacing="0">
					<form name="form2" method="post" action="">
						...
						<tr>
							...
							<td>
								<?
								db_input('z01_numcgm', 6, $Iz01_numcgm, true, 'text', 4, "onkeyup='js_ValidaCampos(this,1,\"C�digo\",\"\",\"\",event);'", "numcgmDigitadoParaPesquisa");
								?>
							</td>
							<td align="right">
			...
			<script>
				/*
         Valida para n�o deixar colar letras nos campos num�ricos
         */
			...
			<td align="center" valign="top">
				...
				if (!isset($pesquisa_chave)) {
					...
					if (isset($campos) == false) {
						$campos = " distinct cgm.z01_numcgm, to_ascii(z01_nome) as z01_nome,trim(z01_cgccpf) as z01_cgccpf, case when length(trim(z01_cgccpf)) = 14 then 'JURIDICA' else 'F�SICA' end as tipo, trim(z01_ender) as z01_ender, z01_munic, cgm.z01_uf, z01_cep, z01_email,cgm.z01_incest";
					}
					...
					if (isset($lCadTecMunic)) {
						$campos = " distinct cgm.z01_numcgm, to_ascii(z01_nome) as z01_nome,trim(z01_cgccpf) as z01_cgccpf, case when length(trim(z01_cgccpf)) = 14 then 'JURIDICA' else 'F�SICA' end as tipo, trim(z01_ender) as z01_ender, z01_numero, z01_compl, z01_munic, cgm.z01_uf, z01_cep, z01_email,cgm.z01_incest";
					}

					if (isset($lCadTec)) {
						$campos = " distinct cgm.z01_numcgm, to_ascii(z01_nome) as z01_nome,trim(z01_cgccpf) as z01_cgccpf, case when length(trim(z01_cgccpf)) = 14 then 'JURIDICA' else 'F�SICA' end as tipo, q02_inscr, q02_inscmu, trim(z01_ender) as z01_ender, z01_numero, z01_compl, z01_munic, cgm.z01_uf, z01_cep, z01_email,cgm.z01_incest";
					}
					...
					if (isset($nomeDigitadoParaPesquisa) && ($nomeDigitadoParaPesquisa != "")) {
						...
						$campos 		 = "z05_numcgm as z01_numcgm, z05_nome as z01_nome,trim(z05_cgccpf) as z05_cgccpf, case when length(trim(z05_cgccpf)) = 14 then 'JURIDICA' else 'F�SICA' end as tipo, trim(z05_ender) as z05_ender, z05_munic, z05_uf, z05_cep, z05_email,z05_data_alt, z05_hora_alt,login";
						$sSqlConv = "";
						if (isset($z01_tipcre_cnpj)) {
							$sSqlConv .= " and z01_tipcre = 2 ";
						}
										...
										<td>
											<fieldset>
												...
												<table>
													<tr>
														<td>
															Clique no bot�o abaixo para pesquisar nomes alterados!
														</td>
													</tr>
												</table>
											</fieldset>
