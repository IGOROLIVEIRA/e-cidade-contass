...
if (isset($_POST['btnSalvar'])){
  ...
  foreach ($oDados as $oRow) {
     ...
     $_POST['cargo'] = trim(utf8_encode($_POST['cargo']));
		  ...
		  if (filesize($sArquivo) > filesize("config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomresponsavel.xml")/2) { 
		    system("cp $sArquivo config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomresponsavel.xml");
		  }
			echo"
