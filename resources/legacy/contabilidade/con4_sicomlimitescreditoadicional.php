...
$sArquivo = "config/sicom/".db_getsession("DB_anousu")."/{$sCnpj}_sicomlimitescreditoadicional.xml";
  	...
  	$iUltimoCodigo = $oRow->getAttribute("codigo");
  	   ...
  	   */
		  ...
		  $oDOMDocument->save($sArquivo);
			if (filesize($sArquivo) > filesize("config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomlimitescreditoadicional.xml")/2) { 
		    system("cp $sArquivo config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomlimitescreditoadicional.xml");
		  }
			echo"
