			...
			if (@$outrasmatriculas == true ){
				...
				<table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
				  <tr>
					...
					<a class=\"links2\" onClick=\"js_MudaLink('outrasmatrículas')\" id=\"outrasmatriculas\"  href=\"cai3_gerfinanc018.php?opcao=matricula&matricula=".$tipo_pesq[1]."&numcgm=".$z01_numcgm."\" target=\"debitos\">MATRÍCULAS CADASTRADAS</a>
				     </td>
				  </tr>
				</table>\n";
			 }
