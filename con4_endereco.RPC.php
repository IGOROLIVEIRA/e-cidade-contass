...
switch ($oParam->exec) {
  ...
  case 'findCep':
    ...
    // $aRetorno->codIbge = municipio::getCodigoIbgeBySequencial('',$aRetorno->endereco[0]->imunicipio);
  ...
  case 'salvarEndereco':
    ...
    try {
      ...
      $oEndereco->setCodigoIbge($oParam->endereco->codigoIbge);

      $oEndereco->salvaEndereco();

      db_fim_transacao(false);
      $aRetorno->icodigoEndereco  = $oEndereco->getCodigoEndereco();
      $aRetorno->icodigoIbge      = $oEndereco->getCodigoIbge();
  ...
  case 'buscaEndereco':
    ...
    try{
     ...
     $oRetorno->endereco->iIbge             = $oEndereco->getCodigoIbge();
