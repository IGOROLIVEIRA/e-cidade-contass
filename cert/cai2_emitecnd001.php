<?
// codproc - numero do processo
//           se for incluido por exemplo 1/2000, processo 1 de 2000, a variavel exercicio serã 200 senao serã o ano atual
// exercicio - exercicio do processo
// codimpresso - codigo a ser impresso na certidao
...
//**************************************************************************************************************************//
  ...
  $rescodimpresso = $clnumpref->sql_record($clnumpref->sql_query(db_getsession("DB_anousu"),"k03_tipocodcert"));
  if($clnumpref->numrows==0)
  	db_redireciona("db_erros.php?fechar=true&db_erro=Tipo de codificação da certdão não configurada nos parâmetros.");
...
//****************************************    P D F   ******************************************************// 
   ...
   if(isset($cadrecibo) && $cadrecibo == 't'){
    ...
    if($clcertidao->p50_codimpresso!="")
 	  $pdf->MultiCell(0,4,$tipocer.' N'.chr(176).' '.$clcertidao->p50_codimpresso,0,"C",0);
    else 	
 	  $pdf->MultiCell(0,4,$tipocer,0,"C",0);
