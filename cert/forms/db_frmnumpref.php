...
db_input('k03_anousu',5,$Ik03_anousu,true,'text',3,"")
?>
    </td>
  </tr>
  <tr>
...
db_input('k06_descr',50,$Ik06_descr,true,'text',3,'')
    ...
    <tr>
    <td nowrap title="<?=@$Tk03_tipocodcert?>">
       <?
       echo $Lk03_tipocodcert;
       ?>
    </td>
    <td> 
    <?
    $x = array("0"=>"Não codifica","1"=>"Código Sequencial geral","2"=>"Código do Processo","3"=>"Sequencial conforme tipo"); 
    db_select('k03_tipocodcert',$x,true,'text',$db_opcao)
    ?>
    </td>
  </tr>
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_numpref','func_numpref.php?funcao_js=parent.js_preenchepesquisa|k03_anousu','Pesquisa',true);
}
