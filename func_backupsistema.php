...
system("pg_dump -U dbportal e-cidade | bzip2 -c > /var/www/e-cidade/tmp/backup_e-cidade_".date("dmY").".sql.bz2");
...
echo json_encode("/var/www/e-cidade/tmp/backup_e-cidade_".date("dmY").".sql.bz2");
