...
<html>
  ...
  <body class="body-default">
    ...
    <center>
      ...
      <strong>Apenas serão aceitas imagens do tipo "JPG", "JPEG" e "PNG" com tamanho máximo de <span style='color:red'>100 KB</span>.</strong>
    </center>
...
oGridFotos.show($('ctnDbGridFotos'));
 ...
 function js_getFotos() {
   ...
   oParam.iBem      = iNumBem;
   oParam.iLote     = iLote;
   console.log('Parametros js...', oParam);
   var oAjax        = new Ajax.Request(
                               sUrlRpc,
                              { parameters: 'json='+Object.toJSON(oParam),
                                method: 'post',
