        ...
        <form name="form" id="form" method="post" action="" enctype="multipart/form-data">
            ...
            <table class="form-container">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        db_input('l221_sequencial', 12, $Il221_sequencial, true, 'text', 3, " onChange='js_pesquisaata(false);'");
...
<script type="text/javascript">
    ...
    function js_pesquisaata(mostra){
        if(mostra===true){
            js_OpenJanelaIframe('CurrentWindow.corpo',
                ...
                'func_licatareg.php?enviopncp=true&funcao_js=parent.js_preencheAta|l221_sequencial|l20_objeto',
                'Pesquisa Atas',true);
        }else{
            js_OpenJanelaIframe('CurrentWindow.corpo',
                'db_iframe_acocontroleataspncp',
                'func_licatareg.php?enviopncp=true&pesquisa_chave='+
                document.form.l221_sequencial.value+'&funcao_js=parent.js_preencheAta2',
                'Pesquisa',false);
        }
    }

    function js_preencheAta(l221_sequencial,l20_objeto){
        document.form.l221_sequencial.value = l221_sequencial;
    ...
    function js_getAnexo() {
        ...
        oParam.sequencial = $F('l221_sequencial');
    ...
    function js_enviarDocumentoPNCP() {
        ...
        let iCodigoAta = $('l221_sequencial').value;
        let aDocumentos = [];
