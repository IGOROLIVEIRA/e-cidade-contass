...
$result14 = pg_query("DELETE FROM alunonecessidade");
$result15 = pg_query("DELETE FROM necessidade WHERE ed48_i_codigo < 100");
$result16 = pg_query("ALTER SEQUENCE necessidade_ed48_i_codigo_seq START 114");

$result17 = pg_query("UPDATE telefoneescola SET ed26_i_ddd = substr(ed26_i_ddd,1,2)::integer");
$result18 = pg_query("UPDATE telefoneescola SET ed26_i_numero = substr(ed26_i_numero,1,8)::integer");
$result19 = pg_query("ALTER TABLE escolaestrutura ADD ed255_i_aee integer");
$result20 = pg_query("UPDATE escolaestrutura SET ed255_i_aee = 0");
$result21 = pg_query("ALTER TABLE escolaestrutura ADD ed255_i_efciclos integer");
$result22 = pg_query("UPDATE escolaestrutura SET ed255_i_efciclos = 0");
$result23 = pg_query("ALTER TABLE turmaac ADD ed268_c_aee char(20)");
$result24 = pg_query("UPDATE escolaestrutura SET ed255_c_dependencias = '00000000000000001'");
$result25 = pg_query("UPDATE escolaestrutura SET ed255_c_equipamentos = '0000000'");
$result26 = pg_query("UPDATE escolaestrutura SET ed255_c_materdidatico = '100'");

$result27 = pg_query("ALTER TABLE caddisciplina DROP CONSTRAINT caddisciplina_censodisciplina_fk");

$result28 = pg_query("INSERT INTO censodisciplina VALUES(25,'DISCIPLINAS PEDAGOGICAS')");
$result29 = pg_query("INSERT INTO censodisciplina VALUES(26,'ENSINO RELIGIOSO')");
$result30 = pg_query("INSERT INTO censodisciplina VALUES(27,'LINGUA INDIGENA')");
$result31 = pg_query("INSERT INTO censodisciplina VALUES(99,'OUTRAS DISCIPLINAS')");
$result32 = pg_query("DELETE FROM censoregradisc WHERE ed272_i_censodisciplina in (18,19)");
$result33 = pg_query("DELETE FROM censodisciplina WHERE ed265_i_codigo in (18,19)");
$result34 = pg_query("UPDATE caddisciplina SET ed232_i_codcenso = 99 WHERE ed232_i_codcenso in (18,19,24)");
$result35 = pg_query("UPDATE censoregradisc SET ed272_i_censodisciplina = 99 WHERE ed272_i_censodisciplina = 24");
$result36 = pg_query("UPDATE caddisciplina SET ed232_i_codcenso = 26 WHERE ed232_i_codigo = 17");
$result37 = pg_query("DELETE FROM censodisciplina WHERE ed265_i_codigo = 24");

$result38 = pg_query("ALTER TABLE caddisciplina ADD CONSTRAINT caddisciplina_censodisciplina_fk FOREIGN KEY (ed232_i_codcenso) REFERENCES censodisciplina");
$result39 = pg_query("ALTER TABLE turmaac ADD ed268_c_horaini char(5)");
$result40 = pg_query("ALTER TABLE turmaac ADD ed268_c_horafim char(5)");
