...
set_time_limit(0);
$host="192.168.0.2";
$base="auto_sapiranga_20090426_v102";
$user="postgres";
$pass="";
$port="5432";
...
system("clear");
pg_exec("begin");
$z01_munic_banco = array("NOVO HAMBURGO]"=>"4313409",
                         "SANTA MA HERVAL"=>"4307104"
                        );
$rh01_natura_banco = array("CACHOEURA DO SUL"=>"4303004",
                           "CAMPO BOM "=>"4303905",
                           "DOIS IRMÃOS"=>"4306403",
                           "MAL. CANDIDO RONDON"=>"4114609",
                           "PAROBÉ"=>"4314050",
                           "SAO JOSE DO HORTENCIA"=>"4318481",
                           "SAO LOURENÇO DO SUL"=>"4318804",
                           "STO ANTONIO DA PATRULHA"=>"4317608",
                           "STO ANT SUDOESTE"=>"4124400"
...
for($x=0;$x<$linhas;$x++){
 ...
 if($z01_munic!=""){
  $naotem = false;
  reset($z01_munic_banco);
  for($t=0;$t<count($z01_munic_banco);$t++){
   if($z01_munic==key($z01_munic_banco)){
    $z01_munic = $z01_munic_banco[key($z01_munic_banco)];
    $naotem = true;
    break;
   }
   next($z01_munic_banco);
  }
  if($naotem==false){
   ...
   if($z01_munic!=""){
    $sql1 = "SELECT ed261_i_censouf FROM censomunic WHERE ed261_i_codigo = $z01_munic";
    $result1 = pg_query($sql1);
    $ed20_i_censomunicender = $z01_munic;
    $ed20_i_censoufender = pg_result($result1,0,0);
   }else{
    $ed20_i_censomunicender = "null";
    $ed20_i_censoufender = "null";
   }
