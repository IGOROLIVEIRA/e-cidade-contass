...
set_time_limit(0);
$host="192.168.0.2";
$base="auto_capivari_20090428_v103";
$user="postgres";
$pass="";
$port="5432";
...
system("clear");
pg_exec("begin");
$z01_munic_banco = array("BALNEÁRIO PINHAL"=>"4301636",
                         "OSÓRIO"=>"4313508"
                        );
$rh01_natura_banco = array("PALMARES DOSUL"=>"4313656",
                           "STO ANTONIO PATRULHA"=>"4317608"
                          );
$sql = "SELECT z01_nome,
               z01_mae,
               z01_munic,
