...
$objAlunonecessidade = new tableDataManager ( $connOrigem, 'escola.alunonecessidade', 'ed214_i_codigo', true, 1);
...
pg_query( $connOrigem, $strSQL ) or die ( "\n ERRO: $strSQL \n\n ".pg_errormessage() );
pg_query($connOrigem, "commit");
	 ...
	 if($ed47_i_atendespec==1){
	  ...
	  for($w=0;$w<13;$w++){
	    ...
	    if( $ed214_i_necessidade[$w] > 0 ){ 
		 ...
		 $objAlunonecessidade->ed214_c_principal   = "N�O";
