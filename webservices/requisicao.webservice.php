...
$HTTP_SERVER_VARS['SCRIPT_FILENAME']       ='/var/www/e-cidade.2.3.39/webservices/requisicao.webservice.php';
$HTTP_SERVER_VARS['SCRIPT_NAME']           ='/var/www/e-cidade.2.3.39/webservices/requisicao.webservice.php';
$HTTP_SERVER_VARS['PHP_SELF']              ='e-cidade.2.3.39/webservices/requisicao.webservice.php';
...
$oSoapServer = new SoapServer(null,
                              array('uri' => 'http://10.250.30.11/e-cidade.2.3.39/'));
