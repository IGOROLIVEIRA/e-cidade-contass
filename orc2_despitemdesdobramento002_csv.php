...
$result = db_dotacaosaldo(8,1,4,true,$sele_work,$anousu,$dtini,$datafin);
for($contDotacao = 0; $contDotacao < pg_numrows($result); $contDotacao++){
    db_fieldsmemory($result,$contDotacao);
    if($o58_elemento != ""){
...
$result = db_query($cldesdobramento->sql($sele_work2,$dtini,$dtfim,$instits)) or die($cldesdobramento->sql($sele_work2,$dtini,$dtfim,$instits).pg_last_error());
