...
for ($ii = 0; $ii < $this->linhasdositens; $ii++) {
  ...
  $descricaoitem = 'RESUMO: ' . trim(pg_result($this->recorddositens, $ii, $this->descricaoitem));
...
// Separa cada item com uma linha
  ...
  // $resumo = stripslashes($descricaoitem);
  ...
  if ((isset($resumo) && $resumo != "" && $volta_impressao == 0) || $volta_impressao == 1) {
    ...
    $resumo = $this->objpdf->Row_multicell(array('', '', '', stripslashes($resumo), '', ''), $dist, false, 5, 0, true, true, 3, ($this->objpdf->h - 35));
    if ($resumo != "") {
      $volta_impressao = 1;
  ...
  if ((isset($prazo) && $prazo != "" && $volta_impressao == 0) || $volta_impressao == 2) {
    $volta_impressao = 0;
    $prazo = $this->objpdf->Row_multicell(array('', '', '', stripslashes($prazo), '', ''), $dist, false, 5, 0, true, true, 3, ($this->objpdf->h - 35));
    if ($prazo != "") {
      $volta_impressao = 2;
  ...
  if ((isset($pgto) && $pgto != "" && $volta_impressao == 0) || $volta_impressao == 3) {
    $volta_impressao = 0;
    $pgto = $this->objpdf->Row_multicell(array('', '', '', stripslashes($pgto), '', ''), $dist, false, 5, 0, true, true, 3, ($this->objpdf->h - 35));
    if ($pgto != "") {
      $volta_impressao = 3;
