...
class db_impcarne extends cl_assinatura
{
  ...
  // VARUAVEUS PRECO REFERENCIA
  var $inscricaoestadualinstituicao ="";
  var $codpreco = "";
  var $precoreferencia = "";
  var $datacotacao = "";
  var $pc80_tipoprocesso = "";
  var $pc80_criterioadjudicacao = "";
  var $impjust = "";
  var $tipoprecoreferencia = "";
  var $rsLotes = "";
  var $sqlitens = "";
  var $quantLinhas = 0;
