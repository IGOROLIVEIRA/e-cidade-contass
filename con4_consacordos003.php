...
if ($clAcordo->getInstit() != db_getsession('DB_instit')) {
    ...
    $sMensagem = "Acordo de c�digo {$oGet->ac16_sequencial} n�o pertence a institui��o {$oInstituicao->getDescricao()}.";
    ...
    <center>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td class="tdBgColor">
                                    ...
                                    $sDescricaoAcordoGrupo = "N�o definido!";
                            ...
                            <tr>
                                ...
                                <td class="tdBgColor">
                                    ...
                                    if (!$clAcordo->getSituacaoVigencia()) {
                                        ...
                                        echo "{$oDataInicial->getDate(DBDate::DATA_PTBR)} at� {$oDataFinal->getDate(DBDate::DATA_PTBR)}";
                                    } else {
                                        echo "-";
                                    }
                                    ?>
                            ...
                            <tr>
                                ...
                                <td class="tdWidth"><b>Classifica��o:</b></td>
                                <td class="tdBgColor" colspan="1">
         ...
         */
            ...
            if ($clAcordo->getTipoOrigem() ==  "5" || $clAcordo->getTipoOrigem() ==  "8" || $clAcordo->getTipoOrigem() ==  "9") {
                $oTabDetalhes->add(
                    "Licita��o Realizada por outros �rg�os",
                    "Licita��o Realizada por outros �rg�os",
            ...
            //    $oTabDetalhes->add("paralisacoes", "Paralisa��es",
...
<script type="text/javascript">
    function js_windowAditamentosDetalhes(aDados) {
        ...
        oWindowGridDetalhesAditamento = new windowAux('wndGridDetalhesAditamento', '�tens do Aditamento ',
        ...
        oGrvDetalhesAditamento.setHeader(new Array('C�digo', 'Descri��o', 'Quantidade', 'Unidade', 'Valor Unit�rio',
            'Valor Total'));
    ...
    function js_consultaLicitacao(iCodigoLicitacao) {
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_infolic', 'lic3_licitacao002.php?l20_codigo=' + iCodigoLicitacao, 'Pesquisa Licita��o', true);
    }

    function js_consultaLicitacaooutroorgao(iCodigoLicitacao) {
        js_OpenJanelaIframe('top.corpo', 'db_iframe_infolic', 'lic3_licitacao002.php?l20_codigo=' + iCodigoLicitacao, 'Pesquisa Licita��o', true);
    }
    ...
    function js_showInfoItem(oDados) {
        ...
        sContent += "  </div>";
        sContent += "  <fieldset style='text-align:center;border:0px;border-top:2px groove white'>";
        sContent += "    <legend><b>Dota��es</b></legend>";
        ...
        oGridDotacoes.setHeader(new Array("Dota��o", "Valor", "Valor Util.", "Valor reservado", "Reserva"));
    ...
    function js_openPrevisao(iCodigo) {
        ...
        oPrevisao = new DBViewAcordoPrevisao(iCodigo, 'oPrevisao', 'Previs�o de Execu��o do Contrato',
        ...
        oPrevisao.show();
        oPrevisao.setAjuda('Previs�es de execu��o do contrato ' + iCodigo + ' - ' + sDescricaoContrato);
    }
</script>
