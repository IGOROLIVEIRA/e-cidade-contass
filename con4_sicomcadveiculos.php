...
if (isset($_POST['btnSalvar'])){
  ...
  foreach ($oDados as $oRow) {
  	   ...
  	   */
		  ...
		  if (filesize($sArquivo) > filesize("config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomcadveiculos.xml")/2) { 
		    system("cp $sArquivo config/sicom/".db_getsession("DB_anousu")."/backup_{$sCnpj}_sicomcadveiculos.xml");
		  }
			echo"
