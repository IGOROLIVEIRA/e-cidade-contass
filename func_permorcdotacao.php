 ...
 * retirado condi��o pois n�o estava permitindo retornar dota��es na hora
 * de empenhar
 */
/*else{
...
// vari�vel que determina o obrigatoriedade de digitar departamento
//$obriga_depto = "sim";
...
if (!isset($filtroquery)) {
  // vari�vel usada na solicita��o de compras para retornar departamento quando o reduzido � digitado
  if (!isset($retornadepart)) {
    $retornadepart = null;
  }
  // desmentando abaixo descobrimos se a classe
  // esta retornando as permiss�es
    ...
    if (isset($chave_o58_coddot) && $chave_o58_coddot != "") {
      ...
      if ($tem_perm == 1) {
        ...
        if ($passar) {
          ...
          // vari�vel retornadepart usada na solicita��o de compras para retornar departamento quando o reduzido � digitado
          ...
          $erro  = "Voc� deve selecionar um Departamento!";
        }
      } else {
        $erro = "Sem permiss�o para esta dota��o!";
      }
    }
}
?>
...
<head>
  ...
  <script>
    ...
    function js_origempermissao() {
      ...
      js_OpenJanelaIframe('parent', 'db_iframe_origempermissao', sUrl, 'Origem Permiss�o', true, '0', 1);
    }
  </script>
</head>
      ...
      <tr>
        <td valign="top" align="center">
            ...
            <table border="0" cellspacing="0">
                ...
                <td>
                  ...
                  if ($clpermusuario_dotacao->sql != "") {
                    ...
                    if ($result != false && pg_numrows($result) > 0) {
                      ...
                      $sem_departamento = "N�o existem departamentos para esta secret�ria";
              ...
              <tr>
                <td colspan="2" align="center">
                  ...
                  <input name="origempermissao" type="button" id="origempermissao" value="Origem Permiss�o" onClick="js_origempermissao();">
                </td>
              </tr>
            </table>
          </form>
          ...
          if ($clpermusuario_dotacao->sql != "") {
            ...
            echo "<table><tr><td><br><strong>N�o existe dota��o para este item</strong>.</td></tr></table>";
          }
