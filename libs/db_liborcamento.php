...
function db_receitasaldosicom($nivel = 11, $tipo_nivel = 1, $tipo_saldo = 2, $descr = true, $where = '', $anousu = null, $dataini = null, $datafim = null, $query = false, $campos = ' * ', $comit = true,$nivel_agrupar=0) {
  ...
  if( $anousu > 2007 ){
    ...
    k81_exerc, 
    k81_emparlamentar
    from(select DISTINCT o70_anousu, o70_codrec, o70_codfon, o70_codigo, o70_valor, o70_reclan,
                o70_instit, o70_concarpeculiar,
                o57_codfon, o57_anousu, o57_fonte, o57_descr, o57_finali,
                k81_regrepasse, k81_exerc, k81_emparlamentar,
                fc_receitasaldo($anousu,o70_codrec,$tipo_saldo,'$dataini','$datafim')
    from orcreceita d
    LEFT JOIN taborc ON (d.o70_anousu, d.o70_codrec) = (k02_anousu,k02_codrec)
    LEFT JOIN tabrec ON (taborc.k02_codigo,taborc.k02_anousu) = (tabrec.k02_codigo,d.o70_anousu)
    LEFT JOIN placaixarec ON tabrec.k02_codigo = k81_receita
    inner join orcfontes e on d.o70_codfon = e.o57_codfon and e.o57_anousu = d.o70_anousu
    where o70_anousu = $anousu
    $condicao
    order by o57_fonte
...
//db_criatabela($result);exit;
    ...
    $nivel5 .= "	      subelemento,k81_regrepasse, 
    k81_exerc, 
    k81_emparlamentar
    ) as e";
