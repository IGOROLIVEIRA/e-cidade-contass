...
$HTTP_SESSION_VARS['DB_document_root'    ] = '/var/www/dbportal';
 ...
 */
$configCuboBi                         = array();
$configCuboBi['ftp']['server']        = "54.175.32.7";
$configCuboBi['ftp']['usuario']       = "dbseller";
$configCuboBi['ftp']['senha']         = "dbseller2015";
$configCuboBi['ftp']['diretorio']     = "gp-{cliente}";
$configCuboBi['ftp']['passive_mode']  = false;