        ...
        try {
            foreach ($oParam->aContratos as $aContrato) {
                ...
                if ($rsApiPNCP[1] == 201) {
                    ...
                    $ac213_numerocontrolepncp = '17316563000196-2-'. str_pad(substr($codigocontrato[0],75),6,'0', STR_PAD_LEFT). '/' .$oDadosContrato->anocontrato;
                    ...
                    $clacocontrolepncp->ac213_ano = substr($codigocontrato[0], 70, 4);
                    $clacocontrolepncp->ac213_sequencialpncp = str_pad(substr($codigocontrato[0], 75), 6, '0', STR_PAD_LEFT);
