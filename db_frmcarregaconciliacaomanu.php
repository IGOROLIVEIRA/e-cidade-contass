...
<center>
<fieldset style="width: 980px;margin-left: 0p	x; margin-top: 80px;">
...
<table border="0">
  <tr>
	...
	db_input('k199_saldofinalextrato',17,$Ik199_saldofinalextrato,true,'text',3,"");
	?>
    </td>
  </tr>
...
function js_click(){
   ...
   /*  var url       = 'cai4_verificadados.php';
     var parametro = 'banco='+banco+'&periodoini='+periodoinicio+'&periodofim='+periodofim+'&codconta='+codigoconta;  
     var objAjax   = new Ajax.Request (url,{method:'post',parameters:parametro});

	
	/*var url       = 'cai4_verificadados.php';
    var parametro = 'banco='+banco+'&codigoconta='+codigoconta+'&periodoinicio='+periodoinicio+'&periodofim='+periodofim;
    
    var objAjax   = new Ajax.Request (url,{method:'post',parameters:parametro,onComplete:js_click});*/
...
function js_salvaconciliacao(){
	...
	// document.getElementById('salvarconciliacao').disabled = true;
