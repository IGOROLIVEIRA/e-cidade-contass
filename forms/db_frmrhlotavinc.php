...
function js_importa() {
  js_OpenJanelaIframe('top.corpo.iframe_rhlotavinc', 'db_iframe_rhlotavinc', 'func_rhlotavinc.php?filtroano=true&funcao_js=parent.js_confirmaimporta|rh25_codlotavinc', 'Pesquisa', true, 0);
}
