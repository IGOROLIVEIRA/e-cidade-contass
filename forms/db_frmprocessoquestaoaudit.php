    ...
    <table>
        <tr>
            ...
            <?
                ...
                $cliframe_alterar_excluir->sql     = $clquestaoaudit->sql_query_file(null,"*","ci02_codquestao","ci02_codtipo = $ci03_codtipoquest and ci02_instit = ".db_getsession('DB_instit'));
