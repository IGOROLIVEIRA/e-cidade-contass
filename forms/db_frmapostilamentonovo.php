    ...
    <form name="form1" method="post" action="">
        ...
        <table border="0" style="margin-right: 10px; margin-left: -45%;">
            ...
            <tr>
                ...
                <td>
                    <?
                    $x = array("00" => "Selecione...", "01" => "Reajuste de preço previsto no contrato", "02" => "Atualizações, compensações ou penalizações", "03" => "Empenho de dotações oramentárias suplementares");
            ...
            <tr>
                ...
                <td>
                    <?
                    $x = array("1" => "Acrescimo de valor", "2" => "Decrescimo de valor", "3" => "Não houve alteração de valor");
...
<<<<<<< HEAD
        sContent += "<fieldset><legend>Adicionar Dota��es</legend>";
=======
...
<<<<<<< HEAD
        sContent += "       onclick='pesquisao47_coddot(true);'><b>Dota��es:</b></a>";
        sContent += "     </td>";
        sContent += "     <td id='inputdotacao'></td>";
        sContent += "     <td>";
        sContent += "      <b>Saldo Dota��es:</b>";
=======
...
<<<<<<< HEAD
        ...
        oGridDotacoes.setHeader(["Dota��es", "Valor", "&nbsp;"]);
=======
...
<<<<<<< HEAD
        if (confirm("Remover dota��es do item?")) {
=======
...
<<<<<<< HEAD
            alert("Campo dota��es � de preenchimento obrigat�rio.");
=======
...
>>>>>>> master
        ...
        aItensPosicao[iLinha].dotacoes.forEach(function(oDotacaoItem) {
            ...
            if (oDotacaoItem.dotacao == oDotacao.dotacao) {
                lInserir = false;
<<<<<<< HEAD
                alert("Dota��es j� incluida para o item.");
=======
...
<<<<<<< HEAD
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_saldos', arq, 'Saldo da dota��es', true);
=======
...
>>>>>>> master
    ...
    /**
<<<<<<< HEAD
     * calcula os valores da dota��es conforme o valor modificado pelo usuario
=======
