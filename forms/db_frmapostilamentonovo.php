...
<script>
    ...
    oGridItens.setHeader(["C�d", "Item", "Qtde Anterior", "Vl Unit Anterior", "Quantidade", "Vl Unit�rio", "Vl Total", "Vl Apostilado", "Qt Aditada", "Dota��es", "Seq"]);
    ...
    function saveDotacao(iLinha) {
        ...
        if (nValorTotal > (aItensPosicao[iLinha].quantidade * aItensPosicao[iLinha].valorunitario)) {
            alert("Valor Dota��es maior que valor do item.");
            return false;
        }
    ...
    function mostraSaldo(chave) {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_saldos', arq, 'Saldo da dota��o', true);
