...
<script>
    function js_pesquisa(){
        js_OpenJanelaIframe('','db_iframe_naturrecsiope','func_naturrecsiope.php?funcao_js=parent.js_preenchepesquisa|c224_natrececidade|c224_natrecsiope','Pesquisa',true,0);
    }
