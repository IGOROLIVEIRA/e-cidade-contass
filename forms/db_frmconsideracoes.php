...
$x = array("IDE"=>"IDE","PESSOA"=>"PESSOA","ORGAO"=>"ORGAO","CONSOR"=>"CONSOR","PAREC"=>"PAREC",
  "REC"=>"REC","ARC"=>"ARC","LAO"=>"LAO","AOC"=>"AOC","ITEM"=>"ITEM","REGLIC"=>"REGLIC","ABERLIC"=>"ABERLIC",
   ...
   "AOB"=>"AOB","NTF"=>"NTF","CVC"=>"CVC","DDC"=>"DDC","PARPPS"=>"PARPPS","DCLRF"=>"DCLRF","SUPDEF"=>"SUPDEF","CONSID"=>"CONSID");
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_consideracoes','func_consideracoes.php?funcao_js=parent.js_preenchepesquisa|si171_sequencial','Pesquisa',true);
}
