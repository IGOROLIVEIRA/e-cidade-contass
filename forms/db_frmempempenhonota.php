    ...
    <fieldset style="width:800px">
        ...
        <center>
            <table border="0">
                ...
                <tr>
                    <td nowrap title="Data da Senten�a Judical">
                        <strong>Data da Senten�a Judical:</strong>
                    </td>
                    <td>
                        <?
            ...
            <input name="lanc" type="button" id="lanc" value="Lan�ar autoriza��es"
                   onclick="parent.location.href='emp1_empautoriza001.php';">

            <?php $lDisable = empty($e60_numemp) ? "disabled" : ''; ?>

            <input type="button" id="btnLancarCotasMensais" value="Manuten��o das Cotas Mensais"
                   onclick="manutencaoCotasMensais();" <?php echo $lDisable; ?> />
            <input name="pesquisar" type="button" id="pesquisar" value="Pesquisar autoriza��es"
                   onclick="js_pesquisa();">
        </center>
</form>
