...
<form name="form1" method="post" action="">
  <center>
    <fieldset style="margin-left: 80px; margin-top: 10px;">
      <legend>Identifica��o dos Respos�veis</legend>
      <table border="0">
        <tr>
        ...
        <tr>
          ...
          <td>
            ...
            if (db_getsession("DB_modulo") != 952) {
              $x = array('1' => 'Gestor', '2' => 'Contador', '3' => 'Controle Interno', '4' => 'Ordenador de Despesa por Delega��o', '5' => 'Tesoureiro', '6' => 'Respons�vel Pelo Or�amento Municipal');
            } else {
              $x = array('7' => 'Respons�vel pelo envio');
            }
        ...
        <tr id="orgao" style="visibility: hidden;">
          <td nowrap title="<?= @$Tsi166_orgao ?>">
            <? db_ancora("<b>Org�o</b>", "js_pesquisao41_orgao(true);", $db_opcao); ?>
          </td>
          <td>
            <?
