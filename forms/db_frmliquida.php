...
function js_saida(oAjax){
   ...
   js_removeObj("msgBox"); 
    ...
    // $('ct01_codcategoria').value  = obj.ct01_codcategoria; 
    // $('numempresa').value         = obj.numempresa; 
    // $('valorremuneracao').value   = obj.valorremuneracao; 
    // $('valordesconto').value      = obj.valordesconto; 
    // $('competencia').value        = obj.competencia;
