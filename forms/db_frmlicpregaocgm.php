...
<table border="0">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
	<?
	$al46_tipo = array('1'=>'1-Leiloeiro','2'=>'2-Membro/Equipe de Apoio','3'=>'3-Presidente','4'=>'4-Secretário','5'=>'5-Servidor Designado','6'=>'6-Pregoeiro');
...
function js_pesquisal46_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo.iframe_licpregaocgm','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true,'0','1');
  }else{
     if(document.form1.l46_numcgm.value != ''){
        js_OpenJanelaIframe('CurrentWindow.corpo.iframe_licpregaocgm','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.l46_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false);
     }else{
