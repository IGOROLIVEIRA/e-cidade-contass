...
<script>
    function js_pesquisa(){
        js_OpenJanelaIframe('','db_iframe_naturdessiops','func_naturdessiops.php?funcao_js=parent.js_preenchepesquisa|c226_natdespecidade|c226_natdespsiops','Pesquisa',true,0);
    }
