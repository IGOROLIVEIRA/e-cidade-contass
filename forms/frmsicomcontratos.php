...
function codigo_dotacao(cod) {
  ...
  top.corpo.iframe_db_dotacao.location.href='con4_sicomdotacao.php?codigo='+cod;
  if (cod == '') {
 ...
 */
 function js_pesquisa_liclicita(mostra) {
  ...
  function pegar_valor(param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, 
    ...
    top.corpo.iframe_db_dotacao.location.href='con4_sicomdotacao.php?codigo='+param1;
