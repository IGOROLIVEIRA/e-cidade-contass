...
<script>
    function js_pesquisa(){
        js_OpenJanelaIframe('','db_iframe_naturdessiope','func_naturdessiope.php?funcao_js=parent.js_preenchepesquisa|c222_natdespecidade|c222_natdespsiope','Pesquisa',true,0);
    }
