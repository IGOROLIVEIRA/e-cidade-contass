...
?>
  ...
  <tr>
    ...
    <tr>
      ...
      <td>
        <?
          db_input('o142_numeroloa', 20, $Io142_numeroloa, true, 'text', $db_opcao, "")
        ?>
      </td>
      <td>
        <?=$Lo142_dataloa ?>
    ...
    <fieldset><legend><b>Lei do PPA</b></legend>
      <table>
        ...
        <tr>
          ...
          <td>
            <?
              db_input('o142_numeroleippa', 20, $Io142_numeroleippa, true, 'text', $db_opcao, "")
            ?>
          </td>
          <td>
             <?=@$Lo142_dataleippa ?>
        ...
        <td>
          ...
          <td>
            <?
              db_input('o142_leialteracaoppa', 20, $Io142_leialteracaoppa ,true, 'text', $db_opcao, "")
            ?>
          </td>
        </tr>
        <tr>
