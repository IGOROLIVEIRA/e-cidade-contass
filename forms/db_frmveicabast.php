  ...
  <table>
    ...
    function js_pesquisae60_codemp(mostra) {
      if (mostra == true) {
        ...
        js_OpenJanelaIframe('CurrentWindow.corpo', 'db_iframe_empempenho', 'func_empempenho.php?filtroabast=1&ve70_abast='+ve70_abast+'&funcao_js=parent.js_mostraempempenho2|e60_numemp|e60_codemp|e60_anousu|DB_e60_emiss', 'Pesquisa', true);
      } else {
