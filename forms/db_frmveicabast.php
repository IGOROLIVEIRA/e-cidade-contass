...
<script>
    ...
    function js_pesquisae60_codemp(mostra, controlador) {
        if (mostra == true) {
            ...
            if (controlador == 0) {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_empempenho', 'func_empempenho.php?filtroabast=1&ve70_abast=' + ve70_abast + '&chave_e60_codemp=' + e60_codemp + '&funcao_js=parent.js_mostraempempenho2|e60_numemp|e60_codemp|e60_anousu|DB_e60_emiss|e60_numcgm', 'Pesquisa', true);
            } else {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_empempenho', 'func_empempenho.php?filtroabast=1&ve70_abast=' + ve70_abast + '&funcao_js=parent.js_mostraempempenho2|e60_numemp|e60_codemp|e60_anousu|DB_e60_emiss|e60_numcgm', 'Pesquisa', true);
            }

        } else {
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_empempenho', 'func_empempenho.php?filtroabast=1&ve70_abast=' + ve70_abast + '&pesquisa_chave=' + document.form1.si05_numemp.value + '&funcao_js=parent.js_mostraempempenho&lNovoDetalhe=1', 'Pesquisa', false);
        }
    }
    /*
     * Ocorrência: 971
    ...
    function js_pesquisaItem_emp(mostra) {
        if (mostra == true) {
            ...
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_empempitem', 'func_empempitem.php?chave_e62_numemp=' + si05_numemp + '&funcao_js=parent.js_mostraitem_emp2|e62_vlrun|e62_quant', 'Pesquisa', true);
        }
    }
    ...
    function js_pesquisave73_veicretirada(mostra) {
        ...
        if (mostra == true) {
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veicretirada', 'func_veicretirada.php?funcao_js=parent.js_mostraveicretirada1|ve60_codigo|ve60_codigo|ve60_datasaida|ve60_horasaida&codigoveiculo=' + iCodVeiculo, 'Pesquisa', true);
        } else {
            if (document.form1.ve73_veicretirada.value != '') {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veicretirada', 'func_veicretirada.php?pesquisa_chave=' + document.form1.ve73_veicretirada.value + '&funcao_js=parent.js_mostraveicretirada&codigoveiculo=' + iCodVeiculo, 'Pesquisa', false);
            } else {
    ...
    function js_pesquisave70_veiculos(mostra) {
        ...
        if (mostra == true) {
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiculos', 'func_veiculosalt.php?funcao_js=parent.js_mostraveiculos1|ve01_codigo|ve01_placa', 'Pesquisa', true);
        } else {
            if (document.form1.ve70_veiculos.value != '') {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiculos', 'func_veiculosalt.php?pesquisa_chave=' + document.form1.ve70_veiculos.value + '&funcao_js=parent.js_mostraveiculos', 'Pesquisa', false);
            } else {
    ...
    function js_mostraveiculos(chave, erro) {
        ...
        if (erro == true) {
            ...
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiculos', 'func_veiculos.php?sigla=true&pesquisa_chave=' + document.form1.ve70_veiculos.value + '&funcao_js=parent.js_mostraveictipoabast', 'Pesquisa', false);
        }
    }
    ...
    function js_pesquisave70_veiculoscomb(mostra, controlador) {
        ...
        if (mostra == true) {
            if (document.form1.ve70_veiculos.value != "") {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiculoscomb', 'func_veiculoscomb.php?filtrar_veiculo=' + document.form1.ve70_veiculos.value + '&controlador=' + controlador + '&funcao_js=parent.js_mostraveiculoscomb1|ve06_sequencial|ve26_descr|ve06_veiccadcomb', 'Pesquisa', true);
            }
        } else {
            if (document.form1.ve70_veiculoscomb.value != '' && document.form1.ve70_veiculos.value != "") {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiculoscomb', 'func_veiculoscombabast.php?filtrar_veiculocomb=' + document.form1.ve70_veiculoscomb.value + '&controlador=' + controlador + '&funcao_js=parent.js_mostraveiculoscomb&cod_veiculo=' + document.form1.ve70_veiculos.value + '&pesquisa_chave=' + document.form1.ve70_veiculoscomb.value, 'Pesquisa', false);
            } else {
    ...
    function js_pesquisave71_veiccadposto(mostra, conrtolador) {
        ...
        if (mostra == true) {
            if (conrtolador == 0) {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiccadposto', 'func_veiccadpostoalt.php?param_tipo=<?= $param_tipo ?>&chave_numcgm=' + numcgm_posto + '&funcao_js=parent.js_mostraposto1|ve29_codigo|z01_nome|descrdepto|z01_numcgm', 'Pesquisa', true);
            } else {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiccadposto', 'func_veiccadpostoalt.php?param_tipo=<?= $param_tipo ?>&funcao_js=parent.js_mostraposto1|ve29_codigo|z01_nome|descrdepto|z01_numcgm', 'Pesquisa', true);
            }
        } else {
            if (document.form1.ve71_veiccadposto.value != '') {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veiccadposto', 'func_veiccadpostoalt.php?param_tipo=<?= $param_tipo ?>&pesquisa_chave=' + document.form1.ve71_veiccadposto.value + '&funcao_js=parent.js_mostraposto', 'Pesquisa', false);
            } else {
                document.form1.posto.value = '';
            }
        }
    ...
    function js_pesquisa_empnota(mostra) {
        if (mostra == true) {
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_empnota', 'func_empnota.php?funcao_js=parent.js_mostraempnota1|e69_codnota|e69_numero', 'Pesquisa', true);
        } else {
            ...
            if (document.form1.empnota.value != '') {
                js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_empnota', 'func_empnota.php?pesquisa_chave=' + document.form1.empnota.value + '&funcao_js=parent.js_mostraempnota', 'Pesquisa', false);
            }
        }
    }
    ...
    ?>
        ...
        function js_pesquisa() {
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veicabast', 'func_veicabastexclusao.php?funcao_js=parent.js_preenchepesquisa|dl_Cod_Abast', 'Pesquisa', true);
        }
    <?
    } else {
    ?>
        ...
        function js_pesquisa() {
            js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_veicabast', 'func_veicabast.php?funcao_js=parent.js_preenchepesquisa|dl_Cod_Abast', 'Pesquisa', true);
        }
    <?
    }
    ?>
    ...
    function js_pesquisa_ultimamedida() {
        ...
        js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_medida',
        ...
        js_OpenJanelaIframe('(window.CurrentWindow || parent.CurrentWindow).corpo', 'db_iframe_proximamedida',
