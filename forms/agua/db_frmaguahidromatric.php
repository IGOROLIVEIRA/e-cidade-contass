...
function js_pesquisax04_codmarca(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_aguahidromarca','func_aguahidromarca.php?funcao_js=parent.js_mostraaguahidromarca1|x03_codmarca|x03_nomemarca','Pesquisa',true);
  }else{
     if(document.form1.x04_codmarca.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_aguahidromarca','func_aguahidromarca.php?pesquisa_chave='+document.form1.x04_codmarca.value+'&funcao_js=parent.js_mostraaguahidromarca','Pesquisa',false);
     }else{
...
function js_pesquisax04_coddiametro(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_aguahidrodiametro','func_aguahidrodiametro.php?funcao_js=parent.js_mostraaguahidrodiametro1|x15_coddiametro|x15_diametro','Pesquisa',true);
  }else{
     if(document.form1.x04_coddiametro.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_aguahidrodiametro','func_aguahidrodiametro.php?pesquisa_chave='+document.form1.x04_coddiametro.value+'&funcao_js=parent.js_mostraaguahidrodiametro','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_aguabase','func_aguabase.php?funcao_js=parent.js_mostraaguabase1|x01_matric|x01_numcgm','Pesquisa',true);
     ...
     if(document.form1.x04_matric.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_aguabase','func_aguabase.php?pesquisa_chave='+document.form1.x04_matric.value+'&funcao_js=parent.js_mostraaguabase','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_aguahidromatric','func_aguahidromatric.php?funcao_js=parent.js_preenchepesquisa|x04_codhidrometro','Pesquisa',true);
}
