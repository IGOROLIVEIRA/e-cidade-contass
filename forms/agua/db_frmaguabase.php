...
function js_pesquisax01_codrua(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_ruas','func_ruas.php?funcao_js=parent.js_mostraruas1|j14_codigo|j14_nome','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.x01_codrua.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_ruas','func_ruas.php?pesquisa_chave='+document.form1.x01_codrua.value+'&funcao_js=parent.js_mostraruas','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_pesquisax01_codbairro(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_bairro','func_bairro.php?funcao_js=parent.js_mostrabairro1|j13_codi|j13_descr','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.x01_codbairro.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_bairro','func_bairro.php?pesquisa_chave='+document.form1.x01_codbairro.value+'&funcao_js=parent.js_mostrabairro','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_pesquisax01_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_cgm','func_cgm.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.x01_numcgm.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_cgm','func_cgm.php?pesquisa_chave='+document.form1.x01_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo.iframe_aguabase','db_iframe_aguabase','func_aguabase.php?funcao_js=parent.js_preenchepesquisa|x01_matric','Pesquisa',true,'0','1','775','390');
}
