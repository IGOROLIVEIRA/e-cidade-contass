  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_aguahidromatric','func_aguahidromatric.php?funcao_js=parent.js_mostraaguahidromatric1|x04_codhidrometro|x04_codmarca','Pesquisa',true);
     ...
     if(document.form1.x21_codhidrometro.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_aguahidromatric','func_aguahidromatric.php?pesquisa_chave='+document.form1.x21_codhidrometro.value+'&funcao_js=parent.js_mostraaguahidromatric','Pesquisa',false);
     }else{
...
function js_pesquisax21_situacao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_aguasitleitura','func_aguasitleitura.php?funcao_js=parent.js_mostraaguasitleitura1|x17_codigo|x17_descr','Pesquisa',true);
  }else{
     if(document.form1.x21_situacao.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_aguasitleitura','func_aguasitleitura.php?pesquisa_chave='+document.form1.x21_situacao.value+'&funcao_js=parent.js_mostraaguasitleitura','Pesquisa',false);
     }else{
...
function js_pesquisax21_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_agualeiturista','func_agualeiturista.php?funcao_js=parent.js_mostraagualeiturista1|x16_numcgm|x16_numcgm','Pesquisa',true);
  }else{
     if(document.form1.x21_numcgm.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_agualeiturista','func_agualeiturista.php?pesquisa_chave='+document.form1.x21_numcgm.value+'&funcao_js=parent.js_mostraagualeiturista','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_db_usuarios','func_db_usuarios.php?funcao_js=parent.js_mostradb_usuarios1|id_usuario|nome','Pesquisa',true);
     ...
     if(document.form1.x21_usuario.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_db_usuarios','func_db_usuarios.php?pesquisa_chave='+document.form1.x21_usuario.value+'&funcao_js=parent.js_mostradb_usuarios','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_agualeitura','func_agualeitura.php?funcao_js=parent.js_preenchepesquisa|x21_codleitura','Pesquisa',true);
}
