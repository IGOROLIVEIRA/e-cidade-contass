  ...
  <center>
    <fieldset style="margin-left: 50%; margin-top: 10px;">
      ...
      <table border="0">
        ...
        <tr>
        <td nowrap title="<?= @$Tsi01_tipoprecoreferencia ?>">
            <strong>Cota��o por item:</strong>
          </td>
        <td>
            <?php
              $y = array('0' => 'Selecione','1' => 'No m�nimo uma cota��o', '2' => 'No m�nimo duas cota��o', '3' => 'No m�nimo tr�s cota��o');
        ...
        <tr>
                                    <td nowrap title="respCotacaocodigo">
                                        <?
                                        db_ancora("Respons�vel pela Cota��o: ","js_pesquisal31_numcgm(true,'respCotacaocodigo','respCotacaonome');",$db_opcao)
        ...
        <tr>
                                    <td nowrap title="respOrcacodigo">
                                        <?
                                        db_ancora("Resp. Recursos Or�ament�rios:","js_pesquisal31_numcgm(true,'respOrcacodigo','respOrcanome');",$db_opcao)
