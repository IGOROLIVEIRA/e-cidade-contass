...
if(isset($pc11_numero) && (!isset ($opcao) || (isset($opcao) && $opcao != "alterar" && $opcao != "excluir")) && isset($verificado)) {
  ...
  //Verifica se est� sendo acessada a rotina pela acessa itens com Licita��o ou processo de compras
...
if (isset($pc11_codigo) && $pc11_codigo != '') {
	...
	// faremos uma query na pcdotac para ver se o item, possui dota��o
	// caso nao possua, podemos liberar a sele��o de Sub elelemnto
    ...
    <center>
        <table border="0" height="100%">
            <tr>
                ...
                <td>
                    <input name="info" type="button" id="info" value="Outras informa��es"
            ...
            <tr>
                <td nowrap title="<?=@$Tpc16_codmater?>">
                    <?
                    // $tranca --> vari�vel q torna o campo pc16_codmater readOnly
                    $tranca = 1;
                    // $tquant --> vari�vel q passa para o iframe se valor ou quant � readOnly
                    $tquant = false;
                        ...
                        echo "
                                    ...
                                    function js_verificainteger(){
                                      ...
                                      if(arr_ksadecimalqtd[x.pc17_unid.value]=='f' && valor.indexOf('.')!=-1){
                                        alert('Unidade selecionada n�o permite quantidade com valor decimal. Verifique.');
            ...
            <tr>
                ...
                <td nowrap title="Quantidade restante a ser lan�ada">
                ...
                // Altera��o feita para processo de compra e licitacao
                if ( isset ($param) && trim($param) != "") {
                ...
                <td colspan="2">
                    <? if ($pc30_maximodiasorcamento > 0) { ?>
                      <input type='button' value='�ltimos Or�amentos' id='ultimosorcamentos'>
                    <? } ?>
            ...
            <tr id='ctnServicoQuantidade' style="display:none;">
              <td><strong>Servi�o Controlado por Quantidades: </strong></td>
              <td>
                <?php
                 ...
                 if(substr($o56_elemento,0,7) == '3449052'){
                     ...
                     $aOpcoes = array("false"=>"N�O","true"=>"SIM");
                 }
        ...
        <table border = "0" width="100%" height="50%">
            ...
            <tr>
                <td valign="top" align="center" width="100%">
                    ...
                    $cliframe_alterar_excluir->sql_disabled = $sSqlVerificaAut; // Desabilita Itens que tem Autoriza��o de Empenho
                    ...
                    if ( isset ($pc11_codigo) && trim($pc11_codigo) != ""){
                        $cliframe_alterar_excluir->msg_vazio = ($db_opcao == 1?"Inclus�o":($db_opcao == 2 || $db_opcao == 22?"Altera��o":"Exclus�o"))." do item $pc11_codigo";
                    } else {
            ...
            <tr>
                <td>
                    <center>
                        <b>Se ap�s cadastrar um item esse permanecer em vermelho, o cadastro esta incorreto.</b>
                    </center>
                </td>
            </tr>
            <tr>
...
function js_retornogetDados(oAjax) {
  ...
  if((num[1].substr(0,7))!=(valorElem.substr(0,7))){
    alert("Elemento do item selecionado diferente do item anterior, � necess�rio remover as dota��es vinculadas ao item para a troca do material");
 ...
 *
 ...
 js_habilitaCamposServico(sServicoQuantidade)
   aqui iremos verificar se o item � servi�o, agora se for sera possivel
   alterar quantidades, unidades
   e o usuario ainda ter� que definir se ele ser� controlado por quantidade ou
   como � hoje, controlando apenas pelo valor total
...
function js_verificaServicoQuantidade(){
  ...
  if (sServicoQuantidade == '' && lServico == 't') {
    alert('Selecione a forma de controle da quantidade do servi�o');
...
<?php
  ...
  //if ($oDaoSolicitem->numrows > 0) {
    ...
    if ($pc01_servico == 't' && substr($o56_elemento, 0, 7) != '34490') {
      ...
      echo "  $('pc11_servicoquantidade').options[1]     = new Option('N�O', 'false'); ";
