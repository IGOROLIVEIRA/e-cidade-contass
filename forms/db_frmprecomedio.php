  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_pcmater','func_pcmater.php?funcao_js=parent.js_mostrapcmater1|pc01_codmater|pc01_descrmater','Pesquisa',true);
     ...
     if(document.form1.l209_item.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_pcmater','func_pcmater.php?pesquisa_chave='+document.form1.l209_item.value+'&funcao_js=parent.js_mostrapcmater','Pesquisa',false);
     }else{
  ...
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo','db_iframe_liclicita','func_liclicita.php?funcao_js=parent.js_mostraliclicita1|l20_codigo|l20_codigo','Pesquisa',true);
     ...
     if(document.form1.l209_licitacao.value != ''){ 
        js_OpenJanelaIframe('top.corpo','db_iframe_liclicita','func_liclicita.php?pesquisa_chave='+document.form1.l209_licitacao.value+'&funcao_js=parent.js_mostraliclicita','Pesquisa',false);
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo','db_iframe_precomedio','func_precomedio.php?funcao_js=parent.js_preenchepesquisa|l209_licitacao','Pesquisa',true);
}
