<form name="form1" method="post" action="">
	<fieldset style="width: 500px; height: auto;"><!-- Alterado o height para auto para se adaptar à inclusão de novos campos-->
		<legend>
  ...
  <tr>
			<td><? db_ancora("<b>Código Slip: <b>","js_pesquisak17_codigo(true);",1);  ?>
							...
							<td><? db_input('k17_codigo',16,$Ik17_codigo,true,'text',4," onchange='js_pesquisak17_codigo(false);' onkeydown='js_enter_tab();'")  ?>
							</td>
			</tr>
			...
			<tr>
			  ...
			  <td colspan="2">
			  <input type="text" name="k00_formapag" id="k00_formapag" size="35" style="text-transform: uppercase;">
			  </td>
			</tr>
			<?php
...
function js_nova_linha(){
	...
	var oAjax = new Ajax.Request("func_ordembancariapagamento.RPC.php",
		  ...
		  parameters:{k00_cgmfornec: document.form1.k00_cgmfornec.value,k00_codordembancaria: document.form1.k00_codordembancaria.value,
			  k00_codord: document.form1.e53_codord.value,k17_codigo: document.form1.k17_codigo.value,k00_valor: document.form1.k00_valor.value,
			  k00_contabanco: document.form1.k00_contabanco[i].value,k00_formapag: document.form1.k00_formapag.value, k00_dtvencpag: dtvencpag},
