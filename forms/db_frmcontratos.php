...
function js_pesquisasi172_fornecedor(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_contratos','db_iframe_pcorcamforne','func_licitaforne.php?pesquisa_chave='+document.form1.si172_licitacao.value+'&funcao_js=parent.js_mostrapcorcamforne1|z01_numcgm|z01_nome','Pesquisa',true,'0','1','775','390');
  }else{
     if(document.form1.si172_fornecedor.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_contratos','db_iframe_pcorcamforne','func_licitaforne.php?pesquisa_chave='+document.form1.si172_fornecedor.value+'&funcao_js=parent.js_mostrapcorcamforne','Pesquisa',false,'0','1','775','390');
     }else{
...
function js_pesquisasi172_licitacao(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_contratos','db_iframe_liclicita','func_liclicitacontrato.php?funcao_js=parent.js_mostraliclicita1|l20_codigo|pc50_descr|l20_anousu|l20_edital|l20_naturezaobjeto|l20_objeto|l20_tipoprocesso','Pesquisa',true,'0','1','1300','550');
  }else{
     if(document.form1.si172_licitacao.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_contratos','db_iframe_liclicita','func_liclicitacontrato.php?pesquisa_chave='+document.form1.si172_licitacao.value+'&funcao_js=parent.js_mostraliclicita','Pesquisa',false,'0','1','1300','550');
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo.iframe_contratos','db_iframe_contratos','func_contratos.php?funcao_js=parent.js_preenchepesquisa|si172_sequencial','Pesquisa',true,'0','1','1300','550');
}
