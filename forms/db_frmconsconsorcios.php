...
function js_pesquisac200_numcgm(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('top.corpo.iframe_consconsorcios','db_iframe_cgm','func_nome.php?funcao_js=parent.js_mostracgm1|z01_numcgm|z01_nome','Pesquisa',true,'0','1');
  }else{
     if(document.form1.c200_numcgm.value != ''){ 
        js_OpenJanelaIframe('top.corpo.iframe_consconsorcios','db_iframe_cgm','func_nome.php?pesquisa_chave='+document.form1.c200_numcgm.value+'&funcao_js=parent.js_mostracgm','Pesquisa',false,'0','1');
     }else{
...
function js_pesquisa(){
  js_OpenJanelaIframe('top.corpo.iframe_consconsorcios','db_iframe_consconsorcios','func_consconsorcios.php?funcao_js=parent.js_preenchepesquisa|c200_sequencial','Pesquisa',true,'0','1');
}
