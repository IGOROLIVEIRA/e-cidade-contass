...
function js_pesquisao06_codrec(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('CurrentWindow.corpo','db_iframe_orcfontes','func_orcfontesreceita.php?funcao_js=parent.js_mostraorcfontes1|o57_codfon|o57_descr','Pesquisa',true);
  }else{
