...
function js_verifica_select(valor){
    ...
    if(valor == '3'){
    	var combo = document.getElementById('si04_especificacao');
    	removeAllOptions(combo);
    	combo.options[0] = new Option ("Veículo de passeio", "3");
    	combo.options[1] = new Option ("Utilitário (Camionete)", "4");
    	combo.options[2] = new Option ("Ônibus", "5");
    	combo.options[3] = new Option ("Caminhão", "6");
    	combo.options[4] = new Option ("Motocicleta", "7");
    	combo.options[5] = new Option ("Van", "8");
    }
    if(valor == '4'){
    	var combo = document.getElementById('si04_especificacao');
    	removeAllOptions(combo);
    	combo.options[0] = new Option ("Trator de Esteira", "9");
    	combo.options[1] = new Option ("Trator de Pneu", "10");
    	combo.options[2] = new Option ("Moto niveladora", "11");
    	combo.options[3] = new Option ("Pá-Carregadeira", "12");
    	combo.options[4] = new Option ("Retro Escavadeira", "13");
    	combo.options[5] = new Option ("Mini Carregadeira", "14");
    	combo.options[6] = new Option ("Escavadeira", "15");
    	combo.options[7] = new Option ("Empilhadeira", "16");
    	combo.options[8] = new Option ("Compactador", "17");
    }
    if(valor == '5'){
    	var combo = document.getElementById('si04_especificacao');
    	removeAllOptions(combo);
    	combo.options[0] = new Option ("Gerador", "18");
    	combo.options[1] = new Option ("Moto bomba", "19");
    	combo.options[2] = new Option ("Roçadeira", "20");
    	combo.options[3] = new Option ("Motoserra", "21");
    	combo.options[4] = new Option ("Pulverizador", "22");
    	combo.options[5] = new Option ("Compactador de Mão", "23");
    	combo.options[6] = new Option ("Oficina", "24");
    	combo.options[7] = new Option ("Motor de Popa", "25");
    }
    if(valor == '99'){
    	var combo = document.getElementById('si04_especificacao');
    	removeAllOptions(combo);
...
if ($db_opcao==2 || $db_opcao==22) {
	...
	if ($si04_especificacao == 23) {
		input.value = 'Compactador de Mão';
	}
