...
if(isset($incluir) ||isset($excluir)){
  ...
  if($clbensimoveis->numrows > 0){
    echo "CurrentWindow.corpo.iframe_bensmater.location.href='pat1_bensmater001.php?desabilita=true&t53_codbem=$t54_codbem';";
  }else{
    if(isset($excluir)){
      echo "CurrentWindow.corpo.iframe_bensmater.location.href='pat1_bensmater001.php?t53_codbem=$t54_codbem';";
    }
  }
}
?>
