...
function js_pesquisa_liclicita(mostra){
  if(mostra==true){
    js_OpenJanelaIframe('','db_iframe_liclicita','func_liclicita.php?criterioadjudicacao=true&funcao_js=parent.js_mostraliclicita1|l20_codigo|l20_edital|l20_anousu|pc50_codcom|l03_tipo','Pesquisa',true);
  }else{
