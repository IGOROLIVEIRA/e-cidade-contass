...
<table  border="0" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    ...
    if($numrows_itens>0){
      ...
      echo "<td nowrap class='bordas' align='center'><b>Taxa/Tabela %</b></td> <!--OC3770-->";
