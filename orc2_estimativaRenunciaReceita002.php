...
$iAnoUsu_2    = $iAnoUsu + 2;
/*
 * valida��o da op��o ldo ou loa, para imprimir no head3.
 */
if ($oGet->sModelo == 'ldo') {
  $sModelo = 'LEI DE DIRETRIZES OR�AMENT�RIAS';
} else {
  $sModelo = 'LEI OR�AMENT�RIA ANUAL';
}
$head2 = "MUNIC�PIO DE {$munic}";
$head3 = $sModelo;
$head4 = "ANEXO DE METAS FISCAIS";
$head5 = $iAnoUsu;
$head6 = "ESTIMATIVA E COMPENSA��O DA REN�NCIA DE RECEITA";
