  ...
  if (isset($chavepesquisa) && trim($chavepesquisa) != "" && $liberaaba == "false") {
    ...
    if ($clpcproc->numrows > 0) {
      ...
      if ($oSolicitacao->pc10_solicitacaotipo != 5) {
        ...
        db_msgbox("Solicita��o em processo de compras.");
...
if (isset($alterar) || isset($chavepesquisa)) {
  ...
  if (isset($alterar)) {
    ...
    /**
     * Altera��o do c�digo do Protocolo Administrativo
     */
    if (!$sqlerro) {
    ...
    if (!$sqlerro) {
     ...
     /**
      * verificamos se a solicitacao � de Regitro de preco
      */
      ...
      if ($oDaoSolicitaVinculo->numrows > 0) {
        ...
        if ($pc10_solicitacaotipo == 5   && $pc54_solicita != $iNumeroRegistroPrecoAnterior) {
          ...
          /**
           * verifica se existe itens lan�ados para a Solicitacao
           */
          if ($iTotalItensCadastrados > 0) {

            $sqlerro  = true;
            $erro_msg = 'Antes de alterar a Compila��o do Registro de pre�o ,exclua os itens da solicita��o.';
          ...
          if ($iTotalItensCadastrados > 0) {
            ...
            $sqlerro  = true;
            $erro_msg = 'Antes de alterar o tipo da solicita��o ,exclua os itens da solicita��o.';
        ...
        if ($lAlteraVinculoCompilacaoRegistroPreco) {
          ...
          if ($oDaoSolicitaVinculo->erro_status == 0) {
            ...
            $erro_msg = 'Erro ao modificar vinculo da Solicitacao com o Registro de Pre�o.';
            $sqlerro  = true;
          }
        ...
        if ($pc10_solicitacaotipo == 5 && !$sqlerro) {
          ...
          if ($oDaoSolicitaVinculo->erro_status == 0) {
            ...
            $erro_msg  = "Erro ao vincular da Solicitacao com o Registro de Pre�o.\n";
            $erro_msg .= $oDaoSolicitaVinculo->erro_msg;
            $sqlerro  = true;
          }
        }
   ...
   /*
    * Verificamos se a solicita��o possui vinculo com o  pacto, e entao
   ...
   if ($oDaoOrctiporecConvenioPacto->numrows > 0) {
     ...
     if ($oConvenio->o74_sequencial != $o74_sequencial) {
      ...
      /**
       * Verificamos se o usu�rio j� cadastrou algum item
      ...
      if ($oDaoSolicitem->numrows > 0) {
        ...
        $sqlerro  = true;
        $erro_msg = "Solicita��o j� possui itens cadastrados!\\nA solicita��o n�o podera ser vinculada a  um pacto.";
  ...
  if ($clsolicita->numrows > 0) {
    ...
    /**
     * verifica se a solicitacao � de RP. caso for, traz o codigo da compilacao
     */
...
if(isset($chavepesquisa) || isset($pc10_numero)){
  ...
  if($erro==true){
    db_msgbox("Usu�rio: \\n\\nFoi gerada autoriza��o de empenho para um ou mais item desta solicita��o.\\nSolicita��o de compras n�o poder� ser alterada.\\n\\nAdiministrador:");
  ...
  */
  ...
  if (isset($param) && trim($param) == ""){
    ...
    if ( $clpcprocitem->numrows > 0 ) {
      ...
      /**
       * Tipo de solicatao: 5 - Registro de pre�o
