...
$head5 = "MODALIDADE: ".$l20_numero."/".substr($l20_anousu,0,4);
$oPDF->addpage();
...
$oPDF->setfont('arial','',10);
$oPDF->cell(0,5,$l212_dtinicio." a ".$l212_dtfim,0,1,"L",0);
$oPDF->setfont('arial','b',10);
$oPDF->cell(23,5,"Objeto:",0,0,"L",0);
$oPDF->setfont('arial','',10);
$oPDF->cell(0,5,$l20_objeto,0,1,"L",0);
$oPDF->cell(0,5,"_____________________________________________________________________________________________",0,1,"L",0);
$oPDF->setfont('arial','b',14);
$oPDF->ln(5);
$oPDF->cell(0,5,"ITENS CREDENCIADOS",0,1,"C",0);
$oPDF->ln(5);
$result_itenscredenciados = $clcredenciamentotermo->sql_record($clcredenciamentotermo->sql_query_itens($l212_sequencial));
$numrows_itenscredenciamento=$clcredenciamentotermo->numrows;
$oPDF->setfont('arial','b',10);
$oPDF->cell(30,5,"Número do item",    1,0,"C",0);
$oPDF->cell(100,5,"Material",         1,0,"C",0);
$oPDF->cell(35,5,"Unidade de Medida", 1,0,"C",0);
$oPDF->cell(30,5,"Valor unitário",    1,1,"C",0);
$oPDF->setfont('arial','',8);
for($x = 0; $x < $numrows_itenscredenciamento;$x++){
    db_fieldsmemory($result_itenscredenciados,$x);
    $oPDF->cell(30,5,$pc01_codmater,    1,0,"C",0);
    $oPDF->cell(100,5,$pc01_descrmater, 1,0,"C",0);
    $oPDF->cell(35,5,$m61_descr,        1,0,"C",0);
    $oPDF->cell(30,5,$pc23_vlrun,       1,1,"C",1);
