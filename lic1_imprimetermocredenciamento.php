...
$oPDF->ln(5);
$result_itenscredenciados = $clcredenciamentotermo->sql_record($clcredenciamentotermo->sql_query_itensprecomedio(null, 'pc01_codmater,pc11_seq,pc01_descrmater,m61_descr,si02_vlprecoreferencia,l205_datacred', null, "l212_sequencial = $l212_sequencial"));
$numrows_itenscredenciamento = $clcredenciamentotermo->numrows;
$oPDF->setfont('arial', 'b', 10);
$oPDF->cell(35, 5, "Código do Material",    1, 0, "C", 0);
$oPDF->cell(30, 5, "Sequencial",            1, 0, "C", 0);
$oPDF->cell(100, 5, "Material",             1, 0, "C", 0);
$oPDF->cell(35, 5, "Unidade de Medida",     1, 0, "C", 0);
$oPDF->cell(30, 5, "Valor unitário",        1, 0, "C", 0);
