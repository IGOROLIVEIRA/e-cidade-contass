...
class cl_pcprocitem { 
   ...
   function incluir ($pc81_codprocitem){ 
     ...
     if($pc81_codprocitem == "" || $pc81_codprocitem == null ){
       $result = @pg_query("select nextval('pcprocitem_pc81_codprocitem_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from pcprocitem_pc81_codprocitem_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,6385,'$this->pc81_codprocitem','I')");
       $resac = pg_query("insert into db_acount values($acount,1043,6385,'','".AddSlashes(pg_result($resaco,0,'pc81_codprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1043,6386,'','".AddSlashes(pg_result($resaco,0,'pc81_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1043,6387,'','".AddSlashes(pg_result($resaco,0,'pc81_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc81_codprocitem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6385,'$this->pc81_codprocitem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc81_codprocitem"]))
           $resac = pg_query("insert into db_acount values($acount,1043,6385,'".AddSlashes(pg_result($resaco,$conresaco,'pc81_codprocitem'))."','$this->pc81_codprocitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc81_codproc"]))
           $resac = pg_query("insert into db_acount values($acount,1043,6386,'".AddSlashes(pg_result($resaco,$conresaco,'pc81_codproc'))."','$this->pc81_codproc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc81_solicitem"]))
           $resac = pg_query("insert into db_acount values($acount,1043,6387,'".AddSlashes(pg_result($resaco,$conresaco,'pc81_solicitem'))."','$this->pc81_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc81_codprocitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6385,'$this->pc81_codprocitem','E')");
         $resac = pg_query("insert into db_acount values($acount,1043,6385,'','".AddSlashes(pg_result($resaco,$iresaco,'pc81_codprocitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1043,6386,'','".AddSlashes(pg_result($resaco,$iresaco,'pc81_codproc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1043,6387,'','".AddSlashes(pg_result($resaco,$iresaco,'pc81_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
...
//    inner join  inner join   where pc81_codproc=2 and pc22_codorc=1;
     $sql .= " from pcprocitem ";
     $sql .= "      inner join pcorcamitemproc on pcorcamitemproc.pc31_pcprocitem=pcprocitem.pc81_codprocitem";
     $sql .= "      inner join pcorcamitem on pcorcamitem.pc22_orcamitem=pcprocitemproc.pc31_orcamitem";
     $sql .= "      inner join solicitem  on  solicitem.pc11_codigo = pcprocitem.pc81_solicitem";
     $sql .= "      inner join pcproc  on  pcproc.pc80_codproc = pcprocitem.pc81_codproc";
     $sql .= "      inner join solicita  on  solicita.pc10_numero = solicitem.pc11_numero";
