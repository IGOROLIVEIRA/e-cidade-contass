...
class cl_solicitempcmater { 
   ...
   function incluir ($pc16_codmater,$pc16_solicitem){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5550,'$this->pc16_codmater','I')");
       $resac = pg_query("insert into db_acountkey values($acount,6388,'$this->pc16_solicitem','I')");
       $resac = pg_query("insert into db_acount values($acount,1046,5550,'','".AddSlashes(pg_result($resaco,0,'pc16_codmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,1046,6388,'','".AddSlashes(pg_result($resaco,0,'pc16_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc16_codmater=null,$pc16_solicitem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5550,'$this->pc16_codmater','A')");
         $resac = pg_query("insert into db_acountkey values($acount,6388,'$this->pc16_solicitem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc16_codmater"]))
           $resac = pg_query("insert into db_acount values($acount,1046,5550,'".AddSlashes(pg_result($resaco,$conresaco,'pc16_codmater'))."','$this->pc16_codmater',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc16_solicitem"]))
           $resac = pg_query("insert into db_acount values($acount,1046,6388,'".AddSlashes(pg_result($resaco,$conresaco,'pc16_solicitem'))."','$this->pc16_solicitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
   ...
   function excluir ($pc16_codmater=null,$pc16_solicitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5550,'$this->pc16_codmater','E')");
         $resac = pg_query("insert into db_acountkey values($acount,6388,'$this->pc16_solicitem','E')");
         $resac = pg_query("insert into db_acount values($acount,1046,5550,'','".AddSlashes(pg_result($resaco,$iresaco,'pc16_codmater'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,1046,6388,'','".AddSlashes(pg_result($resaco,$iresaco,'pc16_solicitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
