   ...
   function excluir ($pc29_orcamitem=null,$pc29_solicitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6389,'$this->pc29_orcamitem','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5516,'$this->pc29_solicitem','E')");
