...
class cl_orcelemento { 
   ...
   function alterar ($o56_codele=null) { 
      $this->atualizacampos();
   ...
   function excluir ($o56_codele=null,$dbwhere=null) { 
     if($dbwhere==null || $dbwhere==""){
       $resaco = $this->sql_record($this->sql_query_file($o56_codele));
     }else{ 
   ...
   function sql_query ( $o56_codele=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   // funcao do sql 
   function sql_query_file ( $o56_codele=null,$campos="*",$ordem=null,$dbwhere=""){ 
     $sql = "select ";
     if($campos != "*" ){
       $campos_sql = explode("#",$campos);
       $virgula = "";
   ...
   function db_verifica_elemento_exclusao($elemento){
   ...
   function db_verifica_elemento($elemento){
    ...
    $cod_mae = db_le_mae($elemento,false);
    $this->sql_record($this->sql_query_file("","o56_elemento","","o56_elemento='$cod_mae'"));
    if($this->numrows<1){
