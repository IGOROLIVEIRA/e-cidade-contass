...
class cl_pcdotac { 
   ...
   function excluir ($pc13_codigo=null,$pc13_anousu=null,$pc13_coddot=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5561,'$this->pc13_codigo','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5559,'$this->pc13_anousu','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5560,'$this->pc13_coddot','E')");
   ...
   function sql_query ( $pc13_codigo=null,$pc13_anousu=null,$pc13_coddot=null,$campos="*",$ordem=null,$dbwhere=""){ 
     ...
     $sql .= "      inner join orcelemento  on  orcelemento.o56_codele = pcdotac.pc13_codele";
     ...
     $sql .= "      inner join orcelemento  as a on   a.o56_codele = orcdotacao.o58_codele";
