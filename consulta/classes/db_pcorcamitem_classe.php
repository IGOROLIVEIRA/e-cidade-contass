...
class cl_pcorcamitem { 
   ...
   function incluir ($pc22_orcamitem){ 
     ...
     if($pc22_orcamitem == "" || $pc22_orcamitem == null ){
       $result = @pg_query("select nextval('pcorcamitem_pc22_orcamitem_seq')"); 
       if($result==false){
       ...
       $result = @pg_query("select last_value from pcorcamitem_pc22_orcamitem_seq");
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acountkey values($acount,5514,'$this->pc22_orcamitem','I')");
       $resac = pg_query("insert into db_acount values($acount,859,5514,'','".AddSlashes(pg_result($resaco,0,'pc22_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,859,5515,'','".AddSlashes(pg_result($resaco,0,'pc22_codorc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc22_orcamitem=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5514,'$this->pc22_orcamitem','A')");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc22_orcamitem"]))
           $resac = pg_query("insert into db_acount values($acount,859,5514,'".AddSlashes(pg_result($resaco,$conresaco,'pc22_orcamitem'))."','$this->pc22_orcamitem',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc22_codorc"]))
           $resac = pg_query("insert into db_acount values($acount,859,5515,'".AddSlashes(pg_result($resaco,$conresaco,'pc22_codorc'))."','$this->pc22_codorc',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc22_orcamitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,5514,'$this->pc22_orcamitem','E')");
         $resac = pg_query("insert into db_acount values($acount,859,5514,'','".AddSlashes(pg_result($resaco,$iresaco,'pc22_orcamitem'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,859,5515,'','".AddSlashes(pg_result($resaco,$iresaco,'pc22_codorc'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
