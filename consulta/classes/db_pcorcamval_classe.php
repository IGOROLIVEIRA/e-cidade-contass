   ...
   function excluir ($pc23_orcamforne=null,$pc23_orcamitem=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         $resac = pg_query("select nextval('db_acount_id_acount_seq') as acount");
         $acount = pg_result($resac,0,0);
         $resac = pg_query("insert into db_acountkey values($acount,6378,'$this->pc23_orcamforne','E')");
         $resac = pg_query("insert into db_acountkey values($acount,5517,'$this->pc23_orcamitem','E')");
