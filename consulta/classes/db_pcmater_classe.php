...
class cl_pcmater { 
   ...
   function incluir ($pc01_codmater){ 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       ...
       $resac = pg_query("insert into db_acount values($acount,855,6602,'','".AddSlashes(pg_result($resaco,0,'pc01_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       $resac = pg_query("insert into db_acount values($acount,855,6761,'','".AddSlashes(pg_result($resaco,0,'pc01_conversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
     }
     return true;
   } 
   ...
   function alterar ($pc01_codmater=null) { 
     ...
     if($this->numrows>0){
       for($conresaco=0;$conresaco<$this->numrows;$conresaco++){
         ...
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_ativo"]))
           $resac = pg_query("insert into db_acount values($acount,855,6602,'".AddSlashes(pg_result($resaco,$conresaco,'pc01_ativo'))."','$this->pc01_ativo',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         if(isset($GLOBALS["HTTP_POST_VARS"]["pc01_conversao"]))
           $resac = pg_query("insert into db_acount values($acount,855,6761,'".AddSlashes(pg_result($resaco,$conresaco,'pc01_conversao'))."','$this->pc01_conversao',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
     $result = @pg_exec($sql);
     if($result==false){ 
   ...
   function excluir ($pc01_codmater=null,$dbwhere=null) { 
     ...
     if(($resaco!=false)||($this->numrows!=0)){
       for($iresaco=0;$iresaco<$this->numrows;$iresaco++){
         ...
         $resac = pg_query("insert into db_acount values($acount,855,6602,'','".AddSlashes(pg_result($resaco,$iresaco,'pc01_ativo'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
         $resac = pg_query("insert into db_acount values($acount,855,6761,'','".AddSlashes(pg_result($resaco,$iresaco,'pc01_conversao'))."',".db_getsession('DB_datausu').",".db_getsession('DB_id_usuario').")");
       }
     }
