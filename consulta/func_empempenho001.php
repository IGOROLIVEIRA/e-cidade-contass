...
<script>
 function js_abre_pagordem(){
    js_OpenJanelaIframe('top.corpo','db_iframe_pagordem','func_pagordem002.php?e60_numemp='+"<?=$e60_numemp ?>",'Pesquisa',true);
 }
 function js_abre_empnota(){
    js_OpenJanelaIframe('top.corpo','db_iframe_empnota','func_empnota001.php?e60_numemp='+"<?=$e60_numemp ?>",'Pesquisa',true);
 }
 
 function js_abre_lancamentos(){
    js_OpenJanelaIframe('top.corpo','db_iframe_conlancam002','func_conlancam002.php?chavepesquisa='+"<?=$e60_numemp  ?>",'Pesquisa',true);
 }
 function js_abre_empempitem(){
    js_OpenJanelaIframe('top.corpo','db_iframe_empempitem','emp1_empempitem005.php?e60_numemp='+"<?=$e60_numemp?>"+'&e55_autori='+"<?=@$e61_autori?>",'Pesquisa',true);
 }
