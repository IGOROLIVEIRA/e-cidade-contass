...
<form>
    <center>
        <table border="0" width="350;">
            <tr>
                <td><b>Sequencial:</b></td>
                <td>
                    <?php 
                        db_input("sequencial", 10, null, true, "text", 3);
                    ?>
                </td>
            </tr>
            <tr>
                <td><b>CGM do Ente:</b></td>
                <td>
                    <?php 
                    db_input("cgmente", 10, null, true, "text", 3);
                    ?>
                </td>
            </tr>
            <tr>
                <td><b>Tipo Órgão?:</b></td>
                <td>
                    <?php
                        $tipoOrgao = array('0' => 'Selecione', 
                            '1' => "Administração Direta Executivo",
                            '2' => "Administração Direta Legislativo",
                            '3' => "Unidade Gestora");
                        db_select('beneficiariotesouro', $tipoOrgao, true, 1, "");
                    ?>
                </td>
            </tr>
        </table>
        ...
        <fieldset>
            <legend><b>Itens Lançados</b></legend>
